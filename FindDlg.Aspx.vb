...
Partial Public Class FindDlg
    ...
    Protected Sub GetSelectedRecords()
        ...
        Try
            Result.Columns.AddRange(New DataColumn(15) {New DataColumn("Invoice_No"), New DataColumn("Invoicetype"), New DataColumn("Invoice_Date"), New DataColumn("Supplier"), New DataColumn("SupplierName"), New DataColumn("Rfference_No"), New DataColumn("Invoice"), New DataColumn("Potongan"), New DataColumn("DPP"), New DataColumn("PPn"), New DataColumn("PPn_Invoice"), New DataColumn("PPh"), New DataColumn("PPh_Invoice"), New DataColumn("TotalAmount"), New DataColumn("SupplierType"), New DataColumn("Remark")})
            For Each Row As GridViewRow In GridView1.Rows
                If Row.RowType = DataControlRowType.DataRow Then
                    Dim chkRow As CheckBox = TryCast(Row.Cells(0).FindControl("chkRow"), CheckBox)
                    If chkRow.Checked Then
                        Result.Rows.Add(Row.Cells(1).Text, Row.Cells(2).Text, Row.Cells(3).Text, Row.Cells(4).Text, Row.Cells(5).Text, Row.Cells(6).Text, Row.Cells(7).Text, Row.Cells(8).Text, Row.Cells(9).Text, Row.Cells(10).Text, Row.Cells(11).Text, Row.Cells(12).Text, Row.Cells(13).Text, Row.Cells(14).Text, Row.Cells(15).Text, Row.Cells(16).Text)
                    End If
                End If
            Next
            Session("Result") = Result
