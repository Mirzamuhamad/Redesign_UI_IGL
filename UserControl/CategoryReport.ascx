<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CategoryReport.ascx.vb" Inherits="UserControl_CategoryReport" %>
        ...
        <table width="50%">
            ...
            <tr>
                <td style="width:47%;">
                   ...
                   <dx:ASPxGridView ID="Grid1" ClientInstanceName="Grid1" runat="server" KeyFieldName="CODE" EmptyDataText="There are no data record(s) to display."
