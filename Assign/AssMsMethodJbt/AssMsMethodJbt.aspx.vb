...
Imports System.Data
Partial Class Assign_AssMsMethodJbt_AssMsMethodJbt
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsMethodJbtAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsMethodJbtAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsMethodJbtAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "Method" Then
                StrSelected = SelectedGridDev(AvailableGrid, "JobTtlCode")
            ElseIf ddlGroupBy.SelectedValue = "Job Title" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Method" Then
                StrSelected = SelectedGridDev(AssignedGrid, "JobTitle")
            ElseIf ddlGroupBy.SelectedValue = "Job Title" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsMethodJbtCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Method" Then
                Session("filter") = "SELECT * FROM VMsMethod"
                ResultField = "MethodCode, MethodName"
            Else
                Session("filter") = "SELECT * FROM VMsJobTitle"
                ResultField = "Job_Title_Code, Job_Title_Name"
            End If
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Method" Then
                Session("filter") = "SELECT * FROM VMsMethod"
                ResultField = "MethodCode, MethodName"
            Else
                Session("filter") = "SELECT * FROM VMsJobTitle"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Method" Then
                ds = SQLExecuteQuery("SELECT MethodCode, MethodName FROM MsMethod WHERE MethodCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("SELECT JobTtlCode, JobTtlName FROM MsJobTitle WHERE JobTtlCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Method" Then
                ds = SQLExecuteQuery("SELECT MethodCode, MethodName FROM MsMethod WHERE MethodCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT JobTtlCode, JobTtlName FROM MsJobTitle WHERE JobTtlCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Method" Then
                ds = SQLExecuteQuery("SELECT MethodCode, MethodName FROM MsMethod WHERE MethodCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT JobTtlCode, JobTtlName FROM MsJobTitle WHERE JobTtlCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Method" Then
                SQLString = "EXEC S_MsMethodJbtPrint 0, 'Method - Job Title', 'Job Title Code', 'Job Title Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsMethodJbtPrint 1, 'Job Title - Method', 'Method Code', 'Method Name', " + QuotedStr(ViewState("UserId"))
            End If
