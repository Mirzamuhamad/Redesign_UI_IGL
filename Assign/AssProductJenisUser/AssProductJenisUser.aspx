<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssProductJenisUser.aspx.vb" Inherits="AssProductJenisUser" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">
        <asp:Label ID="lblJudul" runat="server" Text="Label"></asp:Label></div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Product Jenis</asp:ListItem>
