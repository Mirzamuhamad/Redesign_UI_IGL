...
Imports System.Data
Partial Class AssProductJenisUser
    ...
    Protected Sub InitProperty()
        ...
        lblJudul.Text = "Product Jenis Autorization - User"
    End Sub
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsProductJenisUserAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsProductJenisUserAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsProductJenisUserAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AvailableGrid, "JenisCode")
            ElseIf ddlGroupBy.SelectedValue = "Product Jenis" Then
                StrSelected = SelectedGridDev(AvailableGrid, "UserID")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = User   1 = ProductJenis
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AssignedGrid, "ProductJenis")
            ElseIf ddlGroupBy.SelectedValue = "Product Jenis" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = User   1 = ProductJenis
            SqlString = "EXEC S_MsProductJenisUserCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "select * FROM MsProductJenis"
                ResultField = "JenisCode, JenisName"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "ProductJenis" Then
                ds = SQLExecuteQuery("select JenisCode, JenisName FROM MsProductJenis Where JenisCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "ProductJenis" Then
                ds = SQLExecuteQuery("select JenisCode, JenisName FROM MsProductJenis Where JenisCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "ProductJenis" Then
                ds = SQLExecuteQuery("select JenisCode, JenisName FROM MsProductJenis Where JenisCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                SQLString = "EXEC S_MsProductJenisUserPrint 0, 'User - ProductJenis', 'Product Jenis Code', 'Product Jenis Name', " + QuotedStr(ViewState("UserId")) + ""
            Else
                SQLString = "EXEC S_MsProductJenisUserPrint 1, 'ProductJenis - User', 'User Code', 'User Name', " + QuotedStr(ViewState("UserId")) + ""
            End If
