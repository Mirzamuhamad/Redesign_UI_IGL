<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsReportUser.aspx.vb" Inherits="Assign_AssMsReportUser_AssMsReportUser" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Report User</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Report</asp:ListItem>
