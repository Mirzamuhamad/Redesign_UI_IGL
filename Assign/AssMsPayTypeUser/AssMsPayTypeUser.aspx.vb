...
Partial Class Assign_AssMSPayTypeUser_AssMsPayTypeUser
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSPayTypeUserAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSPayTypeUserAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
                dsAssigned.SelectCommand = "Select '' as CODE, '' as NAME, '' AS ACCOUNT"
                dsAvailable.SelectCommand = "Select '' as CODE, '' as NAME, '' AS ACCOUNT"
            End If
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsPayTypeUserAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AvailableGrid, "PayCode")
            ElseIf ddlGroupBy.SelectedValue = "Pay Type" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AssignedGrid, "PayCode")
            ElseIf ddlGroupBy.SelectedValue = "Pay Type" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = User   1 = Pay Type
            SqlString = "EXEC S_MsPayTypeUserCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "select * FROM VMsPayType"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Pay Type" Then
                ds = SQLExecuteQuery("select PayCode, PayName FROM MsPayType Where PayCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Pay Type" Then
                ds = SQLExecuteQuery("select PayCode, PayName FROM MsPayType Where PayCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Pay Type" Then
                ds = SQLExecuteQuery("select PayCode, PayName FROM MsPayType Where PayCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                SQLString = "EXEC S_MSPayTypeUserPrint 0, 'User - Pay Type', 'Pay Type Code', 'Pay Type Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MSPayTypeUserPrint 1, 'Pay Type - User', 'User Code', 'User Name', " + QuotedStr(ViewState("UserId"))
            End If
