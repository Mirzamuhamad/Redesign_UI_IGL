<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssUserProduct.aspx.vb" Inherits="Assign_AssUserProduct_AssUserProduct" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign User Product</div>
    <hr style="color:Blue" /> 
        <br />        
