<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssSuppProduct.aspx.vb" Inherits="Assign_AssSuppProduct_AssSuppProduct" %>
                ...
                <td style="width:40%;">
                   <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">                   
                    <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        ...
                        <dx:GridViewDataColumn FieldName="TYPE" VisibleIndex="3" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                                
                        </Columns>
