...
Partial Class Assign_AssSuppProduct_AssSuppProduct
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsSuppProductAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsSuppProductAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
                dsAssigned.SelectCommand = "Select '' as CODE, '' as NAME, '' AS TYPE"
                dsAvailable.SelectCommand = "Select '' as CODE, '' as NAME, '' AS TYPE"
            End If
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsSuppProductAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Supplier" Then
            ...
            ElseIf ddlGroupBy.SelectedValue = "Product" Then
                ...
                StrSelected = SelectedGridDev(AvailableGrid, "SuppCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            ElseIf ddlGroupBy.SelectedValue = "Product" Then
                ...
                StrSelected = SelectedGridDev(AssignedGrid, "SuppCode")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Supplier   1 = User
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Supplier   1 = User
            SqlString = "EXEC S_MsSuppProductCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Supplier" Then
                ds = SQLExecuteQuery("select Supplier_Code, Supplier_Name From VMsSupplier Where Supplier_Code = " + QuotedStr(tbCode.Text), ViewState("DBConnection"))
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Supplier" Then
                ds = SQLExecuteQuery("select SupplierCode, SupplierName From MsSupplier Where SupplierCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Supplier" Then
                ds = SQLExecuteQuery("select SupplierCode, SupplierName From MsSupplier Where SupplierCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Supplier" Then
                SQLString = "EXEC S_MsSuppProductPrint 0, 'Supplier - Product', 'Product Code', 'Product Name' ," + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsSuppProductPrint 1, 'Product - Supplier', 'Supplier Code', 'Supplier Name'," + QuotedStr(ViewState("UserId"))
            End If
            Session("DBConnection") = ViewState("DBConnection")
