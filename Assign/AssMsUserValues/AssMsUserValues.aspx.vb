...
Partial Class Assign_AssMSPayTypeUser_AssMsUserValues
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_SAUserValuesAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_SAUserValuesAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
                dsAssigned.SelectCommand = "Select '' as CODE, '' as NAME, '' AS RANGE"
                dsAvailable.SelectCommand = "Select '' as CODE, '' as NAME, '' AS RANGE"
            End If
            AssignedGrid.Columns(3).Visible = (ddlGroupBy.SelectedValue.ToUpper = "USER")
            AvailableGrid.Columns(3).Visible = (ddlGroupBy.SelectedValue.ToUpper = "USER")
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_SAUserValuesAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString + ", " + tbRange.text
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            'If AvailableGrid.FilterEnabled = True And AvailableGrid.FilterExpression.ToString <> "" Then
            '    lbstatus.Text = MessageDlg(AvailableGrid.FilterExpression)
            'Else
            '    lbstatus.Text = MessageDlg("NO")
            'End If
            'Exit Sub   
            ...
            ElseIf ddlGroupBy.SelectedValue = "Trans Type" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = User   1 = Pay Type
            SqlString = "EXEC S_SAUserValuesCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Pay Type" Then
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                SQLString = "EXEC S_SAUserValuesPrint 0, 'User - Trans Type', 'Trans Type Code', 'Trans Type Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_SAUserValuesPrint 1, 'Trans Type - User', 'User Code', 'User Name', " + QuotedStr(ViewState("UserId"))
            End If
