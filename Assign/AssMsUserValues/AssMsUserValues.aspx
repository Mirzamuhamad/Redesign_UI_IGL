<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsUserValues.aspx.vb" Inherits="Assign_AssMSPayTypeUser_AssMsUserValues" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign User Values</div>
    <hr style="color:Blue" /> 
        <br />        
        ...
        <asp:Panel runat="server" ID="PnlAssign">          
              <table width="100%">
                <tr>
                    ...
                    <td class="style1">RANGE :</td>
                    <td>
                        
                        <asp:TextBox CssClass="TextBox" Id="tbRange" value="0" runat="server" Width="140px" 
                            AutoPostBack="True"/>
                ...
                <td style="width:40%;">
                   <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">                   
                    <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        ...
                        <dx:GridViewDataColumn FieldName="RANGE" VisibleIndex="3" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                                
                        </Columns>
