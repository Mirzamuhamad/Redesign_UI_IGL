...
Imports System.Data
Partial Class Assign_AssMsPLCategoryAcc_AssMsPLCategoryAcc
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsPLCategoryAccAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsPLCategoryAccAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsPLCategoryAccAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "PL Cost Center" Then
                StrSelected = SelectedGridDev(AvailableGrid, "Account")
            ElseIf ddlGroupBy.SelectedValue = "Account" Then
                StrSelected = SelectedGridDev(AvailableGrid, "PLCategorySubCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            ElseIf ddlGroupBy.SelectedValue = "Account" Then
                StrSelected = SelectedGridDev(AssignedGrid, "PLCategorySubCode")
            End If
            If StrSelected.Trim <> "" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = PL Cost Center   1 = Account
            SqlString = "EXEC S_MsPLCategoryAccCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "PL Cost Center" Then
                Session("filter") = "SELECT * FROM VMsPLCategorySub"
                ResultField = "PLCategorySubCode, PLCategorySubName"
            Else
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "PL Cost Center" Then
                Session("filter") = "SELECT * FROM VMsPLCategorySub"
                ResultField = "LPCategorySubCode, PLCategorySubName"
            Else
                Session("filter") = "SELECT * FROM VMsAccount WHERE COALESCE(FgActive,'N') = 'Y'"
                ResultField = "Account, Description"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "PL Cost Center" Then
                ds = SQLExecuteQuery("SELECT PLCategorySubCode, PLCategorySubName FROM MsPLCategorySub WHERE PLCategorySubCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "PL Cost Center" Then
                ds = SQLExecuteQuery("SELECT PLCategorySubCode, PLCategorySubName FROM MsPLCategorySub WHERE PLCategorySubCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "PL Cost Center" Then
                ds = SQLExecuteQuery("SELECT PLCategorySubCode, PLCategorySubName FROM MsPLCategorySub WHERE PLCategorySubCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "PL Cost Center" Then
                SQLString = "EXEC S_MsPLCategoryAccPrint 0, 'PL Cost Center - Account', 'Account', 'Description'," + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsPLCategoryAccPrint 1, 'Account - PL Cost Center', 'PL Cost Center Code', 'PL Cost Center Name' ," + QuotedStr(ViewState("UserId"))
            End If
