<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsPLCategoryAcc.aspx.vb" Inherits="Assign_AssMsPLCategoryAcc_AssMsPLCategoryAcc" %>
...
<head id="Head1" runat="server">
    <title>PL Cost Center - Account</title>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign PL Cost Center - Account</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">PL Cost Center</asp:ListItem>
