<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMaintenanceTypeUser.aspx.vb" Inherits="Assign_AssMaintenanceTypeUser_AssMaintenanceTypeUser" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Maintenance Type - User</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Maintenance Type</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>                    
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbFromName" runat="server" Width="288px" 
                            Enabled="False" /> 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbToName" runat="server" Width="288px" 
                            Enabled="False" /> 
              ...
              <table width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbName" runat="server" Width="288px" 
                            Enabled="False" /> 
