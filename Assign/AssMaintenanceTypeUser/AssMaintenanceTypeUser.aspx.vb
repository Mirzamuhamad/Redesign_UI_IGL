...
Imports System.Data
Partial Class Assign_AssMaintenanceTypeUser_AssMaintenanceTypeUser
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsMaintenanceTypeUserAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsMaintenanceTypeUserAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsMaintenanceTypeUserAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Maintenance Type" Then
                StrSelected = SelectedGridDev(AvailableGrid, "UserID")
            ElseIf ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AvailableGrid, "MaintenanceTypeCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            ElseIf ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AssignedGrid, "MaintenanceTypeCode")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Warehouse   1 = User
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsmaintenanceTypeUserCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Maintenance Type" Then
                Session("filter") = "select * From VMsMaintenanceType"
                ResultField = "MaintenanceTypeCode, MaintenanceTypeName"
            Else
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Maintenance Type" Then
                Session("filter") = "select * From VMsMaintenanceType"
                ResultField = "MaintenanceTypeCode, MaintenanceTypeName"
            Else
                Session("filter") = "select * From VSAUsers where FgAdmin = 'N'"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Maintenance Type" Then
                ds = SQLExecuteQuery("select MaintenanceTypeCode, MaintenanceTypeName From VMsMaintenanceType Where MaintenanceTypeCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Maintenance Type" Then
                ds = SQLExecuteQuery("select MaintenanceTypeCode, MaintenanceTypeName From VMsMaintenanceType Where MaintenanceTypeCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Maintenance Type" Then
                ds = SQLExecuteQuery("select MaintenanceTypeCode, MaintenanceTypeName From VMsMaintenanceType Where MaintenanceTypeCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Maintenance Type" Then
                SQLString = "EXEC S_MsMaintenanceTypeUserPrint 0, 'Maintenance Type - User', 'User Id', 'User Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsMaintenanceTypeUserPrint 1, 'User - Maintenance Type', 'Maintenance Type Code', 'Maintenance Type Name',  " + QuotedStr(ViewState("UserId"))
            End If
