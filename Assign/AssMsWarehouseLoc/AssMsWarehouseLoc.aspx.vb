...
Imports System.Data
Partial Class Assign_AssMsWarehouseLoc_MsWarehouseLoc
    ...
    Private Sub LoadDataGrid()
        Try
            '0 = Warehouse, 1 = Warehouse Location
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSWarehouseLocAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSWarehouseLocAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MSWarehouseLocAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Warehouse" Then
                StrSelected = SelectedGridDev(AvailableGrid, "WLocationCode")
            ElseIf ddlGroupBy.SelectedValue = "Warehouse Location" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Warehouse" Then
                StrSelected = SelectedGridDev(AssignedGrid, "WLocationCode")
            ElseIf ddlGroupBy.SelectedValue = "Warehouse Location" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = Warehouse Location
            SqlString = "EXEC S_MSWarehouseLocCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "select * From VMsWrhsLocation where FgAll = 'N'"
                ResultField = "Location_Code, Location_Name"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Warehouse" Then
                ds = SQLExecuteQuery("select WrhsCode, WrhsName From MsWarehouse Where WrhsCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Warehouse Location" Then
                ds = SQLExecuteQuery("select WLocationCode, WLocationName From MsWrhsLocation Where FgAll = 'N' AND WLocationCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Warehouse" Then
                ds = SQLExecuteQuery("select WrhsCode, WrhsName From MsWarehouse Where WrhsCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Warehouse Location" Then
                ds = SQLExecuteQuery("select WLocationCode, WLocationName From MsWrhsLocation Where FgAll = 'N' AND WLocationCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Warehouse" Then
                ds = SQLExecuteQuery("select WrhsCode, WrhsName From MsWarehouse Where WrhsCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Warehouse Location" Then
                ds = SQLExecuteQuery("select WLocationCode, WLocationName From MsWrhsLocation Where FgAll = 'N' AND WLocationCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Warehouse" Then
                SQLString = "EXEC S_MSWarehouseLocPrint 0, 'Warehouse - Location', 'Location Code', 'Location Name' "
            Else
                SQLString = "EXEC S_MSWarehouseLocPrint 1, 'Location - Warehouse', 'Warehouse Code', 'Warehouse Name' "
            End If
