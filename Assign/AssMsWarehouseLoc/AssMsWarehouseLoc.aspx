<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsWarehouseLoc.aspx.vb" Inherits="Assign_AssMsWarehouseLoc_MsWarehouseLoc" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Warehouse Location</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList ID = "ddlGroupByCopy" CssClass="DropDownList" runat = "server" AutoPostBack="true" >
                            ...
                            <asp:ListItem>Warehouse Location</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
