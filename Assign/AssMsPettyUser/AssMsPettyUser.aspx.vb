...
Imports System.Data
Partial Class Assign_AssMSPettyUser_AssMsPettyUser
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSPettyUserAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSPettyUserAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsPettyUserAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AvailableGrid, "PettyCode")
            ElseIf ddlGroupBy.SelectedValue = "Petty" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "User" Then
                StrSelected = SelectedGridDev(AssignedGrid, "Petty")
            ElseIf ddlGroupBy.SelectedValue = "Petty" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = User   1 = Petty
            SqlString = "EXEC S_MsPettyUserCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "select * FROM MsPetty"
                ResultField = "PettyCode, PettyName"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Petty" Then
                ds = SQLExecuteQuery("select PettyCode, PettyName FROM MsPetty Where PettyCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Petty" Then
                ds = SQLExecuteQuery("select PettyCode, PettyName FROM MsPetty Where PettyCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Petty" Then
                ds = SQLExecuteQuery("select PettyCode, PettyName FROM MsPetty Where PettyCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                SQLString = "EXEC S_MSPettyUserPrint 0, 'User - Petty', 'Petty Code', 'Petty Name', " + QuotedStr(ViewState("UserId")) + ""
            Else
                SQLString = "EXEC S_MSPettyUserPrint 1, 'Petty - User', 'User Code', 'User Name', " + QuotedStr(ViewState("UserId")) + ""
            End If
