<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsPettyUser.aspx.vb" Inherits="Assign_AssMSPettyUser_AssMsPettyUser" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Petty User</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            ...
                            <asp:ListItem>Petty</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
