<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssSickSolution.aspx.vb" Inherits="Assign_AssSickSolution_AssSickSolution" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Sick Solution</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Sick Type</asp:ListItem>
                            <asp:ListItem>Sick Solution</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
