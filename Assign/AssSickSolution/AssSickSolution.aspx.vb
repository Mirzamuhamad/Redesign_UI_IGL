...
Imports System.Data
Partial Class Assign_AssSickSolution_AssSickSolution
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSSickTypeSolutionAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSSickTypeSolutionAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsSickTypeSolutionAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                StrSelected = SelectedGridDev(AvailableGrid, "SickSolutionCode")
            ElseIf ddlGroupBy.SelectedValue = "Sick Solution" Then
                StrSelected = SelectedGridDev(AvailableGrid, "SickTypeCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                StrSelected = SelectedGridDev(AssignedGrid, "SickSolutionCode")
            ElseIf ddlGroupBy.SelectedValue = "Sick Solution" Then
                StrSelected = SelectedGridDev(AssignedGrid, "SickType")
            End If
            If StrSelected.Trim <> "" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            SqlString = "EXEC S_MsSickTypeSolutionCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                Session("filter") = "select * From MsSickType"
                ResultField = "SickTypeCode, SickTypeName"
            Else
                Session("filter") = "select * From MsSickSolution"
                ResultField = "SickSolutionCode, SickSolutionName"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                ds = SQLExecuteQuery("select SickTypeCode, SickTypeName From MsSickType Where SickTypeCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("select SickSolutionCode, SickSolutionName From MsSickSolution Where SickSolutionCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                ds = SQLExecuteQuery("select SickTypeCode, SickTypeName From MsSickType Where SickTypeCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Sick Solution" Then
                ds = SQLExecuteQuery("select SickSolutionCode, SickSolutionName From MsSickSolution Where SickSolutionCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Sick Type" Then
                SQLString = "EXEC S_MSSickTypeSolutionPrint 0, 'SickType - SickSolution', 'Sick Solution Code', 'Sick Solution Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MSSickTypeSolutionPrint 1, 'SickSolution - SickType', 'Sick Type Code', 'Sick Type Name',  " + QuotedStr(ViewState("UserId"))
            End If
