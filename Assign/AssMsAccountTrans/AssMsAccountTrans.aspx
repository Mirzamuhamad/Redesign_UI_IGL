<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsAccountTrans.aspx.vb" Inherits="Assign_AssMsAccountTrans_AssMsAccountTrans" %>
        ...
        <asp:Panel runat="server" ID="pnlCopy" Visible="False">
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlGroupByCopy" CssClass="DropDownList" runat="server" AutoPostBack="true">
                            <asp:ListItem Selected="True">Trans Type</asp:ListItem>
                ...
                <tr>
                    <td style="width: 40%;">
                        <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                            <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" Style="table-layout:auto;"
                                EmptyDataText="There are no data records to display." KeyFieldName="CODE" AllowPaging="True"
                                DataSourceID="dsAssigned" AutoGenerateColumns="False">
                                <Columns>
                                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0">
                                        <HeaderTemplate>
                                            <input type="checkbox" onclick="AssignedGrid.SelectAllRowsOnPage (this.checked);" title="Select/Unselect all rows on the page" /></HeaderTemplate>
                                    ...
                                    <dx:GridViewDataColumn FieldName="CurrCode" VisibleIndex="3">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn FieldName="FgSubled" VisibleIndex="4">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataColumn>
                                </Columns>
                        ...
                        <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                            <dx:ASPxGridView ID="AvailableGrid" runat="server" Width="100%" Style="table-layout: fixed;"
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0">
                                        <HeaderTemplate>
                                            <input type="checkbox" onclick="AvailableGrid.SelectAllRowsOnPage (this.checked);" title="Select/Unselect all rows on the page" /></HeaderTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewCommandColumn>
                                    <dx:GridViewDataColumn FieldName="CODE" VisibleIndex="1">
                                        <Settings AutoFilterCondition="Contains" />
