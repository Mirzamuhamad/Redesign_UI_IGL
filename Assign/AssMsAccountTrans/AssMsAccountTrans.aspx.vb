...
Partial Class Assign_AssMsAccountTrans_AssMsAccountTrans
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSAccountTransAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSAccountTransAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
                dsAssigned.SelectCommand = "Select '' as CODE, '' as NAME, '' As CurrCode, '' As FgSubled"
                dsAvailable.SelectCommand = "Select '' as CODE, '' as NAME, '' As CurrCode, '' As FgSubled"
            End If
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            ...
            SQLString = "EXEC S_MsAccountTransAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Trans Type   1 = Account
            SqlString = "EXEC S_MsAccountTransCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Trans Type" Then
                Session("filter") = "Select * From VMsTransType Where FgAccount = 'Y'"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Trans Type" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select Account, AccountName From MsAccount Where Account = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Trans Type" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select Account, AccountName From MsAccount Where Account = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Trans Type" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select Account, AccountName From MsAccount Where Account = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Trans Type" Then
                SQLString = "EXEC S_MSAccountTransPrint 0, 'Trans Type - Account', 'Account Code', 'Account Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MSAccountTransPrint 1, 'Account - Trans Type', 'Trans Type Code', 'Trans Type Name', " + QuotedStr(ViewState("UserId"))
            End If
            Session("DBConnection") = ViewState("DBConnection")
