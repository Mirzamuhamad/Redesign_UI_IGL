...
Imports System.Data
Partial Class AssMsProductTrans
    Inherits System.Web.UI.Page
    Protected Sub Page_z(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                lblJudul.Text = "Product Autorization - Transaction"
                InitProperty()
            End If
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsProductTransAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsProductTransAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsProductTransAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Trans Type" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            Else
                StrSelected = SelectedGridDev(AssignedGrid, "TransTypeCode")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Product   1 = TransType
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Product   1 = User
            SqlString = "EXEC S_MsProductTransCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "select * From MsProduct"
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Trans Type" Then
                Session("filter") = "select * From VMsTransType"
                ResultField = "Trans_Type_Code, Trans_Type_Name"
            Else
                Session("filter") = "select * From MsProduct"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "TransType" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbCode.Text) + " And FgProduct = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Dim ds As DataSet
        Try
            If ddlGroupByCopy.SelectedValue = "Product" Then
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbFromCode.Text) + " And FgProduct = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbToCode.Text) + " And FgProduct = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Trans Type" Then
                SQLString = "EXEC S_MsProductTransPrint 0, 'Product - TransType', 'TransType Code', 'TransType Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsProductTransPrint 1, 'TransType - Product', 'Product Code', 'Product Name' , " + QuotedStr(ViewState("UserId"))
            End If
