<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsProductTrans.aspx.vb" Inherits="AssMsProductTrans" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">
       <asp:Label ID="lblJudul" runat="server" Text="Label"></asp:Label></asp:Label></div>
    <hr style="color:Blue" /> 
        <br />        
