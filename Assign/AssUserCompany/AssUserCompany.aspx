<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssUserCompany.aspx.vb" Inherits="Assign_AssUserCompany_AssUserCompany" %>
...
<head id="Head1" runat="server">
    <title>Assign User Company</title>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign User Company</div>
    <hr style="color:Blue" /> 
        <br />        
        <asp:Panel runat="server" ID="pnlCopy" Visible="False">
              <table width="100%">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:TextBox Id="tbToCode" CssClass="TextBox" runat="server" Width="75px" 
