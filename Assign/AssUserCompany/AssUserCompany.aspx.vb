...
Imports System.Data
Partial Class Assign_AssUserCompany_AssUserCompany
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_SAUserCompanyAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_SAUserCompanyAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_SAUserCompanyAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "User" Then
                'StrSelected = SelectedGrid(AvailableGrid, "cbAvailable", "lbAvailableCode", "Company")
                StrSelected = SelectedGridDev(AvailableGrid, "Company")
            ElseIf ddlGroupBy.SelectedValue = "Company" Then
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "User" Then
                'StrSelected = SelectedGrid(AssignedGrid, "cbAssign", "lbAssignCode", "Company")
                StrSelected = SelectedGridDev(AssignedGrid, "Company")
            ElseIf ddlGroupBy.SelectedValue = "Company" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = User   1 = User
            SqlString = "EXEC S_SAUserCompanyCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                Session("filter") = "select * From VSAUsers where COALESCE(FgAdmin, 'N') = 'N' "
                ResultField = "User_Id, User_Name"
            Else
                Session("filter") = "select * From VMsCompany"
                ResultField = "Company, DBName"
            End If
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "User" Then
                Session("filter") = "select * From VSAUsers Where FgAdmin ='N'"
                ResultField = "User_Id, User_Name"
            Else
                Session("filter") = "select * From VMsCompany"
                ResultField = "Company, DBName"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("select User_Id, User_Name From VSAUsers Where FgAdmin ='N' AND User_Id = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Company" Then
                ds = SQLExecuteQuery("select Company, DBName From VMsCompany Where Company = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("select User_Id, User_Name From VSAUsers Where User_Id = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select Company, DBName From VMsCompany Where Company = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("select User_Id, User_Name From VSAUsers Where User_Id = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select Company, DBName From VMsCompany Where Company = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "User" Then
                SQLString = "EXEC S_SAUserCompanyPrint 0, 'User - Company', 'Company Code', 'Company Name' "
            Else
                SQLString = "EXEC S_SAUserCompanyPrint 1, 'Company - User', 'User Code', 'User Name' "
            End If
            Session("PrintType") = "Print"
            Session("DBConnection") = ViewState("DBConnection")
            Session("SelectCommand") = SQLString
            Session("ReportFile") = ".../../../Rpt/RptPrintAssign.frx"
            AttachScript("openprintdlgms();", Page, Me.GetType)
        Catch ex As Exception
