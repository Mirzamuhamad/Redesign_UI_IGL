<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssSamplingAccept.aspx.vb" Inherits="Assign_AssSamplingAccept_AssSamplingAccept" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Sampling Accept</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Sampling</asp:ListItem>
                            <asp:ListItem>Defect Group</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <td>
                          :</td>
                      <td>
                          <asp:TextBox ID="tbAcceptable" runat="server" 
                  ...
                  <tr>
                      ...
                      <td>
                          :</td>
                      <td>
                          <asp:TextBox ID="tbMinReject" runat="server" 
                              CssClass="TextBox" Width="75px" />
                      </td>
                  </tr>
            </table>
                ...
                <td style="width:40%;">
                   <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">                   
                    <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        ...
                        <dx:GridViewDataColumn FieldName="Acceptable" VisibleIndex="3" >                        
                        <Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="MinReject" VisibleIndex="4" >
                        <Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>
