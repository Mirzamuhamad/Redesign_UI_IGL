<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssProductCategorysubDt.aspx.vb" Inherits="Assign_AssProductCategorysubDt_AssProductCategorysubDt" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Product Sub Category</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Product Sub Category</asp:ListItem>
