...
Imports System.Data
Partial Class Assign_AssProductCategorysubDt_AssProductCategorysubDt
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsProductCategorysubDtAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsProductCategorysubDtAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsProductCategorySubDtAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Product Sub Category" Then
                'StrSelected = SelectedGrid(AvailableGrid, "cbAvailable", "lbAvailableCode", "ProductCode")
                StrSelected = SelectedGridDev(AvailableGrid, "ProductCode")
            ElseIf ddlGroupBy.SelectedValue = "Product" Then
                'StrSelected = SelectedGrid(AvailableGrid, "cbAvailable", "lbAvailableCode", "ProductSubCatCode")
                StrSelected = SelectedGridDev(AvailableGrid, "ProductSubCatCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Product Sub Category" Then
                StrSelected = SelectedGridDev(AssignedGrid, "ProductCode")
            ElseIf ddlGroupBy.SelectedValue = "Product" Then
                StrSelected = SelectedGridDev(AssignedGrid, "ProductSubCatCode")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Warehouse   1 = User
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsProductCategorySubDtCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Product Sub Category" Then
                Session("filter") = "select Sub_Category_Code, Sub_Category_Name From VMsProductCategorySub"
                ResultField = "Sub_Category_Code, Sub_Category_Name"
            Else
                Session("filter") = "select Product_Code, Product_Name, Specification1 From VMsProduct"
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Product Sub Category" Then
                Session("filter") = "select Sub_Category_Code, Sub_Category_Name From VMsProductCategorySub"
                ResultField = "Sub_Category_Code, Sub_Category_Name"
            Else
                Session("filter") = "select Product_Code, Product_Name, Specification From VMsProduct"
                ResultField = "Product_Code, Product_Name"
            End If
            Session("DBConnection") = ViewState("DBConnection")
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Product Sub Category" Then
                ds = SQLExecuteQuery("select ProductSubCatCode, ProductSubCatName From MsProductCategorySub Where ProductSubCatCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Product" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Dim ds As DataSet
        Try
            If ddlGroupByCopy.SelectedValue = "Warehouse" Then
                ds = SQLExecuteQuery("select ProductSubCatCode, ProductSubCatName From MsProductCategorySub Where ProductSubCatCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Warehouse" Then
                ds = SQLExecuteQuery("select ProductSubCatCode, ProductSubCatName From MsProductCategorySub Where ProductSubCatCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Product Sub Category" Then
                SQLString = "EXEC S_MsProductCategorySubDtPrint 0, 'Product Report - Product', 'Product Code', 'Product Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsProductCategorySubDtPrint 1, 'Product - Product Report', 'Product Sub Category Code', 'Product Sub Category Name', " + QuotedStr(ViewState("UserId"))
            End If
    ...
    'Protected Sub AssignedGrid_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles AssignedGrid.PageIndexChanging
    '    AssignedGrid.PageIndex = e.NewPageIndex
    '    LoadDataAssign()
    'End Sub

    'Protected Sub AvailableGrid_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles AvailableGrid.PageIndexChanging
    '    AvailableGrid.PageIndex = e.NewPageIndex
    '    LoadDataAvailable()
    'End Sub

    'Protected Sub cbAssignHd_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    CheckAllAssign(AssignedGrid, sender)
    'End Sub

    'Protected Sub cbAavailableHd_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    CheckAllAvailable(AvailableGrid, sender)
    'End Sub
