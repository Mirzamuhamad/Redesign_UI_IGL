<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssProcessWIP.aspx.vb" Inherits="Assign_AssProcessWIP_AssProcessWIP" %>
...
<head id="Head1" runat="server">
    <title>Assign Process WIP</title>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Process WIP</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            ...
                            <asp:ListItem Selected="True">Process</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
        ...
        <asp:Panel runat="server" ID="PnlAssign">          
              <table width="100%">
                <tr>
                    ...
                    <%--<td class="style2" style="text-align: right">Unit :
                    </td>
                    <td>
                        <asp:DropDownList CssClass="DropDownList" ValidationGroup="Input" runat="server" ID="ddlUnit" Width="200px" />
                    </td>--%>
               </tr>                         
            </table>
            <br />
