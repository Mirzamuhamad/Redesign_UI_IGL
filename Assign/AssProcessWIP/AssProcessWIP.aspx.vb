...
Partial Class Assign_AssProcessWIP_AssProcessWIP
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsProcessWIPAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsProcessWIPAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            '+ ", " + QuotedStr(ddlUnit.SelectedValue)
            SQLString = "EXEC S_MsProcessWIPAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "WIP" Then
                StrSelected = SelectedGridDev(AvailableGrid, "ProcessCode")
            ElseIf ddlGroupBy.SelectedValue = "Process" Then
                StrSelected = SelectedGridDev(AvailableGrid, "WIPCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "WIP" Then
                StrSelected = SelectedGridDev(AssignedGrid, "ProcessCode")
            ElseIf ddlGroupBy.SelectedValue = "Process" Then
                StrSelected = SelectedGridDev(AssignedGrid, "WIPCode")
            End If
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsProcessWIPCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "WIP" Then
                Session("filter") = "select * From MsWIP"
                ResultField = "WIPCode, WIPName"
            Else
                Session("filter") = "select * From MsProcess"
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "WIP" Then
                Session("filter") = "select * From MsWIP"
                ResultField = "WIPCode, WIPName"
            Else
                Session("filter") = "select * From MsProcess"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "WIP" Then
                ds = SQLExecuteQuery("select WIPCode, WIPName From MsWIP Where WIPCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("select ProcessCode, ProcessName From MsProcess Where ProcessCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "WIP" Then
                ds = SQLExecuteQuery("select WIPCode, WIPName From MsWIP Where WIPCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProcessCode, ProcessName From MsProcess Where ProcessCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "WIP" Then
                ds = SQLExecuteQuery("select WIPCode, WIPName From MsWIP Where WIPCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select ProcessCode, ProcessName From MsProcess Where ProcessCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "WIP" Then
                SQLString = "EXEC S_MsProcessWIPPrint 0, 'WIP - Process', 'Process Code', 'Process Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsProcessWIPPrint 1, 'Process - WIP', 'WIP Code', 'WIP Name',  " + QuotedStr(ViewState("UserId"))
            End If
