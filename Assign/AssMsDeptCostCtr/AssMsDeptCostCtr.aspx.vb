...
Imports System.Data
Partial Class Assign_AssMsDeptCostCtr_AssMsDeptCostCtr
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsDeptCostCtrAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsDeptCostCtrAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsDeptCostCtrAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Department" Then
                StrSelected = SelectedGridDev(AvailableGrid, "CostCtrCode")
            ElseIf ddlGroupBy.SelectedValue = "Cost Center" Then
                StrSelected = SelectedGridDev(AvailableGrid, "Dept_Code")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Department" Then
                StrSelected = SelectedGridDev(AssignedGrid, "CostCtr")
            ElseIf ddlGroupBy.SelectedValue = "Cost Center" Then
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsDeptCostCtrCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                Session("filter") = "SELECT CostCtrCode, CostCtrName FROM MsCostCtr"
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Department" Then
                Session("filter") = "SELECT Dept_Code, Dept_Name FROM VMsCostDept"
                ResultField = "Dept_Code, Dept_Name"
            Else
                Session("filter") = "SEELCT CostCtrCode, CostCtrName FROM MsCostCtr"
                ResultField = "CostCtrCode, CostCtrName"
            End If
            Session("DBConnection") = ViewState("DBConnection")
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("SELECT CostCtrCode, CostCtrName FROM MsCostCtr WHERE CostCtrCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT CostCtrCode, CostCtrName FROM MsCostCtr WHERE CostCtrCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT CostCtrCode, CostCtrName FROM MsCostCtr WHERE CostCtrCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Department" Then
                SQLString = "EXEC S_MsDeptCostCtrPrint 0, 'Department - Cost Center', 'Cost Center Code', 'Cost Center Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsDeptCostCtrPrint 1, 'Cost Center - Department', 'Department Code', 'Department Name',  " + QuotedStr(ViewState("UserId"))
            End If
