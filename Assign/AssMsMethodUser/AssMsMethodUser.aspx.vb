...
Imports System.Data
Partial Class Assign_AssMsMethodUser_AssMsMethodUser
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsMethodUserCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("SELECT UserID, UserName FROM SAUsers WHERE UserID = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString) 'FgAdmin = 'N' AND 
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT UserID, UserName FROM SAUsers WHERE UserID = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString) 'FgAdmin = 'N' AND 
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT UserID, UserName FROM SAUsers WHERE UserID = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString) 'FgAdmin = 'N' AND 
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Method" Then
                SQLString = "EXEC S_MsMethodUserPrint 0, 'Method - User', 'User Id', 'User Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsMethodUserPrint 1, 'User - Method', 'Method Code', 'Method Name', " + QuotedStr(ViewState("UserId"))
            End If
            Session("DBConnection") = ViewState("DBConnection")
