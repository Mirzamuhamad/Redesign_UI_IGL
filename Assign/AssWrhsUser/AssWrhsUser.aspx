<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssWrhsUser.aspx.vb" Inherits="Assign_AssWrhsUser_AssWrhsUser" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1"><asp:Label runat="server" ID="lblTitle" Text ="Assign Warehouse User"></asp:Label></div>
    <hr style="color:Blue" /> 
        <br />        
