...
Partial Class Assign_AssPayrollEmp_AssPayrollEmp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                btnCopyTo.Visible = ViewState("MenuLevel").Rows(0)("FgInsert") = "Y"
                ...
                ddlCurr.SelectedValue = SQLExecuteScalar("EXEC S_GetHomeCurreny", ViewState("DBConnection"))
                tbAmount.Text = "0"                
                tbEffDate.SelectedDate = Date.Now
            End If
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsPayrollEmpAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
                dsAvailable.SelectCommand = "EXEC S_MsPayrollEmpAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
            Else
                dsAssigned.SelectCommand = "Select '' as CODE, '' as NAME, '' as StartDate, '' as Currency, 0 as Amount, '' as Formula, '' as Remark "
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal EffDate As Date, ByVal Currency As String, ByVal Amount As Double, ByVal Formula As String, ByVal Remark As String, ByVal StrSelected As String, ByVal Flag As Integer)
        Dim SQLString As String
        Try
            SQLString = "EXEC S_MsPayrollEmpAddRemove '" + GroupValue + "', " + Page.ToString + ",'" + EffDate + "', '" + Currency + "'," + Amount.ToString + ",'" + Formula + "','" + Remark + "', '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
            SQLExecuteQuery(SQLString, ViewState("DBConnection").ToString)
            LoadDataGrid()
        Catch ex As Exception
    ...
    Protected Sub btnAddAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddAll.Click
        ...
        Try
            'Dim str As String
            'str = AvailableGrid.FilterExpression
            'If str Is Nothing Then
            '    str = ""
            'End If
            'str = "* " + str + " *"
            'lbstatus.Text = MessageDlg(str)
            'Exit Sub
            If tbCode.Text = "" Then Exit Sub
            ' 0 = Warehouse   1 = Employee
            ...
            Else
                StrFilter = ""
            End If
            ExecSPAddRemove(tbCode.Text, ddlGroupBy.SelectedIndex, tbEffDate.SelectedDate, ddlCurr.SelectedValue, CFloat(tbAmount.Text), ddlFormula.SelectedValue, tbRemark.Text, StrFilter, 0)
            AvailableGrid.Selection.UnselectAll()
        Catch ex As Exception
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            If ddlGroupBy.SelectedValue = "Employee" Then
                StrSelected = SelectedGridDev(AvailableGrid, "PayrollCode")
            ElseIf ddlGroupBy.SelectedValue = "Payroll" Then
                StrSelected = SelectedGridDev(AvailableGrid, "EmpNumb")
            End If
            
            If StrSelected.Trim <> "" Then
                ExecSPAddRemove(tbCode.Text, ddlGroupBy.SelectedIndex, tbEffDate.SelectedDate, ddlCurr.SelectedValue, CFloat(tbAmount.Text), ddlFormula.SelectedValue, tbRemark.Text, StrSelected, 1)               
            End If
            AvailableGrid.Selection.UnselectAll()
        Catch ex As Exception
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Employee" Then
                StrSelected = SelectedGridDev(AssignedGrid, "PayrollCode")
            ElseIf ddlGroupBy.SelectedValue = "Payroll" Then
                StrSelected = SelectedGridDev(AssignedGrid, "EmpNumb")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Employee   1 = Payroll
                ExecSPAddRemove(tbCode.Text, ddlGroupBy.SelectedIndex, tbEffDate.SelectedDate, ddlCurr.SelectedValue, CFloat(tbAmount.Text), ddlFormula.SelectedValue, tbRemark.Text, StrSelected, 2)
            End If
            AssignedGrid.Selection.UnselectAll()
        Catch ex As Exception
    ...
    Protected Sub btnRemoveAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemoveAll.Click
        ...
        Try
            ...
            Else
                StrFilter = ""
            End If
            ExecSPAddRemove(tbCode.Text, ddlGroupBy.SelectedIndex, tbEffDate.SelectedDate, ddlCurr.SelectedValue, CFloat(tbAmount.Text), ddlFormula.SelectedValue, tbRemark.Text, StrFilter, 3)
            AssignedGrid.Selection.UnselectAll()
        Catch ex As Exception
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Employee   1 = Payroll
            SqlString = "EXEC S_MsPayrollEmpCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Employee" Then
                Session("filter") = "SELECT * FROM V_MsEmpUser WHERE Fg_Active = 'Y' AND UserId = " + QuotedStr(ViewState("UserId"))
                ResultField = "Emp_No, Emp_Name"
            Else
                Session("filter") = "SELECT * FROM V_MsPayroll Where Payroll_Pref = 'P' AND GroupBy = 'Employee'"
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Employee" Then
                Session("filter") = "SELECT * FROM V_MsEmpUser WHERE Fg_Active = 'Y' AND UserId = " + QuotedStr(ViewState("UserId"))
                ResultField = "Emp_No, Emp_Name"
            Else
                Session("filter") = "SELECT * FROM V_MsPayroll Where Payroll_Pref = 'P' AND GroupBy = 'Employee'"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Employee" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsEmpUser WHERE Fg_Active = 'Y' AND UserId = " + QuotedStr(ViewState("UserId")) + " AND Emp_No = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Payroll" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsPayroll WHERE Payroll_Code = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Employee" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsEmpUser WHERE Fg_Active = 'Y' AND UserId = " + QuotedStr(ViewState("UserId")) + " AND Emp_No = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Payroll" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsPayroll WHERE Payroll_Code = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Employee" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsEmpUser WHERE Fg_Active = 'Y' AND UserId = " + QuotedStr(ViewState("UserId")) + " AND Emp_No = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Payroll" Then
                ds = SQLExecuteQuery("SELECT * FROM V_MsPayroll WHERE Payroll_Code = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Employee" Then
                SQLString = "EXEC S_MsPayrollEmpPrint 0, 'Employee - Payroll Slip', 'Payroll Code', 'Payroll Name', 'Start Date', 'Formula', " + QuotedStr(ViewState("UserId").ToString)
            Else
                SQLString = "EXEC S_MsPayrollEmpPrint 1, 'Payroll Slip - Employee', 'Employee No', 'Employee Name' , 'Start Date', 'Formula', " + QuotedStr(ViewState("UserId").ToString)
            End If
            Session("PrintType") = "Print"
            Session("DBConnection") = ViewState("DBConnection")
            Session("SelectCommand") = SQLString
            Session("ReportFile") = ".../../../Rpt/RptPrintAssign4.frx"
    ...
    Protected Sub AvailableGrid_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles AvailableGrid.Init
