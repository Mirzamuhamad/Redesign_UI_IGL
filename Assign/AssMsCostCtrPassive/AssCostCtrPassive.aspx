<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssCostCtrPassive.aspx.vb" Inherits="Assign_AssCostCtrPassive_AssCostCtrPassive" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Cost Center Passive</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Cost Center Active</asp:ListItem>
                            <asp:ListItem>Cost Center Passive</asp:ListItem>
                        </asp:DropDownList> </td>
                </tr>
                <tr>
                    <td>From</td>
