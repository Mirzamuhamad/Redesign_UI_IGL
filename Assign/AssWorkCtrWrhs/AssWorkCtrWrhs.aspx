<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssWorkCtrWrhs.aspx.vb" Inherits="Assign_AssWorkCtrWrhs_AssWorkCtrWrhs" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Work Center Warehouse</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Work Center</asp:ListItem>
