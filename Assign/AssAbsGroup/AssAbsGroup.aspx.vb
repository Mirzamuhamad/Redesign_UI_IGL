...
Imports System.Data
Partial Class Assign_AssAbsGroup_AssAbsGroup
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MSAbsGroupAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MSAbsGroupAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MSAbsGroupAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Absence Group" Then
                StrSelected = SelectedGridDev(AvailableGrid, "AbsStatusCode")
            ElseIf ddlGroupBy.SelectedValue = "Absence" Then
                StrSelected = SelectedGridDev(AvailableGrid, "AbsGroup")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Absence Group" Then
                StrSelected = SelectedGridDev(AssignedGrid, "AbsStatusCode")
            ElseIf ddlGroupBy.SelectedValue = "Absence" Then
                StrSelected = SelectedGridDev(AssignedGrid, "AbsGroup")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Warehouse   1 = User
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MSAbsGroupCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Absence Group" Then
                Session("filter") = "SELECT AbsGroup AS AbsGroupCode, AbsGroup AS AbsGroupName FROM VMsAbsGroup"
                ResultField = "AbsGroupCode, AbsGroupName"
            Else
                Session("filter") = "SELECT * FROM VMsAbsStatus"
                ResultField = "AbsStatusCode, AbsStatusName"
            End If
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Absence Group" Then
                Session("filter") = "SELECT AbsGroup AS AbsGroupCode, AbsGroup AS AbsGroupName FROM VMsAbsGroup"
                ResultField = "AbsGroupCode, AbsGroupName"
            Else
                Session("filter") = "SELECT * FROM VMsAbsStatus"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Absence Group" Then
                ds = SQLExecuteQuery("SELECT AbsGroup AS AbsGroupCode, AbsGroup AS AbsGroupName FROM VMsAbsGroup WHERE AbsGroup = " + QuotedStr(tbCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("SELECT AbsStatusCode, AbsStatusName FROM VMsAbsStatus WHERE AbsStatusCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Absence Group" Then
                ds = SQLExecuteQuery("SELECT AbsGroup AS AbsGroupCode, AbsGroup AS AbsGroupName FROM VMsAbsGroup WHERE AbsGroup = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT AbsStatusCode, AbsStatusName FROM VMsAbsStatus WHERE AbsStatusCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Absence Group" Then
                ds = SQLExecuteQuery("SELECT AbsGroup AS AbsGroupCode, AbsGroup AS AbsGroupName FROM VMsAbsGroup WHERE AbsGroup = " + QuotedStr(tbToCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT AbsStatusCode, AbsStatusName FROM VMsAbsStatus WHERE AbsStatusCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Absence Group" Then
                SQLString = "EXEC S_MSAbsGroupPrint 0, 'Absence Group - Absence', 'Absence Code', 'Absence Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MSAbsGroupPrint 1, 'Absence - Absence Group', 'Absence Group Code', 'Absence Group Name', " + QuotedStr(ViewState("UserId"))
            End If
