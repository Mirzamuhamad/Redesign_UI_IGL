<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsStockTypeDt.aspx.vb" Inherits="Assign_AssMsStockTypeDt_AssMsStockTypeDt" %>
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Stock Type</asp:ListItem>
