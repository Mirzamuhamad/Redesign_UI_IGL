...
Imports System.Data
Partial Class Assign_AssMsStockTypeDt_AssMsStockTypeDt
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                lblTitle.Text = "Stock Type Autorization - Transaction"
                InitProperty()
            End If
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsStockTypeDtAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsStockTypeDtAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsStockTypeDtAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAddAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddAll.Click
        ...
        Try
            ...
            AvailableGrid.Selection.UnselectAll()
        Catch ex As Exception
            lbstatus.Text = "btn add all error : " + ex.ToString
        End Try
    End Sub
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Stock Type" Then
                StrSelected = SelectedGridDev(AvailableGrid, "TransTypeCode")
            Else
                StrSelected = SelectedGridDev(AvailableGrid, "StockTypeCode")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Stock Type" Then
                StrSelected = SelectedGridDev(AssignedGrid, "TransType")
            Else
                StrSelected = SelectedGridDev(AssignedGrid, "StockTypeCode")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = StockType   1 = TransType
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = StockType   1 = User
            SqlString = "EXEC S_MsStockTypeDtCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Stock Type" Then
                Session("filter") = "select * From VMsStockType"
                ResultField = "Stock_Type_Code, Stock_Type_Name"
            Else
                Session("filter") = "select * From VMsTransType WHERE FgStockType = 'Y' "
                ResultField = "Trans_Type_Code, Trans_Type_Name"
            End If
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Stock Type" Then
                Session("filter") = "select * From VMsStockType"
                ResultField = "Stock_Type_Code, Stock_Type_Name"
            Else
                Session("filter") = "select * From VMsTransType"
                ResultField = "Trans_Type_Code, Trans_Type__Name"
            End If
            Session("DBConnection") = ViewState("DBConnection")
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Stock Type" Then
                ds = SQLExecuteQuery("select StockTypeCode, StockTypeName From MsStockType Where StockTypeCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "TransType" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbCode.Text) + " And FgStockType = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Stock Type" Then
                ds = SQLExecuteQuery("select StockTypeCode, StockTypeName From MsStockType Where StockTypeCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbFromCode.Text) + " And FgStockType = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Stock Type" Then
                ds = SQLExecuteQuery("select StockTypeCode, StockTypeName From MsStockType Where StockTypeCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("select TransTypeCode, TransTypeName From MsTransType Where TransTypeCode = " + QuotedStr(tbToCode.Text) + " And FgStockType = 'Y' ", ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Stock Type" Then
                SQLString = "EXEC S_MsStockTypeDtPrint 0, 'Stock Type Autorization Transaction', 'Trans Type Code', 'Trans Type Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsStockTypeDtPrint 1, 'Trans Type Autorization Stock Type', 'Stock Type Code', 'Stock Type Name', " + QuotedStr(ViewState("UserId"))
            End If
