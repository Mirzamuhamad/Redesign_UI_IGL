...
Partial Class Assign_AssCustProduct_AssCustProduct
    ...
    Private Sub LoadDataGrid()
        Try
            If tbCode.Text.Trim <> "" Then
                ...
                dsAssigned.SelectCommand = "EXEC S_MsCustProductAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                'lbstatus.Text = "EXEC S_MsCustProductAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                'Exit Sub


                dsAvailable.SelectCommand = "EXEC S_MsCustProductAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                'lbstatus.Text = "EXEC S_MsCustProductAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsCustProductAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Product" Then
                'StrSelected = SelectedGrid(AvailableGrid, "cbAvailable", "lbAvailableCode", "ProductCode")
                StrSelected = SelectedGridDev(AvailableGrid, "CustCode")
            ElseIf ddlGroupBy.SelectedValue = "Customer" Then
                'StrSelected = SelectedGrid(AvailableGrid, "cbAvailable", "lbAvailableCode", "SupplierCode")
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Product" Then
                'StrSelected = SelectedGrid(AssignedGrid, "cbAssign", "lbAssignCode", "ProductCode")
                StrSelected = SelectedGridDev(AssignedGrid, "CustCode")
            ElseIf ddlGroupBy.SelectedValue = "Customer" Then
                'StrSelected = SelectedGrid(AssignedGrid, "cbAssign", "lbAssignCode", "SupplierCode")
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Supplier   1 = User
            SqlString = "EXEC S_MsCustProductCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Customer" Then
                Session("filter") = "select * From VMsCustomer Where FgActive='Y'"
                ResultField = "Customer_Code, Customer_Name"
            Else
                Session("filter") = "select * From VMsProduct"
    ...
    Protected Sub btnSearchTo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchTo.Click
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Customer" Then
                ...
                ResultField = "Customer_Code, Customer_Name"
            Else
                Session("filter") = "select * From VMsProductNFGSimple"
                ResultField = "Product_Code, Product_Name"
            End If
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            If ddlGroupBy.SelectedValue = "Customer" Then
                ds = SQLExecuteQuery("select Customer_Code, Customer_Name From VMsCustomer Where FgActive='Y' AND Customer_Code = " + QuotedStr(tbCode.Text), ViewState("DBConnection"))
            Else 'If ddlGroupBy.SelectedValue = "Product" Then
                ds = SQLExecuteQuery("select ProductCode, ProductName From MsProduct Where ProductCode = " + QuotedStr(tbCode.Text), ViewState("DBConnection"))
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Dim ds As DataSet
        Try
            If ddlGroupByCopy.SelectedValue = "Supplier" Then
                ds = SQLExecuteQuery("select CustomerCode, CustomerName From MsCustomer Where CustomerCode = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Customer" Then
                ds = SQLExecuteQuery("select CustomerCode, CustomerName From MsCustomer Where SupplierCode = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            Session("DBConnection") = ViewState("DBConnection")
            If ddlGroupBy.SelectedValue = "Customer" Then
                SQLString = "EXEC S_MsCustProductPrint 0, 'Customer - Product', 'Product Code', 'Product Name' ," + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsCustProductPrint 1, 'Product - Customer', 'Customer Code', 'Customer Name' ," + QuotedStr(ViewState("UserId"))
            End If
