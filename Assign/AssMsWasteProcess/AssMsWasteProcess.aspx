<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssMsWasteProcess.aspx.vb" Inherits="Assign_AssMsWasteProcess_AssMsWasteProcess" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Waste -&nbsp; Process</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Waste</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>                    
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbFromName" runat="server" Width="324px" 
                            Enabled="False" /> 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbToName" runat="server" Width="324px" 
                            Enabled="False" /> 
              ...
              <table width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox CssClass="TextBox" ID="tbName" runat="server" Width="351px" 
                            Enabled="False" /> 
