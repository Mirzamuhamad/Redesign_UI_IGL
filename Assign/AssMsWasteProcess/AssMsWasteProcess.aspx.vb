...
Imports System.Data
Partial Class Assign_AssMsWasteProcess_AssMsWasteProcess
    ...
    Private Sub LoadDataGrid()
        Try
            ...
            If tbCode.Text.Trim <> "" Then
                dsAssigned.SelectCommand = "EXEC S_MsWasteProcessAssign " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
                dsAvailable.SelectCommand = "EXEC S_MsWasteProcessAvailable " + QuotedStr(tbCode.Text) + ", " + ddlGroupBy.SelectedIndex.ToString
            Else
    ...
    Private Sub ExecSPAddRemove(ByVal GroupValue As String, ByVal Page As Integer, ByVal StrSelected As String, ByVal Flag As Integer)
        ...
        Try
            SQLString = "EXEC S_MsWasteProcessAddRemove '" + GroupValue + "', " + Page.ToString + ", '" + StrSelected + "', '" + ViewState("UserId").ToString + "', " + Flag.ToString
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        Try
            If tbCode.Text = "" Then Exit Sub
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Waste" Then
                StrSelected = SelectedGridDev(AvailableGrid, "Process_Code")
            ElseIf ddlGroupBy.SelectedValue = "Process" Then
                StrSelected = SelectedGridDev(AvailableGrid, "Waste_Code")
            End If
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            StrSelected = ""
            If ddlGroupBy.SelectedValue = "Waste" Then
                StrSelected = SelectedGridDev(AssignedGrid, "Process_Code")
            ElseIf ddlGroupBy.SelectedValue = "Process" Then
                StrSelected = SelectedGridDev(AssignedGrid, "Waste_Code")
            End If
            If StrSelected.Trim <> "" Then
                ' 0 = Warehouse   1 = User
    ...
    Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCopy.Click
        ...
        Try
            ...
            SqlString = ""
            ' 0 = Warehouse   1 = User
            SqlString = "EXEC S_MsWasteProcessCopyFrom " + QuotedStr(tbFromCode.Text) + ", " + QuotedStr(tbToCode.Text) + ", " + ddlGroupByCopy.SelectedIndex.ToString + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Waste" Then
                Session("filter") = "SELECT Waste_Code, Waste_Name FROM VMsWaste"
                ResultField = "Waste_Code, Waste_Name "
            Else
                Session("filter") = "SELECT Process_Code, Process_Name FROM VMsProcess"
                ResultField = "Process_Code, Process_Name"
            End If
    ...
    Protected Sub btnSearchFrom_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchFrom.Click
        Dim ResultField As String
        Try
            If ddlGroupByCopy.SelectedValue = "Waste" Then
                Session("filter") = "SELECT Waste_Code, Waste_Name FROM VMsWaste"
                ResultField = "Waste_Code, Waste_Name "
            Else
                Session("filter") = "SELECT Process_Code, Process_Name FROM VMsProcess"
    ...
    Protected Sub tbCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbCode.TextChanged
        ...
        Try
            ...
            Else 'If ddlGroupBy.SelectedValue = "User" Then
                ds = SQLExecuteQuery("SELECT Process_Code, Process_Name FROM VMsProcess WHERE Process_Code = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbFromCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFromCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Waste" Then
                ds = SQLExecuteQuery("SELECT Waste_Code, Waste_Name FROM VMsWaste WHERE Waste_Code = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT Process_Code, Process_Name FROM VMsProcess WHERE Process_Code = " + QuotedStr(tbFromCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub tbToCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbToCode.TextChanged
        ...
        Try
            If ddlGroupByCopy.SelectedValue = "Waste" Then
                ds = SQLExecuteQuery("SELECT Waste_Code, Waste_Name FROM VMsWaste WHERE Waste_Code = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            Else 'If ddlGroupBy.SelectedValue = "Account" Then
                ds = SQLExecuteQuery("SELECT Process_Code, Process_Name FROM VMsProcess WHERE Process_Code = " + QuotedStr(tbToCode.Text), ViewState("DBConnection").ToString)
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            If ddlGroupBy.SelectedValue = "Waste" Then
                SQLString = "EXEC S_MsWasteProcessPrint 0, 'Waste - Process', 'Process Code', 'Process Name', " + QuotedStr(ViewState("UserId"))
            Else
                SQLString = "EXEC S_MsWasteProcessPrint 1, 'Process - Waste', 'Waste Code', 'Waste Name',  " + QuotedStr(ViewState("UserId"))
            End If
