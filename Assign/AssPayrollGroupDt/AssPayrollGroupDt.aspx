<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssPayrollGroupDt.aspx.vb" Inherits="Assign_AssPayrollGroupDt_AssPayrollGroupDt" %>
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Group Payroll</asp:ListItem>
