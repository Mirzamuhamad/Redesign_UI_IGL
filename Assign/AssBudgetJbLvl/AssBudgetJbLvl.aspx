<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssBudgetJbLvl.aspx.vb" Inherits="Assign_AssBudgetJbLvl_AssBudgetJbLvl" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Assign Budget Plafond</div>
    <hr style="color:Blue" /> 
        <br />        
              ...
              <table width="100%">
                <tr>
                    ...
                    <td><asp:DropDownList CssClass="DropDownList" ID = "ddlGroupByCopy" runat = "server" AutoPostBack="true" >
                            <asp:ListItem Selected="True">Budget</asp:ListItem>
                ...
                <td style="width:40%;">
                   <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">                   
                    <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        ...
                        <dx:GridViewDataColumn FieldName="Plafond" VisibleIndex="3" >
                        <Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>
