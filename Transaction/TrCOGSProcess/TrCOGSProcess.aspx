<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrCOGSProcess.aspx.vb" Inherits="Transaction_TrCOGSProcess_TrCOGSProcess" %>
...
<body>
    ...
    <div class="Content">
        <div class="H1">
        <asp:Label ID="lblTitle" CssClass="TextBox" Text = "" runat="server"/>            
        </div>
        <hr style="color:Blue" />
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      <asp:ListItem Selected="True" Value="Start_Date">Start Date</asp:ListItem>
                      <asp:ListItem Value="End_Date">End Date</asp:ListItem>
                  ...
                  <asp:TemplateField HeaderStyle-Width="110">
                      <ItemTemplate>
                          <asp:DropDownList CssClass="DropDownList" ID="ddl" runat="server">
                              ...
                              <asp:ListItem Text="Compute" /> <%--c--%>
                              <asp:ListItem Text="Complete" /> <%--f--%>
                              <asp:ListItem Text="Un-Complete" /> <%--f--%>
                          </asp:DropDownList>
                          <asp:Button class="btngo" runat="server" ID="BtnGo" Text="G" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" CommandName="Go" />                
                      </ItemTemplate>
                      <HeaderStyle Width="110px" />
                  </asp:TemplateField>
                  <asp:BoundField DataField="Start_Date" SortExpression="StartDate" HeaderText="Start Date"></asp:BoundField>
                  <asp:BoundField DataField="End_Date" SortExpression="EndDate" HeaderText="End Date"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      ...
      <hr style="color:Blue" />  
        <asp:Panel runat="server" ID="pnlDt">
            <asp:Label ID="lbType" CssClass="TextBox" Text = "Product : " runat="server"/>            
            <asp:DropDownList ID="ddlTypeDt" CssClass="DropDownList" runat="server" Width="300px" AutoPostBack = "true" />
       ...
       <br />          
         ...
         <asp:Button ID="btnCompute" Text="Compute" CssClass="Button" runat="server"/>
         <asp:Button ID="btnComplete" Text="Complete" CssClass="Button" runat="server"/>
         <asp:Button ID="btnUnComplete" Text="Un-Complete" CssClass="Button" runat="server"/>
