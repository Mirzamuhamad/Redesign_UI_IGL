...
Partial Class ApprovalVoucher
    ...
    Private Sub SetInit()
        ...
        'Me.tbInvoice.Attributes.Add("ReadOnly", "False")
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                "InvoiceType, ExpenseType, BankPenerima, NamaPenerima, AccNmbr, TotalAmountHd, TotalPotongan, TotalDpp, TotalPPN, TotalPPH, TotalInvoice,PerkiraanBayar, PphCode, " + _
                ...
                QuotedStr(tbTotalInvoice.Text.Replace(",", "")) + ",'" + Format(tbPerkiraanBayar.SelectedDate, "yyyy-MM-dd") + "', " + QuotedStr(ddlpph.SelectedValue) + ", " + _
    ...
    Function CekHd() As Boolean
        Try
            ...
            If TbTotalPPH.Text <> 0 And ddlInvoiceType.SelectedValue <> "Invoice" Then
                If ddlpph.SelectedValue = "" Then
                    lbStatus.Text = MessageDlg("Pph Type must have value")
                    ddlpph.Focus()
                    Return False
                End If
            End If
    ...
    Function CekDt(Optional ByVal Dr As DataRow = Nothing) As Boolean
        Try
            If Not Dr Is Nothing Then
                ...
                'End If
            Else
                If Val(tbInvoice.Text) = 0 Or tbInvoice.Text = "" Then
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            ...
            BindToText(tbType, Dt.Rows(0)("TypePph").ToString)
        Catch ex As Exception
