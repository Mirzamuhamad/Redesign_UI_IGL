<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ARPending.Aspx.vb" Inherits="ARPending" %>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Customer" HeaderStyle-Width="150px" SortExpression="Customer" HeaderText="Customer"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        <tr>
            ...
            <%--<asp:Label runat="server" ID="lbTransClass" Visible="false"/>&nbsp; &nbsp; --%>
                <%--<asp:ImageButton ID="btnGetDt" ValidationGroup="Input" runat="server" 
                    ImageUrl="../../Image/btnSelectOn.png"
                    onmouseover="this.src='../../Image/btnSelectOff.png';"
                    onmouseout="this.src='../../Image/btnSelectOn.png';"
        ...
        <tr>
            ...
            <td><asp:Button class="bitbtn btngo" ValidationGroup="Input" runat="server" 
        ...
        <tr>
            ...
            <td>:</td>
            <td><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbWrhsCode" AutoPostBack="true" /> 
        ...
        <tr>
            <td>SO No</td>
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbSONo" CssClass="TextBox" Width="150px"/></td>
        </tr>                        
        <tr>
                ...
                &nbsp Rate : &nbsp <asp:TextBox ID="tbRate" ValidationGroup="Input" runat="server" CssClass="TextBox" Width="70px" style="text-align:right;" />
                </td>
        </tr>  
        <tr>
                <td>Total</td>
                ...
                <td colspan="2">
                    <table>
                        ...
                        <tr>
                            <td><asp:TextBox ID="tbBaseForex" runat="server" CssClass="TextBoxR" style="text-align:right;" /></td>
                            <td><asp:TextBox ID="tbPPN" ValidationGroup="Input" runat="server" CssClass="TextBox" style="text-align:right;" /></td>
                            <td><asp:TextBox ID="tbPPNForex" runat="server" CssClass="TextBoxR" style="text-align:right;" /></td>
                            <td><asp:TextBox ID="tbTotalForex" runat="server" CssClass="TextBoxR" style="text-align:right;"/></td>
                        </tr>
                    </table>
                </td>                
             </tr>   
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="QtyM2" HeaderStyle-Width="100px" HeaderText="Qty M2" ItemStyle-HorizontalAlign = "Right"  />
                        <asp:BoundField DataField="QtyRoll" HeaderStyle-Width="100px" HeaderText="Qty Roll" ItemStyle-HorizontalAlign = "Right"  />
                        <asp:BoundField DataField="PriceInUnit" HeaderStyle-Width="80px" HeaderText="Price In Unit" ItemStyle-HorizontalAlign = "Right" />                        
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
            <table>                
                ...
                <tr>
                    <td>Qty </td>
                    <td>:</td>
                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbQty" AutoPostBack="True" style="text-align:right;"  /></td>                    
                </tr>
                <tr>
                    <td>Unit </td>
                    <td>:</td>
                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbUnit" Enabled="false" /></td>
                </tr>  
                <tr>
                    <td>Qty M2</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Price In Unit</td>
                    <td>:</td>
                    <td><asp:DropDownList Id ="ddlUnit" Enabled="true" runat="server" 
                ...
                <tr>
                    <td>Price </td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" CssClass="TextBox" ID="tbPrice" style="text-align:right;" AutoPostBack="True"/></td>
                </tr>              
                <tr>
                    <td>Amount Forex </td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" CssClass="TextBoxR" ID="tbAmountForex" style="text-align:right;"/></td>
                </tr>  
                <tr>
                    <td>Remark </td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" CssClass="TextBox" ID="tbRemarkDt" /></td>
                </tr>                              
            </table>
            <br />          
