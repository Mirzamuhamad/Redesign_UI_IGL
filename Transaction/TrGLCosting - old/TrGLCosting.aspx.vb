...
Partial Class Transaction_TrGLCosting_TrGLCosting
    ...
    '            StrQuery = "EXEC S_GLProcessAlokasiV2 " + QuotedStr(tbDate.SelectedDate) + " , " + QuotedStr(tbDateE.Text) + ", " + QuotedStr(tbAccCode.Text) + ", ' order by " + StrFilter + "'"
    ...
    '            End If
    '            StrQuery = "EXEC S_GLProcessAlokasiV2 " + QuotedStr(tbDate.SelectedDate) + " , " + QuotedStr(tbDateE.Text) + ", " + QuotedStr(tbAccCode.Text) + ", " + QuotedStr(StrFilter)
    '        End If
    ...
    '    Return "EXEC S_GLProcessAlokasiV2 " + QuotedStr(Date.Today) + ", " + QuotedStr(Date.Today) + ", '',''"
    '    lbStatus.Text = Nmbr
    '    Exit Function
    'End Function
    ...
    Private Sub BindDataFromTable()
        ...
        Try
            ...
            SQLString = "SELECT * FROM FINTandaTerimaCostAlokasi WHERE TTdate Between " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + " AND " + QuotedStr(Format(tbDateE.SelectedValue, "yyyy-MM-dd")) + " " + StrFilter + ""
    ...
    'Return "EXEC S_GLProcessAlokasiV2 " + QuotedStr(tbDate.SelectedDate) + " , " + QuotedStr(tbDateE.Text) + ", " + QuotedStr(Nmbr) + ", ''"
    'End Function
    ...
    Private Sub BindData()
        ...
        Try
            ...
            Dim dt As New DataTable
            ViewState("Dt2") = Nothing
            SQLString = "EXEC S_GLProcessAlokasiV2 " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + ", " + QuotedStr(Format(tbDateE.SelectedValue, "yyyy-MM-dd"))
            dt = SQLExecuteQuery(SQLString, ViewState("DBConnection").ToString).Tables(0)
            ViewState("Dt2") = dt
            BindGridDt(dt, GridView1)
        Catch ex As Exception
    ...
    Protected Sub BtnGetDt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGetDt.Click
        Try
            SQLExecuteNonQuery("EXEC S_GLProcessAlokasiV2 " + QuotedStr(tbDate.SelectedDate) + " , " + QuotedStr(tbDateE.Text) + "", ViewState("DBConnection").ToString)
            BindData()
        Catch ex As Exception
