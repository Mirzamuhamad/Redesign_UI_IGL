...
Imports System.IO
Partial Class Transaction_TrBeginLandPurchaseReq
    Inherits System.Web.UI.Page
    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "SELECT * FROM V_GLBeginLandPurchaseReqHd"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Session("Result") Is Nothing Then
                ...
                If ViewState("Sender") = "btnNotaris" Then
                    BindToText(tbNotaris, Session("Result")(0).ToString)
                    BindToText(tbNotarisName, Session("Result")(1).ToString)
                    AttachScript("setformathd();", Page, Me.GetType)
                End If

                If ViewState("Sender") = "btnWakil" Then
                    BindToText(tbwakilCode, Session("Result")(0).ToString)
                    BindToText(tbWakilName, Session("Result")(1).ToString)
                    AttachScript("setformathd();", Page, Me.GetType)
                End If
            ...
            If Not ViewState("TransNmbr") Is Nothing Then
                If HiddenRemarkReject.Value <> "False Value" Then
                    ...
                    'sqlstring = "Update GLBeginLandPurchaseReqHd Set Status = 'R', remarkReject = " + QuotedStr(HiddenRemarkReject.Value) + " WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr").ToString) + "  "
                    'SQLExecuteNonQuery(sqlstring, ViewState("DBConnection").ToString)
                    sqlstring = "Declare @A VarChar(255) EXEC S_PLGLBeginLandPurchaseReqReject " + QuotedStr(ViewState("TransNmbr").ToString) + "," + CInt(Session(Request.QueryString("KeyId"))("Year")).ToString + ", " + CInt(Session(Request.QueryString("KeyId"))("Period")).ToString + "," + QuotedStr(HiddenRemarkReject.Value) + "," + QuotedStr(ViewState("UserId")) + ", @A OUT SELECT @A"
    ...
    Protected Sub btnKtp_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnKtp.Click
        Try
            ...
            Dim dt As DataTable
            path2 = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FupMain.FileName
            namafile2 = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FupMain.FileName

            SQLString1 = "UPDATE GLBeginLandPurchaseReqHd SET DocKTP = " + QuotedStr(namafile2) + _
    ...
    Protected Sub btnsaveKK_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveKK.Click
        ...
        Try
            ...
            Path2KK = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubKK.FileName
            NameFile2KK = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubKK.FileName
            SQLString2 = "UPDATE GLBeginLandPurchaseReqHd SET DocKK = " + QuotedStr(NameFile2KK) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPPT_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPPT.Click
        ...
        Try
            ...
            Path2SPPT = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPPT.FileName
            NameFile2SPPT = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPPT.FileName

            SQLString3 = "UPDATE GLBeginLandPurchaseReqHd SET DocSPPT = " + QuotedStr(NameFile2SPPT) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSTTS_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSTTS.Click
        ...
        Try
            ...
            Path2STTS = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSTTS.FileName
            NameFile2STTS = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSTTS.FileName

            SQLString4 = "UPDATE GLBeginLandPurchaseReqHd SET DocSTTS = " + QuotedStr(NameFile2STTS) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveTTD_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveTTD.Click
        ...
        Try
            ...
            Path2TTD = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubTTD.FileName
            NameFile2TTD = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubTTD.FileName

            SQLString5 = "UPDATE GLBeginLandPurchaseReqHd SET DocTTD = " + QuotedStr(NameFile2TTD) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveAJB_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveAJB.Click
        ...
        Try
            ...
            Path2AJB = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAJB.FileName
            NameFile2AJB = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAJB.FileName

            SQLString6 = "UPDATE GLBeginLandPurchaseReqHd SET DocAJB = " + QuotedStr(NameFile2AJB) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveAJB2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveAJB2.Click
        ...
        Try
            ...
            Path2AJB2 = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAJB2.FileName
            NameFile2AJB2 = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAJB2.FileName

            SQLString7 = "UPDATE GLBeginLandPurchaseReqHd SET DocAJB2 = " + QuotedStr(NameFile2AJB2) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSSP_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSSP.Click
        ...
        Try
            ...
            Path2SSP = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSSP.FileName
            NameFile2SSP = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSSP.FileName

            SQLString8 = "UPDATE GLBeginLandPurchaseReqHd SET DocSSP = " + QuotedStr(NameFile2SSP) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSSD_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSSD.Click
        ...
        Try
            ...
            Path2SSD = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSSD.FileName
            NameFile2SSD = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSSD.FileName

            SQLString9 = "UPDATE GLBeginLandPurchaseReqHd SET DocSSD = " + QuotedStr(NameFile2SSD) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSKTS_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSKTS.Click
        ...
        Try
            ...
            Path2SKTS = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKTS.FileName
            NameFile2SKTS = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKTS.FileName

            SQLString10 = "UPDATE GLBeginLandPurchaseReqHd SET DocKTS = " + QuotedStr(NameFile2SKTS) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPBT_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPBT.Click
        ...
        Try
            ...
            Path2SPBT = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPBT.FileName
            NameFile2SPBT = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPBT.FileName

            SQLString11 = "UPDATE GLBeginLandPurchaseReqHd SET DocSBPT = " + QuotedStr(NameFile2SPBT) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPKTT_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPKTT.Click
        ...
        Try
            ...
            Path2SPKTT = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPKTT.FileName
            NameFile2SPKTT = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPKTT.FileName

            SQLString12 = "UPDATE GLBeginLandPurchaseReqHd SET DocSPKTT = " + QuotedStr(NameFile2SPKTT) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveBAM_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveBAM.Click
        ...
        Try
            ...
            Path2BAM = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBAM.FileName
            NameFile2BAM = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBAM.FileName

            SQLString13 = "UPDATE GLBeginLandPurchaseReqHd SET DocBAM = " + QuotedStr(NameFile2BAM) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveBAPL_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveBAPL.Click
        ...
        Try
            ...
            Path2BAPL = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBAPL.FileName
            NameFile2BAPL = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBAPL.FileName

            SQLString14 = "UPDATE GLBeginLandPurchaseReqHd SET DocBAPL = " + QuotedStr(NameFile2BAPL) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsavePTPP_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsavePTPP.Click
        ...
        Try
            ...
            Path2PTPP = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPTPP.FileName
            NameFile2PTPP = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPTPP.FileName

            SQLString15 = "UPDATE GLBeginLandPurchaseReqHd SET DocPTPP = " + QuotedStr(NameFile2PTPP) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsavePTPP2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsavePTPP2.Click
        ...
        Try
            ...
            Path2PTPP2 = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPTPP2.FileName
            NameFile2PTPP2 = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPTPP2.FileName

            SQLString16 = "UPDATE GLBeginLandPurchaseReqHd SET DocPTPP2 = " + QuotedStr(NameFile2PTPP2) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSKRT_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSKRT.Click
        ...
        Try
            ...
            Path2SKRT = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKRT.FileName
            NameFile2SKRT = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKRT.FileName

            SQLString17 = "UPDATE GLBeginLandPurchaseReqHd SET DocSKRT = " + QuotedStr(NameFile2SKRT) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSKD_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSKD.Click
        ...
        Try
            ...
            Path2SKD = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKD.FileName
            NameFile2SKD = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSKD.FileName

            SQLString18 = "UPDATE GLBeginLandPurchaseReqHd SET DocSKD = " + QuotedStr(NameFile2SKD) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveFcGirik_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveFCGirik.Click
        ...
        Try
            ...
            Path2FcGirik = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubFCGirik.FileName
            NameFile2FcGirik = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubFCGirik.FileName

            SQLString19 = "UPDATE GLBeginLandPurchaseReqHd SET DocFcGirik = " + QuotedStr(NameFile2FcGirik) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveFDP_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveFDP.Click
        ...
        Try
            ...
            Path2FDP = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubFDP.FileName
            NameFile2FDP = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubFDP.FileName

            SQLString20 = "UPDATE GLBeginLandPurchaseReqHd SET DocFDP = " + QuotedStr(NameFile2FDP) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsavePatok_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsavePatok.Click
        ...
        Try
            ...
            Path2Patok = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPatok.FileName
            NameFile2Patok = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubPatok.FileName

            SQLString21 = "UPDATE GLBeginLandPurchaseReqHd SET DocPatok = " + QuotedStr(NameFile2Patok) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSporadik_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSporadik.Click
        ...
        Try
            ...
            Path2Sporadik = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSporadik.FileName
            NameFile2Sporadik = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSporadik.FileName

            SQLString22 = "UPDATE GLBeginLandPurchaseReqHd SET DocSporadik = " + QuotedStr(NameFile2Sporadik) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveAHU_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveAHU.Click
        ...
        Try
            ...
            Path2AHU = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAHU.FileName
            NameFile2AHU = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubAHU.FileName

            SQLString23 = "UPDATE GLBeginLandPurchaseReqHd SET DocAHU = " + QuotedStr(NameFile2AHU) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSejarah_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSejarah.Click
        ...
        Try
            ...
            Path2Sporadik = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSejarah.FileName
            NameFile2Sporadik = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSejarah.FileName

            SQLString24 = "UPDATE GLBeginLandPurchaseReqHd SET DocSejarah = " + QuotedStr(NameFile2Sporadik) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPJH_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPJH.Click
        ...
        Try
            ...
            Path2SPJH = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPJH.FileName
            NameFile2SPJH = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPJH.FileName

            SQLString25 = "UPDATE GLBeginLandPurchaseReqHd SET DocSPJH = " + QuotedStr(NameFile2SPJH) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveLainLain_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveLainLain.Click
        ...
        Try
            ...
            Path2LainLain = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain.FileName
            NameFile2FubLainLain = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocLainLain = " + QuotedStr(NameFile2FubLainLain) + _
    ...
    Protected Sub btnsaveKTPW_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveKtpW.Click
        ...
        Try
            ...
            Path2KTPW = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FupKTPW.FileName
            NameFile2KTPW = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FupKTPW.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocKTPW = " + QuotedStr(NameFile2KTPW) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPW_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPW.Click
        ...
        Try
            ...
            Path2SPW = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPW.FileName
            NameFile2SPW = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPW.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocSPW = " + QuotedStr(NameFile2SPW) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveSPKW_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveSPKW.Click
        ...
        Try
            ...
            Path2SPKW = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPKW.FileName
            NameFile2SPKW = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubSPKW.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocSPKW = " + QuotedStr(NameFile2SPKW) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveBPJS_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveBPJS.Click
        ...
        Try
            ...
            Path2BPJS = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBPJS.FileName
            NameFile2BPJS = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubBPJS.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocBPJS = " + QuotedStr(NameFile2BPJS) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnsaveLainLain2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveLainLain2.Click
        ...
        Try
            ...
            Dim dt As DataTable
            Dim Path2LainLain, NameFile2FubLainLain, SQLString26 As String
            Path2LainLain = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain2.FileName
            NameFile2FubLainLain = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain2.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocLainLain2 = " + QuotedStr(NameFile2FubLainLain) + _
    ...
    Protected Sub btnsaveLainLain3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveLainLain3.Click
        ...
        Try
            ...
            Dim dt As DataTable
            Dim Path2LainLain, NameFile2FubLainLain, SQLString26 As String
            Path2LainLain = Server.MapPath("~/Image/DokumenBegin/") + tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain3.FileName
            NameFile2FubLainLain = tbCode.Text.Trim.Replace("/", "") + Format(Now, "-yyMMddHHmmss-") + FubLainLain3.FileName

            SQLString26 = "UPDATE GLBeginLandPurchaseReqHd SET DocLainLain3 = " + QuotedStr(NameFile2FubLainLain) + _
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_GLBeginLandPurchaseReqDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Private Function GetStringDt3(ByVal Nmbr As String) As String
        Return "SELECT * From V_GLBeginLandPurchaseReqDt2 WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function

    Private Function GetStringDt4(ByVal Nmbr As String) As String
        Return "SELECT * From V_GLBeginLandPurchaseReqSubDt2 WHERE TransNmbr = " + QuotedStr(Nmbr) + " ORDER BY DocDate ASC "
    End Function
    ...
    Private Sub OriginalTotal()
        Dim biaya As String
        Try

            tbOriginalAmount.Text = Val(tbTandaJadi.Text.Replace(",", "")) + Val(tbPelunasan.Text.Replace(",", "")) + Val(tbJumlah.Text.Replace(",", "")) + Val(tbBiayaBPHTB.Text.Replace(",", "")) + Val(tbBiayaSurvey.Text.Replace(",", "")) + Val(tbBiayaModerator.Text.Replace(",", "")) + Val(tbBiayaLainLain.Text.Replace(",", ""))

            tbOriginalAmount.Text = FormatNumber(tbOriginalAmount.Text, ViewState("DigitHome"))
        Catch ex As Exception
            Throw New Exception("Count : " + ex.ToString)
        End Try
    End Sub
    ...
    Private Sub CountTotalDt()
        ...
        Try
            ...
            If tbHrgPerm2Akta.Text = "" Then
                tbHrgPerm2Akta.Text = 0
            End If
            ...
            If ddlHitungTotal.SelectedValue = "SPPT" Then
                biaya = 60000000
                tbTotalHrgAkta.Text = Val(tbHrgPerm2Akta.Text.Replace(",", "")) * Val(tbSPPT.Text.Replace(",", ""))

            ElseIf ddlHitungTotal.SelectedValue = "AJB/SPH/SHM" Then
                biaya = 60000000
                tbTotalHrgAkta.Text = Val(tbHrgPerm2Akta.Text.Replace(",", "")) * Val(tbAjbSphShm.Text.Replace(",", ""))

            ElseIf ddlHitungTotal.SelectedValue = "Luas Ukur" Then

                biaya = 60000000
                tbTotalHrgAkta.Text = Val(tbHrgPerm2Akta.Text.Replace(",", "")) * Val(tbLuasUkur.Text.Replace(",", ""))


            End If

            If Val(tbTotalHrgAkta.Text) > biaya Then
                tbBiayaBPHTB.Text = (Val(tbTotalHrgAkta.Text) - Val(biaya)) * 5 / 100
            Else
                tbBiayaBPHTB.Text = 0
            End If
            tbBiayaBPHTB.Text = FormatNumber(tbBiayaBPHTB.Text, ViewState("DigitHome"))
            tbTotalHrgAkta.Text = FormatNumber(tbTotalHrgAkta.Text, ViewState("DigitHome"))
            tbHrgPerm2Akta.Text = FormatNumber(tbHrgPerm2Akta.Text, ViewState("DigitHome"))
            btnSaveAll.Focus()
        Catch ex As Exception
            Throw New Exception("Count : " + ex.ToString)
        End Try
    ...
    Protected Sub tbHrgPerm2Akta_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles tbHrgPerm2Akta.TextChanged
    ...
    Protected Sub tbTandaJadi_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles tbTandaJadi.TextChanged

        Try
            tbPelunasan.Text = Val(tbTotal.Text.Replace(",", "")) - Val(tbTandaJadi.Text.Replace(",", ""))
            tbPelunasan.Text = FormatNumber(tbPelunasan.Text, ViewState("DigitHome"))
            tbTandaJadi.Text = FormatNumber(tbTandaJadi.Text, ViewState("DigitHome"))
        Catch ex As Exception
            lbStatus.Text = "btn Search Cust Error : " + ex.ToString
        End Try
    End Sub
    ...
    Private Sub ClearHd()
        Try
            ...
            tbPelunasan.Text = 0
            tbNoDocNotaris.Text = ""
            tbBiayaNotaris.Text = 0
            tbJumlah.Text = 0
            tbBiayaSurvey.Text = 0
            tbBiayaBPHTB.Text = 0
            tbBiayaModerator.Text = 0
            tbBiayaLainLain.Text = 0
            tbDokumen.Text = 0
            tbHrgPerm2Akta.Text = 0
            tbTotalHrgAkta.Text = 0
            tbOriginalAmount.Text = 0
            tbAmountAlocation.Text = 0
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            ...
            BindToDate(tbDateDokumen, Dt.Rows(0)("P_DokumenDate").ToString)
            BindToText(tbwakilCode, Dt.Rows(0)("WakilPembeli").ToString)
            BindToText(tbWakilName, Dt.Rows(0)("WAkilPembeliName").ToString)
            BindToText(tbNamaWP, Dt.Rows(0)("WPName").ToString)
            BindToText(tbAlamatWP, Dt.Rows(0)("WPAlamat").ToString)
            BindToText(tbKTPWP, Dt.Rows(0)("WPKtp").ToString)
            BindToText(tbTelpWP, Dt.Rows(0)("WPTelp").ToString)
            BindToText(tbNotaris, Dt.Rows(0)("NotarisCode").ToString)
            BindToText(tbNotarisName, Dt.Rows(0)("NotarisName").ToString)
            BindToText(tbPayTerm, Dt.Rows(0)("BrpaKliBayar").ToString)
            BindToDropList(ddlPembayaran, Dt.Rows(0)("RncanaBayar").ToString)
            BindToText(tbTandaJadi, Dt.Rows(0)("QtyTJ").ToString, ViewState("DigitCurr"))
            BindToText(tbPelunasan, Dt.Rows(0)("QtyPelunasan").ToString, ViewState("DigitCurr"))
            BindToDropList(ddlJenisDokNotaris, Dt.Rows(0)("JnsDokNotaris").ToString)
            BindToText(tbBiayaNotaris, Dt.Rows(0)("B_NotarisPerM").ToString, ViewState("DigitCurr"))
            BindToText(tbJumlah, Dt.Rows(0)("TtlB_Notaris").ToString, ViewState("DigitCurr"))
            BindToText(tbBiayaSurvey, Dt.Rows(0)("B_Survey").ToString, ViewState("DigitCurr"))
            BindToText(tbBiayaBPHTB, Dt.Rows(0)("B_BPHTB").ToString, ViewState("DigitCurr"))
            BindToText(tbBiayaModerator, Dt.Rows(0)("B_Moderator").ToString, ViewState("DigitCurr"))
            BindToText(tbBiayaLainLain, Dt.Rows(0)("B_LainLain").ToString, ViewState("DigitCurr"))
            BindToText(tbNoDocNotaris, Dt.Rows(0)("NoDokNotaris").ToString)
            BindToText(tbHrgPerm2Akta, Dt.Rows(0)("HrgAkta").ToString, ViewState("DigitCurr"))
            BindToText(tbTotalHrgAkta, Dt.Rows(0)("TtlHrgAkta").ToString, ViewState("DigitCurr"))
            BindToText(tbOriginalAmount, Dt.Rows(0)("OriginalAmount").ToString, ViewState("DigitCurr"))
            BindToText(tbAmountAlocation, Dt.Rows(0)("UnAllocAmount").ToString, ViewState("DigitCurr"))
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbCode.Text = GetAutoNmbr("BLS", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO GLBeginLandPurchaseReqHd (TransNmbr,	TransDate,	Status,	Block,	Kohir ,	Persil , AJBNo, SPHNo, SHMNo, SellCode, ModCode,  " + _
                ...
                "Remark,AreaCode, LuasFrom, LandType, JnsDocSertifikat, NoDocSertifikat,TglTerbit, MasaBerlaku,NoBNIB,NoSuratUkur, NoLainLain, " + _
                "P_Dokumen, " + _
                "P_DokumenDate, " + _
                "WakilPembeli, " + _
                "WPName, " + _
                ...
                QuotedStr(tbDokumen.Text) + "," + _
                QuotedStr(tbDateDokumen.Text) + "," + _
                QuotedStr(tbwakilCode.Text) + "," + _
                QuotedStr(tbNamaWP.Text) + "," + _
                QuotedStr(tbKTPWP.Text) + "," + _
                QuotedStr(tbAlamatWP.Text) + "," + _
                QuotedStr(tbTelpWP.Text) + "," + _
                QuotedStr(tbHrgPerm2Akta.Text.Replace(",", "")) + "," + _
                QuotedStr(tbTotalHrgAkta.Text.Replace(",", "")) + "," + _
                QuotedStr(tbPayTerm.Text) + "," + _
                QuotedStr(ddlPembayaran.SelectedValue) + "," + _
                QuotedStr(tbTandaJadi.Text.Replace(",", "")) + "," + _
                QuotedStr(tbPelunasan.Text.Replace(",", "")) + "," + _
                QuotedStr(tbNotaris.Text) + "," + _
                QuotedStr(ddlJenisDokNotaris.SelectedValue) + "," + _
                QuotedStr(tbNoDocNotaris.Text) + "," + _
                QuotedStr(tbBiayaNotaris.Text.Replace(",", "")) + "," + _
                QuotedStr(tbJumlah.Text.Replace(",", "")) + "," + _
                QuotedStr(tbBiayaSurvey.Text.Replace(",", "")) + "," + _
                QuotedStr(tbBiayaModerator.Text.Replace(",", "")) + "," + _
                QuotedStr(tbBiayaBPHTB.Text.Replace(",", "")) + "," + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM GLBeginLandPurchaseReqHd WHERE TransNmbr = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                ...
                SQLString = "UPDATE GLBeginLandPurchaseReqHd SET TransDate = " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + _
                ...
                ", P_Dokumen = " + QuotedStr(tbDokumen.Text) + _
                ", P_DokumenDate = " + QuotedStr(tbDateDokumen.Text) + _
                ", WakilPembeli = " + QuotedStr(tbwakilCode.Text) + _
                ", WPName = " + QuotedStr(tbNamaWP.Text) + _
                ", WPKtp= " + QuotedStr(tbKTPWP.Text) + _
                ", WPAlamat= " + QuotedStr(tbAlamatWP.Text) + _
                ", WPTelp= " + QuotedStr(tbTelpWP.Text) + _
                ", HrgAkta= " + QuotedStr(tbHrgPerm2Akta.Text.Replace(",", "")) + _
                ", TtlHrgAkta= " + QuotedStr(tbTotalHrgAkta.Text.Replace(",", "")) + _
                ", BrpaKliBayar = " + QuotedStr(tbPayTerm.Text) + _
                ", RncanaBayar = " + QuotedStr(ddlPembayaran.SelectedValue) + _
                ", QtyTJ= " + QuotedStr(tbTandaJadi.Text.Replace(",", "")) + _
                ", QtyPelunasan= " + QuotedStr(tbPelunasan.Text.Replace(",", "")) + _
                ", NotarisCode= " + QuotedStr(tbNotaris.Text) + _
                ", JnsDokNotaris= " + QuotedStr(ddlJenisDokNotaris.SelectedValue) + _
                ", NoDokNotaris = " + QuotedStr(tbNoDocNotaris.Text) + _
                ", B_NotarisPerM = " + QuotedStr(tbBiayaNotaris.Text.Replace(",", "")) + _
                ", TtlB_Notaris = " + QuotedStr(tbJumlah.Text.Replace(",", "")) + _
                ", B_Survey= " + QuotedStr(tbBiayaSurvey.Text.Replace(",", "")) + _
                ", B_Moderator= " + QuotedStr(tbBiayaModerator.Text.Replace(",", "")) + _
                ", B_BPHTB= " + QuotedStr(tbBiayaBPHTB.Text.Replace(",", "")) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, KetKegiatan, NoSurat, DateSurat, Luas, NameAwal, NameAkhir, Remark FROM GLBeginLandPurchaseReqDt WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
            ...
            Dim Update_Command = New SqlCommand( _
                    "UPDATE GLBeginLandPurchaseReqDt SET KetKegiatan = @KetKegiatan, NoSurat = @NoSurat, DateSurat = @DateSurat, Luas = @Luas, NameAwal = @NameAwal, NameAkhir = @NameAkhir, Remark = @Remark " + _
            ...
            Update_Command.Parameters.Add("@NameAwal", SqlDbType.VarChar, 60, "NameAwal")
            Update_Command.Parameters.Add("@NameAkhir", SqlDbType.VarChar, 225, "NameAkhir")
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM GLBeginLandPurchaseReqDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND ItemNo = @ItemNo", con)
            ' Add the parameters for the DeleteCommand.
            param = Delete_Command.Parameters.Add("@ItemNo", SqlDbType.VarChar, 5, "ItemNo")
            param.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command

            Dim Dt As New DataTable("GLBeginLandPurchaseReqDt")
            ...
            'save dt3
            cmdSql = New SqlCommand("SELECT TransNmbr, NoWL, NoPercilDt2, AwalName, LuasAwal, WlLvlName1, WlLvlName2, WlLvlName3, WlLvlName4, WlLvlName5, LuasLvlNo1, LuasLvlNo2, LuasLvlNo3, LuasLvlNo4, LuasLvlNo5, NoWarisLevel, Remark FROM GLBeginLandPurchaseReqDt2 WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
            da = New SqlDataAdapter(cmdSql)
            dbcommandBuilder = New SqlCommandBuilder(da)
            da.InsertCommand = dbcommandBuilder.GetInsertCommand
            'da.DeleteCommand = dbcommandBuilder.GetDeleteCommand
            ...
            Dim Update_Command3 = New SqlCommand( _
                    "UPDATE GLBeginLandPurchaseReqDt2 SET NoPercilDt2 = @NoPercilDt2, AwalName = @AwalName, LuasAwal = @LuasAwal, " + _
            ...
            Dim Delete_Command3 = New SqlCommand( _
                "DELETE FROM GLBeginLandPurchaseReqDt2 WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND NoWL = @NoWL", con)
            ' Add the parameters for the DeleteCommand.
            param3 = Delete_Command3.Parameters.Add("@NoWL", SqlDbType.VarChar, 40, "NoWL")
            param3.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command3

            Dim Dt3 As New DataTable("GLBeginLandPurchaseReqDt2")
            ...
            If Not ViewState("NoWl") Is Nothing Then
                ...
                ", Name4 , NoAjb4, Luas4, Sisa4,Name5, NoAjb5, Luas5, Sisa5, Remark FROM GLBeginLandPurchaseReqSubDt2 WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr"))
                ...
                '        "UPDATE GLBeginLandPurchaseReqSubDt2 SET Name = @Name, Descript = @Descript, Docdate = @Docdate, NoAjb = @NoAjb, @Luas = @Luas, Sisa = @Sisa, " + _
                ...
                '    "DELETE FROM GLBeginLandPurchaseReqSubDt2 WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND NoWl = @NoWl AND NoDok = @NoDok ", con)
                '' Add the parameters for the DeleteCommand.
                ...
                Dim Dt4 As New DataTable("GLBeginLandPurchaseReqSubDt2")
        ...
        Try
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf DDL.SelectedValue = "Reject" Then
                    ...
                    '        SqlString = "Update GLBeginLandPurchaseReqHd Set Status = 'H', remark = " + QuotedStr(HiddenRemarkReject.Value) + " WHERE Transnmbr = " + QuotedStr(GVR.Cells(2).Text) + " "
                    '        Result = SQLExecuteScalar(SqlString, ViewState("DBConnection"))
                ...
                ElseIf DDL.SelectedValue = "Print Check Doc" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_PRLandBeginOfferingSurvey ''" + QuotedStr(GVR.Cells(2).Text) + "'', '0'," + QuotedStr(ViewState("UserId"))
                        Session("ReportFile") = ".../../../Rpt/FormBeginChecklistDokumen.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                ...
                ElseIf DDL.SelectedValue = "Print Riwayat" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_PRLandBeginOfferingSurvey ''" + QuotedStr(GVR.Cells(2).Text) + "'', '1'," + QuotedStr(ViewState("UserId"))
                        Session("ReportFile") = ".../../../Rpt/FormBeginHistory.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg()", Page, Me.GetType)
                    Catch ex As Exception
                        lbStatus.Text = "btn print Error = " + ex.ToString
                ...
                ElseIf DDL.SelectedValue = "Print Letter C" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_PRLandBeginOfferingSurvey ''" + QuotedStr(GVR.Cells(2).Text) + "'', '2'," + QuotedStr(ViewState("UserId"))
                        Session("ReportFile") = ".../../../Rpt/FormBeginLetterC.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg()", Page, Me.GetType)
                    Catch ex As Exception
                        lbStatus.Text = "btn print Error = " + ex.ToString
    ...
    Protected Sub tbLainLain_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbLainLain.TextChanged
        Try
            ...
            SQLStrings = "UPDATE GLBeginLandPurchaseReqHd SET LainLain = " + QuotedStr(tbLainLain.Text) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub tbLainLain2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbLainLain2.TextChanged
        Try
            ...
            Dim dt As DataTable
            Dim SQLStrings As String
            SQLStrings = "UPDATE GLBeginLandPurchaseReqHd SET LainLain2 = " + QuotedStr(tbLainLain2.Text) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
            SQLExecuteNonQuery(SQLStrings, ViewState("DBConnection").ToString)
        Catch ex As Exception
            Throw New Exception("ddlHitungTotal All Error : " + ex.ToString)
    ...
    Protected Sub tbLainLain3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbLainLain3.TextChanged
        Try
            ...
            Dim dt As DataTable
            Dim SQLStrings As String
            SQLStrings = "UPDATE GLBeginLandPurchaseReqHd SET LainLain3 = " + QuotedStr(tbLainLain3.Text) + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
            SQLExecuteNonQuery(SQLStrings, ViewState("DBConnection").ToString)
        Catch ex As Exception
            Throw New Exception("ddlHitungTotal All Error : " + ex.ToString)
    ...
    Protected Sub tbBiayaNotaris_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbBiayaNotaris.TextChanged
        Try
            ...
            If ddlHitungTotal.SelectedValue = "SPPT" Then
                tbJumlah.Text = FormatNumber((tbSPPT.Text * tbBiayaNotaris.Text), ViewState("DigitCurr"))
            ElseIf ddlHitungTotal.SelectedValue = "AJB/SPH/SHM" Then
                'tbTotal.Text = Val(tbAjbSphShm.Text * tbNilai.Text)
                tbJumlah.Text = FormatNumber((tbAjbSphShm.Text * tbBiayaNotaris.Text), ViewState("DigitCurr"))
            ElseIf ddlHitungTotal.SelectedValue = "Luas Ukur" Then
                'tbTotal.Text = Val(tbLuasUkur.Text * tbNilai.Text)
                tbJumlah.Text = FormatNumber((tbLuasUkur.Text * tbBiayaNotaris.Text), ViewState("DigitCurr"))
            Else
                tbJumlah.Text = 0
            End If
            tbBiayaNotaris.Text = FormatNumber((tbBiayaNotaris.Text), ViewState("DigitCurr"))
            btnSaveAll.Focus()
    ...
    Protected Sub lbKTP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbKtp.Click
        Try
            ...
            URL = ResolveUrl("~/Image/DokumenBegin/" + filePath)
            'URL = ResolveUrl("~/Image/DokumenBegin/" + filePath)
    ...
    Protected Sub btnDelKtp_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDelKTP.Click
        ...
        Try
            ...
            File.Delete(Server.MapPath("~/Image/DokumenBegin/" + PathDel))

            SQLString2 = "UPDATE GLBeginLandPurchaseReqHd SET DocKTP =  NULL " + _
            " WHERE TransNmbr = " + QuotedStr(tbCode.Text)
    ...
    Protected Sub btnNotaris_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnNotaris.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT NotCode, NotName FROM V_MsNotaris "
            ResultField = "NotCode, NotName"
            ViewState("Sender") = "btnNotaris"
            Session("Column") = ResultField.Split(",")
            Session("DBConnection") = ViewState("DBConnection")
            AttachScript("myPopup();", Page, Me.GetType())
        Catch ex As Exception
    ...
    Protected Sub lbNotaris_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbNotaris.Click
        Try
            AttachScript("OpenMaster('" + Request.QueryString("KeyId") + "','MsNotaris')();", Page, Me.GetType())
        Catch ex As Exception
            lbStatus.Text = "lbNotaris_Click Error : " + ex.ToString
        End Try
    End Sub


    Protected Sub btnWakil_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnWakil.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT TugasCode, TugasName FROM V_MsPemberitugas "
            ResultField = "TugasCode, TugasName"
            ViewState("Sender") = "btnWakil"
            Session("Column") = ResultField.Split(",")
            Session("DBConnection") = ViewState("DBConnection")
            AttachScript("myPopup();", Page, Me.GetType())
        Catch ex As Exception
    ...
    Protected Sub lbWakilPembeli_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbWakilPembeli.Click
        ...
        Catch ex As Exception
            lbStatus.Text = "lbWakil_Click Error : " + ex.ToString
        End Try
    End Sub
