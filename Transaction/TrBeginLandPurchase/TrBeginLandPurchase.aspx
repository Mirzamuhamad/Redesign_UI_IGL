<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrBeginLandPurchase.aspx.vb" Inherits="Transaction_TrBeginLandPurchaseReq" %>
...
<head runat="server">
    <title>Begin Land Purchase</title>
...
<body>
    ...
    <div class="Content">
        <div class="H1">Begin Land Purchase</div>
        <hr/>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
        ...
        <asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="0">
                    ...
                    <tr>          
                       <td>Nama Pembeli</td>
                        ...
                        <td><asp:TextBox runat="server" MaxLength ="100" ValidationGroup="Input" ID="tbNamaPembeli" CssClass="TextBox" Width="225px"/></td>
                         ...
                         <td><asp:LinkButton ID="lbWakilPembeli" ValidationGroup="Input" runat="server" Text="Wakil Pembeli"/></td>
                        <td>:</td>
                        <td>
                            <asp:TextBox runat="server" ValidationGroup="Input" ID="tbwakilCode" CssClass="TextBox" Visible="false" Width="225px"/>
                        <asp:TextBox runat="server" ValidationGroup="Input" ID="tbWakilName" CssClass="TextBox" Enabled="false" Width="192px"/>
                         <asp:Button ID="btnWakil" runat="server" Class="btngo" visible = True Text="v" />
                    ...
                    <tr>
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="tbNamaWP" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td> 
                                        <td><asp:TextBox ID="tbKTPWP" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox ID="tbAlamatWP" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox ID="tbTelpWP" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>                        
                                    </tr>
                                </table>
                            </td>                
                    </tr>
                                    ...
                                    <tr>
                                         <td>
                                             <asp:DropDownList ID="ddlJenisDokumen" runat="server" AutoPostBack="true" 
                                                 CssClass="DropDownList" ValidationGroup="Input" Width="177px">
                                         ...
                                         <td><asp:TextBox runat="server" MaxLength ="200" ValidationGroup="Input" ID="tbNoDokumen" CssClass="TextBox" Width="170px"/></td>    
                                         <td>
                                             <BDP:BasicDatePicker ID="tbTglTerbit" runat="server" AutoPostBack="false" 
                                                 ...
                                                 <TextBoxStyle CssClass="TextDate" Width="148px" />
                                             </BDP:BasicDatePicker>
                                         </td> 
                                         <td>
                                             <BDP:BasicDatePicker ID="tbMasaBerlaku" runat="server" AutoPostBack="false" 
                                                 ...
                                                 TextBoxStyle-CssClass="TextDate" ValidationGroup="Input" Width="140px">
                                                 <TextBoxStyle CssClass="TextDate" Width="148px" />
                                             </BDP:BasicDatePicker>
                                         </td>                                              
                                    </tr>
                    ...
                    <tr>
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="tbSPPT" runat="server" CssClass="TextBox" Width="125px" AutoPostBack="true"/></td>
                                        <td><asp:TextBox ID="tbAjbSphShm" ValidationGroup="Input" runat="server" CssClass="TextBox" width="125px" AutoPostBack="true"/></td>
                                        <td><asp:TextBox ID="tbLuasUkur" runat="server" CssClass="TextBox" Width="125px" AutoPostBack="true"/></td>                          
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                         ...
                                         <td><asp:TextBox runat="server" MaxLength ="30" ValidationGroup="Input" ID="tbProvinsi" CssClass="TextBox" Width="110px"/></td>    
                                         <td><asp:TextBox runat="server" MaxLength ="50" ValidationGroup="Input" ID="tbKab" CssClass="TextBox" Width="120px"/></td> 
                                         <td><asp:TextBox runat="server" MaxLength ="50" ValidationGroup="Input" ID="tbKec" CssClass="TextBox" Width="120px"/></td>
                                         <td><asp:TextBox runat="server" MaxLength ="100" ValidationGroup="Input" ID="tbDesa" CssClass="TextBox" Width="120px"/></td>
            ...
            <td>:</td>
            <td>              
              <asp:TextBox ID="tbDokumen" runat="server" AutoPostBack="true" CssClass="TextBox" Width="50px" ValidationGroup="Input" />
                Hari / 
               ...
               <BDP:BasicDatePicker ID="tbDateDokumen" runat="server" DateFormat="dd MMM yyyy" 
                        ...
                        ShowNoneButton="False"><TextBoxStyle Width="136px" CssClass="TextDate" />
            </BDP:BasicDatePicker>  
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <asp:TextBox ID="tbPayTerm" ValidationGroup="Input" Enabled ="True"  runat="server" CssClass="TextBox" Width="170px"/> 
                                        
                                        <asp:DropDownList CssClass="DropDownList"  ValidationGroup="Input" Width="170px" Visible="false" runat="server" ID="ddlTerm" AutoPostBack="true" /> 
                                        ...
                                        <td><asp:TextBox ID="tbTandaJadi" ValidationGroup="Input" Enabled ="True" AutoPostBack="true"  runat="server" CssClass="TextBox" Width="170px"/></td> 
                                        <td><asp:TextBox ID="tbPelunasan" ValidationGroup="Input" Enabled = "false" runat="server" CssClass="TextBox" width="170px"/></td>
                    ...
                    <tr>
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                        <td><asp:DropDownList CssClass="DropDownList" ValidationGroup="Input" Width="177px" runat="server" ID="ddlJenisDokNotaris" >
                                             <asp:ListItem Selected="True">AJB</asp:ListItem>
                                                        <asp:ListItem>SPH</asp:ListItem>
                                                        <asp:ListItem>SHM</asp:ListItem>
                                                        <asp:ListItem>SHGB</asp:ListItem>
                                        ...
                                        <td><asp:TextBox ID="tbNoDocNotaris" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox ID="tbBiayaNotaris" runat="server" CssClass="TextBox" Width="170px" Autopostback = "true" /></td>
                                        <td><asp:TextBox ID="tbJumlah" runat="server" Enabled = "False" CssClass="TextBox" Width="170px"/></td>                          
                                    </tr>
                                </table>
                            </td>                
                    </tr>
                            ...
                            <td colspan="7">
                                <table>
                                    <tr style="background-color:Silver;text-align:center; border-radius:30px;">
                                        ...
                                        <td>Biaya BPHTB<sup>2</sup> </td>
                                        <td>Biaya Lain Lain</td>
                                    </tr>
                                    <tr>
                                        <td><asp:TextBox ID="tbBiayaSurvey" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td> 
                                        <td><asp:TextBox ID="tbBiayaModerator" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox ID="tbBiayaBPHTB" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox ID="tbBiayaLainLain" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>                        
                                    </tr>
                                </table>
                            </td>                
                    </tr>
                    <tr>
                            ...
                            <td colspan="7">
                                <table>
                                    <tr style="background-color:Silver;text-align:center; border-radius:30px;">
                                        ...
                                        <td>Amount Alocation</td>
                                        <td>Remark</td>
                                    </tr>
                                    <tr>
                                        <td><asp:TextBox ID="tbOriginalAmount" ValidationGroup="Input" runat="server" Enabled ="false" CssClass="TextBox" width="170px"/></td> 
                                        <td><asp:TextBox ID="tbAmountAlocation" ValidationGroup="Input" runat="server" CssClass="TextBox" width="170px"/></td>
                                        <td><asp:TextBox runat="server" MaxLength ="255" TextMode="MultiLine" ValidationGroup="Input" ID="tbRemark" CssClass="TextBox" Width="350px"/></td>
                     ...
                     <tr>
                        ...
                        <%--<td>Remark Reject</td>
                        <td>:</td>--%>
                        <td><asp:TextBox runat="server" TextMode="MultiLine" Visible = "false" ValidationGroup="Input" Enabled= false ID="tbRemarkReject" CssClass="TextBox" Width="225px"/></td>
 ...
 -->
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>
                        <asp:checkbox id="cbPTPP" runat="server" text=" Denah / Peta Tanah Pembeli dari Pihak IGL" autopostback="False"/>
                        </td>
            ...
            <asp:View ID="TabW" runat="server">
                <table>
                    ...
                    <tr>
                        <td>
                        <asp:checkbox id="cbPTPP2" runat="server" text=" Denah / Peta Tanah Pembeli dari Pihak IGL terhadap Ijin Kawasan / Ijin Lokasi" autopostback="False"/>
                        </td>
