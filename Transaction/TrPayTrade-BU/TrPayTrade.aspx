<%@ Page MaintainScrollPositionOnPostback ="true" Language="VB" AutoEventWireup="false" CodeFile="TrPayTrade.aspx.vb" Inherits="Transaction_TrPayTrade_TrPayTrade" %>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Currency" HeaderStyle-Width="80px" HeaderText="Currency" ></asp:BoundField>
                  <asp:BoundField DataField="TotalPayForex" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" SortExpression="TotalPayForex" HeaderText="Total Payment Forex"></asp:BoundField>
                  <asp:BoundField DataField="TotalPayment" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" SortExpression="TotalPayment" HeaderText="Total Payment"></asp:BoundField>
                  <asp:BoundField DataField="TotalOthers" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" SortExpression="TotalOthers" HeaderText="Total Others"></asp:BoundField>
           ...
           <asp:View ID="Tab1" runat="server">
                ...
                <table>              
                    ...
                    <tr>
                        ...
                        <td>
                             ...
                             <asp:Label ID="lbItemNo1" runat="server" ForeColor="#FF3300" Text="*" />
            ...
            <asp:View ID="Tab2" runat="server">            
               <table>
                ...
                <%--<asp:Label ID="lbProductTypeDt2" runat="server" Visible="false" />--%>
                    ...
                    <tr>
                                ...
                                <table>
                                    <tr style="background-color:Silver;text-align:center">
                                    <td><asp:Label ID="lblVPayHome" runat="server" CssClass="TextBox" 
                                            Text = "Payment Home"/></td>                                    
                                    <td><asp:Label ID="lblVInvHome" runat="server" CssClass="TextBox" 
                                            Text = "Invoice Home"/></td> 
                                    <td><asp:Label ID="lblVPPhHome" runat="server" CssClass="TextBox" 
                                            Text = "PPh Home"/></td>   
                                   <%-- <td><asp:Label ID="lblVChargeHome" runat="server" CssClass="TextBox" 
                                            Text = "Charge Home"/></td>                                                                     
                                    <td><asp:Label ID="lblVSelisihHome" runat="server" CssClass="TextBox" 
                                            Text = "Selisih Home"/></td>  --%>                                                                       
                                </tr>
                                <tr>
                                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbPayHomeDt" Width="80px" 
                                            Enabled ="false"/></td>
                                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbInvHomeDt" Width="80px" 
                                            Enabled ="false"/></td>   
                                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbPPhHomeDt" Width="80px" 
                                            Enabled ="false"/></td>                                   
                                    <%--<td><asp:TextBox CssClass="TextBox" runat="server" ID="tbChargeHomeDt2" 
                                            Width="80px" Enabled ="false"/></td>   --%>                                 
                                    <%--<td><asp:TextBox CssClass="TextBox" runat="server" ID="tbSelisihHomeDt2" 
                                            Width="80px" Enabled ="false"/></td>   --%>                                 
                                </tr>
                            </table>
                        </td>
