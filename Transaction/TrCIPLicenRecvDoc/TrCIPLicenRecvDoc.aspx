      ...
      line-height: 160px; height: 160px; color: #fff;
        ...
        <body>
            <form id="form1" runat="server">
                <div class="Content">
                    <div class="H1">License & Administration</div>
                    ...
                    <asp:Panel runat="server" ID="pnlInput" Visible="false">
                        ...
                        <asp:Menu ID="Menu1" runat="server" CssClass="Menu" StaticMenuItemStyle-CssClass="MenuItem"
                            ...
                            <Items>
                                ...
                                <%--<asp:MenuItem Text="Detail FA Location" Value="1"></asp:MenuItem>--%>
                                    ...
                                    <asp:MenuItem Text="Detail Tahapan" Value="3"></asp:MenuItem>
                                    <asp:MenuItem Text="Reference Doc Receive" Value="5"></asp:MenuItem>
                            </Items>
                        </asp:Menu>
                        ...
                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                            ...
                            <asp:View ID="Tab4" runat="server">
                                <asp:Panel runat="server" ID="pnlDtTahapan">
                                    <asp:Button class="bitbtndt btnadd" runat="server" ID="btnAdddtTahapan" Text="Add"
                                        ValidationGroup="Input" />
                                    <asp:Button Class="bitbtndt btnsearch" ID="btnGetTahapan" Text="Get Tahapan"
                                        runat="server" Visible="True" ValidationGroup="Input" Width="120px" />
                                    <br>
                                    <br>
                                    <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                                        <asp:GridView ID="GridDtTahapan" runat="server" AutoGenerateColumns="false"
                                            ShowFooter="False">
                                            <HeaderStyle CssClass="GridHeader" />
                                            <RowStyle CssClass="GridItem" Wrap="false" />
                                            <AlternatingRowStyle CssClass="GridAltItem" />
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnEdit" runat="server" class="bitbtndt btnedit"
                                                            Text="Edit" CommandName="Edit" />
                                                        <asp:Button Visible = "False" ID="btnDelete" runat="server"
                                                            class="bitbtndt btndelete" Text="Delete"
                                                            OnClientClick="return confirm('Sure to delete this data?');"
                                                            CommandName="Delete" />
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnView" runat="server" class="bitbtndt btnedit"
                                                            Text="Sub Tahapan" Width="120px" CommandName="View"
                                                            CommandArgument='<%# Container.DataItemIndex %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="ItemNo" HeaderStyle-Width="100px"
                                                    HeaderText="No Item" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="Tahapan" HeaderStyle-Width="120px"
                                                    HeaderText="Tahapan" />
                                                <asp:BoundField DataField="TransNmbrTahapan" HeaderStyle-Width="120px"
                                                    HeaderText="TransNmbrTahapan" />

                                                <asp:BoundField DataField="Percen" HeaderStyle-Width="120px"
                                                    HeaderText="%" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="TargetWaktu" HeaderStyle-Width="100px"
                                                    HeaderText="Target Waktu" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="Biaya1" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="Biaya1"
                                                    DataFormatString="{0:#,##0.00}" />
                                                <asp:BoundField DataField="Biaya2" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="Biaya2"
                                                    DataFormatString="{0:#,##0.00}" />
                                                <asp:BoundField DataField="PIC" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="PIC"
                                                    Visible="false" />
                                                <asp:BoundField DataField="PICName" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="PICName" />
                                                <asp:BoundField DataField="SpvName1" HeaderStyle-Width="150px"
                                                    HeaderText="SPV 1" />
                                                <asp:BoundField DataField="SpvName2" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="SPV 2" />
                                                <asp:BoundField DataField="DireksiName" HeaderStyle-Width="150px"
                                                    HeaderText="Direksi" />
                                                <asp:BoundField DataField="QcVerifiedName" HeaderStyle-Width="150px"
                                                    HeaderText="Qc Verified" />
                                                <asp:BoundField DataField="FgPermanent" HeaderStyle-Width="150px"
                                                    HeaderText="Exp Date Update" ItemStyle-HorizontalAlign="center" />
                                    ...
                                    <asp:Button class="bitbtndt btnadd" runat="server" ID="btnAddDtke2Tahapan"
                                        Text="Add" ValidationGroup="Input" />
                                </asp:Panel>
                                <asp:Panel runat="server" ID="pnlEditDtTahapan" Visible="false">
                                    <table>
                                        ...
                                        <tr>
                                            <%--<td>Payment No</td>
                                                <td>:</td>--%>
                                                <td>
                                                    <asp:TextBox CssClass="TextBox" runat="server" ID="tbPaymentNo"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbPIC"
                                                    Visible="false" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbSpv1"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnspv1" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbSpv2"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnSpv2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbDireksi"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnDireksi" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbQc"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnQc" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbRemarkDtTahapan" runat="server" CssClass="TextBox"
                                    ...
                                    <br />
                                    <asp:Button class="bitbtndt btnsave" runat="server" ID="btnsavedtTahapan"
                                        Text="Save" />
                                    <asp:Button class="bitbtndt btncancel" runat="server" ID="btnCancelDtTahapan"
                                        Text="Cancel" />
                                </asp:Panel>
                            </asp:View>
                            ...
                            <asp:View ID="tab5" runat="server">
                                ...
                                <asp:Panel ID="pnlDt2Tahapan" runat="server">
                                    <br />
                                    <asp:Button class="bitbtndt btnadd" runat="server" ID="btnaddDt2Tahapan" Text="Add"
                                        ValidationGroup="Input" />
                                    <asp:Button class="bitbtndt btnback" runat="server" ID="btnBackDt2Tahapan"
                                        Text="Back" />
                                    <br />&nbsp;

                                    <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                                        <asp:GridView ID="GridDt2Tahapan" runat="server" AutoGenerateColumns="false"
                                            ShowFooter="False">
                                            <HeaderStyle CssClass="GridHeader" />
                                            <RowStyle CssClass="GridItem" Wrap="false" />
                                            <AlternatingRowStyle CssClass="GridAltItem" />
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-Width="110" HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:Button class="bitbtndt btnedit" runat="server" ID="btnEdit"
                                                            Text="Edit" CommandName="Edit" />
                                                        <asp:Button Visible = "False" class="bitbtndt btndelete" runat="server"
                                                            ID="btnDelete" Text="Delete" CommandName="Delete"
                                                            OnClientClick="return confirm('Sure to delete this data?');" />
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                ...
                                                <asp:BoundField DataField="ItemNoDt2" HeaderStyle-Width="100px"
                                                    HeaderText="No Item" />
                                                <asp:BoundField DataField="Tahapan" HeaderStyle-Width="120px"
                                                    HeaderText="Tahapan" />
                                                <asp:BoundField DataField="TransNmbrTahapan" HeaderStyle-Width="120px"
                                    ...
                                    <asp:Button class="bitbtndt btnadd" runat="server" ID="btnaddDt2Tahapanke2"
                                        Text="Add" ValidationGroup="Input" />
                                    <asp:Button class="bitbtndt btnback" runat="server" ID="btnBackDt2Tahapanke2"
                                        Text="Back" />
                                </asp:Panel>
                                <asp:Panel runat="server" ID="pnlEditDt2Tahapan" Visible="false">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:Label ID="lbItemNoDt2" runat="server" Text="Item" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbPICDt2"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnPICDt2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbSpv1Dt2"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnspv1Dt2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbSpv2Dt2"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnSpv2Dt2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server"
                                                    ID="tbDireksiDt2" Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnDireksiDt2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox CssClass="TextBox" Width=225 runat="server" ID="tbQcDt2"
                                                    Visible="false" />
                                                <asp:Button class="btngo" runat="server" ID="btnQcDt2" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbRemarkDt2Tahapan" runat="server" CssClass="TextBox"
                                    ...
                                    <br />
                                    <asp:Button class="bitbtndt btnsave" runat="server" ID="btnsaveDt2Tahapan"
                                        Text="Save" />
                                    <asp:Button class="bitbtndt btncancel" runat="server" ID="btncancelDt2Tahapan"
                                        Text="Cancel" />
                                </asp:Panel>
                            </asp:View>
                            ...
                            <asp:View ID="tab6" runat="server">
                                ...
                                <asp:Panel ID="pnlDt5" runat="server">
                                    ...
                                    <asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDt5" Text="Add"
                                        ValidationGroup="Input" visible="false" />
                                    <asp:Button Class="bitbtndt btnsearch" ID="btnGetRefDoc" Text="Get Reference Doc"
                                        runat="server" Visible="True" ValidationGroup="Input" Width="120px" />
                                    <br>
                                    <br>
                                    ...
                                    <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                                        ...
                                        <asp:GridView ID="GridDt5" runat="server" AutoGenerateColumns="False"
                                            ShowFooter="False">
                                            <HeaderStyle CssClass="GridHeader" />
                                            <RowStyle CssClass="GridItem" Wrap="false" />
                                            <AlternatingRowStyle CssClass="GridAltItem" />
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="NoDokumen" HeaderStyle-Width="150px"
                                                    HeaderText="NoDokumen" SortExpression="Remark">
                                                    <HeaderStyle Width="200px" />
                                                </asp:BoundField>
                                    ...
                                    <asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDt5ke2" Text="Add"
                                        ValidationGroup="Input" visible="false" />
                                ...
                                <asp:Panel runat="server" ID="pnlEditDt5" Visible="false">
                                    <table>
                                        <tr>
                                            ...
                                            <td> : </td>
                                            <td>
                                                <asp:TextBox ID="tbPaymentNoDt5" Width="225px" runat="server"
                                                    Enabled="True" CssClass="TextBox" />
                                                <asp:Button Class="btngo" ID="Button9" Text="..." runat="server" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> : </td>
                                            <td>
                                                <asp:TextBox ID="tbRemarkdt5" Width="225px" TextMode="MultiLine"
                                                    runat="server" Enabled="True" CssClass="TextBox" />
                                            </td>
                                        </tr>
                                    ...
                                    <asp:Button ID="btnCancelDt5" runat="server" class="bitbtndt btncancel"
                                        Text="Cancel" />
                                </asp:Panel>
