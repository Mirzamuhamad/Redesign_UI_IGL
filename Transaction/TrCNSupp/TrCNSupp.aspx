<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrCNSupp.aspx.vb" Inherits="CNSupp" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Credit Note Supplier</div>
     <hr style="color:Blue" />        
            ...
            <table>                                
                ...
                <tr>
                    ...
                    <tr>
                        <td>Cost Center</td>
                        <td>:</td>
                        <td colspan="4"><asp:DropDownList CssClass="DropDownList" ID="ddlCostCenter" runat="server"/></td>
                    </tr>  
                    <tr>
                        <td>Qty</td>
                        <td>:</td>
