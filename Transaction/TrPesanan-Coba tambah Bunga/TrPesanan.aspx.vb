...
Partial Class TrPemesanan
    ...
    Private Sub SetInit()
        ...
        tbBunga.Attributes.Add("OnBlur", "setformatdtppn2();")
        ...
        tbBunga.Attributes.Add("OnKeyDown", "return PressNumeric();")
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            'save dt2
            cmdSql = New SqlCommand("SELECT TransNmbr, ItemNo, UnitCode, PayDate,Type, PayKav, Ppn, PpnValue, Pph, PphValue, BungaValue, AmountDt2, Remark, BankCode, NoGiro, AngsuranKe FROM MKTTSPDt2 WHERE TransNmbr  = " + QuotedStr(ViewState("TransNmbr")), con)
            da = New SqlDataAdapter(cmdSql)
    ...
    Protected Sub FillTextBoxDt2(ByVal FALoc As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToText(tbBunga, Dr(0)("BungaValue").ToString, ViewState("DigitHome"))
