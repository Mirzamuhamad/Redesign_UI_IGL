...
//                
        ...
        function setformatdt2(change) {
            try 
            {
                ...
                document.getElementById("tbTotalNominal").value = parseFloat(document.getElementById("tbNominal").value.replace(/\$|\,/g, "")) + parseFloat(document.getElementById("tbBunga").value.replace(/\$|\,/g, "")) + parseFloat(Math.floor(document.getElementById("tbPpnValuedt2").value.replace(/\$|\,/g, ""))) - parseFloat(Math.floor(document.getElementById("tbPphValueDt2").value.replace(/\$|\,/g, "")));


                document.getElementById("tbBunga").value = setdigit(document.getElementById("tbBunga").value.replace(/\$|\,/g, ""), '<%=ViewState("DigitHome")%>');
                        ...
                        <asp:GridView ID="GridDt2" runat="server" AutoGenerateColumns="false" 
                            ...
                            <Columns>
                             ...
                             <asp:BoundField DataField="ItemNo" HeaderText="No Item" />  
                                    ...
                                    <asp:BoundField DataField="BungaValue"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px" DataFormatString="{0:#,##0.00}" HeaderText="Bunga" />
                            ...
                            <td colspan="7">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="tbBunga"  ValidationGroup="Input" runat="server" Enabled = "True" CssClass="TextBox" Width="120px"/></td>                                      
