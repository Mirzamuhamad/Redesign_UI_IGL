<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrMTNSPRequest.aspx.vb" Inherits="Transaction_TrMTNSPRequest_TrMTNSPRequest" %>
...
<body>     
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="DepartmentName" HeaderStyle-Width="150px" HeaderText="Department" SortExpression="DepartmentName"/>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            <td><asp:Label runat="server" ID="lbMONo" Text = "MO No"></asp:Label>
            </td>
            <td>:</td>
            <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbMONo" Enabled="false" Width="130px"/> 
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="DropDownList" Width="310px" ValidationGroup="Input" />
            </td>
        </tr>
        <tr>
            <td>Remark</td>
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>                        
                        ...
                        <asp:BoundField DataField="Remark" HeaderStyle-Width="350px" HeaderText="Remark"/>
                        <asp:BoundField DataField="DoneClosing" HeaderStyle-Width="80px" HeaderText="Closing"/>
                    </Columns>
                </asp:GridView>
          </div>   
