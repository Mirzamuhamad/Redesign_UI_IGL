<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSptOut.aspx.vb" Inherits="TrSptOut" %>
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      ...
                      <asp:ListItem Value="Do_no">DO</asp:ListItem>
                      <asp:ListItem Value="So_No">SO</asp:ListItem>
                      <asp:ListItem Value="ItemType">Jenis Barang</asp:ListItem>
                      <asp:ListItem Value="ItemTypeName">Jenis Name</asp:ListItem>
                      <asp:ListItem Value="Customer">Customer</asp:ListItem>
                      <asp:ListItem Value="CustomerName">Customer Name</asp:ListItem>
                      <asp:ListItem Value="Car">Car</asp:ListItem>
                      <asp:ListItem Value="CarName">CarName</asp:ListItem>
                      <asp:ListItem Value="Operator">Operator</asp:ListItem>
                      <asp:ListItem Value="OperatorName">Operator Name</asp:ListItem>
                      <%--<asp:ListItem Value="BM">BM</asp:ListItem>--%>
                      <asp:ListItem Value="BMName">BMName</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Do_No" HeaderStyle-Width="120px" HeaderText="No_Do" 
                      SortExpression="Do_No">
                      <HeaderStyle Width="120px" />
                  </asp:BoundField>
                  
                  <asp:BoundField DataField="So_No" HeaderStyle-Width="120px" HeaderText="No SO" 
                      SortExpression="So_No">
                      <HeaderStyle Width="120px" />
                  </asp:BoundField>
                  ...
                  <asp:BoundField DataField="Car" HeaderStyle-Width="120px" HeaderText="Car No" 
                  SortExpression="Car"> 
                  <HeaderStyle Width="120px" />                
                    </asp:BoundField>

                    <asp:BoundField DataField="CarName" HeaderStyle-Width="120px" HeaderText="Car Name" 
                    SortExpression="CarName">                 
                    </asp:BoundField> 

                <asp:BoundField DataField="Operator" HeaderStyle-Width="120px"  HeaderText="Operator" 
                        SortExpression="Operator">                 
                    </asp:BoundField>

                <asp:BoundField DataField="OperatorName" HeaderStyle-Width="120px" HeaderText="Operator Name" 
                    SortExpression="OperatorName">                 
                </asp:BoundField>

                <asp:BoundField DataField="ItemType" HeaderStyle-Width="120px" HeaderText="Jenis Barang" 
                    SortExpression="ItemType">                 
                </asp:BoundField>

                <asp:BoundField DataField="ItemTypeName" HeaderStyle-Width="120px" HeaderText="Jenis Barang Name" 
                    SortExpression="ItemTypeName">                 
                </asp:BoundField>
                
                <asp:BoundField DataField="BM" Visible="false" HeaderStyle-Width="120px" HeaderText="BM" 
                SortExpression="BM">                 
                </asp:BoundField>
                
                <asp:BoundField DataField="BMName" Visible="false" HeaderStyle-Width="120px" HeaderText="BM Name" 
                SortExpression="BMName">                 
                </asp:BoundField>

                <asp:BoundField DataField="ContractNo" HeaderStyle-Width="120px" HeaderText="Contract No" 
                    SortExpression="ContractNo">                 
                </asp:BoundField>
                
                <asp:BoundField DataField="TphTujuan" HeaderStyle-Width="120px" HeaderText="Tujuan" 
                SortExpression="TphTujuan">  
                <HeaderStyle Width="200px"  />               
                </asp:BoundField>
                
                <asp:BoundField DataField="FghariHitam"  HeaderStyle-Width="120px" HeaderText="Hari Hitam" 
                SortExpression="FghariHitam">
                <HeaderStyle Width="200px"  />                 
                </asp:BoundField>
      ...
      <table>
        ...
        <tr>
            ...
            <td>
                :</td>
            <td>
                <asp:TextBox ID="tbCustomer" runat="server" Enabled="False" CssClass="TextBox" />
                <asp:TextBox ID="tbCustomerName" runat="server" CssClass="TextBoxR" Enabled="False" 
                    Width="200px" />
                <asp:Button ID="btnCustomer" runat="server" Class="btngo" visible = false Text="..." />
            </td>
        ...
        <tr>
              ...
              <td>:</td>
              <td>
                  <asp:TextBox ID="tbNoDo" runat="server" CssClass="TextBox" />
                  <asp:Button ID="btnDO" runat="server" Class="btngo" Text="..."/>
              </td>
          ...
          <tr>
            ...
            <td>
                :</td>
            <td>
                <asp:TextBox ID="tbNoSo" e runat="server" Enabled="False"  CssClass="TextBox" />
            </td>
            ...
            <td>
                <asp:TextBox ID="tbOperator"  runat="server" CssClass="TextBox" 
                    ...
                    <asp:TextBox ID="tbOperatorrName" runat="server" CssClass="TextBoxR" Enabled="False" 
                    Width="200px" />
          ...
          <tr>
            <td>Item Type</td>
                <td>:</td>
                <td>
                    <asp:TextBox ID="tbItemType" Enabled="False" runat="server" CssClass="TextBox" 
                        ValidationGroup="Input"  />
                        <asp:TextBox ID="tbItemTypeName" runat="server" CssClass="TextBoxR" Enabled="False" 
                        Width="150px" />  
                </td>                
            </td>
            ...
            <td></td>
                <td></td>
                <td>
                    <asp:TextBox ID="tbBM" runat="server" visible="False" CssClass="TextBox" 
                    />

                    <asp:TextBox ID="tbBMName" runat="server" visible="False" CssClass="TextBoxR" Enabled="False" 
                    Width="200px" />
                <asp:Button ID="btnBM" runat="server" Class="btngo" visible="False" Text="..." />
                </td>                
            </td>
          ...
          <tr>
            <td>Contract No</td>
                <td>:</td>
                <td>
                    <asp:TextBox ID="tbContractNo" runat="server" Enabled = "False " CssClass="TextBox" 
                        ValidationGroup="Input" Width="293px" />
                </td>                
            </td>
