<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrDPSuppRetur.aspx.vb" Inherits="TrDPSuppRetur" %>
    ...
    <script type="text/javascript">         
       ...
       function setformatdt()
        ...
        try
         ...
         document.getElementById("tbReceiptForexDt2").value = setdigit(ReceiptForex,'<%=VIEWSTATE("DigitExpenseCurr")%>');
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField">
                            ...
                            <asp:ListItem Value="TotalReceipt">Receipt</asp:ListItem>
                            <asp:ListItem Value="TotlaDP">DP</asp:ListItem>
            ...
            <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px" SortExpression="Nmbr" HeaderText="Receipt No"/>
                        <asp:BoundField DataField="Status" HeaderText="Status"/>
                        <asp:BoundField DataField="TransDate" HtmlEncode="true" DataFormatString="{0:dd MMM yyyy}" HeaderStyle-Width="80px" SortExpression="TransDate" HeaderText="Receipt Date"/>
                        <asp:BoundField DataField="FgReport" HeaderStyle-Width="80px" HeaderText="Report"/>
                        <asp:BoundField DataField="Supplier" HeaderStyle-Width="200px" SortExpression="Supplier" HeaderText="Supplier"/>
                        <asp:BoundField DataField="Attn" HeaderStyle-Width="200px" SortExpression="Attn" HeaderText="Attn"/>
                        <asp:BoundField DataField="TotalReceipt" DataFormatString="{0:#,##0.00}" HeaderStyle-Width="80px" SortExpression="TotalReceipt" HeaderText="Receipt"/>
                        <asp:BoundField DataField="TotalDP" DataFormatString="{0:#,##0.00}" HeaderStyle-Width="80px" SortExpression="TotalDP" HeaderText="DP"/>
                        <asp:BoundField DataField="TotalCharge" DataFormatString="{0:#,##0.00}" HeaderStyle-Width="80px" SortExpression="TotalCharge" HeaderText="Charge"/>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <%--Report : &nbsp<asp:DropDownList AutoPostBack="true" ValidationGroup="Input" CssClass="DropDownList" ID="ddlReport" runat="server" >
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        <asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbSuppCode"
                            AutoPostBack="true" />
                    ...
                    <td colspan="4">
                        <table>
                            <tr style="background-color: Silver; text-align: center">
                                <td>
                                    <asp:Label ID="lbTotReceipt" runat="server" CssClass="TextBox" Text="Receipt" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:TextBox runat="server" ID="tbTotalReceipt" CssClass="TextBoxR" />
                                </td>
                                <td>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <asp:TextBox runat="server" ValidationGroup="Input" ID="tbRemark" CssClass="TextBoxMulti"
                    ...
                    <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="tbRemarkDt" CssClass="TextBoxMulti" MaxLength="255"
                    ...
                    <asp:Panel runat="server" ID="pnlEditDt2" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList CssClass="DropDownList" ID="ddlBankGiroDt2" runat="server" />
                                </td>
                                <td>
                                    Due Date
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <table>
                                        <tr style="background-color: Silver; text-align: center">
                                            <td>
                                                <asp:Label ID="lbPayForex" CssClass="TextBox" runat="server" Text="Receipt Forex" /></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lbPayHome" CssClass="TextBox" runat="server" Text="Receipt Home" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox CssClass="TextBox" runat="server" ID="tbReceiptForexDt2" Width="80px" />
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="TextBoxR" runat="server" ID="tbReceiptHomeDt2" Width="80px" />
                                            </td>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="tbRemarkDt2" CssClass="TextBoxMulti" MaxLength="255"
