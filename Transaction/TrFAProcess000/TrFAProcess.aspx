            ...
            <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Year" HeaderStyle-Width="60px" HeaderText="Year" SortExpression="Year">
                            <HeaderStyle Width="60px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Period" HeaderStyle-Width="80px" HeaderText="Period" SortExpression="Period">
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PeriodName" HeaderStyle-Width="80px" HeaderText="Period"
