...
Partial Class Transaction_TrLeaveExt_TrLeaveExt
    Inherits System.Web.UI.Page
    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "SELECT DISTINCT Nmbr, TransNmbr,TransDate, Status, Year, Remark, UserPrep, DatePrep, UserAppr, DateAppr FROM V_PELeaveExtHd "
                ...
                ElseIf ViewState("Sender") = "btnGetDt" Then
                    ...
                    For Each drResult In Session("Result").Rows
                        ...
                        If Row.Count = 0 Then
                            ...
                            dr("QtyReset") = FormatFloat(drResult("QtyReset"), ViewState("DigitQty"))
                            dr("QtyExtend") = FormatFloat(drResult("QtyExtend"), ViewState("DigitQty"))
                            dr("Reason") = ""
                            dr("Remark") = ""
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * FROM V_PELeaveExtDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Next
                Result = Result + "'"
                Session("SelectCommand") = "EXEC S_PEFormLeaveExt " + Result
                Session("ReportFile") = ".../../../Rpt/FormLeaveExt.frx"
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_PELeaveExt", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
    ...
    Private Sub Cleardt()
        Try
            ...
            tbNewExpireDate.SelectedDate = ViewState("ServerDate")
            tbReason.Text = ""
            TbRemarkDt.Text = ""
        Catch ex As Exception
    ...
    Protected Sub FillTextBoxDt(ByVal Course As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToDate(tbNewExpireDate, Dr(0)("NewExpireDate").ToString)
                BindToText(tbLeave, Dr(0)("QtyLeave").ToString, ViewState("DigitQty"))
                BindToText(tbReset, Dr(0)("QtyReset").ToString, ViewState("DigitQty"))
                BindToText(tbExtend, Dr(0)("QtyExtend").ToString, ViewState("DigitQty"))
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveDt.Click
        Try
            ...
            If ViewState("StateDt") = "Edit" Then
                ...
                Row("ExpireDate") = tbExpireDate.SelectedDate
                Row("NewExpireDate") = tbNewExpireDate.SelectedDate
                Row("QtyLeave") = FormatFloat(tbLeave.Text, ViewState("DigitQty"))
                Row("QtyReset") = FormatFloat(tbReset.Text, ViewState("DigitQty"))
                Row("QtyExtend") = FormatFloat(tbExtend.Text, ViewState("DigitQty"))
            ...
            Else
                ...
                dr("ExpireDate") = tbExpireDate.SelectedDate
                dr("NewExpireDate") = tbNewExpireDate.SelectedDate
                dr("QtyLeave") = FormatFloat(tbLeave.Text, ViewState("DigitQty"))
                dr("QtyReset") = FormatFloat(tbReset.Text, ViewState("DigitQty"))
                dr("QtyExtend") = FormatFloat(tbExtend.Text, ViewState("DigitQty"))
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbCode.Text = GetAutoNmbr("LE", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO PELeaveExtHd (TransNmbr, TransDate, Status, Year, " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("SELECT Status FROM PELeaveExtHd WHERE TransNmbr = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE PELeaveExtHd SET Year = " + ddlYear.SelectedValue + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, EmpNumb, JobTitle, HireDate, QtyLeave, QtyExtend, QtyReset, ExpireDate, NewExpireDate, Reason, Remark FROM PELeaveExtDt WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
            ...
            Dim Dt As New DataTable("PELeaveExtDt")
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Train No, Status, Year, Remark"
            FilterValue = "TransNmbr, Status, Year, Remark"
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_PEFormLeaveExt '''" + GVR.Cells(2).Text + "'''"
                        Session("ReportFile") = ".../../../Rpt/FormLeaveExt.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    Protected Sub btnEmp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmp.Click
        ...
        Try
            ...
            Session("filter") = "EXEC S_PELeaveExtReff '', ''," + ddlYear.SelectedValue
            ResultField = "EmpNumb, EmpName, JobTitle, HireDate, ExpireDate, NewExpireDate"
            'EmpNumb, EmpName, HireDate, JobTitle, JobTitleName, ExpireDate, NewExpireDate, QtyLeave, QtyReset, QtyExtend, Reason, Remark
    ...
    Protected Sub tbEmpNumb_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbEmpNumb.TextChanged
        ...
        Dim SQLString As String
        Try
            SQLString = "EXEC S_PELeaveExtReff ' AND A.EmpNumb = '" + QuotedStr(tbEmpNumb.Text) + "'', ''," + ddlYear.SelectedValue
            ...
            If Dt.Rows.Count > 0 Then
                ...
                tbExpireDate.SelectedDate = Dr("ExpireDate")
                tbNewExpireDate.SelectedDate = Dr("NewExpireDate")
                tbLeave.Text = FormatFloat(Dr("QtyLeave"), ViewState("DigitQty"))
                tbExtend.Text = FormatFloat(Dr("QtyExtend"), ViewState("DigitQty"))
                tbReset.Text = FormatFloat(Dr("QtyReset"), ViewState("DigitQty"))
            Else
                tbEmpNumb.Text = ""
                tbEmpName.Text = ""
                ddlJobTitle.SelectedValue = ""
                tbHireDate.SelectedValue = Nothing
                tbExpireDate.SelectedValue = Nothing
                tbLeave.Text = FormatFloat(0, ViewState("DigitQty"))
                tbExtend.Text = FormatFloat(0, ViewState("DigitQty"))
                tbReset.Text = FormatFloat(0, ViewState("DigitQty"))
            End If
        Catch ex As Exception
    ...
    Protected Sub btnGetData_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGetData.Click
        ...
        Try
            ...
            ResultField = "EmpNumb, EmpName, HireDate, JobTitle, JobTitleName, ExpireDate, NewExpireDate, QtyLeave, QtyReset, QtyExtend"
            CriteriaField = "EmpNumb, EmpName, HireDate, JobTitle, JobTitleName, ExpireDate, NewExpireDate, QtyLeave, QtyReset, QtyExtend"
    ...
    Protected Sub tbExtend_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbExtend.TextChanged
        Try
            tbReset.Text = FormatFloat(tbLeave.Text - tbExtend.Text, ViewState("DigitQty"))
        Catch ex As Exception
            lbStatus.Text = "tbExtend_TextChanged Error : " + ex.ToString
        End Try
    End Sub
End Class
