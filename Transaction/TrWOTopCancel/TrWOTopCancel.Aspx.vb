    ...
    Sub BindData()
        ...
        Try
            ...
            If StrFilter.Length > 5 Then
                ...
                tempDS = SQLExecuteQuery("EXEC S_PLWOPlanOutCancel " + QuotedStr(StrFilter), ViewState("DBConnection").ToString)
            Else
                tempDS = SQLExecuteQuery("EXEC S_PLWOPlanOutCancel " + QuotedStr(StrFilter1), ViewState("DBConnection").ToString)
            End If
    ...
    Private Sub bindDataProcess()
        Try
            ...
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "DECLARE @A VARCHAR(255) EXEC S_PLWOPlanCancel " + QuotedStr(lbReference.Text) + ", '',  " + QuotedStr(ViewState("GLYear").ToString) + "," + QuotedStr(lbWeek.Text) + _
