<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrWOPlan.aspx.vb" Inherits="Transaction_TrWOPLan_TrWOPLan" %>
    ...
    <div class="Content">
            ...
            <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="QtyBlok" HeaderText="Qty Blok" 
        ...
        <asp:Panel runat="server" ID="pnlInput" Visible="false">
            ...
            <td><asp:DropDownList ValidationGroup="Input" CssClass="DropDownList" ID="ddlLHPType" runat="server" >
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlWorkBy" runat="server" AutoPostBack="true" 
                            ...
                            Width="150px" />
                            <asp:TextBox ID="tbFgBorongan" runat="server"
                            CssClass="TextBox" MaxLength="30" ValidationGroup="Input" visible = "False" Width="32px" />
                    </td>
                    <td>
                        Person</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        :</td>
                    <td>
                        <asp:TextBox ID="tbQtyBlock" runat="server" CssClass="TextBoxR" Enabled="False" 
                            Width="65px" />
                    </td>
                    <td>
                        Qty</td>
            ...
            <asp:Menu ID="Menu1" runat="server" CssClass="Menu" StaticMenuItemStyle-CssClass="MenuItem"
                ...
                <Items>
                    <asp:MenuItem Text="Detail Divisi / Blok" Value="0" ></asp:MenuItem>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                ...
                                <Columns>
                                   ...
                                   <asp:Button ID="btnViewM" runat="server" class="bitbtndt btndetail" 
                                    ...
                                    <asp:BoundField DataField="DivisiBlok" HeaderStyle-Width="150px" 
                                        HeaderText="Block" SortExpression="DivisiBlok"><HeaderStyle Width="70px" /></asp:BoundField>
                                    <asp:BoundField DataField="DivisiBlokName" HeaderStyle-Width="200px" 
                                        HeaderText="Blok Name" SortExpression="Block Name"><HeaderStyle Width="70px" /></asp:BoundField>
                                    <asp:BoundField DataField="StatusTanam" HeaderText="Status Tanam Code" 
                                        SortExpression="StatusTanam" ><HeaderStyle Width="200px" /> </asp:BoundField>
                                    <asp:BoundField DataField="StatusTanamName" HeaderText="Status Tanam Name" 
                                        SortExpression="StatusTanamName" ><HeaderStyle Width="200px" /> </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="QtyTotal" DataFormatString="{0:#,##0.##}"
                                        HeaderText="Qty Total" SortExpression="QtyTotal" ><HeaderStyle Width="100px"  />
                                    </asp:BoundField>
                                        
                                    <asp:BoundField DataField="Qty" DataFormatString="{0:#,##0.##}" 
                                        HeaderStyle-Width="100px" HeaderText="Qty WO" SortExpression="Qty"><HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    
                                    <asp:BoundField DataField="NormaHK" DataFormatString="{0:#,##0.##}" 
                                        HeaderStyle-Width="150px" HeaderText="Capacity (HK)" SortExpression="NormaHK"><HeaderStyle Width="150px" />
                                    </asp:BoundField>
                        ...
                        <td colspan="4"><asp:Label ID="lbWONo" runat="server" Text="WO No" />
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    ...
                                    <asp:TextBox CssClass="TextBoxR" Enabled ="false"  runat="server" ID="tbBlock"
                                ...
                                <td colspan="4">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbTotal" runat="server" CssClass="TextBox" Width="65px" AutoPostBack = "true" />
                                            </td>
                                            <td>
                ...
                <asp:Label ID="LblTypeMA" runat="server" ForeColor="Blue" Text="Type :" ></asp:Label>
                     <asp:Label ID="LblTypeM" runat="server" ForeColor="Blue" Text=""></asp:Label><br />
                                <asp:Label ID="LblBlocMA" runat="server" ForeColor="Blue" Text="Block :"></asp:Label>
                                 <asp:Label ID="LblBlockM" runat="server" ForeColor="Blue" Text=""></asp:Label>
                                <asp:Label ID="LblBlocNameMA" runat="server" ForeColor="Blue" Text="Block Name :"></asp:Label>
                                 <asp:Label ID="LblBlockNameM" runat="server"  ForeColor="Blue" Text=""></asp:Label><br />
                ...
                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text="Type :"></asp:Label>
                     <asp:Label ID="LblTypeE" runat="server"  ForeColor="Blue" Text=""></asp:Label><br />
                                <asp:Label ID="Label3" runat="server" ForeColor="Blue" Text="Block :"></asp:Label>
                                 <asp:Label ID="LblBlockE" runat="server" ForeColor="Blue" Text=""></asp:Label>
                                <asp:Label ID="Label5" runat="server" ForeColor="Blue" Text="Block Name :"></asp:Label>
                                 <asp:Label ID="LblBlockNameE" runat="server" ForeColor="Blue" Text=""></asp:Label><br />
                    ...
                    <asp:Panel ID="pnlDt3" runat="server">
                            ...
                            <asp:GridView ID="GridDt3" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Equipment" HeaderStyle-Width="150px" 
                                        HeaderText="Equipment" SortExpression="Equipment">
                                    ...
                                    <asp:BoundField DataField="Qty" DataFormatString="{0:#,##0.##}" 
                                        HeaderStyle-Width="80px" HeaderText="Qty" SortExpression="Qty">
                        ...
                        <asp:Button ID="btnAddDt3ke2" runat="server" class="bitbtn btnadd" Text="Add" 
                            ValidationGroup="Input" />
                        <asp:Button ID="BtnBackDt3ke2" runat="server" class="bitbtn btnback" 
                            Text="Back" />
                    </asp:Panel>
                    <asp:Panel ID="pnlEditDt3" runat="server" Visible="false">
                        <table>
                            <tr>
                                <td>
                                    Equipment</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbQtyE" runat="server" CssClass="TextBox" 
                                        ValidationGroup="Input" Width="65px" />
                                    <asp:TextBox ID="tbUnitE" runat="server" CssClass="TextBoxR" Enabled="false" 
                                        Width="65px" />
                                </td>
                            </tr>
                        </table>
                ...
                <asp:View ID="Tab5" runat="server">
                  <asp:Label ID="Label2" runat="server" ForeColor="Blue" Text="Type :"></asp:Label>
                     <asp:Label ID="LblTypeMT" runat="server" ForeColor="Blue" Text=""></asp:Label><br />
                                <asp:Label ID="Label6" runat="server" ForeColor="Blue" Text="Block :"></asp:Label>
                                 <asp:Label ID="LblBlockMT" runat="server" ForeColor="Blue" Text=""></asp:Label>
                                <asp:Label ID="Label8" runat="server" ForeColor="Blue" Text="Block Name :"></asp:Label>
                                 <asp:Label ID="LblBlockNameMT" runat="server" ForeColor="Blue" Text=""></asp:Label><br />
                    <asp:Button ID="btnAdddt4" runat="server" class="bitbtn btnadd" Text="Add" 
                        ValidationGroup="Input" Visible="false" />
&nbsp;
                    <asp:Button ID="BtnBackDt4" runat="server" class="bitbtndt btnback" 
                        Height="18px" Text="Back" ValidationGroup="Input" Width="70px" />
                    &nbsp;&nbsp;
