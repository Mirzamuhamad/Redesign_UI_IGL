<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSTRejectSJ.aspx.vb" Inherits="TrSTRejectSJ" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Delivery Note Return Supplier</div>
     <hr style="color:Blue" />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      <asp:ListItem Value="TransNmbr" Selected="True">Delivery Note No</asp:ListItem>
                      <asp:ListItem Value="dbo.FormatDate(TransDate)">Date</asp:ListItem>
                      <asp:ListItem>Status</asp:ListItem>
                      <asp:ListItem Value="Supplier_Name">Supplier</asp:ListItem>
                      <asp:ListItem Value="Attn">Attention</asp:ListItem>
                      <asp:ListItem Value="PurchaseReject">Purchase Retur No</asp:ListItem>
            ...
            <td>
                ...
                &nbsp &nbsp &nbsp &nbsp
                <asp:Label runat="server" ID="Label1" Text="Delivery Retur Gantung : "/>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="PurchaseReject" HeaderText="Purchase Retur No." 
                      SortExpression="PurchaseReject" />
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        <tr>
            ...
            <td>:</td>
            <td style="width:280px"><asp:TextBox CssClass="TextBox" Enabled = "false" runat="server" ID="tbTransNo" Width="149px"/> 
            ...
            <BDP:BasicDatePicker ID="tbDate" runat="server" DateFormat="dd MMM yyyy" 
             ...
             <tr>
                <td>Purchase Retur No.</td>
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbRejectNo" 
            ...
            <asp:Button Class="btngo" ID="btnPO" Text="..." runat="server" ValidationGroup="Input" />                                                                                                                                                                                              
                ...
                <td class="style1">:</td>
                <td>
                <asp:TextBox ID="tbAttn" ValidationGroup="Input" AutoPostBack="False" Width="150px" 
          ...
          <tr>
              ...
              <td colspan="4">
                  <asp:TextBox ID="tbRemark" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" Width="300px" MaxLength = "255" />
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="tbProdName" runat="server" CssClass="TextBox" Enabled="False" 
                            EnableTheming="True" ReadOnly="True" Width="195px" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbQty" runat="server" CssClass="TextBox" 
                            AutoPostBack="False" MaxLength = "13"/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        :</td>
                    <td>
                        <asp:TextBox ID="tbRemarkDt" runat="server" CssClass="TextBox" MaxLength = "255" Width="304px" />
                    </td>
                </tr>
            </table>
            </td>
