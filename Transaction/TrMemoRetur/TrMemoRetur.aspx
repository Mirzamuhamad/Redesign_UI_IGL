<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrMemoretur.aspx.vb" Inherits="Transaction_TrMemoRetur_TrMemoRetur" %>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            AllowSorting="True" AutoGenerateColumns="False" CssClass="Grid">
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderStyle-Width="130">
                      <ItemTemplate>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            <td>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbWoPlan" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" AutoPostBack="true" />
                  
                  <asp:Button ID="btnWoPlan" runat="server" Class="btngo" Text="..." 
			...
			<td>
              ...
              <td>
                  <asp:TextBox ID="tbCar" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" AutoPostBack="true" />
                  <asp:TextBox ID="tbCarName" runat="server" CssClass="TextBoxR" 
        ...
        <tr>
            ...
            <td>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbKontraktor" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" AutoPostBack="true" />
        ...
        <tr>
			...
			<td>Mandor</td>
            <td>:</td>
            <td><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbMandor" AutoPostBack="False" /> 
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbSubLed" AutoPostBack="true" /> 
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbJob" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" AutoPostBack="true" />
        ...
        <tr>
			...
			<%--<td>Person</td>
            <td>:</td>--%>
            <td><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbPerson" Visible="False" /> 
            ...
            <div style="border:0px;  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
						...
						<asp:BoundField DataField="DivisiBlok" HeaderStyle-Width="80px" 
                            HeaderText="Block" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="BlockName" HeaderStyle-Width="80px" 
						...
						<asp:BoundField DataField="Capacity" HeaderStyle-Width="80px" DataFormatString="{0:#,##0.####}"
                            HeaderText="Capacity" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="QtySuggest" HeaderStyle-Width="80px" DataFormatString="{0:#,##0.####}"
                            HeaderText="Suggest(Ha)" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="Hk" HeaderStyle-Width="80px" DataFormatString="{0:#,##0.####}" 
                            HeaderText="HK" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
                        
						<asp:BoundField DataField="QtyMax" HeaderStyle-Width="80px" HeaderText="Material Max" DataFormatString="{0:#,##0.####}" > 
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="QtyDone" HeaderStyle-Width="80px" HeaderText="Material Done" DataFormatString="{0:#,##0.####}" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>

            <asp:BoundField DataField="QtySJ" HeaderStyle-Width="80px" HeaderText="Qty SJ" DataFormatString="{0:#,##0.####}" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>                   

						
						<asp:BoundField DataField="Qty" HeaderStyle-Width="80px" HeaderText="Retur Qty" DataFormatString="{0:#,##0.####}">
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="Unit" HeaderStyle-Width="80px" HeaderText=" Retur Unit" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="EveryPackage" HeaderStyle-Width="80px" HeaderText="Package satuan" DataFormatString="{0:#,##0.####}">
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="QtyPackage" HeaderStyle-Width="80px" HeaderText="Package Qty" DataFormatString="{0:#,##0.####}">
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="UnitPackage" HeaderStyle-Width="80px" HeaderText="Package Unit" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="QtyMax" HeaderStyle-Width="80px" HeaderText="Qty Sisa" DataFormatString="{0:#,##0.####}" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						
						<asp:BoundField DataField="Unit" HeaderStyle-Width="80px" HeaderText="Qty Unit" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
			    ...
			    <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <td>
                               <asp:TextBox CssClass="TextBox" runat="server" ID="tbCapacity" 
                               Width="80px" />
                                                    
                            <td>Suggest(Ha)</td>
                            <td>:</td>
                            <td>
                               <asp:TextBox CssClass="TextBox" runat="server" ID="tbSuggest" 
                               Width="80px" />
                            ...
                            <td>:</td>
                            <td>
                               <asp:TextBox CssClass="TextBox" runat="server" ID="tbHk" 
                               Width="80px" />                 
                            </td>
				...
				<tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td><asp:TextBox ID="tbMax" runat="server" CssClass="TextBoxR" Width="60px" AutoPostBack="False" 
                                        Enabled="False"/></td>
                                <td><asp:TextBox ID="tbDone" runat="server" CssClass="TextBoxR" Width="60px" 
                                        Enabled="False" /></td>
				...
				<tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td><asp:TextBox ID="tbQtyDt" runat="server" CssClass="TextBoxR" Width="60px" AutoPostBack="False" 
                                        Enabled="False"/></td>
                                <td><asp:TextBox ID="tbUnitDt" runat="server" CssClass="TextBoxR" Width="60px" 
                                        Enabled="False" /></td>
				...
				<tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td><asp:TextBox ID="tbSatuan" runat="server" CssClass="TextBoxR" Width="60px" AutoPostBack="False" 
                                        Enabled="False"/></td>
                                <td><asp:TextBox ID="tbQtyPackage" runat="server" CssClass="TextBoxR" Width="60px" 
                                        Enabled="False" /></td>
								<td><asp:TextBox ID="tbUnitPackage" runat="server" CssClass="TextBoxR" Width="60px" 
                                        Enabled="False" /></td>
				...
				<tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td><asp:TextBox ID="tbSisa" runat="server" CssClass="TextBoxR" Width="60px" AutoPostBack="False" 
                                        Enabled="False"/></td>
                                <td><asp:TextBox ID="tbUnitSisa" runat="server" CssClass="TextBoxR" Width="60px" 
                                        Enabled="False" /></td>
