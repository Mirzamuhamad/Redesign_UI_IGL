...
<body>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
          <%--  <td>Supplier/Instansi</td>--%>
            <td><asp:LinkButton ID="lbSupplier" ValidationGroup="Input" runat="server" Text="Supplier/Instansi"/></td>
            <td>:</td>  
            <td>
        ...
        <tr>
            ...
            <td>
               ...
               <asp:FileUpload ID="fupRecvFile" style="color: blue;" runat="server" accept="application/pdf" />            
        ...
        <tr>
            ...
            <td>
               ...
               <asp:FileUpload ID="fupApplFile" style="color: blue;" runat="server" accept="application/pdf" />            
        ...
        <tr>
            ...
            <td>
              ...
              Height="25px" onchange="SetTextTerm();" OnSelectedIndexChanged="ddlTerm_SelectedIndexChanged" AutoPostBack="false"  />             
