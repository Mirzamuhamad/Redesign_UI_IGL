...
Partial Class Transaction_TrCIPLicenAdmInv_TrCIPLicenAdmInv
    ...
    Private Sub CountTotalAmount()
        ...
        Try
            ...
            For Each Dr In ViewState("Dt").Rows
                ...
                End If
            Next
            tbBaseForex.Text = FormatNumber(BeaForex, ViewState("DigitHome"))
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                "TermPayment,DueDate,Currency,ForexRate,BaseForex,Disc,DiscForex,DPPForex,PPn,PPnForex,PPh,PPhForex,TotalForex,Remark,FgReport,FgActive,UserPrep,DatePrep) " + _
    ...
    Protected Sub tbTerm_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbTerm.TextChanged
        ...
        End Try
        'Dim strSQL As String
        'strSQL = "SELECT xrange FROM MsTerm WHERE TermCode = " + QuotedStr(ddlTerm.SelectedValue) 'QuotedStr(tbTerm.Text)
        'tbForexRate.Text = SQLExecuteScalar(strSQL, ViewState("DBConnection").ToString)
    End Sub
