<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSetupAccount.aspx.vb" Inherits="Transaction_TrSetupAccount_TrSetupAccount" %>
...
<body>
    ...
    <div class="Content">
     <div class="H1">Setup Account</div>
     <hr style="color:Blue" />
     ...
     <Columns>
        <dx:GridViewDataColumn FieldName="SetDescription" Caption="Setup Accout" VisibleIndex="1" Width = "230px"><Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>
        <dx:GridViewDataColumn FieldName="SetValue" Caption="Account" VisibleIndex="2" Width = "60px"><Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>        
        <dx:GridViewDataColumn FieldName="AccountName" Caption="Account Name" VisibleIndex="3" Width = "200px"><Settings AutoFilterCondition="Contains" /></dx:GridViewDataColumn>
     ...
     <asp:Panel ID="pnlInput" runat="server" Visible="false">
        <table>
            ...
            <tr>
                <td>Account</td>
                <td>:</td>
                <td><asp:TextBox ID="tbAcc" CssClass="TextBox" runat="server" Width="100px" AutoPostBack="True" /><asp:TextBox ID="tbAccName" CssClass="TextBox" Width="200px" runat="server" Enabled="false" />
                    <asp:Button ID="btnSearchAcc" class="btngo" runat="server" Text="Search" 
                        Width="40px"/></td>                
            </tr>                        
            <tr>
