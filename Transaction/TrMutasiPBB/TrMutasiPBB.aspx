<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrMutasiPBB.aspx.vb" Inherits="TrMutasiPBB" %>
    ...
    <%@ Register Assembly="BasicFrame.WebControls.BasicDatePicker" Namespace="BasicFrame.WebControls" TagPrefix="BDP" %>
        ...
        <body>
            <form id="form1" runat="server">
                <div class="Content">
                    <div class="H1">Mutasi SPPT</div>
                    <hr style="color: rgb(178, 178, 178)" />
                    <asp:Panel runat="server" ID="PnlHd">
                        <table>
                            <tr>
                                ...
                                <%--TransNmbr, TransDate, STATUS, FgReport, UserType, UserCode, UserName, Attn,
                                    Remark--%>
                                    <td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px"
                                        SortExpression="TransNmbr" HeaderText="No Mutasi"></asp:BoundField>
                                    <asp:BoundField DataField="Status" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-Width="60px" HeaderText="Status"></asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="AreaCode" HeaderStyle-Width="80px"
                                        SortExpression="AreaCode" HeaderText="Area Code"></asp:BoundField>
                                    <asp:BoundField DataField="AreaName" HeaderStyle-Width="80px"
                                        SortExpression="AreaName" HeaderText="Area Name"></asp:BoundField>
                    ...
                    <asp:Panel runat="server" ID="pnlInput" Visible="false">
                        <table>
                            <tr>
                                ...
                                <td>:</td>
                                <td width="250px">
                                    <asp:TextBox CssClass="TextBoxR" runat="server" ID="tbCode" Width="150px"
                                        Enabled="False" />
                                </td>
                                <td>Date Mutasi</td>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbArea" CssClass="TextBox"
                                        Width="50px" />
                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbAreaName"
                                        CssClass="TextBox" Width="175px" />
                                    <asp:Button Class="btngo" ID="btnArea" Text="..." runat="server"
                            ...
                            <asp:View ID="Tab1" runat="server">
                                <asp:Panel runat="server" ID="PnlDt">
                                    <asp:Button class="bitbtndt btnadd" runat="server" ID="btnAdddt" Text="Add"
                                        ValidationGroup="Input" />&nbsp;
                                    <asp:Button Class="bitbtndt btnsearch" ID="btnGetreference" Text="Get Data"
                                        runat="server" Visible="false" ValidationGroup="Input" />
                                    ...
                                    <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                                        <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnView" runat="server" class="bitbtndt btnedit"
                                                            Text="Detail Dokumen" Width="120px" CommandName="View"
                                                ...
                                                <asp:BoundField DataField="JenisMutasi" HeaderStyle-Width="120px"
                                                    HeaderText="Jenis Mutasi" />
                                                <asp:BoundField DataField="JenisDokumen" HeaderStyle-Width="100px"
                                                    HeaderText="Jenis Dokumen" />
                                                <asp:BoundField DataField="NoDokumen" HeaderStyle-Width="100px"
                                                    HeaderText="No Dokumen SPPT" />
                                                <asp:BoundField DataField="NoPayment" HeaderStyle-Width="120px"
                                                    HeaderText="No Payment" Visible = "false" />

                                                <asp:BoundField DataField="Luas" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="Luas" />
                                                    <asp:BoundField DataField="UnitCode" HeaderStyle-Width="150px"
                                                    HeaderText="Object Code" />
                                                <asp:BoundField DataField="UnitName" HeaderStyle-Width="150px"
                                                    HeaderText="Object" />
                                                <asp:BoundField DataField="SisaLuas" HeaderStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="Sisa Luas" />
                                                <asp:BoundField DataField="Nama" HeaderStyle-Width="150px"
                                                    HeaderText="Nama" />
                                                <asp:BoundField DataField="Info" HeaderStyle-Width="150px"
                                                    HeaderText="Dokumen Info" />
                                                    <asp:BoundField DataField="NoSertifikat" HeaderStyle-Width="150px"
                                ...
                                <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style4">:</td>
                                            <td class="style4">
                                                <asp:DropDownList CssClass="DropDownList" AutoPostBack="true"
                                                    Width="230px" runat="server" ID="ddlJenisMutasi">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbLuas" runat="server" CssClass="TextBox"
                                                    MaxLength="255" Width="225px" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="TextBox" ValidationGroup="Input" Width="50px"
                                                    runat="server" ID="tbObject" AutoPostBack="true" />
                                                <asp:TextBox CssClass="TextBox" runat="server" ID="tbObjectName"
                                                    Enabled="false" Width="165px" />
                                                <asp:Button class="btngo" runat="server" ID="btnObject" Text="..."
                                                    ValidationGroup="Input" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbSisaLuas" runat="server" CssClass="TextBox"
                                                    MaxLength="255" Width="225px" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbInfo" runat="server" CssClass="TextBox"
                                                    MaxLength="255" Width="225px" />
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="tbNoSertifikat" runat="server" CssClass="TextBox"
                                                    MaxLength="255" Width="225px" />
                                            </td>
                                        </tr>
                                    ...
                                    <asp:Button class="bitbtndt btncancel" runat="server" ID="btnCancelDt"
                                        Text="Cancel" />
                                </asp:Panel>
                            </asp:View>
                            ...
                            <asp:View ID="Tab2" runat="server">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:Label ID="lbReference" runat="server" Text="JenisDokumen" />
                                        </td>
                                ...
                                <hr style="color: rgb(195, 195, 195)" />
                            ...
                            <asp:View ID="Tab3" runat="server">
                                ...
                                <asp:Panel ID="pnlDt3" runat="server">
                                    ...
                                    <asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDt3" Text="Add"
                                        ValidationGroup="Input" />
                                    <asp:Button Class="bitbtndt btnsearch" ID="btnGetDt" Text="Get Data" runat="server"
                                        ...
                                        <asp:GridView ID="GridDt3" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PaymentNo" HeaderStyle-Width="150px"
                                                    HeaderText="Payment No" SortExpression="PaymentNo">
                        ...
                        <asp:Button class="bitbtndt btnsave" runat="server" ID="btnSaveTrans" Text="Save"
                            ValidationGroup="Input" />
                        <asp:Button class="bitbtndt btnback " runat="server" ID="btnBack" Text="Cancel"
                            ValidationGroup="Input" />
