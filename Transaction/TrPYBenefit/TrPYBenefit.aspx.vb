...
Partial Class Transaction_TrPYBenefit_TrPYBenefit
    Inherits System.Web.UI.Page
    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "SELECT distinct TransNmbr, Nmbr, Status, TransDate, Department, Dept_Name, Remark FROM V_PYBenefitHd "
    ...
    Private Sub SetInit()
        Try
            ...
            FillCombo(ddlBenefit, "SELECT Benefit, Benefit_Name FROM VMsBenefit", True, "Benefit", "Benefit_Name", ViewState("DBConnection"))
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * FROM V_PYBenefitDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Next
                Result = Result + "'"
                Session("SelectCommand") = "EXEC S_PYBenefit " + Result
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_PYBenefit", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
        ...
        Try
            ...
            Else
                If tbEmpNo.Text.Trim = "" Then
                    ...
                    Return False
                End If
                If ddlBenefit.Text.Trim = "" Then
                    lbStatus.Text = MessageDlg("Benefit Must Have Value")
                    ddlBenefit.Focus()
                    Return False
                End If
    ...
    Protected Sub FillTextBoxDt(ByVal ItemNo As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToDropList(ddlBenefit, Dr(0)("Benefit").ToString)
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveDt.Click
        Try
            ...
            If ViewState("StateDt") = "Edit" Then
                ...
                Row("Benefit") = ddlBenefit.SelectedValue
                Row("Benefit_Name") = ddlBenefit.SelectedItem.Text
            ...
            Else
                ...
                dr("Benefit") = ddlBenefit.SelectedValue
                dr("Benefit_Name") = ddlBenefit.SelectedItem.Text
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbCode.Text = GetAutoNmbr("PYB", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO PYBenefitHd (TransNmbr, TransDate, Status, Department, Remark, UserPrep, DatePrep) " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("SELECT Status FROM PYBenefitHd WHERE TransNmbr = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE PYBenefitHd SET TransDate = " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, EmpNumb, JobLevel, Benefit, Currency, ForexRate, AmountForex, Remark FROM PYBenefitDt WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
            ...
            Dim Dt As New DataTable("PYBenefitDt")
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Reference, Status, Organization, Employee ID, Employee Name, Benefit, Remark"
            FilterValue = "TransNmbr, Status, Dept_Name, EmpNumb, EmpName, Benefit_Name, Remark"
