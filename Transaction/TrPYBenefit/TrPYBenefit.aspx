<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrPYBenefit.aspx.vb" Inherits="Transaction_TrPYBenefit_TrPYBenefit" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Payroll Benefit</div>
     <hr style="color:Blue" />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >     
                    ...
                    <asp:ListItem Value="Benefit_Name">Benefit</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Department" HeaderStyle-Width="250px" SortExpression="Dept_Name" HeaderText="Organization"></asp:BoundField>
      ...
      <hr style="color:Blue" />  
                ...
                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Benefit_Name" HeaderStyle-Width="180px" HeaderText="Benefit" />
              ...
              <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                <table style="width: 583px">             
                    ...
                    <tr>
                        <td class="style7">Benefit</td>
                        <td>:</td>
                        <td style="margin-left: 40px">
                        <asp:DropDownList ID="ddlBenefit" runat="server" CssClass="DropDownList" Height="17px" ValidationGroup="Input" Width="228px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
