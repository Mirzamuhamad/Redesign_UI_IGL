                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px" SortExpression="Nmbr"
                            HeaderText="Transfer No"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="Operator" HeaderStyle-Width="80px" SortExpression="Operator"
        ...
        <asp:Panel runat="server" ID="pnlInput" Visible="false">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ValidationGroup="Input" ID="tbOperator" MaxLength="255"
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="Tab1" runat="server">
                    <asp:Panel runat="server" ID="PnlDt">
                        ...
                        <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                            ...
                            <asp:BoundField DataField="ProductName" HeaderStyle-Width="100px" HeaderText="Product Name" />--%>
                                    ...
                                    <asp:BoundField DataField="StartMonthDepr" HeaderStyle-Width="80px" HeaderText="Start Month Depr" />
                                    <asp:BoundField DataField="StartYearDepr" HeaderStyle-Width="50px" HeaderText="Start Year Depr" />
                                    <asp:BoundField DataField="LifeMonth" HeaderStyle-Width="100px" HeaderText="Life Month" />
                                    <asp:BoundField DataField="LifeProcessDepr" HeaderStyle-Width="100px" HeaderText="Life Process Depr" />
                    ...
                    <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                        ...
                        <asp:Panel runat="server" ID="PnlRegistrasi">
                            <table>
                                <tr>
                                    <td class="style2">
                                        RR No
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="tbProductCode" runat="server" CssClass="TextBox" Enabled="false"
                                            Width="125px" />
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCostCenterDt" runat="server" CssClass="DropDownList" />
                                </td>
                                <td class="style2">
                                    Buying Date
                                </td>
                ...
                <asp:View ID="Tab2" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;<asp:Label ID="lbBuyingDate" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lbFASubGroup" runat="server" CssClass="TextBox" Text="lbFASubGroup" />
                            </td>
                            <td>
                                Currency
                            </td>
                        ...
                        <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                            <asp:GridView ID="GridDt2" runat="server" AutoGenerateColumns="false" ShowFooter="True">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Qty" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
                                        HeaderText="Qty" />
                    ...
                    <asp:Panel runat="server" ID="pnlEditDt2" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox CssClass="TextBox" runat="server" ID="tbQtyDt2" />
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <asp:Button class="btngo" runat="server" ID="btnHome" Text="Home" Width="51px" />
        </asp:Panel>
    </div>
