...
Partial Class Transaction_TrFATransfer_TrFATransfer
        ...
        Try
            ...
            If Not Session("Result") Is Nothing Then
                If ViewState("Sender") = "btnFASubGroup" Then
                    ...
                    tbLifeMonth.Text = Session("Result")(2).ToString
                ...
                If ViewState("Sender") = "btnRRNo" Then
                    ...
                    ddlUnit.SelectedValue = Session("Result")(6).ToString
                    tbPriceForex.Text = Session("Result")(7).ToString
                    tbSpecFA.Text = Session("Result")(8).ToString
    ...
    Private Sub SetInit()
        Try
            ...
            ElseIf Request.QueryString("ContainerId").ToString = "TrEARegistraionID" Then
                ...
                ViewState("FgExpendable") = "Y"
                PnlRegistrasi.Visible = True
                lbUnit.Visible = True
                ddlUnit.Enabled = False
                tbPriceForex.Enabled = False
                ...
                tbLifeProcessDepr.Visible = False
                tbAmountProcessDepr.Visible = False
                tbFAName.Enabled = False
            Else
                ViewState("TransferType") = "Registration"
    ...
    Protected Sub btnRRNo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRRNo.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT RR_No, RR_Date, Currency, dbo.FormatFloat(ForexRate," + ViewState("DigitRate").ToString + ") AS ForexRate, Product, Product_Name, Specification, Unit, dbo.FormatFloat(PriceForex,2) AS PriceForex FROM V_STRRForFARegistration WHERE FgExpendable = " + QuotedStr(ViewState("FgExpendable").ToString)
            ResultField = "RR_No, RR_Date, Currency, ForexRate, Product, Product_Name, Unit, PriceForex, Specification"
