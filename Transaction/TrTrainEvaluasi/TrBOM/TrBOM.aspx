...
<body>     
    ...
    <div class="Content">
    <div class="H1">Bill Of Material</div>
     <hr style="color:Blue" />        
         ...
         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px" SortExpression="Nmbr" HeaderText="BOM No"></asp:BoundField>                  
                  <asp:BoundField DataField="Status" HeaderText="Status"></asp:BoundField>                  
                  <asp:BoundField DataField="TransDate" dataformatstring="{0:dd MMM yyyy}" htmlencode="true" HeaderStyle-Width="80px" SortExpression="TransDate" HeaderText="BOM Date"></asp:BoundField>
                  ...
                  <asp:BoundField DataField="BOMType" HeaderStyle-Width="50px" SortExpression="BOMType" HeaderText="BOM Type"></asp:BoundField>                  
                  <asp:BoundField DataField="Product" HeaderStyle-Width="150px" SortExpression="Product" HeaderText="Product Code"></asp:BoundField>                  
                  <asp:BoundField DataField="Product_Name" HeaderStyle-Width="250px" SortExpression="Product_Name" HeaderText="Product Name"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table style="width: 676px">
        ...
        <tr>
            <td class="style9">Effective Date</td>
            <td>:</td>
          ...
          <tr>
              <td class="style9">Product</td>
              <td>:</td>
              <td><asp:TextBox ID="tbProductCode" runat="server" CssClass="TextBox" MaxLength="20" ValidationGroup="Input" Width="124px" AutoPostBack = "true"/>
                  <asp:TextBox ID="tbProductName" runat="server" CssClass="TextBoxR" 
                      ValidationGroup="Input" Width="358px" />
                  <asp:Button ID="btnProduct" runat="server" class="bitbtn btngo" Text="..." 
                      ValidationGroup="Input" />
                  <asp:Label ID="label1" runat="server" Text="*" Font-Underline="False" 
                      ForeColor="#FF3300" />
              </td>
          </tr>
        
        <tr>
            <td class="style9">Specification</td>
            <td>:</td>
            <td>
                <asp:TextBox ID="tbSpecificationHd" runat="server" CssClass="TextBox" 
                    Enabled="False" MaxLength="255" TextMode="MultiLine" 
                    Width="430px" />
            </td>
        </tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:DropDownList ID="ddlBomType" runat="server" CssClass="DropDownList" Height="16px" ValidationGroup="Input" Width="96px" AutoPostBack="True">
                  </asp:DropDownList>
        ...
        <asp:Panel runat="server" ID="pnlTissue">
            <table style="width: 676px">
                <tr style="width: 80px">
                    <td class="style9">Length</td>
                    <td style="width: 10px">:</td>
                    <td>
                        <asp:TextBox ID="tbLength" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="72px" />                            
                        cm
                        <asp:Label ID="label3" runat="server" Font-Underline="False" ForeColor="#FF3300" Text="*" />
                    </td>
                    <td align = "right">Width</td>
                    <td>:</td>
                    <td>
                        <asp:TextBox ID="tbWidth" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="72px" />
                        cm
                        <asp:Label ID="label4" runat="server" Font-Underline="False" ForeColor="#FF3300" Text="*" />
                     </td>
                </tr>
                <tr>
                    <td class="style10">Sheet</td>
                    <td class="style12">:</td>
                    <td>
                        <asp:TextBox ID="tbSheet" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="72px" />
                        /pack
                        <asp:Label ID="label6" runat="server" Font-Underline="False" ForeColor="#FF3300" Text="*" />
                    </td>
                    <td align="right">GSM</td>
                    <td>:</td>
                    <td>
                        <asp:TextBox ID="tbGSM" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="72px" />
                        <asp:Label ID="label5" runat="server" Font-Underline="False" ForeColor="#FF3300" Text="*" />    
                    </td>
                </tr>
                <tr>
                    <td class="style10">Ratio Premix</td>
                    <td class="style12">:</td>
                    <td>
                        <asp:TextBox ID="tbRatio" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="72px" />
                        <asp:Label ID="label7" runat="server" Font-Underline="False" ForeColor="#FF3300" Text="*" />    
                    </td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="style12">:</td>
                    <td><asp:TextBox ID="tbTotalgr" runat="server" CssClass="TextBoxR" Width="72px"/>
                        gr</td>
                    <td align="right">Premix</td>
                    <td>:</td>
                    <td>
        ...
        <table style="width: 676px">
          <tr>
              <td class="style9">Remark</td>
              <td class="style2">:</td>
              <td>
                  <asp:TextBox ID="tbRemark" runat="server" CssClass="TextBox" MaxLength="255" TextMode="MultiLine" ValidationGroup="Input" Width="430px" />
              </td>
          </tr>
      </table>  
      ...
      <hr style="color:Blue" />  
       <%--<asp:Menu
        ...
        <asp:View ID="tabProcess" runat="server">      
           <asp:Panel runat="server" ID="pnlDtProcess">
            <asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDtProcess" Text="Add" ValidationGroup="Input" />	                  
            <br /><br />
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
       ...
       <asp:Panel runat="server" ID="pnlEditDtProcess" Visible="false">
            <table style="width: 673px">
                <tr>
                    <td><asp:LinkButton ID="lbProcess"  runat="server" Text="Process"/> </td>
                    <td>:</td>
                    <td colspan="4"><asp:TextBox runat="server" ID="tbProcessCode" CssClass="TextBox" AutoPostBack="true" MaxLength = "5" Width="124px"/>
                        <asp:TextBox runat="server" CssClass="TextBoxR" ID="tbProcessName" 
                            Width="387px" Enabled="False"/>
                ...
                <tr>
                    <td>Successor</td>
                    <td>:</td>
                    <td colspan="4"><asp:TextBox ID="tbSuccessorCode" runat="server" AutoPostBack="true" CssClass="TextBox" MaxLength="5" Width="124px" />
                        <asp:TextBox ID="tbSuccessorName" runat="server" CssClass="TextBoxR" 
                            Width="386px" Enabled="False" />
                ...
                <tr>
                    ...
                    <td>:</td>                    
                    <td colspan="4">
                        <asp:TextBox ID="tbFormulaProcess" runat="server" AutoPostBack="true" 
                            CssClass="TextBox" MaxLength="20" Width="124px" />
                        <asp:TextBox ID="tbFormulaName" runat="server" CssClass="TextBoxR" 
                            Enabled="False" Width="386px" />
                        <asp:Button ID="btnFormulaProcess" runat="server" Class="btngo" Text="..." 
                            ValidationGroup="Input" />
                    </td>
                </tr>                                                                
                <tr>
                    ...
                    <td>
                        :</td>
                    <td colspan="4">
                        <asp:DropDownList ID="ddlOutputType" runat="server" AutoPostBack="true" 
                            CssClass="DropDownList" Height="16px" Width="49px" Enabled="False">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4">
                        <asp:TextBox ID="tbProductOutputCode" runat="server" AutoPostBack="true" CssClass="TextBox" MaxLength="20" Width="124px" />
                        <asp:TextBox ID="tbProductOutputName" runat="server" CssClass="TextBoxR" 
                            Width="384px" Enabled="False" />
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:TextBox ID="tbQtyOutput" runat="server" 
                            CssClass="TextBox" MaxLength="20" Width="45px" />
                    </td>
                    <td align = "right">Unit&nbsp; Output</td>
                    <td>
                        :</td>
                    <td>
                        <asp:DropDownList ID="ddlUnitOutput" runat="server" CssClass="DropDownList" 
                            Enabled="false" Width="62px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        :</td>
                    <td colspan="4">
                        <asp:TextBox ID="tbRemarkProcess" runat="server" CssClass="TextBox" 
                            MaxLength="255" TextMode="MultiLine" Width="526px" />
                    </td>
                </tr>
            </table>
            <br />                     
            <asp:Button ID="btnSaveProcess" runat="server" class="bitbtndt btnsave" 
                Text="Save" />									
            <asp:Button ID="btnCancelProcess" runat="server" class="bitbtndt btncancel" 
                Text="Cancel" />									
       </asp:Panel> 
       <br />     
       </asp:View>
       ...
       <asp:Panel ID="pnlInfoDt" runat="server">
            ...
            <asp:Label ID="lblProcessCodeDt" runat="server" Font-Bold="true" ForeColor="Blue" Text="ProcessCode" />
            <asp:Label ID="lblProcessNameDt" runat="server" Font-Bold="true" ForeColor="Blue" Text="ProcessName" />
        </asp:Panel>
        <br />
         ...
         <asp:Panel runat="server" ID="pnlDt">
          <asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDt" Text="Add" ValidationGroup="Input" />	                  
             ...
             <asp:Button ID="btnGetDt" runat="server" class="bitbtn btngetitem" 
                 Text="Get Material" ValidationGroup="Input" Width="95px" />
            <br /><br />
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
            <table style="width: 673px">
                <tr>
                    <td><asp:LinkButton ID="lbMaterial"  runat="server" Text="Material"/> </td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" ID="tbMaterialCode" CssClass="TextBox" AutoPostBack="true" MaxLength = "20" Width="124px"/>
                        <asp:TextBox runat="server" CssClass="TextBoxR" ID="tbMaterialName" 
                            Width="358px"/>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbSpecificationDt" runat="server" CssClass="TextBox" 
                            Enabled="False" MaxLength="255" TextMode="MultiLine" Width="430px" />
                    </td>
                </tr>                                                                          
                <tr>
                    ...
                    <td>:</td>                    
                    <td>
                        <asp:TextBox ID="tbMaterialAlternate" runat="server" AutoPostBack="true" 
                            CssClass="TextBox" MaxLength="20" Width="124px" />
                        <asp:TextBox ID="tbMaterialAlternateName" runat="server" CssClass="TextBoxR" 
                            Width="358px" Enabled = "false"/>
                        <asp:Button ID="btnMaterialAlternate" runat="server" Class="btngo" Text="..." 
                            ValidationGroup="Input" />
                    </td>
                </tr>                                                                
                <tr>
                    ...
                    <table frame="border">
                        <tr align ="center" style="background-color:Gray">
                            <td>Qty</td>
                            <td>Unit</td>
                            <td class="style13">Qty Compare</td>
                            <td>Unit Compare</td>
                        </tr>
                        <tr align ="center">
                            <td>
                                <asp:TextBox ID="tbQtyDt" runat="server" CssClass="TextBox" Width="43px" />
                                <asp:Label ID="label11" runat="server" Font-Underline="False" 
                                    ForeColor="#FF3300" Text="*" />
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlUnitDt" runat="server" CssClass="DropDownList" 
                                    Enabled="False" Width="62px" />
                            </td>
                            <td class="style13">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlUnitCompare" runat="server" CssClass="DropDownList" 
                                    Height="17px" Width="97px" />
                                <asp:Label ID="label22" runat="server" Font-Underline="False" 
                                    ForeColor="#FF3300" Text="*" />
                            </td>
                        </tr>
                    </table>
