...
Partial Class Transaction_TrJamsostekRegIn_TrJamsostekRegIn
    Inherits System.Web.UI.Page
    Protected con, con2 As New SqlConnection
    Protected da, da2 As New SqlDataAdapter
    Protected GetStringHd As String = "Select * From V_PEJamsostekRegInHd"
        ...
        Try
            ...
            If Not Session("Result") Is Nothing Then
                ...
                If ViewState("Sender") = "btnEmp" Then
                    'ResultField = "EmpNumb, EmpName, Gender, JamsostekNo, BirthDate"
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_PEJamsostekRegInDt WHERE TransNmbr = " + QuotedStr(Nmbr) + " "
    End Function
        ...
        Try
            ...
            For j = 0 To (Nmbr.Length - 1)
                If Nmbr(j) = "" Then
                    Exit For
                Else
                    Result = ExecSPCommandGo(ActionValue, "S_PEJamsostekRegIn", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                    If Trim(Result) <> "" Then
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbRef.Text = GetAutoNmbr("JI", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)
                SQLString = "INSERT INTO PEJamsostekRegInHd (TransNmbr, Status, TransDate, Tahun, Bulan, EmpAppr, JobTtlAppr, EmpAcknow, JobTtlAcknow, Remark, UserPrep, DatePrep) " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM PEJamsostekRegInHd WHERE TransNmbr = " + QuotedStr(tbRef.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE PEJamsostekRegInHd SET Tahun = " + ddlYear.SelectedValue + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, EmpNumb, JamSosTekNo, SalaryGP, JobType, Code, Remark FROM PEJamsostekRegInDt WHERE TransNmbr = '" & ViewState("Reference") & "'", con)
            ...
            Dim Dt As New DataTable("PEJamsostekRegInDt")
        ...
        Try
            If Not (Dr Is Nothing) Then
                ...
                If CFloat(Dr("SalaryGP").ToString) <= 0 Then
                    ...
                    Return False
                End If
                If Dr("JobType").ToString.Trim = "" Then
                    lbStatus.Text = MessageDlg("Job Type Must Have Value")
                    Return False
                End If
                If Dr("Code").ToString.Trim = "" Then
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    ...
                    If CekMenu <> "" Then
                        ...
                        Exit Sub
                    End If
                    Session("SelectCommand") = "EXEC S_PEFormJamsostekRegIn " + QuotedStr(GVR.Cells(2).Text) + "," + QuotedStr(ViewState("UserId"))
                    Session("ReportFile") = ".../../../Rpt/FormJamsostekRegIn.frx"
    ...
    Protected Sub FillTextBoxDt(ByVal ItemNo As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToText(tbJobType, Dr(0)("JobType").ToString)
                BindToText(tbCode, Dr(0)("Code").ToString)
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveDt.Click
        ...
        Try
            If ViewState("StateDt") = "Edit" Then
                ...
                Row("JobType") = tbJobType.Text
                Row("Code") = tbCode.Text
    ...
    Protected Sub btnEmp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmp.Click
        Dim ResultField As String
        Try
            'Session("filter") = "SELECT * FROM V_MsEmployee WHERE COALESCE(Fg_Active, 'N') = 'Y' AND COALESCE(FgJamsostek, 'N') = 'N' AND Emp_No NOT IN (" + QuotedStr(tbEmpAppr.Text) + "," + QuotedStr(tbEmpAcknow.Text) + ")"
            Session("filter") = "EXEC S_PEJamsostekRegInFindEmp " + QuotedStr(tbEmpCode.Text) + "," + QuotedStr(tbEmpAppr.Text) + "," + QuotedStr(tbEmpAcknow.Text)
            Session("DBConnection") = ViewState("DBConnection")
            ResultField = "EmpNumb, EmpName, Gender, JamsostekNo, BirthDate"
    ...
    Protected Sub tbEmpCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbEmpCode.TextChanged
        ...
        Dim DT As DataTable
        Try
            DT = SQLExecuteQuery("EXEC S_PEJamsostekRegInFindEmp " + QuotedStr(tbEmpCode.Text) + "," + QuotedStr(tbEmpAppr.Text) + "," + QuotedStr(tbEmpAcknow.Text), ViewState("DBConnection").ToString).Tables(0)
            If DT.Rows.Count > 0 Then
                Dr = DT.Rows(0)
            Else
                Dr = Nothing
