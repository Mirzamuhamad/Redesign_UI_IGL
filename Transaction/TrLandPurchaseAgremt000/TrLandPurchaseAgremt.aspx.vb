...
Partial Class Transaction_TrLandPurchaseAgremt_TrLandPurchaseAgremt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Dim Rev As Integer
        'Dim Tipe As String
        Dim Pembayaran, Pelunasan, HargaTanah As String
        Try
            If Not IsPostBack Then
                ...
                BindGridDocument()
                'RefreshGridDetil()
                'GetCustomers(txtSearchKegiatan.Text, 1)
            ...
            If Not Session("Result") Is Nothing Then
                If ViewState("Sender") = "btnNoLandSurvey" Then
                    ...
                    'End If
                    HargaTanah = SQLExecuteScalar("SELECT TtlHrgTanah FROM GLLandPurchaseReqHd WHERE Status='P' AND TransNmbr = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
                    Pembayaran = SQLExecuteScalar("SELECT SUM(Pembayaran)AS Pembayaran FROM PRCLandPurchaseTJHd WHERE Status='P' AND LSNo = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
                    Pelunasan = SQLExecuteScalar("SELECT SUM(PayPelunasan)AS Pelunasan FROM PRCLandPurchaseTJHd WHERE Status='P' AND LSNo = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
                    BindToText(tbPembayaran, Pembayaran, ViewState("DigitHome"))
                    BindToText(tbPelunasan, HargaTanah - Pembayaran, ViewState("DigitHome"))
    ...
    Public Shared Function GetCustomers(ByVal searchTerm As String, ByVal pageIndex As Integer) As String
        Dim query As String = "[S_PRCListNoLandSurvey]"
    ...
    Private Shared Function GetData(ByVal cmd As SqlCommand, ByVal pageIndex As Integer) As DataSet
        ...
        'Dim strConnString As String = ViewState("DBConnection").ToString
        Using con As New SqlConnection(strConnString)
            Using sda As New SqlDataAdapter()
                cmd.Connection = con
                sda.SelectCommand = cmd
                Using ds As New DataSet()
                    sda.Fill(ds, "V_GLLandPurchaseReqHd")
    ...
    Function CekHd() As Boolean
        ...
        Try
            ...
            'HargaTanah = SQLExecuteScalar("SELECT TtlHrgTanah FROM V_GLLandPurchaseReqHd WHERE Status='P' AND TransNmbr = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
            HargaTanah = SQLExecuteScalar("SELECT TtlHrgTanah FROM GLLandPurchaseReqHd WHERE Status='P' AND TransNmbr = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
            Pembayaran = SQLExecuteScalar("SELECT SUM(Pembayaran)AS Pembayaran FROM PRCLandPurchaseTJHd WHERE Status='P' AND LSNo = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
            Pelunasan = SQLExecuteScalar("SELECT SUM(PayPelunasan)AS Pelunasan FROM PRCLandPurchaseTJHd WHERE Status='P' AND LSNo = " + QuotedStr(tbNoLandSurvey.Text), ViewState("DBConnection"))
            TotalPembayaran = CFloat(tbPembayaran.Text) + CFloat(tbPelunasan.Text) + Pembayaran + Pelunasan
            If HargaTanah <= TotalPembayaran Then
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            ...
            'BindToText(tbPembayaran, Dt.Rows(0)("Pembayaran").ToString)
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                SQLString = "INSERT INTO PRCLandPurchaseTJHd(TransNmbr,TransDate,Status,Revisi,LSNo,SellerCode," + _
                            "HargaPerM,Luas,HargaTanah,Pembayaran,PayPelunasan,RencanaBayar,Remark,UserPrep,DatePrep,FgReport,FgActive) " + _
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_PRCFormLandPurchaseTJ '''" + GVR.Cells(2).Text + "'''"
    ...
    Protected Sub btnNoLandSurvey_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNoLandSurvey.Click
        ...
        Try
            ...
            strSQL = "SELECT A.TransNmbr, A.TransDate, A.HrgTanah, A.LuasUkur, A.TtlHrgTanah, A.SellCode, A.SellName " + _
            ...
            ResultField = "TransNmbr, TransDate, HrgTanah, LuasUkur, TtlHrgTanah, SellCode, SellName"
            CriteriaField = "TransNmbr, TransDate, HrgTanah, LuasUkur, TtlHrgTanah, SellCode, SellName"
            ViewState("CriteriaField") = CriteriaField.Split(",")
            Session("Column") = ResultField.Split(",")
