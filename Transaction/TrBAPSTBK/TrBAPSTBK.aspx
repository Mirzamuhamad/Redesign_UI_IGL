<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrBAPSTBK.aspx.vb" Inherits="BAPSerahTerimaBuktiKepemilikan" %>
...
<head runat="server">
    <title>BAP Serah Terima Bukti Kepemilikan</title>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">BAP Serah Terima Bukti Kepemilikan</div>
     <hr />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                     <asp:ListItem Value="TransNmbr" Selected="True">No. Serah Terima</asp:ListItem>
                     <asp:ListItem Value="Status">Status</asp:ListItem>
                     <asp:ListItem Value="dbo.FormatDate(TransDate)">Date</asp:ListItem>
                     <asp:ListItem Value="PSNo">No. Pesanan</asp:ListItem>
                     <asp:ListItem Value="Area_Name">Nama Area</asp:ListItem>
                     <asp:ListItem Value="Penjual_Name">Nama Penjual</asp:ListItem>
                     <asp:ListItem Value="Pembeli_Name">Nama Pembeli</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px" SortExpression="Nmbr" HeaderText="Serah Terima No."></asp:BoundField>                  
                  ...
                  <asp:BoundField DataField="PSNo" HeaderStyle-Width="120px" SortExpression="PSNo" HeaderText="Pesanan No."></asp:BoundField> 
                  <asp:BoundField DataField="AreaCode" HeaderStyle-Width="60px" SortExpression="AreaCode" HeaderText="Area"></asp:BoundField>
                  <asp:BoundField DataField="Area_Name" HeaderStyle-Width="150px" SortExpression="Area_Name" HeaderText="Nama Area"></asp:BoundField>                                  
                  <asp:BoundField DataField="SellCode" HeaderStyle-Width="60px" SortExpression="SellCode" HeaderText="Penjual"></asp:BoundField>
                  <asp:BoundField DataField="Penjual_Name" HeaderStyle-Width="150px" SortExpression="Penjual_Name" HeaderText="Nama Penjual"></asp:BoundField>
                  <asp:BoundField DataField="CustCode" HeaderStyle-Width="60px" SortExpression="CustCode" HeaderText="Pembeli"></asp:BoundField>
                  <asp:BoundField DataField="Pembeli_Name" HeaderStyle-Width="150px" SortExpression="Penjual_Name" HeaderText="Nama Pembeli"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">        
            ...
            <tr>
              <td>
                 <asp:Menu ID="Menu2" runat="server" CssClass="Menu" ItemWrap="False" 
                   ...
                   <StaticMenuItemStyle CssClass="MenuItem" />
                   <Items>
                     <asp:MenuItem Text="Form Input BAP Bukti Kepemilikan" Value="0"></asp:MenuItem>
                     <asp:MenuItem Text="Upload Lampiran" Value="1"></asp:MenuItem>
                   </Items>
                 </asp:Menu>                    
              </td>
                <td>
     ...
     <asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="0">
          ...
          <table>
            ...
            <tr>             
                ...
                <td>
                  ...
                  <asp:TextBox ID="tbNoPesanan" runat="server" CssClass="TextBox"  ValidationGroup="Input" Width="185px" />
                  <asp:Button ID="btnNoPesanan" runat="server" Class="btngo" Text="..." ValidationGroup="Input" /> 
                </td>
            </tr>
            <tr>
                <td>Area</td>
                <td>:</td>
                <td>
                   <asp:TextBox ID="tbAreaCode" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbAreaName" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                </td>
            </tr>                                             
            <tr>
                <%--<td>Kavling</td>
                <td>:</td>--%>
                <td>
                   <asp:TextBox ID="tbKavlingCode" Visible = "False" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbKavlingName"  Visible = "False" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                </td>
            </tr>
            <tr>
                <td>Penjual</td>
                <td>:</td>
                <td>
                   <asp:TextBox ID="tbPenjualCode" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbPenjualName" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                </td>
            </tr>
            <tr>
                <td>Pembeli</td>
                <td>:</td>
                <td>
                   <asp:TextBox ID="tbPembeliCode" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbPembeliName" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                </td>
            </tr>   
            <tr>
               <td>Remark</td>
       ...
       <asp:View ID="TabHd1" runat="server">
            <table>
                <tr>
                  <td><asp:Button class="bitbtndt btndelete" OnClientClick="return confirm('Sure to delete this dokumen?');" runat="server" ID="btnClearInv" Width="15px" Text="s" /> Upload Dokumen Lampiran </td>
                  <td>:</td>                  
                  <td> 
      ...
      <asp:Menu
            ...
            <Items>
                ...
                <asp:MenuItem Text="Detail Serah Terima " Value="1"></asp:MenuItem>                   
            </Items>            
      </asp:Menu>
        <hr /> 
                ...
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <asp:BoundField DataField="ItemNo" ItemStyle-HorizontalAlign="Right" HeaderText="Item No" />
                             <asp:BoundField DataField="UnitName" HeaderStyle-Width="150px" HeaderText="Unit"></asp:BoundField>                           
                            <asp:BoundField DataField="CertNo" HeaderStyle-Width="200px" HeaderText="No. Sertifikat" /> 
                            <asp:BoundField DataField="Luas" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="60px" DataFormatString="{0:#,##0}" HeaderText="Luas (M2)" />
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
            <table>                                                
                ...
                <td>:</td>
                <td>
                   <asp:TextBox ID="tbUnitCode"  runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbUnitName"  runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                   <asp:Button ID="btnUnit" runat="server" Class="btngo" Text="..." ValidationGroup="Input" /> 
                </td>
                </tr>  
            
                <tr>
                   <td>No. Mutasi Sertifikat</td>
                   <td>:</td>
                   <td>
                     <asp:TextBox ID="tbMutCertNo" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                     <asp:Button ID="btnMutCertNo" runat="server" Class="btngo" Text="..." ValidationGroup="Input" />                      
                   </td>                
                </tr>
                ...
                <tr>
                   ...
                   <td>:</td>
                   <td>
                     <asp:TextBox ID="tbCertNo" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                   </td>                                
                </tr>                                                                                 
                <tr>                    
                   <td>Luas</td>
                   <td>:</td>
                   <td>
                     <asp:TextBox ID="tbLuas" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="50px" />
                   </td>
                </tr>                                      
                <tr>
                   <td>Remark</td>
