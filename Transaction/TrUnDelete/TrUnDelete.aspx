<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrUnDelete.aspx.vb" Inherits="Transaction_TrUnDelete_TrUnDelete" %>
...
<body>
    ...
    <div class="Content">
     <div class="H1">Un-Delete Customer Invoice</div>
     <hr style="color:Blue" />                     
      <asp:Panel runat="server" ID="pnlSearch" >
      <table>
        <tr>          
          <td style="width:100px;text-align:right">Invoice No :</td>
          <td>           
              <asp:TextBox runat="server" CssClass="TextBox" ID ="tbCode"/> 
          &nbsp &nbsp &nbsp   
           <asp:Button Class="button" ID="btnVerivy" Text="Verivy" runat="server" ValidationGroup="Input" />
              <asp:Label runat ="server" ID="lbVerivy" Text="Verivy" Visible="false" ForeColor="Red"/>
            &nbsp &nbsp &nbsp &nbsp &nbsp     
              <asp:Button Class="button" ID="btnUnDelete" Text="UnDelete" runat="server" ValidationGroup="Input" />
              <asp:Label runat ="server" ID="lbUnDelete" Text="UnDelete" Visible="false" ForeColor="Red"/>
          </td> 
        </tr>        
      </table>      
      </asp:Panel>
