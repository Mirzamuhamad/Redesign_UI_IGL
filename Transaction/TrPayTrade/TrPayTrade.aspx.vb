...
Partial Class Transaction_TrPayTrade_TrPayTrade
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                lbCount.Text = SQLExecuteScalar("SELECT * FROM V_CountSiPosting", ViewState("DBConnection").ToString)
            End If
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, PaymentType, PaymentDate, DocumentNo, Reference, GiroDate, DueDate, BankPayment, Currency, ForexRate, PaymentForex, PaymentHome, Remark, FgMode, FgValue, DPRate FROM FinPayTradeDt WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
    ...
    Protected Sub lbCount_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbCount.Click
        Dim ResultField, CriteriaField, sqlstring, ResultSame As String
        Try
            sqlstring = "EXEC S_FNPayTradeGetInv '','Y',''" '+ ddlReport.SelectedValue.ToString + ""
            'If lbFgModeDt2.Text = "G" Then
            '    If tbSuppCode.Text.Trim = "" Then
            '        'ini diremark, karena product type tidak dipakai lagi
            '        'If tbProductType.Text = "" Then
