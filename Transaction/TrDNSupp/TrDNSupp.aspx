<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrDNSupp.aspx.vb" Inherits="DNSupp" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Debit Note Supplier</div>
     <hr style="color:Blue" />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      ...
                      <asp:ListItem Value="SuppInvNo">Invoice No</asp:ListItem>
                      <asp:ListItem Value="dbo.FormatDate(SuppInvDate)">Invoice Date</asp:ListItem>                                        
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="SuppInvNo" HeaderStyle-Width="120px" SortExpression="SuppInvNo" HeaderText="Supp Inv"></asp:BoundField>
                  <asp:BoundField DataField="SuppInvDate" dataformatstring="{0:dd MMM yyyy}" htmlencode="true" HeaderStyle-Width="80px" SortExpression="SuppInvDate" HeaderText="Supp Inv Date"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                    <asp:DropDownList ID="ddlCostCtr" runat="server" ValidationGroup="Input" CssClass="DropDownList" >                        
                    </asp:DropDownList>
            </td>          
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td><asp:DropDownList CssClass="DropDownList" ValidationGroup="Input" runat="server" ID="ddlTerm" AutoPostBack="true" Width="160px"/> 
        ...
        <tr>
            ...
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbSuppInvNo" CssClass="TextBox" Width="160px"/>
        ...
        <tr>
            <td>Remark</td>
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbRemark" CssClass="TextBoxMulti" Width="400px" TextMode="MultiLine" /></td>
        </tr>
      </table>  
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
            <table>                                
                ...
                <tr>
                        <td>Item No</td>
                        <td>:</td>
                        <td colspan="4"><asp:Label ID="lbItemNo" runat="server" Text="Item" />
                        </td>           
                    </tr>        
                    <tr>                    
                        <td>Account</td>
                    ...
                    <tr>
                        <td>Cost Center</td>
                        <td>:</td>
                        <td colspan="4"><asp:DropDownList CssClass="DropDownList" ID="ddlCostCenter" runat="server" Width="180px"/></td>
                    </tr>  
                    <tr>
                        <td>Qty</td>
                        <td>:</td>
                    ...
                    <tr> 
                        ...
                        <td>:</td>
                        <td>                            
                            <asp:TextBox CssClass="TextBoxR" runat="server" ID="tbAmountForex"/>                            
                        </td>                        
                    </tr>
                    <tr>
                        <td>Remark </td>
