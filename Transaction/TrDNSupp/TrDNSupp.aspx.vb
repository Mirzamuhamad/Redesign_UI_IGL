...
Partial Class DNSupp
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "Select * From V_FNDNSuppHd "
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_FNDNSuppDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Result = Result + "'"
                Session("SelectCommand") = "EXEC S_FNFormCNDNSupp " + Result + ", 'DN' "
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_FNSIDN", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbRef.Text = GetAutoNmbr("DNS", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO FINDNSuppHd (TransNmbr, FgReport, Status, TransDate, Supplier, Attn, CostCtr," + _
                "Term, DueDate, SuppInvNo, SuppInvDate, PPnNo, PPnDate, PPnRate, Currency, ForexRate, BaseForex, Disc, DiscForex, PPn, PPnForex, TotalForex, " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM FINDNSuppHd WHERE TransNmbr = " + QuotedStr(tbRef.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE FINDNSuppHd SET Supplier = " + QuotedStr(tbSuppCode.Text) + ", Attn = " + QuotedStr(tbAttn.Text) + _
                ", Term = " + QuotedStr(ddlTerm.SelectedValue) + ", PPnNo = " + QuotedStr(tbPPnNo.Text) + _
                ...
                ", DueDate = '" + Format(tbDueDate.SelectedDate, "yyyy-MM-dd") + "'" + ", SuppInvNo = " + QuotedStr(tbSuppInvNo.Text) + _
                ", SuppInvDate = '" + Format(tbSuppInvDate.SelectedDate, "yyyy-MM-dd") + "', Currency = " + QuotedStr(ddlCurr.SelectedValue) + ", ForexRate = " + tbRate.Text.Replace(",", "") + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, Account, FgSubled, Subled, CostCtr, Qty, Unit, PriceForex, AmountForex, Remark FROM FINDNSuppDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
            ...
            "UPDATE FINDNSuppDt SET ItemNo = @ItemNo, Account = @Account, " + _
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM FINDNSuppDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND ItemNo = @ItemNo ", con)
            ' Add the parameters for the DeleteCommand.
            param = Delete_Command.Parameters.Add("@ItemNo", SqlDbType.Int, 4, "ItemNo")
            param.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command

            Dim Dt As New DataTable("FINDNSuppDt")
        ...
        Try
            ...
            Else
                ...
                If tbQty.Text = "0" Or tbQty.Text = "" Then
                    ...
                    Return False
                End If
                If tbPrice.Text = "0" Or tbPrice.Text = "" Then
                    lbStatus.Text = MessageDlg("Price Forex Must Have Value")
                    tbPrice.Focus()
                    Return False
                End If
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Reference, Date, Supplier, Term, Due Date, Currency, Invoice No, Remark"
            FilterValue = "TransNmbr, dbo.FormatDate(TransDate), Supplier_Name, Term_Name, dbo.FormatDate(DueDate), Currency, SuppInvNo, Remark"
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_FNFormCNDNSupp '''" + GVR.Cells(2).Text + "''', 'DN' "
                        Session("ReportFile") = ".../../../Rpt/FormCNDNSupp.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    Protected Sub btnAccount_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAccount.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT * FROM V_MsAccountDt WHERE TransType = 'DNS' AND ( Currency = " + QuotedStr(ddlCurr.SelectedValue) + " OR Currency = " + QuotedStr(ViewState("Currency").ToString) + ") "
    ...
    Protected Sub tbAccount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbAccount.TextChanged
        ...
        Dim Dt As DataTable
        Try
            Dt = SQLExecuteQuery("SELECT * FROM V_MsAccountDt WHERE TransType = 'DNS' AND ( Currency = " + QuotedStr(ddlCurr.SelectedValue) + " OR Currency = " + QuotedStr(ViewState("Currency").ToString) + ") AND Account = " + QuotedStr(tbAccount.Text), ViewState("DBConnection").ToString).Tables(0)
            If Dt.Rows.Count > 0 Then
                Dr = Dt.Rows(0)
