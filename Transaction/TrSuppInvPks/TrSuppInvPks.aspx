<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSuppInvPks.aspx.vb" Inherits="SuppInv" %>
...
//        }
        ...
        _prmPPh.value = setdigit(_tempPPh,2);//addCommas(_tempPPh);
        _prmPPhForex.value = setdigit(_tempPPhForex,'<%=VIEWSTATE("DigitCurr")%>');//addCommas(_tempPPhForex);
       ...
       function setformatdt()
        ...
        document.getElementById("tbPPhDt").value = setdigit(PPh,2);
...
<body>     
      ...
      <table>
        <tr>
            ...
            <td>
                ...
                &nbsp &nbsp &nbsp &nbsp
                <asp:Label runat="server" ID="Label1" Text="Outstanding RR PKS : "/>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Supplier" HeaderStyle-Width="200px" SortExpression="Supplier" HeaderText="Supplier"></asp:BoundField>
                  <asp:BoundField DataField="PONo" HeaderStyle-Width="120px" SortExpression="PONo" HeaderText="SPT-IN No"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <tr style="background-color:Silver;text-align:center">
                 ...
                 <tr>
                 <td>
                 <asp:TextBox runat="server" ValidationGroup="Input" ID="tbPPnNo" enable="False" AutoPostBack="true" CssClass="TextBox" Width="150px"/>
                 </td>
                 <td>
                 <BDP:BasicDatePicker ID="tbPPndate" runat="server" enable="False" DateFormat="dd MMM yyyy" 
                            ReadOnly = "true" ValidationGroup="Input"
                            ButtonImageHeight="19px" ButtonImageWidth="20px" 
                            DisplayType="TextBoxAndImage" 
        ...
        <tr>
				...
				<td>Edit Price : <asp:TextBox runat="server" ID="TbEditPrice" AutoPostBack="True" CssClass="TextBox" Width="60px" />  
				 <asp:Button Class="bitbtndt btngetitem" ID="btnGetData" Text="Get Data" runat="server" ValidationGroup="Input" width = "70"/></td>	
				<%--
                <td>Spt-In No</td>
                <td>:</td>--%>
                <td><asp:TextBox runat="server" ID="tbPONo" CssClass="TextBox" Width="150px" visible="False" Enabled ="false"/> 
        ...
        <tr>
            <td>Remark</td>
            <td>:</td>
            <td ><asp:TextBox runat="server" ValidationGroup="Input" ID="tbRemark" MaxLength = "255" CssClass="TextBoxMulti" Width="350px" TextMode="MultiLine" /></td>
	...
	<asp:LinkButton ID="lbPriceSup" ValidationGroup="Input" visible="False" runat="server" Text=" Price Supplier"/>
    </form>
    </body>
</html>
