...
Partial Class TrPRReq
    ...
    Private Function GetStringHd() As String
        Return "Select DISTINCT A.TransNmbr, A.Nmbr, A.TransDate, A.Status, A.Department, A.DeptName, A.ReffNmbr, A.RequestBy, A.Remark, A.UserPrep, A.DatePrep, A.UserAppr, A.DateAppr From V_PRCRequestHd A INNER JOIN VMsDepartment B ON A.Department = B.Dept_Code "
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            tbQtyreq.Text = 0
            tbQtyreq.Text = Format(tbQtyreq.Text, "#,##0.#0")
            tbQtyreq.Text = Len(tbQtyreq.Text)
            ...
            If Not Session("Result") Is Nothing Then
                ...
                If ViewState("Sender") = "btnRequest" Then
                    tbRequestBy.Text = Session("Result")(1).ToString
                End If
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateHd") = "Insert" Then
                ...
                SQLString = "INSERT INTO PRCRequestHd (TransNmbr, STATUS, Transdate, Department, RequestBy, Remark, UserPrep, DatePrep, FgBuffer, RequestType) " + _
            ...
            Else
                ...
                "', Remark = '" + tbRemark.Text + "', DateAppr = getDate()" + _
            ...
            Dim Update_Command = New SqlCommand( _
                    ...
                    " Remark = @Remark " + _
                     "WHERE TransNmbr = " & QuotedStr(ViewState("Reference")), con)
