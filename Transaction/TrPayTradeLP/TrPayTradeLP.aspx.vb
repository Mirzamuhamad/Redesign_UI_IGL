...
Partial Class Transaction_TrPayTradeLP_TrPayTradeLP
    Inherits System.Web.UI.Page
    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "Select * FROM V_FINPayTradeLPHd "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                lbCount.Text = SQLExecuteScalar("EXEC S_GetLP '1'", ViewState("DBConnection").ToString)
            End If
            ...
            If Not Session("Result") Is Nothing Then
                ...
                If ViewState("Sender") = "btnLpNo" Then
                    tbLpCode.Text = Session("Result")(0).ToString
                    BindToText(tbArea, Session("Result")(1).ToString)
                    BindToText(tbPaymentTanah, Session("Result")(2).ToString, ViewState("DigitCurr"))
                    BindToText(tbPaymentNotaris, Session("Result")(3).ToString, ViewState("DigitCurr"))
                    BindToText(tbPaymentBPHTB, Session("Result")(4).ToString, ViewState("DigitCurr"))
                    BindToText(tbPaymentModerator, Session("Result")(5).ToString, ViewState("DigitCurr"))
                    BindToText(tbPaymentSurvey, Session("Result")(6).ToString, ViewState("DigitCurr"))
                    BindToText(tbPaymentLainLain, Session("Result")(7).ToString, ViewState("DigitCurr"))
                    BindToText(tbAreaName, Session("Result")(8).ToString)
                    'AttachScript("setformathd();", Page, Me.GetType)


                ElseIf ViewState("Sender") = "btnLpInv" Then
                    tbLpInv.Text = Session("Result")(0).ToString
                    BindToText(tbTotalAmount, Session("Result")(3).ToString, ViewState("DigitCurr"))
                ...
                ElseIf ViewState("Sender") = "btnDocNo" Then
                    ...
                    If tbLpCode.Text.Trim = "" Then
                        BindToText(tbLpCode, Session("Result")(5).ToString)
                    End If
                    AttachScript("setformatdt();", Page, Me.GetType)
                ...
                ElseIf ViewState("Sender") = "btnInvNo" Then
                    ...
                    'Dim PayRate, PPnRate As Double
                    'sisainv, sisabayar, sisappn, sisapph, lastInvoice
                    ...
                    BindToText(tbType, Session("Result")(16).ToString)
                    tbType.Enabled = False

                    If tbLpCode.Text.Trim = "" Then
                        BindToText(tbLpCode, Session("Result")(14).ToString)
                        tbLpCode.Enabled = False
                        btnLPNo.Visible = False
                    End If

                    ViewState("TotalToPaid") = 0
                    'ViewState("PayRate") = CFloat(tbPayRateDt2.Text)

                    If (ddlCurrDt2.Text = ViewState("Currency").ToString) Then
                        tbPayRateDt2.Text = FormatFloat(1, ViewState("DigitRate"))
                        tbPayRatePPn.Text = FormatFloat(1, ViewState("DigitRate"))
                        tbPayRateDt2.Enabled = False
                        tbPayRatePPn.Enabled = False
                    Else
                        'tbPayRateDt2.Text = FormatFloat(1, ViewState("DigitRate"))
                        ChangeCurrency(ddlCurrDt2, tbDate, tbPayRateDt2, ViewState("Currency"), ViewState("DigitCurr"), ViewState("DBConnection"), ViewState("DigitHome"))
                        tbPayRatePPn.Text = FormatFloat(tbPayRateDt2.Text, ViewState("DigitRate"))
                        tbPayRateDt2.Enabled = True
                        tbPayRatePPn.Enabled = True
                    End If
                    ...
                    tbTotalToPaidDt2.Text = FormatFloat(amount + amountppn + amountpph - balans - balansppn - balanspph, ViewState("DigitCurrInv"))
                    tbBaseToPaidDt2.Text = FormatFloat(amount - balans, ViewState("DigitCurrInv"))
                    tbPPNToPaidDt2.Text = FormatFloat(amountppn - balansppn, ViewState("DigitCurrInv"))
                    tbPPhToPaidDt2.Text = FormatFloat(amountpph - balanspph, ViewState("DigitCurrInv"))
                ...
                ElseIf ViewState("Sender") = "btnGetInv" Then
                    ...
                    For Each drResult In Session("Result").Rows
                        ...
                        If ExistRow.Count = 0 Then
                            'insert
                            If tbLpCode.Text.Trim = "" Then
                                BindToText(tbLpCode, drResult("Supplier").ToString)
                            End If
                            ...
                            'lbItemNodt2.Text = lbItemNo.Text
                            ...
                            If drResult("Currency").ToString = ViewState("Currency") Then
    ...
    Private Sub SetInit()
        Try
            FillRange(ddlRange)
            lbPaymentTanah.Text = "Tanah (" + ViewState("Currency") + ")"
            lbPaymentNotaris.Text = "Notaris (" + ViewState("Currency") + ")"
            lbPaymentBPHTB.Text = "BPHTB (" + ViewState("Currency") + ")"
            lbPaymentModerator.Text = "Moderator (" + ViewState("Currency") + ")"
            lbPaymentSurvey.Text = "Survey (" + ViewState("Currency") + ")"
            lbPaymentLainLain.Text = "Lain -Lain (" + ViewState("Currency") + ")"
            ...
            FillCombo(ddlPayTo, "SELECT Jenis, Jenis FROM V_Jenis ", True, "Jenis", "Jenis", ViewState("DBConnection"))
            ...
            tbBankPayment.Attributes.Add("ReadOnly", "True")
            ...
            tbPaymentLainLain.Attributes.Add("OnKeyDown", "return PressNumeric();")
            tbPaymentTanah.Attributes.Add("OnKeyDown", "return PressNumeric();")
            tbPaymentNotaris.Attributes.Add("OnKeyDown", "return PressNumeric();")
            tbPaymentBPHTB.Attributes.Add("OnKeyDown", "return PressNumeric();")
            tbPaymentModerator.Attributes.Add("OnKeyDown", "return PressNumeric();")
            tbPaymentSurvey.Attributes.Add("OnKeyDown", "return PressNumeric();")

            'tbTotalPaymentForex.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentTanah.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentNotaris.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentBPHTB.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentModerator.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentSurvey.Attributes.Add("OnBlur", "setformathd();")
            'tbPaymentLainLain.Attributes.Add("OnBlur", "setformathd();")



            tbTotalAmount.Attributes.Add("OnBlur", "setformatdt();")
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_FiNPayTradeLPDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If (ActionValue = "Print") Or (ActionValue = "Print Full") Then
                ...
                Session("SelectCommand") = "EXEC S_FNFormVoucherLP" + Result + ",'PYLP'," + QuotedStr(ViewState("UserId"))
                Session("ReportFile") = ".../../../Rpt/FormVoucherLP.frx"
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_FNPayTradeLP", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
    ...
    Private Sub EnableHd(ByVal State As Boolean)
        ...
        Try
            ...
            tbLpCode.Enabled = State  'ViewState("StateHd") = "Insert" And Count = 0
            btnLPNo.Visible = State
            tbArea.Enabled = State
            tbPaymentTanah.Enabled = State
            tbPaymentNotaris.Enabled = State
            tbPaymentBPHTB.Enabled = State
            tbPaymentModerator.Enabled = State
            tbPaymentSurvey.Enabled = State
            tbPaymentLainLain.Enabled = State
            tbRemark.Enabled = State
            tbAreaName.Enabled = False
            btnBackDt2.Visible = False

            btnBackDt2.Visible = False
            'ViewState("StateHd") = "Insert" And Count = 0
        Catch ex As Exception
    ...
    Private Sub ClearHd()
        Try
            ...
            tbLpCode.Text = ""  'ViewState("StateHd") = "Insert" And Count = 0
            btnLPNo.Text = ""
            tbArea.Text = ""
            tbPaymentTanah.Text = "0"
            tbPaymentNotaris.Text = "0"
            tbPaymentBPHTB.Text = "0"
            tbPaymentModerator.Text = "0"
            tbPaymentSurvey.Text = "0"
            tbPaymentLainLain.Text = "0"
            tbBankPayment.Text = "0"
    ...
    Private Sub Cleardt()
        Try
            ...
            If CFloat(tbTotalPaymentForex.Text) > (CFloat(tbBankPayment.Text)) Then
                tbPaymentForex.Text = FormatFloat((CFloat(tbTotalPaymentForex.Text)), ViewState("DigitCurr"))
            Else
    ...
    Public Function CekExistGiro(ByVal GiroNo As String, ByVal Connection As String) As Boolean
        ...
        Try
            ...
            'End If
            sqlstring = "SELECT GiroNo FROM FINGiroOut WHERE Status <> 'C' AND GiroNo = " + QuotedStr(GiroNo)
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveDt.Click
        Try
            'If ViewState("1Payment").ToString = "" Then
            ...
            '                If ddlPaymentType.SelectedValue <> ViewState("PayType").ToString Then
            ...
            If ddlPayTo.SelectedValue = "Tanah" Then

                If (Val(tbTotalAmount.Text.Replace(",", "")) > Val(tbPaymentTanah.Text.Replace(",", ""))) Then
                    lbStatus.Text = MessageDlg("Total Amount can not grether more than Payment Tanah")
                    tbTotalAmount.Focus()
                    Exit Sub
                End If

            ElseIf ddlPayTo.SelectedValue = "Notaris" Then

                If (Val(tbTotalAmount.Text.Replace(",", "")) > Val(tbPaymentNotaris.Text.Replace(",", ""))) Then
                    lbStatus.Text = MessageDlg("Total Amount can not grether more than Notaris")
                    tbTotalAmount.Focus()
                    Exit Sub
                End If

            ElseIf ddlPayTo.SelectedValue = "BPHTB" Then
                If (Val(tbTotalAmount.Text.Replace(",", "")) > Val(tbPaymentBPHTB.Text.Replace(",", ""))) Then
                    lbStatus.Text = MessageDlg("Total Amount can not grether more than Payment BPHTB")
                    tbTotalAmount.Focus()
                    Exit Sub
                End If


            ElseIf ddlPayTo.SelectedValue = "Moderator" Then
                If (Val(tbTotalAmount.Text.Replace(",", "")) > Val(tbPaymentModerator.Text.Replace(",", ""))) Then
                    lbStatus.Text = MessageDlg("Total Amount" + tbTotalAmount.Text.Replace(",", "") + " - " + tbPaymentModerator.Text.Replace(",", "") + " can not grether more than Payment Moderator")
                    tbTotalAmount.Focus()
                    Exit Sub
                End If
            ...
            ElseIf ddlPayTo.SelectedValue = "Lain-Lain" Then
                If (Val(tbTotalAmount.Text.Replace(",", "")) > Val(tbPaymentLainLain.Text.Replace(",", ""))) Then
                    lbStatus.Text = MessageDlg("Total Amount can not grether more than Payment Lain-Lain")
                    tbTotalAmount.Focus()
                    Exit Sub
                End If
            End If
            ...
            'lbStatus.Text = (tbTotalAmount.Text.Replace(",", "") - tbPaymentTanah.Text.Replace(",", ""))
            ...
            If tbFgMode.Text = "G" Then
                If CekExistGiro(tbDocumentNo.Text.Trim, ViewState("DBConnection").ToString) = True Then
            ...
            If ViewState("StateDt") = "Edit" Then
                ...
                Row("Jenis") = ddlPayTo.SelectedValue
                Row("LpInvoiceNo") = tbLpInv.Text
                Row("TotalAmount") = tbTotalAmount.Text
                Row.EndEdit()
            Else
                'Insert
                ...
                'Jenis = ViewState("Dt").Select("Jenis = " + QuotedStr(ddlPayTo.SelectedValue))
                'If Jenis.Count > AllowedRecordDt() Then
                '    lbStatus.Text = MessageDlg("Cannot insert more than one Pay to")
                '    Exit Sub
                'End If
                ...
                dr("Jenis") = ddlPayTo.SelectedValue
                dr("LpInvoiceNo") = tbLpInv.Text
    ...
    Protected Sub btnSaveDt2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveDt2.Click
        Try
            ...
            If ViewState("StateDt2") = "Edit" Then
                ...
                Row = ViewState("Dt2").Select("InvoiceNo = " + QuotedStr(tbInvNoDt2.Text))(0)
                Row.BeginEdit()
    ...
    Private Sub CountTotalInvoiceHomeDt()
        Dim HasilKurs, HasilInv, HasilPPh, Base, PPN, PPh, RateInv, RatePPn, PayRate, PayRatePPn, FgValue, HasilKursDP, RateOri, RateDP, PayForex As Double
        Dim Dr As DataRow
        'Dim drow As DataRow()
    ...
    Private Sub CountTotalDt()
        ...
        Try
            ...
            tbBankPayment.Text = FormatNumber(payforex, ViewState("DigitCurr"))
            tbTotalPaymentForex.Text = FormatNumber(TotalAmount, ViewState("DigitHome"))
            ...
            tbTotalSelisih.Text = FormatNumber(CFloat(tbBankPayment.Text) - CFloat(tbTotalPaymentForex.Text), ViewState("DigitHome"))

            'tbInvHomeDt.Text = tbTotalInvoice.Text
            'tbPayHomeDt.Text = FormatNumber(tbTotalPayment.Text, ViewState("DigitHome"))
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbCode.Text = GetAutoNmbr("APLP", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)
                SQLString = "INSERT INTO FINPayTradeLPHd (TransNmbr, TransDate, Status, FgReport, " + _
                "LpNo, Area, PaymentTanah, PaymentNotaris, PaymentBPHTB, PaymentModerator, PaymentSurvey, PaymentLainlain, TotalPayment, BankPayment, Remark, UserPrep, " + _
                "DatePrep) " + _
                "SELECT " + QuotedStr(tbCode.Text) + ", " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + ", 'H', " + _
                QuotedStr("Y") + ", " + QuotedStr(tbLpCode.Text) + ", " + QuotedStr(tbArea.Text) + _
                ", " + tbPaymentTanah.Text.Replace(",", "").Replace(".", "") + ", " + tbPaymentNotaris.Text.Replace(",", "").Replace(".", "") + _
                ", " + tbPaymentBPHTB.Text.Replace(",", "").Replace(".", "") + ", " + tbPaymentModerator.Text.Replace(",", "").Replace(".", "") + _
                ", " + tbPaymentSurvey.Text.Replace(",", "").Replace(".", "") + ", " + tbPaymentLainLain.Text.Replace(",", "").Replace(".", "") + _
                ", " + tbTotalPaymentForex.Text.Replace(",", "").Replace(".", "") + "," + tbBankPayment.Text.Replace(",", "").Replace(".", "") + ", " + QuotedStr(tbRemark.Text) + "," + _
            ...
            Else
                ...
                If cekStatus = "P" Then
                    ...
                    Exit Sub
                End If
                SQLString = "UPDATE FINPayTradeLpHd SET FgReport =" + QuotedStr("Y") + ", LPNo=" + QuotedStr(tbLpCode.Text) + _
                ", TransDate = " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + ", Area =" + QuotedStr(tbArea.Text) + _
                ", PaymentTanah =" + tbPaymentTanah.Text.Replace(",", "").Replace(".", "") + _
                ", PaymentNotaris =" + tbPaymentNotaris.Text.Replace(",", "").Replace(".", "") + _
                ", PaymentBPHTB =" + tbPaymentBPHTB.Text.Replace(",", "").Replace(".", "") + ", TotalPayment =" + tbTotalPaymentForex.Text.Replace(",", "").Replace(".", "") + _
                ", PaymentModerator = " + tbPaymentModerator.Text.Replace(",", "").Replace(".", "") + ", BankPayment= " + tbBankPayment.Text.Replace(",", "").Replace(".", "") + _
                ", PaymentSurvey = " + tbPaymentSurvey.Text.Replace(",", "").Replace(".", "") + _
                ", PaymentLainlain = " + tbPaymentLainLain.Text.Replace(",", "").Replace(".", "") + ", Remark = " + QuotedStr(tbRemark.Text) + _
                ", DatePrep = GetDate()" + _
            ...
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, PaymentType, PaymentDate, DocumentNo, Reference, GiroDate, DueDate, BankPayment, Currency, ForexRate, PaymentForex, PaymentHome, Remark, FgMode, FgValue, DPRate, Jenis, LpInvoiceNo, TotalAmount FROM FinPayTradeLPDt WHERE TransNmbr = " + QuotedStr(ViewState("TransNmbr")), con)
            ...
            "UPDATE FinPayTradeLpDt SET ItemNo = @ItemNo, PaymentType = @PaymentType, " + _
            ...
            "Jenis = @Jenis, LpInvoiceNo = @LpInvoiceNo, TotalAmount = @TotalAmount " + _
            ...
            Update_Command.Parameters.Add("@Jenis", SqlDbType.VarChar, 15, "Jenis")
            Update_Command.Parameters.Add("@LpInvoiceNo", SqlDbType.VarChar, 30, "LpInvoiceNo")
            Update_Command.Parameters.Add("@TotalAmount", SqlDbType.Decimal, 22, "TotalAmount")
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM FINPayTradeLPDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND ItemNo = @ItemNo ", con)
    ...
    Protected Sub btnSaveTrans_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveTrans.Click
        ...
        Try
            ...
            End If
            If tbLpCode.Text.Trim = "" Then
                lbStatus.Text = MessageDlg("Land Purchase Number must have value")
                tbLpCode.Focus()
                Exit Sub
            End If
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Payment No, Payment Date, Status, Land Purchase No, Invoice No, Jenis Payment, Attn"
            FilterValue = "TransNmbr, dbo.FormatDate(TransDate), Status, LPNo,LpInvoice, JenisPayment, AttnName, Remark"
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf (DDL.SelectedValue = "Print") Or DDL.SelectedValue = "Print Full" Then
                    Try
                        ...
                        End If
                        Session("DBConnection") = ViewState("DBConnection")
                        Session("SelectCommand") = "EXEC S_FNFormVoucherLP '''" + GVR.Cells(2).Text + "''','PYLP'," + QuotedStr(ViewState("UserId"))
                        Session("ReportFile") = ".../../../Rpt/FormVoucherLP.frx"
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    '        Dim GVR As GridViewRow
    '        GVR = GridDt2.Rows(Convert.ToInt32(e.CommandArgument))
    ...
    '        lblCurrPayDt.Text = GVR.Cells(6).Text
    '        lblRatePayDt.Text = GVR.Cells(7).Text
    ...
    '        tbInvHomeDt.Text = GVR.Cells(11).Text
    ...
    '            'Else
    '            '    drow = ViewState("Dt2").Select("Invoice=" + GVR.Cells(2).Text)
    '            '    If drow.Length > 0 Then
    ...
    Protected Sub GridDt2_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridDt2.RowDeleting
        Try
            ...
            dr = ViewState("Dt2").Select("InvoiceNo = " + QuotedStr(GVR.Cells(2).Text))
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            ...
            BindToText(tbLpCode, Dt.Rows(0)("LpNo").ToString)
            BindToText(tbArea, Dt.Rows(0)("Area").ToString)
            BindToText(tbAreaName, Dt.Rows(0)("AreaName").ToString)
            BindToText(tbTotalPaymentForex, Dt.Rows(0)("TotalPayment").ToString, ViewState("DigitCurr"))
            BindToText(tbBankPayment, Dt.Rows(0)("BankPayment").ToString, ViewState("DigitCurr"))
            BindToText(tbPaymentTanah, Dt.Rows(0)("PaymentTanah").ToString, ViewState("DigitHome"))
            BindToText(tbPaymentNotaris, Dt.Rows(0)("PaymentNotaris").ToString, ViewState("DigitHome"))
            BindToText(tbPaymentBPHTB, Dt.Rows(0)("PaymentBPHTB").ToString, ViewState("DigitHome"))
            BindToText(tbPaymentModerator, Dt.Rows(0)("PaymentModerator").ToString, ViewState("DigitHome"))
            BindToText(tbPaymentSurvey, Dt.Rows(0)("PaymentSurvey").ToString, ViewState("DigitHome"))
            BindToText(tbPaymentLainLain, Dt.Rows(0)("PaymentLainlain").ToString, ViewState("DigitHome"))
            BindToText(tbTotalSelisih, (Dt.Rows(0)("PaymentLainlain").ToString - Dt.Rows(0)("PaymentLainlain").ToString), ViewState("DigitHome"))
    ...
    Protected Sub FillTextBoxDt(ByVal ItemNo As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToDropList(ddlPayTo, Dr(0)("Jenis").ToString)
                BindToText(tbLpInv, Dr(0)("LPInvoiceNo").ToString)
                BindToText(tbTotalAmount, Dr(0)("TotalAmount").ToString)
    ...
    Protected Sub GridDt2_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridDt2.RowEditing
        ...
        Try
            ...
            FillTextBoxDt2(tbInvNoDt2.Text, GVR.Cells(2).Text)
    ...
    Protected Sub btnLpNo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLPNo.Click
        Dim ResultField, CriteriaField, sqlstring As String
        Try
            sqlstring = "EXEC S_GetLP '0' "
            Session("DBConnection") = ViewState("DBConnection")
            Session("filter") = sqlstring
            ResultField = "TransNmbr,AreaCode,BiayaTanah,BiayaNotaris,BiayaBPHTB,BiayaModerator,BiayaSurvey, BiayaLainLain, AreaName"
            CriteriaField = "TransNmbr,AreaCode,BiayaTanah,BiayaNotaris,BiayaBPHTB,BiayaModerator,BiayaSurvey, BiayaLainLain, AreaName"
            Session("CriteriaField") = CriteriaField.Split(",")
            ViewState("Sender") = "btnLpNo"
        ...
        End Try
    End Sub
    'Protected Sub tbLpCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbLpCode.TextChanged
    '    Dim Dr As DataRow
    '    Try
    '        Dr = FindMaster("Supplier", tbLpCode.Text, ViewState("DBConnection").ToString)
    '        If Not Dr Is Nothing Then
    '            tbLpCode.Text = Dr("Supplier_Code")
    '            BindToText(tbArea, Dr("Contact_Person"))
    '        Else
    '            tbLpCode.Text = ""
    '            tbArea.Text = ""
    '        End If
    ...
    Protected Sub btnInvNo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnInvNo.Click
        Dim ResultField, CriteriaField, sqlstring As String
        Try
            sqlstring = "EXEC S_FNPayTradeGetInv '" + tbLpCode.Text.Trim + "','Y'," + QuotedStr(ViewState("TransNmbr")) 'ddlReport.SelectedValue.ToString
            Session("DBConnection") = ViewState("DBConnection")
            Session("filter") = sqlstring
    ...
    Protected Sub btnDocNo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDocNo.Click
        ...
        Try
            ...
            Else
                Session("filter") = "SELECT DP_No, DP_Date, User_Code, User_Name, PO_No, PPN_Rate, Currency, Rate, Base_Forex, PPN_Forex, Total_Forex, Base_Paid, PPN_Paid, Total_Paid FROM V_FNDPSuppPending " + _
            "WHERE PPN_Forex = 0 and User_Type = 'Supplier' AND User_Code =" + QuotedStr(tbLpCode.Text) + " AND Report =" + QuotedStr("Y") 'ddlReport.SelectedValue
            End If
            Session("DBConnection") = ViewState("DBConnection")
    ...
    Protected Sub tbLpCode_textChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbLpCode.TextChanged
        ...
        Dim dtUnit, DtCek, DtData As DataTable
        ...
        Try
            ...
            If dtUnit.Rows.Count > 0 Then
                ...
                tbLpCode.Text = drUnit("TransNmbr")
                BindToText(tbArea, drUnit("AreaCode").ToString)
                BindToText(tbAreaName, drUnit("AreaName").ToString)
                BindToText(tbPaymentTanah, drUnit("BiayaTanah").ToString, ViewState("DigitCurr"))
                BindToText(tbPaymentNotaris, drUnit("BiayaNotaris").ToString, ViewState("DigitCurr"))
                BindToText(tbPaymentBPHTB, drUnit("BiayaBPHTB").ToString, ViewState("DigitCurr"))
                BindToText(tbPaymentModerator, drUnit("BiayaModerator").ToString, ViewState("DigitCurr"))
                BindToText(tbPaymentSurvey, drUnit("BiayaSurvey").ToString, ViewState("DigitCurr"))
                BindToText(tbPaymentLainLain, drUnit("BiayaLainLain"), ViewState("DigitCurr"))
                'AttachScript("setformathd();", Page, Me.GetType)
            End If


        Catch ex As Exception
            Throw New Exception("Scan Error : " + ex.ToString)
        End Try
    End Sub


    Protected Sub btnLpInv_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLpInv.Click
        Dim ResultField, CriteriaField, sqlstring As String
        Try
            sqlstring = "EXEC S_GetLpToINV '" + ddlPayTo.Text + "','" + tbLpCode.Text + "'"
            Session("DBConnection") = ViewState("DBConnection")
            Session("filter") = sqlstring
            ResultField = "TransNmbr, NameCode, Name, Biaya "
            CriteriaField = "TransNmbr, NameCode, Name, Biaya "
            Session("CriteriaField") = CriteriaField.Split(",")
            ViewState("Sender") = "btnLpInv"
            Session("Column") = ResultField.Split(",")
            AttachScript("OpenSearchGrid();", Page, Me.GetType())
        Catch ex As Exception
