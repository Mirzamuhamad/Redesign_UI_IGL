<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrCurahHujan.aspx.vb" Inherits="Transaction_TrCurahHujan" %>
...
<body>     
    <form id="form1" runat="server">
     <div class="Content">
    <div class="H1">Sensus Curah Hujan</div>
     <hr style="color:Blue" />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      ...
                      <asp:ListItem Value="Koordinat">Koordinat</asp:ListItem>
                      <asp:ListItem Value="LokasiName">Lokasi Name</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Koordinat"  HeaderText="Koordinat" sortExpression="Koordinat">
                      <HeaderStyle Width="100px" />
                  </asp:BoundField>    
                  
                  <asp:BoundField DataField="LokasiName"  HeaderText="Lokasi Name" sortExpression="LokasiName">
                      <HeaderStyle Width="100px" />
                  </asp:BoundField> 
                  
                  <asp:BoundField DataField="Volume" DataFormatString="{0:#,##0.##}"  HeaderText="Volume" sortExpression="Volume">
                      <HeaderStyle Width="100px" />
                  </asp:BoundField>
                  
                  <asp:BoundField DataField="PIC" HeaderText="PIC" DataFormatString="{0:#,##0.##}" HeaderStyle-Width="100px" SortExpression="PIC" >
                       <HeaderStyle Width="100px" />
        ...
        <%--<tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td >
                  <asp:TextBox ID="tbKoordinat" runat="server" AutoPostBack="true" CssClass="TextBox" 
                       Width="151px" Enabled = "False"/>
                  <asp:Button ID="btnKoordinat" runat="server" Class="btngo" Text="..." 
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbLokasi" runat="server" CssClass="TextBox" Enabled="false" 
                      Width="254px" />
                  &nbsp;&nbsp;&nbsp;<asp:Label ID="Label16" runat="server" ForeColor="Red" Text="*" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
          <tr>
              <td>
        ...
        <tr>
              ...
              <td>
                  <asp:TextBox ID="tbRemark" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" Width="383px" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </td>
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="StatusTanam" HeaderStyle-Width="100px" HeaderText="Status Tanam" SortExpression="StatusTanam" >
                            <HeaderStyle Width="100px" />
                        </asp:BoundField>
