...
Partial Class BAPSerahTerimaLK
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "SELECT * FROM V_MKTBAPSTLKHd "

    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * FROM V_MKTBAPSTLKDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Result = Result + "'"
                Session("SelectCommand") = "EXEC S_MKTFormBAPSTLK " + Result + "," + QuotedStr(ViewState("UserId"))
                Session("ReportFile") = ".../../../Rpt/FormBAPSTLK.frx"
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_MKTBAPSTLK", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbCode.Text = GetAutoNmbr("STLK", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO MKTBAPSTLKHd (TransNmbr,TransDate,Status,UnitCode,PSNo,Remark,FgReport,FgActive,UserPrep,DatePrep) " + _
                "SELECT " + QuotedStr(tbCode.Text) + ", " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + ", 'H', " + _
                QuotedStr(tbKavlingCode.Text) + ", " + QuotedStr(tbNoPesanan.Text) + ", " + QuotedStr(tbRemark.Text) + ", 'Y', " + _
                " 'Y'," + QuotedStr(ViewState("UserId").ToString) + ", GetDate()"
            Else
                Dim cekStatus As String
                cekStatus = SQLExecuteScalar("Select Status FROM MKTBAPSTLKHd WHERE TransNmbr = " + QuotedStr(tbCode.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If

                SQLString = "UPDATE MKTBAPSTLKHd SET TransDate = " + QuotedStr(Format(tbDate.SelectedValue, "yyyy-MM-dd")) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr,ItemNo,ItemName,Qty,UnitCode,Remark FROM MKTBAPSTLKDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
            ...
            "UPDATE MKTBAPSTLKDt SET ItemNo = @ItemNo, ItemName = @ItemName, " + _
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM MKTBAPSTLKDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND ItemNo = @ItemNo ", con)
            ' Add the parameters for the DeleteCommand.
            param = Delete_Command.Parameters.Add("@ItemNo", SqlDbType.Int, 4, "ItemNo")
            param.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command

            Dim Dt As New DataTable("MKTBAPSTLKDt")
    ...
    Protected Sub btnNoPesanan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNoPesanan.Click
        ...
        Try
            ...
            Session("Filter") = "SELECT TransNmbr, TransDate, SPNo, Kavling, Kavling_Name FROM V_MKTGetNoPesanan "
            ResultField = "TransNmbr, TransDate, SPNo, Kavling, Kavling_Name"
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        Session("SelectCommand") = "EXEC FormBAPSTLK '''" + GVR.Cells(2).Text + "''', " + QuotedStr(ViewState("UserId").ToString) + " "
