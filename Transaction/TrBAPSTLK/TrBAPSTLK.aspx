<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrBAPSTLK.aspx.vb" Inherits="BAPSerahTerimaLK" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">BAP Serah Terima Lahan/Kunci</div>
     <hr />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                     ...
                     <asp:ListItem Value="StructureName">Kavling Name</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="UnitCode" HeaderStyle-Width="60px" SortExpression="UnitCode" HeaderText="Kavling"></asp:BoundField>
                  <asp:BoundField DataField="StructureName" HeaderStyle-Width="150px" SortExpression="StructureName" HeaderText="Kavling Name"></asp:BoundField>
            ...
            <tr>
              <td>
                 <asp:Menu ID="Menu2" runat="server" CssClass="Menu" ItemWrap="False" 
                   ...
                   <StaticMenuItemStyle CssClass="MenuItem" />
                   <Items>
                     <asp:MenuItem Text="Form Input BAP Lahan/Kunci" Value="0"></asp:MenuItem>
       ...
       <asp:View ID="TabHd0" runat="server">     
          <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                   <asp:TextBox ID="tbKavlingCode" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="60px" />
                   <asp:TextBox ID="tbKavlingName" runat="server" CssClass="TextBox" ValidationGroup="Input" Width="150px" />
                </td>
            </tr>
            <tr>
               <td>Remark</td>
                ...
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <asp:BoundField DataField="ItemName" HeaderStyle-Width="250px" HeaderText="Item Name" />                           
