<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrNonAbsence.aspx.vb" Inherits="Transaction_TrNonAbsence_TrNonAbsence" %>
...
<body>
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >     
                    ...
                    <asp:ListItem Value="dbo.FormatDate(KeepingDate)">Time Keeping Date</asp:ListItem>
                    <asp:ListItem Value="EmpAppr">Approved By</asp:ListItem>
                    <asp:ListItem Value="EmpApprName">Approved By Name</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="KeepingDate" dataformatstring="{0:dd MMM yyyy}" HeaderStyle-Width="80px" SortExpression="KeepingDate" HeaderText="Time Keeping Date"></asp:BoundField>
                  <asp:BoundField DataField="EmpAppr" HeaderStyle-Width="100px" SortExpression="EmpAppr" HeaderText="Approved By"></asp:BoundField>
                  <asp:BoundField DataField="EmpApprName" HeaderStyle-Width="250px" SortExpression="EmpApprName" HeaderText="Approved By Name"></asp:BoundField>
                  <asp:BoundField DataField="Remark" HeaderStyle-Width="280px" SortExpression="Remark" HeaderText="Remark"></asp:BoundField>
              </Columns>
          </asp:GridView>
          </div>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table style="width: 583px">
        ...
        <tr>
            <td class="style6">Time Keeping Date</td>
            <td>:</td>
            <td><BDP:BasicDatePicker ID="tbKeepingDate" runat="server" DateFormat="dd MMM yyyy" 
                        ReadOnly = "true" ValidationGroup="Input"
                        ButtonImageHeight="19px" ButtonImageWidth="20px" 
                        DisplayType="TextBoxAndImage" 
                        TextBoxStyle-CssClass="TextDate" 
          ...
          <tr>
              <td class="style6">Approval By</td>
              <td>:</td>
              <td colspan="4">
                  <asp:TextBox ID="tbEmpAppr" runat="server" CssClass="TextBox" MaxLength="15" 
                      ValidationGroup="Input" Width="99px" AutoPostBack="True" />
                  <asp:TextBox ID="tbEmpNameAppr" runat="server" CssClass="TextBoxR" ReadOnly="true" 
                      MaxLength="100" ValidationGroup="Input" Width="262px"/>
                  <asp:Button ID="btnEmpAppr" runat="server" class="btngo" Text="..." ValidationGroup="Input" />
              </td>
          </tr>
          <%--<tr>
              ...
              <td colspan="4">
                  <asp:DropDownList ID="ddlJbtAppr1" runat="server" CssClass="DropDownList" 
                      Height="17px" ValidationGroup="Input" Width="228px" Enabled="False">
                  </asp:DropDownList>
              </td>
          </tr>--%>
                ...
                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DepartmentName" HeaderStyle-Width="150px" HeaderText="Department" />
                            <asp:BoundField DataField="ShiftName" HeaderStyle-Width="150px" HeaderText="Shift" />
                            <asp:BoundField DataField="AbsStatusName" HeaderStyle-Width="150px" HeaderText="Sts Absensi" />
                            <asp:BoundField DataField="TimeIn" HeaderStyle-Width="40px" HeaderText="Time In" />
                            <asp:BoundField DataField="TimeOut" HeaderStyle-Width="40px" HeaderText="Time Out" />
              ...
              <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                <table style="width: 583px">             
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td style="margin-left: 40px">
                        <asp:DropDownList ID="ddlShift" runat="server" CssClass="DropDownList" Enabled="false" Height="17px" ValidationGroup="Input" Width="228px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="style7">Sts Absensi</td>
                        <td>:</td>
                        <td style="margin-left: 40px">
                        <asp:DropDownList ID="ddlAbsStatus" runat="server" CssClass="DropDownList" Enabled="True" Height="17px" ValidationGroup="Input" Width="228px" AutoPostBack="true">
                            </asp:DropDownList>
                            <asp:TextBox ID="tbHaveAbsence" runat="server" Visible="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style7">Time In</td>
                        <td>:</td>
                        <td class="style1" style="margin-left: 40px">
                            <asp:TextBox ID="tbTimeIn" runat="server" CssClass="TextBox" Height="18px" MaxLength="5" ValidationGroup="Input" Width="40px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style7">Time Out</td>
                        <td>:</td>
                        <td class="style1" style="margin-left: 40px">
                            <asp:TextBox ID="tbTimeOut" runat="server" CssClass="TextBox" Height="18px" MaxLength="5" ValidationGroup="Input" Width="40px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style7">
