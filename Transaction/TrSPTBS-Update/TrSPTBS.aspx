<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSPTBS.aspx.vb" Inherits="Transaction_TrSPTBS_TrSPTBS" %>
      ...
      <table>
        ...
        <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbBrtMasuk" runat="server" AutoPostBack = "true" CssClass="TextBox" Width="80px" />
              ...
              <td>
                  :</td>--%>
              <td>
                  <asp:TextBox ID="tbCarT" runat="server" Visible =false   CssClass="TextBox" />
                  <asp:TextBox ID="tbCarNameT" Visible =false   runat="server" CssClass="TextBoxR" Enabled="False" 
                      Width="200px" />
                  <asp:Button ID="btnCarT" Visible =false   runat="server" Class="btngo" Text="..." />
              </td>
          </tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbBrtKeluar" AutoPostBack = "true" runat="server" CssClass="TextBox" Width="80px" />
              ...
              <td>
                  :</td>--%>
              <td>
                  <asp:TextBox ID="tbOpT" runat="server" Visible =false   CssClass="TextBox" />
                  <asp:TextBox ID="tbOPNameT" runat="server" Visible =false   CssClass="TextBoxR" Enabled="False" 
                      Width="200px" />
                  <asp:Button ID="btnOPT" runat="server" Visible =false  Class="btngo" Text="..." />
              </td>
          </tr>
          <tr>
              <td>
              ...
              <td>
                  :</td>
              <td>
                  <asp:DropDownList ID="ddlDivision" runat="server" CssClass="DropDownList" 
                      ValidationGroup="Input" AutoPostBack="True">
                  </asp:DropDownList>
              </td>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbBrtGross" Enabled = "False" runat="server" CssClass="TextBox" Width="80px" />
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbGrading" AutoPostBack="true" runat="server" CssClass="TextBox" Width="80px" />
                 
                  &nbsp;%&nbsp;&nbsp;
                  <br />
                  
                  <asp:TextBox ID="tbGradingKg" AutoPostBack = "True" runat="server" CssClass="TextBox" Width="80px" />
                  &nbsp;Kg</td>
              <td>
                  &nbsp;</td>
              <td>
        ...
        <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:TextBox ID="tbBrtNet" Enabled = "False" runat="server" CssClass="TextBox" Width="80px" />
