<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrCIPInstrJob.aspx.vb" Inherits="Transaction_TrCIPLicenAdmInv_TrCIPLicenAdmInv" 
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >                      
                    <asp:ListItem Selected="True" Value="TransNmbr">Instruksi No</asp:ListItem>
                    <asp:ListItem Value="dbo.FormatDate(TransDate)">Instruksi Date</asp:ListItem>
        ...
        <tr>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true" CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="AreaName" HeaderStyle-Width="120px" HeaderText="Lokasi"></asp:BoundField>                  
                  <asp:BoundField DataField="PackJob" HeaderStyle-Width="120px" HeaderText="Paket Pekerjaan"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
              <tr>
                  ...
                  <td>:</td>  
                  <td>
                    <asp:TextBox ID="tbAreaCode" runat="server" CssClass="TextBox" Width="80px" ValidationGroup="Input" /> 
        ...
        <tr>
            ...
            <td>:</td>
            <td>
               <asp:TextBox ID="tbPackJob" runat="server" CssClass="TextBox" MaxLength="225" ValidationGroup="Input" Width="300px" TextMode="MultiLine" AutoPostBack="false" />
            ...
            <td> 
              <div id="dlgDate1"> 
                <BDP:BasicDatePicker ID="tbStartJobDate" runat="server" AutoPostBack="true" DateFormat="dd-MM-yyyy" 
                  ReadOnly = "true" ValidationGroup="Input"
                  ButtonImageHeight="19px" ButtonImageWidth="20px" 
                  DisplayType="TextBoxAndImage" 
                  TextBoxStyle-CssClass="TextDate"   
                  ShowNoneButton="False"><TextBoxStyle CssClass="TextDate" /> <%--dd MMM yyyy--%>
                </BDP:BasicDatePicker>
                 
                 <input id="tbMulaiJobDate" runat="server" type="text" visible="false" />  
              </div>              
            </td>            
        </tr>
        <tr>
            ...
            <td>:</td>
            <td>
               <asp:TextBox ID="tbBaseForex" runat="server" CssClass="TextBox" Width="100px" Enabled="false" AutoPostBack="false" />                                                
            </td>
            <td style="width: 30px"></td>
            ...
            <td>
              <div id="dlgDate2">
                <BDP:BasicDatePicker ID="tbFinishJobDate" runat="server" DateFormat="dd-MM-yyyy"   
                  ReadOnly = "true" ValidationGroup="Input" ButtonImageHeight="19px" ButtonImageWidth="20px" 
                  DisplayType="TextBoxAndImage" TextBoxStyle-CssClass="TextDate" OnClientAfterSelectionChanged="diffdays" AutoPostBack="true" 
                  ShowNoneButton="False"><TextBoxStyle CssClass="TextDate" /> <%--OnSelectionChanged="diffdays()" AutoPostBack="true"  --%>
                </BDP:BasicDatePicker> 
                
                <input id="tbEndJobDate" runat="server" type="text" onselect="diffdays" visible="false" /> 
              </div>                
            </td>                        
        </tr>
        <tr>
            ...
            <td>
              <div id="calculated"> 
                <asp:TextBox ID="tbDurasi" runat="server" CssClass="TextBox" Width="50px" Enabled="false"                  
                AutoPostBack="false" /> 
            ...
            <td colspan="4">
                <table>
                     <tr style="background-color:Silver;text-align:center">
                       <td><asp:Label ID = "lbTotBiaya" runat="server" CssClass="TextBox" Text = "Total HPS"/></td>
