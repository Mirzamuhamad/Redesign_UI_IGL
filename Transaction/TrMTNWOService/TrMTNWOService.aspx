<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrMTNWOService.aspx.vb" Inherits="TrMTNWOService" 
    ...
    <asp:Panel runat="server" id="PnlHd"> 
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >                      
                    ...
                    <asp:ListItem Value="ServiceReqNo">No. Service Req</asp:ListItem>
                    ...
                    <asp:ListItem Value="TechInCharge">Tech In Charge</asp:ListItem>
        ...
        <tr>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true" CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:TemplateField HeaderStyle-Width="110" HeaderText="Action">
                      <ItemTemplate>
                          <asp:DropDownList CssClass="DropDownList" ID="ddl" runat="server">
                              ...
                              <asp:ListItem Text="Print Blank" />
                              <asp:ListItem Text="Print Complete" />
                          </asp:DropDownList>
                  ...
                  <asp:BoundField DataField="ServiceReqNo" HeaderStyle-Width="120px" HeaderText="No. Service Req"></asp:BoundField>                  
                  ...
                  <asp:BoundField DataField="TechInCharge" HeaderStyle-Width="120px" HeaderText="Tech In Charge"></asp:BoundField>                                    
      ...
      <asp:Panel runat="server" ID="pnlInput" Visible="false">
        <table>
          <tr>
              ...
              <td></td>                  
              <td>
                <asp:Label ID="lbStsComplete" runat ="server" Font-Size="25px" ForeColor="#4a9bed" />
              </td>
          </tr>                  
          <tr>
          ...
          <tr>
              ...
              <td>:</td>
              <td>
                <asp:TextBox ID="tbServiceReqNo" runat="server" CssClass="TextBox" Width="200px" ValidationGroup="Input" />
                <asp:Button ID="btnServiceReqNo" runat="server" Class="btngo" Text="v" ValidationGroup="Input" />               
              </td>
              <td style="width: 30px"></td>
              <td>Contact No</td>
              <td>:</td>
          ...
          <tr>
              ...
              <td>:</td>
              <td>
                <asp:TextBox ID="tbTechInCharge" runat="server" CssClass="TextBox" Width="260px" ValidationGroup="Input" />
              </td>                                                                                                                      
          </tr>
          <tr>
          ...
          <%--<br/>&nbsp; <br/>&nbsp; --%>         
          <asp:Panel ID="pnlTechnician" runat="server"  Visible="False">
            <table>              
              <tr>               
                 <td>Technician 1</td>
                 ...
                 <td>:</td>
                 <td>
                  <asp:TextBox ID="tbTechnician1" runat="server" CssClass="TextBox" Width="260px" ValidationGroup="Input" />
                 </td>
                 <td></td> 
                 <td>Manhour 1</td>
                 ...
                 <td>:</td>
                 <td>
                   <asp:TextBox ID="tbManhour1" runat="server" CssClass="TextBox" Width="60px" ValidationGroup="Input" />
                 </td> 
                 <td style="width: 0px"></td>
                 <td>Remark 1</td>
                 <td>:</td>
                 <td>
                   <asp:TextBox ID="tbRemarkTech1" runat="server" CssClass="TextBox" Width="300px" ValidationGroup="Input" />
                 </td>                  
              </tr>
              <tr>
                 <td>Technician 2</td>
                 ...
                 <td>:</td>
                 <td>
                  <asp:TextBox ID="tbTechnician2" runat="server" CssClass="TextBox" Width="260px" ValidationGroup="Input" />
                 </td>
                 <td style="width: 30px"></td> 
                 <td>Manhour 2</td>
                 <td style="width: 20px"></td>
                 <td>:</td>
                 <td>
                  <asp:TextBox ID="tbManhour2" runat="server" CssClass="TextBox" Width="60px" ValidationGroup="Input" />
                 </td> 
                 <td style="width: 0px"></td>
                 <td>Remark 2</td>
                 <td>:</td>
                 <td>
                   <asp:TextBox ID="tbRemarkTech2" runat="server" CssClass="TextBox" Width="300px" ValidationGroup="Input" />
                 </td>                  
              </tr>
              <tr>
                 <td>Technician 3</td>
                 ...
                 <td>:</td>
                 <td>
                  <asp:TextBox ID="tbTechnician3" runat="server" CssClass="TextBox" Width="260px" ValidationGroup="Input" />
                 </td>
                 <td style="width: 30px"></td> 
                 <td>Manhour 3</td>
                 <td style="width: 20px"></td>
                 <td>:</td>
                 <td>
                  <asp:TextBox ID="tbManhour3" runat="server" CssClass="TextBox" Width="60px" ValidationGroup="Input" />
                 </td>
                 <td style="width: 0px"></td>
                 <td>Remark 3</td>
                 <td>:</td>
                 <td>
                   <asp:TextBox ID="tbRemarkTech3" runat="server" CssClass="TextBox" Width="300px" ValidationGroup="Input" />
                 </td>                                                                                                                                                                        
              </tr>
              <tr>
                 <td>No. BMK</td>
                 ...
                 <td>:</td>
                 <td>
                   <asp:TextBox ID="tbBMKNo" runat="server" CssClass="TextBox" Width="200px" ValidationGroup="Input" />
                 </td>
                 <td style="width: 30px"></td>                                                                                                                                                                                      
              </tr>
              <tr>
                 ...
                 <td style="width: 40px"></td>              
                 <td>:</td>  
                 <td><asp:TextBox ID="tbRemarkJournal" runat="server" ValidationGroup="Input" CssClass="TextBoxMulti" Width="300px" 
                    MaxLength="255" TextMode="MultiLine" />
                 </td>                                 
              ...
              <tr>  
                 ...
                 <td style="width: 20px"></td>
                 <td>:</td>
                 <td><asp:TextBox ID="tbKesimpulan" runat="server" ValidationGroup="Input" CssClass="TextBoxMulti" Width="300px" 
                    MaxLength="255" TextMode="MultiLine" />
                 </td>                        
                 </tr>             
            </table> 
      ...
      <hr style="color:Blue" />  
         <%--<asp:Menu ID="Menu1" runat="server" CssClass = "Menu"        
            ...
            Orientation="Horizontal"  ItemWrap = "False"
            StaticEnableDefaultPopOutImage="False">            
            <Items>
                <asp:MenuItem Text="Detail WO Service" Value="0"></asp:MenuItem>
                ...
                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" ShowFooter="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ItemNo" HeaderText="Item No" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="ProductName" HeaderStyle-Width="200px" HeaderText="Product Name" ItemStyle-HorizontalAlign="Left" />
                            <asp:BoundField DataField="Qty" DataFormatString="{0:#,##0.00}" HeaderStyle-Width="80px" HeaderText="Qty" ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="UnitName" HeaderStyle-Width="80px" HeaderText="Unit" ItemStyle-HorizontalAlign="Left" />
                            <asp:BoundField DataField="Remark" HeaderStyle-Width="300px" HeaderText="Remark" ItemStyle-HorizontalAlign="Left" />
                        </Columns>
                    </asp:GridView>
                </div> <br/>&nbsp;  
               <%--<asp:Button class="bitbtn btnadd" runat="server" ID="btnAddDtke2" Text="Add" ValidationGroup="Input" /> --%></asp:Panel> 
       ...
       <br />          
           ...
           <asp:Button ID="btnComplete" runat="server" class="bitbtndt btnsavenew" Text="Complete" Width = "80" />									                                                           
      </asp:Panel>  
