<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrRRPks.aspx.vb" Inherits="Transaction_TrRRPks_TrRRPks" %>
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                      ...
                      <asp:ListItem Value="No_SPTIN">SPTIN No</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="No_SPTIN" HeaderStyle-Width="120px" HeaderText="No SPTIN" 
                  ...
                  <asp:BoundField DataField="SupplierName" HeaderStyle-Width="120px" HeaderText="Supplier Name" 
                      SortExpression="SupplierName">
                      <HeaderStyle Width="120px" />
                  </asp:BoundField>
                  
                  <asp:BoundField DataField="Division" HeaderStyle-Width="120px" HeaderText="Division" 
                  SortExpression="Division">
                  <HeaderStyle Width="120px" />
              </asp:BoundField>

              <asp:BoundField DataField="DivisionName" HeaderStyle-Width="120px" HeaderText="Division Name" 
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
              ...
              <td>:</td>
              <td>
                  <asp:TextBox ID="tbNoSptin" runat="server" CssClass="TextBox" />
              </td>
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemNo" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderText="Item" SortExpression="ItemNo" ></asp:BoundField>
						<asp:BoundField DataField="Jenis_Barang" HeaderText="Jenis Barang" ItemStyle-HorizontalAlign="Center" SortExpression="Jenis_Barang"> </asp:BoundField>
