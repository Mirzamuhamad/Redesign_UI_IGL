    ...
    <asp:Panel runat="server" id="PnlHd"> 
      <table>
        <tr>
            ...
            <td>
                <asp:LinkButton CssClass="Advence-search" ID="LbAdvSearch" runat="server" Text="Advanced Search" />
            </td>
        </tr>
      </table>
      ...
      <table>
        ...
        <tr>
         ...
         <td> 
          ...
          <br />
          <br>
          <div style="margin-left: 5px; border:0px  solid; width:100%; height:100%; overflow:auto;">
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Status" ItemStyle-HorizontalAlign="center" HeaderText="Status" SortExpression="Status"></asp:BoundField>                  
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <asp:DropDownList ID="ddlDivision" Enabled="False" autocomplete="off" runat="server" CssClass="DropDownList" 
                      ValidationGroup="Input" AutoPostBack="True">
                  </asp:DropDownList>
              </td>
        ...
        <tr>
              ...
              <td>:</td>
              <td>
                  <%--<asp:TextBox ID="tbScan" onkeydown="return true;" onpaste="return False;" autoPostback="true" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" Width="250px" />--%>
					  
					  <asp:TextBox ID="tbScan" AutoPostBack="true" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" Width="250px" />
              </td>
                            ...
                            <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Action" >
                                        <ItemTemplate>
                                        <asp:Button class="bitbtn btnedit" runat="server" Visible="False" ID="btnEdit" Text="Edit" CommandName="Edit" />																						 											
                                    ...
                                    <asp:BoundField DataField="WorkBy" HeaderStyle-Width="100px" HeaderText="TK Panen" SortExpression="WorkBy" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left"></asp:BoundField>
									...
									<asp:BoundField DataField="Manual_Input" HeaderStyle-Width="80px" HeaderText="Manul Input" ></asp:BoundField>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            :</td>
                                        <td>
											<asp:DropDownList ID="ddlTphDt" runat="server" CssClass="DropDownList" 
                                                Width="100px">
                                            </asp:DropDownList>
											<asp:Label ID="Label4" runat="server" ForeColor="Red">*</asp:Label>
                                            <asp:TextBox ID="tbTPH" runat="server" CssClass="TextBox" visible="false"  Width="180px" MaxLength="60" />
                        ...
                        <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                            <asp:GridView ID="GridDt2" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:Button class="bitbtn btnedit" Visible="False" runat="server" ID="btnEdit2" Text="Edit" CommandName="Edit" />																						 											
                                            <asp:Button class="bitbtn btndelete" headerStyle-HorizontalAlign="left" FooterStyle-HorizontalAlign="left" runat="server" ID="btnDelete2" Text="Delete" CommandName="Delete"  OnClientClick="return confirm('Sure to delete this data?');" />																						 													     
                                        </ItemTemplate>
                                        <EditItemTemplate>
									...
									<asp:BoundField DataField="Manual_Input" HeaderStyle-Width="80px" HeaderText="Manual Input" ></asp:BoundField>
									<asp:BoundField DataField="Remark" HeaderStyle-Width="80px" HeaderText="Remark" ></asp:BoundField>
                                </Columns>
                            </asp:GridView>
                            </div>   
                          ...
                          <td style="width:60%">                
                              <table>
                                  ...
                                  <tr>
									...
									<%--<asp:DropDownList ID="ddlTphDt2" runat="server" CssClass="DropDownList" 
                                                Width="200px">
                                            </asp:DropDownList> --%>
      ...
      <br />      
       ...
       <asp:Button ID="btnSaveAll" runat="server" class="bitbtndt btnsavenew" Text="Save & New" validationgroup="Input"/>									
