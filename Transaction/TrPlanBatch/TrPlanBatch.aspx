<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrPlanBatch.aspx.vb" Inherits="Transaction_TrPlanBatch" %>
...
<body>     
    <form id="form1" runat="server">
     <div class="Content">
    <div class="H1">Perawatan Planning</div>
     <hr style="color:Blue" />        
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="StartDate" HtmlEncode="true" DataFormatString="{0:dd MMM yyyy}" HeaderText="Start Date" SortExpression="StartDate"></asp:BoundField>           
                  ...
                  <asp:BoundField DataField="TargetRange"  HeaderText="Target Range" sortExpression="TargetRange">
                      <HeaderStyle Width="100px" />
                  </asp:BoundField>
                  
                  <asp:BoundField DataField="QtyBatch" HeaderText="Qty" DataFormatString="{0:#,##0.##}" HeaderStyle-Width="100px" SortExpression="Qty" >
                       <HeaderStyle Width="100px" />
        ...
        <%--<tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td >
                  <asp:TextBox ID="tbBatchNo" runat="server" AutoPostBack="true" CssClass="TextBox" 
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Division&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;
                  <asp:TextBox ID="tbDivisiName" runat="server" CssClass="TextBox" 
                       Width="172px" Enabled ="false"  />
                  <asp:TextBox ID="tbDivisi" Visible="false" runat="server" CssClass="TextBox" Enabled="false" 
                      Width="42px" />
              </td>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td>
                  <BDP:BasicDatePicker ID="tbStartDateHd" runat="server" AutoPostBack="True" 
                      ...
                      TextBoxStyle-CssClass="TextDate" ValidationGroup="Input" Enabled ="false">
                      <TextBoxStyle CssClass="TextDate" />
                  </BDP:BasicDatePicker>
                  <asp:Label ID="Label14" runat="server" ForeColor="Red" Text="*" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Schedule Type&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; :&nbsp;
                  <asp:DropDownList ID="ddlSchedule" runat="server" 
                      CssClass="TextBox" Height="20px" ValidationGroup="Input" Width="103px" />
              </td>
          </tr>
          <tr>
              <td>
              ...
              <td>
                  :</td> 
              <td>
                  <asp:TextBox ID="tbQtyTanam"  ValidationGroup="Input" runat="server" CssClass="TextBox"
                      Width="113px" />
                  &nbsp;<asp:Label ID="Label15" runat="server" ForeColor="Red" Text="*" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Valid From Week&nbsp;&nbsp;:&nbsp;
                  <asp:TextBox ID="tbStartWeek" runat="server" CssClass="TextBox" 
                      ValidationGroup="Input" Width="99px" />
              </td>
          </tr>
        <tr>
              <td>Remark</td>
                ...
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="JobName" HeaderText="Job Name" HeaderStyle-Width="100px" SortExpression="BlocakName" >
                         ...
                         <asp:BoundField DataField="JobGroupPlantName" HeaderStyle-Width="100px" HeaderText="Status Tanam" SortExpression="StatusTanam" >
                            <HeaderStyle Width="100px" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField 
                            DataField="Team" HeaderText="Team" HeaderStyle-Width="200px"  SortExpression="Team" 
                            ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" >
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField 
                            DataField="TeamName" HeaderText="TeamName" HeaderStyle-Width="200px"  SortExpression="Team" 
                            ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" >
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        
                        <%--<asp:BoundField DataField="Week" HeaderText="Week" HeaderStyle-Width="100px" SortExpression="Week" >
                            <HeaderStyle Width="200px" />
                        </asp:BoundField>--%>
                ...
                <td style="width:60%">                
                    <table>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="tbStatusTanam" runat="server" AutoPostBack="true" 
                        ...
                        <tr>
                            ...
                            <td class="style1">
                                <asp:TextBox ID="tbJob" runat="server" AutoPostBack="true" 
                                    CssClass="TextBox" ValidationGroup="Input" Width="106px" />
                            </td>
                        </tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTeam" runat="server" CssClass="TextBox" 
                                ValidationGroup="Input" Width="219px" AutoPostBack = "True" Height="18px" />
