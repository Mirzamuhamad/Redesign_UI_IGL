    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            Else
                ...
                ", Technician2 = " + QuotedStr(tbTechnician2.Text) + ", Manhour2 = " + QuotedStr(tbManhour2.Text.Replace(",", "")) + _
                ", Technician3 = " + QuotedStr(tbTechnician3.Text) + ", Manhour3 = " + QuotedStr(tbManhour3.Text.Replace(",", "")) + _
                ", RemarkJournal = " + QuotedStr(tbRemarkJournal.Text) + ", UserPrep= " + QuotedStr(ViewState("UserId").ToString) + ", DatePrep = GetDate()" + _
