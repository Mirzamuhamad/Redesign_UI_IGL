...
Partial Class TrQCProduction
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    'Protected GetStringHd As String = "Select * From V_QCProductionHd WHERE UserId = " + QuotedStr(ViewState("UserId").ToString)

    Private Function GetStringHd() As String
        Return "Select DISTINCT   TransNmbr, Nmbr, TransDate, Status, QCType, WorkCtr, WorkCtrName, ProductionDate, Shift, ShiftName, InspectionDate, InspectedBy, Remark From V_QCProductionHd "
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Session("Result") Is Nothing Then
                If ViewState("Sender") = "btnLHP" Then
                    ...
                    For Each drResult In Session("Result").Rows
                        ...
                        If Row.Count = 0 Then
                            If FirstTime = True Then
                                tbProductionDate.SelectedDate = drResult("ProductionDate")
                                ddlShift.SelectedValue = drResult("Shift")
                                FirstTime = False
                            End If
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_QCProductionDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    Private Function GetStringDtPartial(ByVal Nmbr As String) As String
        Return "SELECT * From V_QCProductionDt2 WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    ...
                    ElseIf ActionValue = "Post" Then
                        Result = ExecSPCommandGo(ActionValue, "S_QCProduction", Nmbr(j), CInt(ViewState("GLYear")), CInt(ViewState("GLPeriod")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
    ...
    Private Sub EnableHd(ByVal State As Boolean)
        Try
            ...
            tbProductionDate.Enabled = State
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbTransNo.Text = GetAutoNmbr("QCPD", "N", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)
                ...
                SQLString = "INSERT INTO QCProductionHd (TransNmbr, STATUS, Transdate, QCType, WorkCtr, ProductionDate, Shift, InspectionDate, InspectedBy, Remark, UserPrep, DatePrep) " + _
                "SELECT '" + tbTransNo.Text + "', 'H', '" + Format(tbDate.SelectedValue, "yyyy-MM-dd") + "', " + QuotedStr(ddlQCType.SelectedValue) + ", " + QuotedStr(ddlWorkCtr.SelectedValue) + ", '" + Format(tbProductionDate.SelectedValue, "yyyy-MM-dd") + "', " + QuotedStr(ddlShift.SelectedValue) + ", '" + Format(tbInspectionDate.SelectedValue, "yyyy-MM-dd") + "', " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM QCProductionHd WHERE TransNmbr = " + QuotedStr(tbTransNo.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE QCProductionHd SET Transdate = '" + Format(tbDate.SelectedValue, "yyyy-MM-dd") + "', QCType = " + QuotedStr(ddlQCType.SelectedValue) + ", WorkCtr = " + QuotedStr(ddlWorkCtr.SelectedValue) + ", Shift = " + QuotedStr(ddlShift.SelectedValue) + ", InspectedBy = " + QuotedStr(tbInspectedBy.Text) + _
                ", ProductionDate = '" + Format(tbProductionDate.SelectedValue, "yyyy-MM-dd") + "', InspectionDate = '" + Format(tbInspectionDate.SelectedValue, "yyyy-MM-dd") + "',  Remark = " + QuotedStr(tbRemark.Text) + ", DatePrep = getDate()" + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT  TransNmbr, LHPNo, WONo, Product, Qty, SamplingSize, QtySS, Unit, Warehouse, Location, QCStatus, Remark FROM QCProductionDt WHERE TransNmbr = '" & ViewState("Reference") & "'", con)
            ...
            Dim Dt As New DataTable("QCProductionDt")
            ...
            If Not ViewState("Dt2") Is Nothing Then
                SqlString2 = " SELECT  TransNmbr, LHPNo, WONo, ItemNo, Defect, KoefAQL, AcceptReject, QtyReject, Remark FROM QCProductionDt2 WHERE TransNmbr = " + QuotedStr(ViewState("Reference"))
                ...
                Dim DtPartial As New DataTable("QCProductionDt2")
    ...
    Private Sub ClearHd()
        Try
            ...
            tbProductionDate.SelectedDate = ViewState("ServerDate")
    ...
    Function CekHd() As Boolean
        Try
            ...
            If ddlWorkCtr.SelectedValue = "" Then
                ...
                Return False
            End If
            If tbProductionDate.SelectedDate = Nothing Then
                lbStatus.Text = MessageDlg("Production Date must have value")
                tbProductionDate.Focus()
                Return False
            End If
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            ...
            BindToDate(tbInspectionDate, Dt.Rows(0)("InspectionDate").ToString)
    ...
    Protected Sub btnProd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnProd.Click
        ...
        Try
            Session("filter") = "Select LHP_No, WO_No, Product, Product_Name, Specification, Warehouse, Warehouse_Name, Location, Location_Name, Qty, Unit from V_QCProductionReff WHERE WorkCtr = " + QuotedStr(ddlWorkCtr.SelectedValue) + " and ProductionDate = '" + Format(tbProductionDate.SelectedValue, "yyyy-MM-dd") + "' and Shift = " + QuotedStr(ddlShift.SelectedValue)
    ...
    Protected Sub btnGetData_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGetData.Click
        ...
        Try
            ...
            If ddlWorkCtr.SelectedValue = "" Then
                ...
                Exit Sub
            End If
            If tbProductionDate.Enabled = False Then
                Session("filter") = "Select LHP_No, ProductionDate, Shift, WO_No, Product, Product_Name, Specification, Warehouse, Warehouse_Name, Location, Location_Name, Qty, Unit from V_QCProductionReff WHERE WorkCtr = " + QuotedStr(ddlWorkCtr.SelectedValue) + " and ProductionDate = '" + Format(tbProductionDate.SelectedValue, "yyyy-MM-dd") + "' and Shift = " + QuotedStr(ddlShift.SelectedValue)
            Else
                Session("filter") = "Select LHP_No, ProductionDate, Shift, WO_No, Product, Product_Name, Specification, Warehouse, Warehouse_Name, Location, Location_Name, Qty, Unit from V_QCProductionReff WHERE WorkCtr = " + QuotedStr(ddlWorkCtr.SelectedValue)
            End If
            ResultField = "ProductionDate, Shift, LHP_No, WO_No, Product, Product_Name, Specification, Warehouse, Warehouse_Name, Location, Location_Name, Qty, Unit"
