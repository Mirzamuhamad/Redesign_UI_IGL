<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrTrainResult.aspx.vb" Inherits="Transaction_TrTrainResult_TrTrainResult" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Training Result</div>
     <hr style="color:Blue" />        
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >     
                    ...
                    <asp:ListItem Value="PlanNo">Planning No</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px" SortExpression="Nmbr" HeaderText="Result No"></asp:BoundField>                  
                  <asp:BoundField DataField="Status" SortExpression="Status" HeaderText="Status"></asp:BoundField>                  
                  <asp:BoundField DataField="TransDate" dataformatstring="{0:dd MMM yyyy}" htmlencode="true" HeaderStyle-Width="80px" SortExpression="TransDate" HeaderText="Result Date"></asp:BoundField>
                  <asp:BoundField DataField="PlanNo" HeaderStyle-Width="120px" SortExpression="PlanNo" HeaderText="Palnning No"></asp:BoundField>
                  ...
                  <asp:BoundField DataField="FgSertifikat" HeaderStyle-Width="80px" SortExpression="FgSertifikat" HeaderText="Certification"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table style="width: 677px">
        ...
        <tr>
            <td>Planning No</td>
            <td>:</td>
            <td><asp:TextBox ID="tbPlanningNo" runat="server" AutoPostBack="True" CssClass="TextBoxR" MaxLength="20" ValidationGroup="Input" Width="137px" />
                <asp:Button ID="btnPlan" runat="server" class="btngo" Text="..." ValidationGroup="Input" />
            </td>
            <td colspan="2">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td>Organization</td>
            <td>:</td>
            <td><asp:DropDownList ID="ddlDepartment" runat="server" CssClass="DropDownList" 
                    Enabled="False" />
            </td>
            <td colspan="2">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
            <td>Training Yearly</td>
            <td>:</td>
            <td><asp:DropDownList runat="server" ID="ddlFgSchedule" 
                    CssClass="DropDownList" AutoPostBack="True" Enabled="False">
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan="6">
                <asp:TextBox ID="tbCourseTitle" runat="server" CssClass="TextBoxR" 
        ...
        <tr>
            <td>Training Type</td>
            <td>:</td>
            <td><asp:DropDownList ID="ddlTraining" runat="server" CssClass="DropDownList" 
                    Enabled="False" />
            </td>
            <td>Training Place</td>
            <td colspan="2">:</td>
            <td colspan="2"><asp:DropDownList ID="ddlTrainingPlace" runat="server" 
          ...
          <tr>
              ...
              <td>:</td>
              <td colspan="6"><asp:TextBox ID="tbTrainingLocation" runat="server" 
                      CssClass="TextBoxR" MaxLength="60" ValidationGroup="Input" Width="225px" />
              </td>
          </tr>
          <tr>
              <td>Sasaran</td>
              <td>:</td>
              <td colspan="6"><asp:TextBox ID="tbSasaran" runat="server" CssClass="TextBoxR" 
                      MaxLength="255" ValidationGroup="Input" Width="488px" />
              </td>
          </tr>
          <tr>
              <td>Materi</td>
              <td>:</td>
              <td colspan="6"><asp:TextBox ID="tbMateri" runat="server" CssClass="TextBoxR" 
                      MaxLength="255" ValidationGroup="Input" Width="488px" />
              </td>
          </tr>
          <tr>
          ...
          <tr>
              <td>Instructor</td>
              <td>:</td>
              <td colspan="6"><asp:TextBox ID="tbInstructor" runat="server" CssClass="TextBox" MaxLength="60" ValidationGroup="Input" Width="308px" />
              </td>
          </tr>
          <tr>
              <td>Start Date</td>
              ...
              <td>End Date</td>
              <td colspan="2">:</td>
              <td colspan="2"><BDP:BasicDatePicker ID="tbEndDate" runat="server" ButtonImageHeight="19px" 
                      ButtonImageWidth="20px" DateFormat="dd MMM yyyy" DisplayType="TextBoxAndImage" 
                      ReadOnly="true" ShowNoneButton="False" TextBoxStyle-CssClass="TextDate" 
                      ValidationGroup="Input"><TextBoxStyle CssClass="TextDate" /></BDP:BasicDatePicker>
              </td>
          ...
          <tr>
              ...
              <td>Certification</td>
              <td colspan="2">:</td>
              <td colspan="2"><asp:DropDownList ID="ddlFgSertifikat" runat="server" 
          ...
          <tr>
              <td>Qty Participant</td>
              <td>:</td>
              <td colspan="6"><asp:TextBox ID="tbQty" runat="server" CssClass="TextBoxR" MaxLength="60" ValidationGroup="Input" Width="57px" />
              </td>
          </tr>
          <tr>
              <td>Remark</td>
              ...
              <td style="margin-left: 80px">
                  <asp:TextBox ID="tbRemark" runat="server" CssClass="TextBox" MaxLength="255" 
                      ValidationGroup="Input" Width="308px" />
              </td>
          </tr>
      </table>  
      ...
      <hr style="color:Blue" />  
                ...
                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Job_Title_Name" HeaderText="Job Title" />
                            <asp:BoundField DataField="FgTraining" HeaderText="Status Hadir" />                            
                            <asp:BoundField DataField="CertificationNo" HeaderText="Certification No" />
              ...
              <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                <table style="width: 681px">    
                    ...
                    <tr>
                        <td>Sertificate No</td>
                        <td>:</td>
                        <td><asp:TextBox ID="tbSertificate" runat="server" CssClass="TextBox" 
                                MaxLength="30" ValidationGroup="Input" Width="128px" />
                        </td>
                    </tr>       
                    <tr>
                        <td>Conclusion</td>
                        <td>:</td>
                        <td><asp:TextBox ID="tbConclusion" runat="server" CssClass="TextBox" MaxLength="255" ValidationGroup="Input" Width="445px" />
                        </td>
                    </tr>
                    <tr>
                        <td>Suggestion</td>
                        <td>:</td>
                        <td><asp:TextBox ID="tbSuggestion" runat="server" CssClass="TextBox" MaxLength="255" ValidationGroup="Input" Width="445px" />
                        </td>
                    </tr>
                </table>
                <br />           
