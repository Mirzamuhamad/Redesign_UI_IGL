...
Partial Class SuppInv
    ...
    Protected Sub btnGetData_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGetData.Click
        ...
        Try
            ...
            ResultField = "RR_Type, RR_No,IKP, RR_Date, Report, Supplier_Code, Supplier_Name, Attn, PO_No, Term, Currency, Product_Code, Product_Name, Cost_Ctr, Qty_Order, Unit_Order, Qty, Unit, Price_Forex, Bruto_Forex, Disc, Disc_Forex, PPn, PPn_Forex, PPh, PPh_Forex, Netto_Forex, FgPriceIncludePPN, RemarkHd"
            CriteriaField = "RR_Type, RR_No,IKP, RR_Date, Report, Supplier_Code, Supplier_Name,	Attn,	PO_No,	Term, Currency, Supplier_SJ_No,	Supplier_SJ_Date "

            Session("Column") = ResultField.Split(",")
            Session("CriteriaField") = CriteriaField.Split(",")
            ResultSame = "IKP,RR_Date"
