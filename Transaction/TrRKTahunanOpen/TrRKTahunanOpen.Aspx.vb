...
Partial Class Transaction_TrRKTahunanOpen_TrRKTahunanOpen
    ...
    Sub BindData()
        ...
        Try
            ...
            If StrFilter.Length > 5 Then
                ...
                tempDS = SQLExecuteQuery("EXEC S_PLPlanOutstandingOpen " + QuotedStr(StrFilter), ViewState("DBConnection").ToString)
            Else
                tempDS = SQLExecuteQuery("EXEC S_PLPlanOutstandingOpen " + QuotedStr(StrFilter1), ViewState("DBConnection").ToString)
            End If
    ...
    Private Sub bindDataProcess()
        Try
            ...
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "DECLARE @A VARCHAR(255) EXEC S_PLPlanOutOpen " + QuotedStr(lbType.Text) + _
