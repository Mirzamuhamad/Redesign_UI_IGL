<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrBeginSPK.aspx.vb" Inherits="BeginSPK" %>
...
<head runat="server">
    <title>Saldo Awal Surat Perintah Kerja</title>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Saldo Awal Surat Perintah Kerja</div>
     <hr />        
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="AreaName" HeaderStyle-Width="100px" SortExpression="Lokasi" HeaderText="Lokasi"></asp:BoundField>
                  ...
                  <asp:BoundField DataField="TotalAmount" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="80px" SortExpression="TotalAmount" HeaderText="Total Sisa Biaya"></asp:BoundField>
                  <asp:BoundField DataField="OriginalAmount" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="80px" SortExpression="TotalAmount" HeaderText="Original Amount"></asp:BoundField>
                  <asp:BoundField DataField="Alloc_Amount" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="80px" SortExpression="TotalAmount" HeaderText="Unallocated Amount"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
             ...
             <td>No Penawaran</td>
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbPenawaranNo" Enabled = "true" CssClass="TextBox" Width="225px"/>
      <%--      <asp:Button Class="btngo" ID="btnPenawaran" Text="..." Visible = "false" runat="server" ValidationGroup="Input" /></td>
            --%>
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbSuppCode" Visible="false" Width="100px" AutoPostBack="true" />
                <asp:TextBox CssClass="TextBox" runat="server" ID="tbSuppName" Enabled="false" Width="192px"/>
                <%--<asp:TextBox CssClass="TextBox" runat="server" ID="tbSuppType" Visible="false" Enabled="false" Width="190px"/>--%>
                <asp:Button Class="btngo" ID="btnSupp" Text="v" runat="server" ValidationGroup="Input" />                                  
            </td>
             <td>Durasi</td>
            <td>:</td>
                            ...
                            <td colspan="7">
                                <table>
                                    <tr style="background-color:Silver;text-align:center; border-radius:30px;">
                                        <td>Total Sisa Biaya</td>                                        
                                        <td>Ppn</td>
                                        <td>Ppn Value</td>
                                        <td>Pph</td>
                                        <td>Pph Value</td>
                                        <td>Total Sisa Amount</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="tbPph"  ValidationGroup="Input" runat="server" Enabled = "True" CssClass="TextBox" Width="50px"/></td>
                                         ...
                                         <td><asp:TextBox ID="tbTotalAmount"  ValidationGroup="Input" runat="server" Enabled = "false" CssClass="TextBox" Width="120px"/></td> 
                                          <td><asp:TextBox ID="tbUnallocatedAmount"  ValidationGroup="Input" runat="server" Enabled = "True" CssClass="TextBox" Width="120px"/></td>                          
                                    </tr>
                                </table>
                            </td>                
                    </tr>
      <tr>
            ...
            <td>:</td>
            <td><asp:TextBox runat="server" ValidationGroup="Input" ID="tbOriginalAmount" CssClass="TextBox" Width="225px" Enabled= "false"/></td>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <asp:BoundField DataField="Biaya"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="90px" DataFormatString="{0:#,##0.00}" HeaderText="Estimasi Biaya" />
                             <asp:BoundField DataField="BAPAwal"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="70px" DataFormatString="{0:#,##0.00}" HeaderText="BAP Awal(%)" />
                            <asp:BoundField DataField="BAPAwalValue"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="90px" DataFormatString="{0:#,##0.00}" HeaderText="BAP Awal Value(Rp)" />
                            <asp:BoundField DataField="SisaBiaya"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-Width="90px" DataFormatString="{0:#,##0.00}" HeaderText="Sisa Biaya" />
            ...
            <table>                                
                ...
                <tr>
                    ...
                    <tr>                    
                        ...
                        <td>:</td>
                        <td>                             
                            <asp:TextBox CssClass="TextBox" runat="server" ID="tbUraian" Enabled="true" Width="500px"/>                                          
                        </td>
                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="tbBiaya"  ValidationGroup="Input" runat="server"  CssClass="TextBox" Width="120px"/></td>
                                         <td><asp:TextBox ID="tbBAP"  ValidationGroup="Input" runat="server"  CssClass="TextBox" Width="120px"/></td>
                                          <td><asp:TextBox ID="tbBAPValue"  ValidationGroup="Input" runat="server"  CssClass="TextBox" Width="120px"/></td>
                                           <td><asp:TextBox ID="tbSisaBiaya"  ValidationGroup="Input" runat="server"  CssClass="TextBox" Width="120px"/></td>                          
                                    </tr>
                                </table>
                            </td>                
                    </tr> 
