            ...
            <%@ Register
                ...
                <head runat="server">
                    ...
                    <script type="text/javascript">
                        ...
                        function OpenPopupRev() {
                            var left = (screen.width - 600) / 2; //370
                            var top = (screen.height - 600) / 2;
                            window.open("../../ViewDlgData.Aspx", "", 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, copyhistory=no, width=' + 600 + ', height=' + 600 + ', top=' + top + ', left=' + left);
                            return false;
                        }
                        ...
                        function setformatfordt(prmchange) {
                            try {
                                ...
                                if (pph == '') {
                                    document.getElementById("tbpph").value = 0
                                }
                                ...
                                if (pph == 0) {
                                    ...
                                    document.getElementById("tbPphValue").value = parseFloat(document.getElementById("tbPphValue").value.replace(/\$|\,/g, ""))
                    ...
                    <form id="form1" runat="server">
                        <div class="Content">
                            ...
                            <asp:Panel runat="server" id="PnlHd">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlField2" runat="server" CssClass="DropDownList">
                                                    <asp:ListItem Selected="True" Value="TransNmbr">Reference
                                                    </asp:ListItem>
                                                    <asp:ListItem>Status</asp:ListItem>
                                                    <asp:ListItem Value="dbo.FormatDate(TransDate)">Date</asp:ListItem>
                                                    <asp:ListItem Value="TransNmbr" Selected="True">Reference
                                                    </asp:ListItem>
                                                    <asp:ListItem>Status</asp:ListItem>
                                                    <asp:ListItem Value="dbo.FormatDate(TransDate)">Date</asp:ListItem>
                                                    <asp:ListItem Value="SuppCode">Supplier</asp:ListItem>
                                ...
                                &nbsp;
                                <asp:DropDownList CssClass="DropDownList" ID="ddlCommand" runat="server"
                                    Visible="false" />
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="110">
                                                <ItemTemplate>
                                                    <asp:DropDownList CssClass="DropDownList" ID="ddl" runat="server">
                                                        ...
                                                        <asp:ListItem Text="View Dokumen Pendukung" />
                                                    </asp:DropDownList>
                                            ...
                                            <asp:BoundField DataField="TransNmbr" HeaderStyle-Width="120px"
                                                SortExpression="Nmbr" HeaderText="Reference"></asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="Checker">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblfgChecker" runat="server"
                                                        Text='<%# Eval("fgChecker") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="SuppName" HeaderStyle-Width="150px"
                                                SortExpression="SuppName" HeaderText="Supplier"></asp:BoundField>
                                            <asp:BoundField DataField="Attn" HeaderStyle-Width="100px"
                                                SortExpression="Attn" HeaderText="Attn"></asp:BoundField>
                                            <asp:BoundField DataField="InvoiceType" HeaderStyle-Width="120px"
                                                SortExpression="InvoiceType" HeaderText="Invoice Type"></asp:BoundField>

                                            <asp:BoundField DataField="BankPenerima" HeaderStyle-Width="150px"
                                                SortExpression="BankPenerima" HeaderText="Bank Penerima">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NamaPenerima" HeaderStyle-Width="100px"
                                                SortExpression="NamaPenerima" HeaderText="Nama Penerima">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AccNmbr" HeaderStyle-Width="120px"
                                                SortExpression="AccNmbr" HeaderText="Account"></asp:BoundField>

                                            <asp:BoundField DataField="TotalInvoice" DataFormatString="{0:#,##0.00}"
                                                ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px"
                                                SortExpression="TotalInvoice" HeaderText="Total Invoice">
                                            </asp:BoundField>

                                            <asp:BoundField DataField="Remark" HeaderStyle-Width="120px"
                                                SortExpression="Remark" HeaderText="Remark"></asp:BoundField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                                <br />
                            ...
                            <asp:Panel runat="server" ID="pnlInput" Visible="false">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Menu ID="Menu2" runat="server" CssClass="Menu" ItemWrap="False"
                                                ...
                                                <StaticMenuItemStyle CssClass="MenuItem" />
                                                <Items>
                                                    <asp:MenuItem Text="Form Input Voucher" Value="0"></asp:MenuItem>
                                                    <asp:MenuItem Text="Upload Dokumen Pendukung" Value="1">
                                                    </asp:MenuItem>
                                                </Items>
                                            </asp:Menu>
                                        ...
                                        <td>
                                            <asp:Button class="bitbtndt btnback" Visible="false" runat="server"
                                                ID="btnGoEdit" Text="Back" />
                                        </td>
                                        <td style="position: fixed; right: 10px; top: 4px; z-index: 1000;">
                                            <asp:Button ID="btnGeapprPost" runat="server" Width="100"
                                                class="bitbtndt btnsave" Text="Get Approval" validationgroup="Input"
                                                Visible="false" />
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <asp:View ID="TabHd0" runat="server">
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox CssClass="TextBoxR" runat="server" ID="tbRef"
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <BDP:BasicDatePicker ID="tbPerkiraanBayar" runat="server"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lblExpense" Visible="True"
                                                        ValidationGroup="Input" runat="server" Text="Expense Type" />
                                                </td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbExpense"
                                                        CssClass="TextBox" Visible="false" Width="225px" />
                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                        ID="tbExpenseName" CssClass="TextBox" Enabled="false"
                                                        Width="192px" />
                                                    <asp:Button ID="btnExpense" runat="server" Class="btngo"
                                                        visible=True Text="v" />

                                                    <asp:DropDownList ID="ddlExpenseType" ValidationGroup="Input"
                                                        Width="230px" Visible="false" runat="server"
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="ddlInvoiceType" ValidationGroup="Input"
                                                        Width="230px" AutoPostBack="true" runat="server"
                                                        CssClass="DropDownList">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                        ID="tbBankPenerima" CssClass="TextBox" Width="225px" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:LinkButton ID="lbSupp" Visible="True" ValidationGroup="Input"
                                                        runat="server" Text="Supplier" />
                                                </td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox CssClass="TextBox" ValidationGroup="Input"
                                                        runat="server" ID="tbSuppCode" Width="100px"
                                                        AutoPostBack="true" />
                                                    <asp:TextBox CssClass="TextBox" runat="server" ID="tbSuppName"
                                                        Enabled="false" Width="190px" />
                                                    <asp:TextBox CssClass="TextBox" runat="server" ID="tbSuppType"
                                                        Visible="false" Enabled="false" Width="190px" />
                                                    <asp:Button Class="btngo" ID="btnSupp" Text="..." runat="server"
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                        ID="tbNamaPenerima" CssClass="TextBox" Width="225px" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbAttn"
                                                        CssClass="TextBox" Width="225px" />
                                                    <asp:Button class="bitbtn btnsearch" runat="server" ID="btnGetInv"
                                                        Text="Get Invoice" />
                                                </td>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbAccount"
                                                        CssClass="TextBox" Width="225px" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="7">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="TbTotalInvoiceHd"
                                                                    ValidationGroup="Input" runat="server"
                                                                    Enabled="False" CssClass="TextBox" width="120px" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="tbTotalPotongan"
                                                                    ValidationGroup="Input" runat="server"
                                                                    Enabled="false" CssClass="TextBox" width="120px" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="tbTotalDpp" ValidationGroup="Input"
                                                                    runat="server" Enabled="false" CssClass="TextBox"
                                                                    width="120px" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="TbtotalPPN" ValidationGroup="Input"
                                                                    runat="server" Enabled="false" CssClass="TextBox"
                                                                    Width="120px" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="TbTotalPPH" ValidationGroup="Input"
                                                                    runat="server" Enabled="false" CssClass="TextBox"
                                                                    Width="120px" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="tbTotalInvoice" ValidationGroup="Input"
                                                                    runat="server" Enabled="false" CssClass="TextBox"
                                                                    Width="120px" />
                                                            </td>
                                                        </tr>
                                            ...
                                            <%--<tr>
                                                <td>
                                                    <asp:LinkButton ID="lbTerm" ValidationGroup="Input" runat="server"
                                                        Text="Term" />
                                                </td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList CssClass="DropDownList" ValidationGroup="Input"
                                                        runat="server" ID="ddlTerm" AutoPostBack="true" />
                                                    <BDP:BasicDatePicker ID="tbDueDate" runat="server"
                                                        DateFormat="dd MMM yyyy" ReadOnly="true" Enabled="false"
                                                        ButtonImageHeight="19px" ButtonImageWidth="20px"
                                                ...
                                                <%-- <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" ValidationGroup="Input"
                                                            ID="tbSuppInvNo" CssClass="TextBox" Width="150px" />
                                                        <BDP:BasicDatePicker ID="tbSuppInvDate" runat="server"
                                                    ...
                                                    <%--<tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox runat="server"
                                                                            ValidationGroup="Input" ID="tbPPnNo"
                                                                            CssClass="TextBox" Width="150px" />
                                                                    </td>
                                                                    <td>
                                                                        <BDP:BasicDatePicker ID="tbPPndate"
                                                                            runat="server" DateFormat="dd MMM yyyy"
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox runat="server"
                                                                            ValidationGroup="Input" ID="tbPpnRate"
                                                                            CssClass="TextBox" Width="68px" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <%--<tr>
                                                            <td>
                                                                <asp:LinkButton ID="lbCurr" ValidationGroup="Input"
                                                                    runat="server" Text="Currency" />
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlCurr" ValidationGroup="Input"
                                                                    AutoPostBack="true" runat="server"
                                                                    CssClass="DropDownList" />
                                                                &nbsp Rate : &nbsp
                                                                <asp:TextBox ID="tbRate" ValidationGroup="Input"
                                                                    runat="server" CssClass="TextBox" Width="68px" />
                                                            </td>
                                                            </tr> --%>
                                                            <%-- <tr>
                                                                <td>Total</td>
                                                                ...
                                                                <td colspan="6">
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="tbBaseForex"
                                                                                    runat="server" CssClass="TextBoxR"
                                                                                    Width="90px" />
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="tbDisc" runat="server"
                                                                                    CssClass="TextBox" width="40px"
                                                                                    ValidationGroup="Input" />
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="tbDiscForex"
                                                                                    ValidationGroup="Input"
                                                                                    runat="server" CssClass="TextBox"
                                                                                    Width="90px" />
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="tbPPN"
                                                                                    ValidationGroup="Input"
                                                                                    runat="server" CssClass="TextBox"
                                                                                    width="40px" />
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="tbPPNForex"
                                                                                    runat="server" CssClass="TextBoxR"
                                                                                    Width="90px" />
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="tbTotalForex"
                                                                                    runat="server" CssClass="TextBoxR"
                                                                                    Width="90px" />
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox runat="server"
                                                                            ValidationGroup="Input" ID="tbRemark"
                                                                            CssClass="TextBoxMulti" Width="330px"
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox runat="server"
                                                                            ValidationGroup="Input" ID="tbRemarkRevisi"
                                                                            CssClass="TextBoxMulti" Width="335px"
                                                                            TextMode="MultiLine" MaxLength="255" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button class="bitbtn btnsave"
                                                                            runat="server" ID="btnRevisi"
                                                                            Text="Revisi" />
                                                                        <asp:Button ID="btnViewallrevisi" runat="server"
                                                                            Width="110" class="bitbtndt btnsearch"
                                                                            Text="View Revisi Info"
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Button ID="btnsaveINV" CssClass="bitbtndt btnadd"
                                                            runat="server" Text="View" Style="display: none" />
                                                    </td>
                                                    <td>
                                                        <asp:LinkButton ID="lbDokInv" ValidationGroup="Input"
                                                            runat="server" Text="Not Yet Uploaded - Max File 10 Mb" />
                                                    </td>
                                                </tr>
                                            </table>
                                            <br />
                                ...
                                <asp:Menu ID="Menu1" runat="server" CssClass="Menu"
                                    StaticMenuItemStyle-CssClass="MenuItem" StaticSelectedStyle-CssClass="MenuSelect"
                                    Orientation="Horizontal" ItemWrap="False" StaticEnableDefaultPopOutImage="False">
                                    <Items>
                                        ...
                                        <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Action">
                                                    ...
                                                    <%--<FooterTemplate>
                                                        <asp:ImageButton ID="btnAddDt2" ValidationGroup="Input"
                                                            runat="server" ImageUrl="../../Image/btnAddDtOn.png"
                                                ...
                                                <asp:BoundField DataField="InvoiceDate"
                                                    ...
                                                    HeaderStyle-Width="80px" SortExpression="InvoiceDate"
                                                    HeaderText="Invoice Date"></asp:BoundField>

                                                <asp:BoundField DataField="PONo" HeaderStyle-Width="180px"
                                                    HeaderText="Reference No" />
                                                <asp:BoundField DataField="Invoice" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="Invoice" />
                                                <asp:BoundField DataField="Potongan" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="Potongan" />
                                                <asp:BoundField DataField="Dpp" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="DPP" />
                                                <asp:BoundField DataField="PPn" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="PPn (%)" />
                                                <asp:BoundField DataField="PPNInvoice" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="PPN Value" />
                                                <asp:BoundField DataField="PPh" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="PPh (%)" />
                                                <asp:BoundField DataField="PPHInvoice" ItemStyle-HorizontalAlign="Right"
                                                    HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                                                    HeaderText="PPH Value" />
                                                <asp:BoundField DataField="TotalAmount"
                                                    ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px"
                                                    DataFormatString="{0:#,##0.00}" HeaderText="Total Amount" />
                                ...
                                <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:Label ID="lbItemNo" runat="server" Text="Item" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox CssClass="TextBox" runat="server" ID="tbInvoiceNo"
                                                    Enabled="true" Width="225px" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <BDP:BasicDatePicker ID="tbInvoiceDate" runat="server"
                                                    DateFormat="dd MMM yyyy" ReadOnly="true" ValidationGroup="Input"
                                                    ButtonImageHeight="19px" ButtonImageWidth="20px"
                                                    DisplayType="TextBoxAndImage" TextBoxStyle-CssClass="TextDate"
                                                    AutoPostBack="True" ShowNoneButton="False">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox CssClass="TextBox" runat="server" ID="tbReference"
                                                    Enabled="true" Width="225px" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="7">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="tbInvoice" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBox" width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbPotongan" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBox" width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbdpp" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBox" width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbppn" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBox" width="50px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbppnValue" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBox" Width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbpph" ValidationGroup="Input"
                                                                runat="server" Enabled="True" CssClass="TextBox"
                                                                Width="50px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbPphValue" ValidationGroup="Input"
                                                                runat="server" Enabled="True" CssClass="TextBox"
                                                                Width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbTotalAmount" ValidationGroup="Input"
                                                                runat="server" CssClass="TextBoxR" Width="120px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox runat="server" ID="tbRemarkDt" CssClass="TextBox"
