<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrVoucherApproval.aspx.vb" Inherits="ApprovalVoucher" %>
    ...
    <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
        ...
        <%@ Register
            ...
            <ItemTemplate>
                <asp:Label ID="lblfgChecker" runat="server" Text='<%# Eval("fgChecker") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
                                        <asp:BoundField DataField="SuppName" HeaderStyle-Width="150px"
                                            SortExpression="SuppName" HeaderText="Supplier"></asp:BoundField>
                                        <asp:BoundField DataField="Attn" HeaderStyle-Width="100px" SortExpression="Attn"
                                            HeaderText="Attn"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="BankPenerima" HeaderStyle-Width="150px"
                                            SortExpression="BankPenerima" HeaderText="Bank Penerima"></asp:BoundField>
                                        <asp:BoundField DataField="NamaPenerima" HeaderStyle-Width="100px"
                                            SortExpression="NamaPenerima" HeaderText="Nama Penerima"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="TotalInvoice" DataFormatString="{0:#,##0.00}"
                                            ...
                                            SortExpression="TotalInvoice" HeaderText="Total Invoice"></asp:BoundField>
                                    ...
                                    <td>
                                        <asp:Menu ID="Menu2" runat="server" CssClass="Menu" ItemWrap="False"
                                            ...
                                            <Items>
                                                ...
                                                <asp:MenuItem Text="Upload Dokumen Pendukung" Value="1"></asp:MenuItem>
                                            </Items>
                                        </asp:Menu>
                                ...
                                <asp:View ID="TabHd0" runat="server">
                                    <table>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox CssClass="TextBoxR" runat="server" ID="tbRef" Width="225px"
                                                    Enabled="False" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:LinkButton ID="lblExpense" Visible="True" ValidationGroup="Input"
                                                    runat="server" Text="Expense Type" />
                                            </td>
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox runat="server" ValidationGroup="Input" ID="tbExpense"
                                                    CssClass="TextBox" Visible="false" Width="225px" />
                                                <asp:TextBox runat="server" ValidationGroup="Input" ID="tbExpenseName"
                                                    CssClass="TextBox" Enabled="false" Width="192px" />
                                                <asp:Button ID="btnExpense" runat="server" Class="btngo" visible=True
                                                    Text="v" />
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox runat="server" ValidationGroup="Input" ID="tbBankPenerima"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server"
                                                    ID="tbSuppCode" Width="100px" AutoPostBack="true" />
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox runat="server" ValidationGroup="Input" ID="tbNamaPenerima"
                                                    CssClass="TextBox" Width="225px" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="7">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="TbTotalInvoiceHd" ValidationGroup="Input"
                                                                runat="server" Enabled="False" CssClass="TextBox"
                                                                width="120px" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="tbTotalPotongan" ValidationGroup="Input"
                                                                runat="server" Enabled="false" CssClass="TextBox"
                                                                width="120px" />
                                                        </td>
                                                        <td>
                                        ...
                                        <%--<tr>
                                            ...
                                            <%-- <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox runat="server" ValidationGroup="Input" ID="tbSuppInvNo"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                                        ID="tbPPnNo" CssClass="TextBox" Width="150px" />
                                                                </td>
                                                                <td>
                                                                    <BDP:BasicDatePicker ID="tbPPndate" runat="server"
                                                        ...
                                                        <%-- <tr>
                                                            ...
                                                            <td colspan="6">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="tbBaseForex" runat="server"
                                                                                CssClass="TextBoxR" Width="90px" />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="tbPPNForex" runat="server"
                                                                                CssClass="TextBoxR" Width="90px" />
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                                        ID="tbRemark" CssClass="TextBoxMulti"
                                                                        Width="330px" TextMode="MultiLine"
                                                                        MaxLength="255" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox runat="server" ValidationGroup="Input"
                                                                        ID="tbRemarkRevisi" CssClass="TextBoxMulti"
                                                                        Width="335px" TextMode="MultiLine"
                                                                        MaxLength="255" />
                                                                </td>
                                                                <td>
                                                                    <asp:Button class="bitbtn btnsave" runat="server"
                                                                        ID="btnRevisi" Text="Revisi" />
                                                                    <asp:Button ID="btnViewallrevisi" runat="server"
                                                                        Width="110" class="bitbtndt btnsearch"
                                                                        Text="View Revisi Info" validationgroup="Input"
                                                                        Visible="True" />
                                                                </td>
                                                            </tr>
                                    </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button class="bitbtndt btndelete"
                                                        ...
                                                        runat="server" ID="btnClearInv" Width="15px" Text="s" /> Upload
                                                    Dokumen
                                                    Pendukung
                                                </td>
                                                <td>:</td>
                                ...
                                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="InvoiceDate" dataformatstring="{0:dd MMM yyyy}"
                                                htmlencode="true" HeaderStyle-Width="80px" SortExpression="InvoiceDate"
                                            ...
                                            <asp:BoundField DataField="TotalAmount" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Width="80px" DataFormatString="{0:#,##0.00}"
                            ...
                            <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                                <table>
                                        ...
                                        <td colspan="7">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="tbdpp" ValidationGroup="Input" runat="server"
                                                            CssClass="TextBox" width="120px" />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="tbppn" ValidationGroup="Input" runat="server"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="tbpph" ValidationGroup="Input" runat="server"
                                                            Enabled="True" CssClass="TextBox" Width="50px" />
                                                    </td>
                                                    <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="tbRemarkDt" CssClass="TextBox" Width="365px"
