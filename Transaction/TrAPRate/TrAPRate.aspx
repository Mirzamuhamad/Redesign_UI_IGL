<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrAPRate.Aspx.vb" Inherits="TrAPRate" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Difference Rate A/P</div>
     <hr style="color:Blue" />        
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Type" HeaderStyle-Width="50px" HeaderText="Type" />
                        ...
                        <asp:BoundField DataField="Supplier_Name" HeaderStyle-Width="150px"  HeaderText="Supplier" />
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
            <table>                
                <tr>
                    ...
                    <td>:</td>
                    <td>
                       <asp:TextBox runat="server" ID="tbInvType" Enabled="false" CssClass="TextBox" AutoPostBack="False" />
                       <asp:TextBox runat="server" ID="tbInvNo" Enabled="false" CssClass="TextBox" AutoPostBack="false" />
                ...
                <tr>
                    <td>Supplier</td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" ID="tbSuppCode" CssClass="TextBox" Enabled="false" AutoPostBack="true" />
                        <asp:TextBox runat="server"  CssClass="TextBox" ID="tbSuppName" Enabled="false" Width="200px"/> 
                     </td>
                </tr>
                <tr>
                    <td>Supplier Invoice</td>
                    <td>:</td>
                    <td><asp:TextBox ID="tbSuppInv" Enabled="false" runat="server" CssClass="TextBox" />
