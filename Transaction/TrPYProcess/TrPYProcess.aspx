<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrPYProcess.aspx.vb" Inherits="Transaction_TrPYProcess_TrPYProcess" %>
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox" runat="server" ID ="tbFilter"/> 
                  <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >     
                    <asp:ListItem Selected="True" Value="ProcessCode">Reference</asp:ListItem>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="ProcessCode" HeaderStyle-Width="120px" SortExpression="Nmbr" HeaderText="Reference"></asp:BoundField>                  
                  <asp:BoundField DataField="Status" SortExpression="Status" HeaderText="Status"></asp:BoundField>                  
                  <asp:BoundField DataField="MethodName" HeaderStyle-Width="180px" SortExpression="MethodName" HeaderText="Method"></asp:BoundField>
                  <asp:BoundField DataField="Year" HeaderStyle-Width="50px" SortExpression="Year" HeaderText="Year"></asp:BoundField>
                  <asp:BoundField DataField="Month" HeaderStyle-Width="50px" SortExpression="Month" HeaderText="Month"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table style="width: 583px">
        ...
        <%--<tr>
          ...
          <tr>
              <td class="style6">Method Salary</td>
              <td>:</td>
              <td>
                  <asp:DropDownList runat="server" ValidationGroup="Input" ID="ddlMethod" CssClass="DropDownList" Width="200px" AutoPostBack="true" />
                &nbsp;<asp:Label ID="lbred" runat="server" ForeColor="Red">*</asp:Label>               
                <asp:Button class="bitbtn btnpreview" runat="server" ID="btnGenerate" Text="Generate Detail"/>	
              </td>
          </tr>
          <tr>
              ...
              <td>:</td>
              <td>
                  <asp:DropDownList runat="server" ValidationGroup="Input" ID="ddlYear" CssClass="DropDownList" Width="200px" />
                &nbsp;<asp:Label ID="Label1" runat="server" ForeColor="Red">*</asp:Label>               
              </td>
          </tr>
          <tr>
              <td class="style6">Period</td>
              <td>:</td>
              <td>
                  <asp:DropDownList runat="server" ValidationGroup="Input" ID="ddlMonth" CssClass="DropDownList" Width="200px" />
          ...
          <tr>
              ...
              <td>:</td>
              <td><asp:TextBox ID="tbRemark" runat="server" CssClass="TextBox" MaxLength="255" ValidationGroup="Input" Width="225px" />
              </td>
          </tr>
      </table>  
      ...
      <hr style="color:Blue" />  
                ...
                <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PayrollGroup" HeaderStyle-Width="60px" HeaderText="Payroll Group" />
                            <asp:BoundField DataField="PayrollGrpName" HeaderStyle-Width="160px" HeaderText="Payroll Group Name" />
              ...
              <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
                <table style="width: 583px">                                 
                    <tr>                    
                        <td class="style7">Payroll</td>
                        <td>:</td>
                        <td>
                            <asp:DropDownList ID="ddlPayroll" runat="server" CssClass="DropDownList" Enabled="true" Height="17px" ValidationGroup="Input" Width="228px" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>                                                            
                    <tr>                    
