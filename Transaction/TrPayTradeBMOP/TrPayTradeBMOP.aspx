<%@ Page MaintainScrollPositionOnPostback ="true" Language="VB" AutoEventWireup="false" CodeFile="TrPayTradeBMOP.aspx.vb" Inherits="Transaction_TrPayTrade_TrPayTrade" %>
...
<body>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            <td><asp:LinkButton ID="lbSupp" ValidationGroup="Input" visible="false"  runat="server" Text="Supplier"/></td>
            <%--<td>:</td> --%>
            <td colspan="4"><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbSuppCode" visible="false"  AutoPostBack="true" />
                <asp:TextBox CssClass="TextBox" runat="server" ID="tbSuppName" Enabled="false" visible="false"  Width="225px"/>                
                <asp:Button Class="btngo" ID="btnSupp" Text="..." runat="server"  ValidationGroup="Input" Visible="false" />
       ...
       <asp:Menu
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                ...
                <asp:Panel runat="server" ID="pnlEditDt2" Visible="false">
                    <table>  
                     ...
                     <tr>
                        <%--<td>Item No</td>
                        <td>:</td>--%>
                        <td colspan="4"><asp:Label ID="lbItemNo" visible="True" runat="server" Text="itemmm" />
                        </td>           
                    </tr>     
			...
			<table>
				<tr>
					<td>
						<asp:Label ID="lbItemNoDt2" Visible="False" runat="server" Text="" />
					</td>
				</tr>
			</table>
