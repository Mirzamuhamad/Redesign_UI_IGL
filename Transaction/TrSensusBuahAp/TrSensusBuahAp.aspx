<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSensusBuahAp.aspx.vb" Inherits="Transaction_TrSensusBuahAp_TrSensusBuahAp" %>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            CssClass="Grid" AutoGenerateColumns="False"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="WoNo"  HeaderText="WoNo" sortExpression="StartSickDate">
        ...
        <%--<tr>
          ...
          <tr>
              ...
              <td>
                  :</td>
              <td >
                  <asp:TextBox ID="tbWoNo" runat="server" AutoPostBack="true" CssClass="TextBox" 
                      ValidationGroup="Input" Width="108px" />
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BlocKName" HeaderText="Block Name" HeaderStyle-Width="100px" SortExpression="BlocakName" >
                            <HeaderStyle Width="100px" />
                        </asp:BoundField>
                        
                        <asp:BoundField 
                            DataField="ProposeWeek" HeaderText="Propose Week" HeaderStyle-Width="100px"  SortExpression="ProposeWeek" 
                        ...
                        <asp:BoundField DataField="Density" HeaderText="Density Panen" HeaderStyle-Width="100px" SortExpression="Densitys" >
                            <HeaderStyle Width="100px" />
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" /> 
                        </asp:BoundField>

                        <asp:BoundField DataField="Areal" HeaderText="Areal" DataFormatString="{0:#,##0.##}" HeaderStyle-Width="100px" SortExpression="Areal" >
                            <HeaderStyle Width="100px" />
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" /> 
                        </asp:BoundField>
                        
                        <asp:BoundField DataField="StartWeight" HeaderText="Start Weight"  DataFormatString="{0:#,##0.##}" HeaderStyle-Width="100px" SortExpression="StartWeight" >
                            <HeaderStyle Width="100px"  />
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" /> 
                        </asp:BoundField>  
                        ...
                        <asp:BoundField 
                            DataField="EndWeight" HeaderText="End Weight" DataFormatString="{0:#,##0.##}" 
                            HeaderStyle-Width="100px" SortExpression="EndWeight" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
                            <HeaderStyle Width="100px" />
                            <FooterStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" /> 
                        </asp:BoundField>
                        
                        <asp:BoundField DataField="TotStartWeight" HeaderText="To Start Weight" DataFormatString="{0:#,##0.##}"  HeaderStyle-Width="100px" SortExpression="ToStartWeight" >
                            <HeaderStyle Width="100px"  /> 
                        </asp:BoundField>    
                        
                        <asp:BoundField DataField="TotEndWeight" HeaderText="To End Weight" DataFormatString="{0:#,##0.##}"  HeaderStyle-Width="100px" SortExpression="ToEndWeight" >
                            <HeaderStyle Width="100px"  /> 
                        </asp:BoundField>                  
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="tbStartDate" runat="server" CssClass="TextBoxR" Enabled="False" 
                                                Width="80px" DateFormat="dd MMM yyyy"/>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbEndDate" DateFormat="dd MMM yyyy" runat="server" CssClass="TextBoxR" Enabled="False" 
                                                Width="80px" />
                                        </td>
                                    </tr>
                                </table>
