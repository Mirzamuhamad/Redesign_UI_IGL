...
Partial Class Transaction_TrSensusBuahAp_TrSensusBuahAp
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "Select * From V_PLSensusPanenHd"
    ...
    Private Sub SetInit()
        FillRange(ddlRange)
        'FillCombo(ddlWoNo, "EXEC S_GetWeek", True, "Week_No", "Week", ViewState("DBConnection"))
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT TransNmbr, Block,BlockName, ProposeWeek, StartDate, EndDate, Density, Areal, StartWeight, EndWeight, TotStartWeight, TotEndWeight, Remark From V_PLSensusPanenDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbRef.Text = GetAutoNmbr("SBP", "Y", Year(tbDate.SelectedDate), Month(tbDate.SelectedDate), "", ViewState("DBConnection").ToString)
                'lbStatus.Text = tbRef.Text
                'Exit Sub

                SQLString = "INSERT INTO PLSensusPanenHd (TransNmbr, TransDate, Status, WoNo, CheckBy, Remark, UserPrep, DatePrep, UserAppr, DateAppr) " + _
                "SELECT " + QuotedStr(tbRef.Text) + ", '" + Format(tbDate.SelectedDate, "yyyy-MM-dd") + "',  'H', " + _
                QuotedStr(tbWoNo.Text) + ", " + QuotedStr(ddlCheckBy.SelectedValue) + " , " + QuotedStr(tbRemark.Text) + "," + _
            ...
            Else
                ...
                If cekStatus = "P" Then
                    ...
                    Exit Sub
                End If
                SQLString = "UPDATE PLSensusPanenHd SET WoNo = " + QuotedStr(tbWoNo.Text) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, Block, ProposeWeek, Density, Areal, StartWeight, EndWeight, TotStartWeight, TotEndWeight, Remark FROM PLSensusPanenDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
    ...
    Protected Sub tbAreal_TextChange(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbDensity.TextChanged, tbAreal.TextChanged, tbStartWeight.TextChanged, tbEndWeight.TextChanged, tbTotStartWeight.TextChanged, tbTotEndWeight.TextChanged
        Try
