<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrJamsostekRegOut.aspx.vb" Inherits="Transaction_TrJamsostekRegOut_TrJamsostekRegOut" %>
...
<head id="Head1" runat="server">
    <title>UnRegister Jamsostek</title>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">UnRegister Jamsostek</div>
     <hr style="color:Blue" />        
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SalaryGP" HeaderText="Last Salary" HeaderStyle-Width="120px" SortExpression="SalaryGP" ></asp:BoundField>
                        <asp:BoundField DataField="Remark" HeaderStyle-Width="250px" HeaderText="Remark" ></asp:BoundField>
                    </Columns>
                </asp:GridView>
          </div>   
       ...
       <asp:Panel runat="server" ID="pnlEditDt" Visible="false">
         <table>
          ...
          <tr>
             <td>JamSosTek No</td>
             <td>:</td>
             <td colspan="5"><asp:TextBox ID="tbJamSosTekNo" EnableTheming="True" ReadOnly="True" Enabled="False" runat="server" CssClass="TextBox" />
             </td>
          </tr>
          <tr>
             <td>Gender</td>
          ...
          <tr>
             <td>Last Salary</td>
             <td>:</td>
             <td colspan="5"><asp:TextBox ID="tbSalaryGP" runat="server" EnableTheming="True" ReadOnly="True" Enabled="False"  CssClass="TextBox" />
             </td>
          </tr>
          <tr>
             <td>Remark </td>
