<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrSensusMN.aspx.vb" Inherits="Transaction_TrWOPLan_TrWOPLan" %>
...
<head runat="server">
    <title>Sensus Pokok Permodule</title>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbPerson" runat="server" CssClass="TextBox" MaxLength="30" 
                            ValidationGroup="Input" Width="76px" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
                                ...
                                <Columns>
                                   ...
                                   <asp:Button ID="btnViewM" runat="server" class="bitbtndt btndetail" 
                                    ...
                                    <asp:BoundField DataField="DivisiBlokName" HeaderStyle-Width="200px" 
                                        HeaderText="Blok Name" SortExpression="Block Name"><HeaderStyle Width="200px" /></asp:BoundField>
                                ...
                                <td colspan="4">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbQtyCapacity" runat="server" CssClass="TextBox" Height="19px" AutoPostBack = "true"
                                                    Width="70px" />
                                            </td>
                                            <td>
