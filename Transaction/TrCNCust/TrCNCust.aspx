<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrCNCust.aspx.vb" Inherits="CNCust" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">Credit Note Customer</div>
     <hr style="color:Blue" />        
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="PPNNo" HeaderStyle-Width="80px" SortExpression="PPNNo" HeaderText="PPN No"></asp:BoundField>                 
                  ...
                  <asp:BoundField DataField="PPNRate" DataFormatString="{0:#,##0.00}" HeaderStyle-Width="80px" SortExpression="PPNRate" HeaderText="PPNRate"></asp:BoundField>
                  <asp:BoundField DataField="Currency" HeaderStyle-Width="10px" SortExpression="Currency" HeaderText="Curr"></asp:BoundField>
                  <asp:BoundField DataField="ForexRate" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" SortExpression="ForexRate" HeaderText="Rate"></asp:BoundField>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        <tr>
            ...
            <asp:DropDownList AutoPostBack="true" ValidationGroup="Input" 
                    CssClass="DropDownList" ID="ddlReport" runat="server" Height="16px" >
            ...
            <table>                                
                ...
                <tr>
                    ...
                    <tr>
                        <td>Cost Center</td>
                        <td>:</td>
                        <td><asp:DropDownList CssClass="DropDownList" ID="ddlCostCenter" runat="server" Width="180px"/></td>
                    </tr>  
                    <tr>
                        <td>Qty</td>
                        <td>:</td>
