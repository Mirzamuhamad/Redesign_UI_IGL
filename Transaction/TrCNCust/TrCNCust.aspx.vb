...
Partial Class CNCust
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "Select * From V_FNCNCustHd "
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_FNCNCustDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Next
                Result = Result + "'"
                Session("SelectCommand") = "EXEC S_FNFormCNDNCust " + Result + ", 'CN' "
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_FNCNCust", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbRef.Text = GetAutoNmbr("CNC", "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO FINCNCustHd (TransNmbr, FgReport, Status, TransDate, Customer, Attn, " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM FINCNCustHd WHERE TransNmbr = " + QuotedStr(tbRef.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE FINCNCustHd SET Customer = " + QuotedStr(tbCustCode.Text) + ", Attn = " + QuotedStr(tbAttn.Text) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ItemNo, Account, FgSubled, Subled, CostCtr, Qty, Unit, PriceForex, AmountForex, Remark FROM FINCNCustDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
            ...
            "UPDATE FINCNCustDt SET ItemNo = @ItemNo, Account = @Account, " + _
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM FINCNCustDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND ItemNo = @ItemNo ", con)
            ' Add the parameters for the DeleteCommand.
            param = Delete_Command.Parameters.Add("@ItemNo", SqlDbType.Int, 4, "ItemNo")
            param.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command

            Dim Dt As New DataTable("FINCNCustDt")
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Reference, Date, Customer, Term, Due Date, Currency, Remark"
            FilterValue = "TransNmbr, dbo.FormatDate(TransDate), Customer_Name, Term_Name, dbo.FormatDate(DueDate), Currency, Remark"
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_FNFormCNDNCust '''" + GVR.Cells(2).Text + "''', 'CN' "
                        Session("ReportFile") = ".../../../Rpt/FormCNDNCust.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    Protected Sub lbCust_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbCust.Click
        ...
        Catch ex As Exception
            lbStatus.Text = "lbCust_Click Error : " + ex.ToString
        End Try
    End Sub
    ...
    Protected Sub btnAccount_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAccount.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT * FROM V_MsAccountDt WHERE TransType = 'CNC' AND ( Currency = " + QuotedStr(ddlCurr.SelectedValue) + " OR Currency = " + QuotedStr(ViewState("Currency").ToString) + ") "
    ...
    Protected Sub tbAccount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbAccount.TextChanged
        ...
        Dim Dt As DataTable
        Try
            Dt = SQLExecuteQuery("SELECT * FROM V_MsAccountDt WHERE TransType = 'CNC' AND ( Currency = " + QuotedStr(ddlCurr.SelectedValue) + " OR Currency = " + QuotedStr(ViewState("Currency").ToString) + ") AND Account = " + QuotedStr(tbAccount.Text), ViewState("DBConnection").ToString).Tables(0)
            If Dt.Rows.Count > 0 Then
                Dr = Dt.Rows(0)
