...
Partial Class Transaction_TrMemoKiriman_TrMemoKiriman
    ...
    Private Function GetStringHd() As String
        Return "SELECT * From V_STCTransferSjHd WHERE Left(TransNmbr,8) = 'IAL/STSJ'"
    End Function
                ...
                If ViewState("Sender") = "btnGetDt" Then
                    ...
                    For Each drResult In Session("Result").Rows
                        ...
                        If CekExistData(ViewState("Dt"), "DivisiBlok +'|'+ ProductCode", drResult("DivisiBlok") + "|" + drResult("Material")) = False Then
                            ...
                            dr("QtySisa") = FormatFloat(dr("QtyMax") - dr("QtyDone"), ViewState("Qty"))
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Session("ReportFile") = ".../../../Rpt/FormMemoKiriman.frx"
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbReference.Text = GetAutoNmbr("STSJ", "N", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), ddlwrhs.SelectedValue, ViewState("DBConnection").ToString)
                'Else
                ...
                QuotedStr(tbPIC.Text) + ",'SJ'," + QuotedStr(tbWoPlan.Text) + "," + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM STCTransferSJHd WHERE TransNmbr = " + QuotedStr(tbReference.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
            ...
            Dim Insert_Command = New SqlCommand( _
                    "INSERT INTO STCTransferSJDt  (TransNmbr, productCode,ProductPart,  divisiBlok, capacity, Qtysuggest,Qty,Unit, HK, QtyMax, QtyDone,EveryPackage, QtyPackage,UnitPackage, PriceCost,Type, Remark) Values " + _
                    "(" + QuotedStr(tbReference.Text) + ",@ProductCode, '', @divisiBlok, @capacity,@QtySuggest,@Qty, @Unit, @HK, @QtyMax, @QtyDone,@EveryPackage, @QtyPackage,@UnitPackage,0,@Type, @Remark)", con)
            ...
            Dim Update_Command = New SqlCommand( _
                    "UPDATE STCTransferSJDt SET ProductCode= @ProductCode, divisiBlok = @divisiBlok, capacity = @capacity , Qtysuggest = @Qtysuggest," + _
