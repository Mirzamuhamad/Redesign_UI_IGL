<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrMemoKiriman.aspx.vb" Inherits="Transaction_TrMemoKiriman_TrMemoKiriman" %>
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
			...
			<td>Person</td>
            <td>:</td>
            <td><asp:TextBox CssClass="TextBox" ValidationGroup="Input" runat="server" ID="tbPerson" AutoPostBack="False" /> 
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
						...
						<asp:BoundField DataField="Qty" HeaderStyle-Width="80px" HeaderText="Qty Wrhs" DataFormatString="{0:#,##0.####}">
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
						...
						<asp:BoundField DataField="QtySisa" HeaderStyle-Width="80px" HeaderText="Qty Sisa" DataFormatString="{0:#,##0.####}" >
                            <HeaderStyle Width="80px" />
                        </asp:BoundField>
