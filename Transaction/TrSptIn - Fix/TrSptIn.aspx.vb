...
Partial Class Transaction_TrSptIn_TrSptIn
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                'FillCombo(ddlVechile, "SELECT * FROM VMsVehicleType", True, "VehicleTypeCode", "VehicleTypeName", ViewState("DBConnection"))
    ...
    Private Function GetStringDt2(ByVal Nmbr As String) As String
        Return "SELECT * From V_PLSPTBSDt2 WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            " SPTBSDate, JamSPTBS, FgHariHitam, Normal, Abnormal, Brondolan,Weight, Remark FROM PLSPTBSDt WHERE TransNmbr = '" & ViewState("Reference") & "'", con)
            ...
            "SPBLDate, JamSPBL, Normal, Abnormal, Brondolan, Weight, Remark FROM PLSPTBSDt2 WHERE TransNmbr = '" & ViewState("Reference") & "' ", con)
            da = New SqlDataAdapter(cmdSql)
    ...
    Protected Sub btnSaveTrans_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveTrans.Click
        ...
        Try
            ...
            'If GetCountRecord(ViewState("Dt")) = 0 Or GetCountRecord(ViewState("Dt2")) = 0 Then
            '    lbStatus.Text = MessageDlg("Detail must have at least 1 record")
            '    Exit Sub
            'End If
    ...
    Protected Sub btnSupplier_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSupplier.Click
        ...
        Try
            ...
            Session("filter") = "select Supplier_Code,Supplier_Name from V_MsSupplier Where GroupType = 'Panen' And FgActive='Y' " '" + QuotedStr(ViewState("UserId").ToString) + ", " + QuotedStr(ddlDept.SelectedValue)
    ...
    Protected Sub tbScan_textChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbScan.TextChanged
        ...
        Dim SQLString, SupplierName, VehicleType, IKPName, CekQrcode As String
        Try
            ...
            CekQrcode = SQLExecuteScalar("SELECT QrCode FROM V_QrCode WHERE Qrcode = '" + tbScan.Text + "'", ViewState("DBConnection").ToString)
            If CekQrcode <> "" Then
            ...
            If Strings.Right(tbScan.Text, 2) = "|Y" Then
                ...
                If dtUnit2.Rows.Count > 0 Then
                    ...
                    dr2("Remark") = drUnit2("Remark").ToString
