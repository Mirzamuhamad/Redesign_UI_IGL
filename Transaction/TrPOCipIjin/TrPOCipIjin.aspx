<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrPOCipIjin.aspx.vb" Inherits="TrPOCipIjin" %>
...
<body>     
    ...
    <div class="Content">
    <div class="H1">PO CIP PERMISSIONS</div>
     <hr style="color:Blue" />        
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:BoundField DataField="Pemohon" htmlencode="true" HeaderStyle-Width="300px" SortExpression="Pemohon" HeaderText="Pemohon"></asp:BoundField>
                  <asp:BoundField DataField="TotalAmount" ItemStyle-HorizontalAlign="right" HeaderText="Luas" DataFormatString="{0:#,##0.##}" SortExpression="TotalAmount"> 
    ...
    <asp:Panel runat="server" ID="pnlInput" Visible="false">
      <table>
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan="4">
                <asp:TextBox ID="tbPemohon" runat="server" CssClass="TextBox" 
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan="4"> 
                <asp:TextBox ID="tbTotalAmount" runat="server" CssClass="TextBox" 
                    ValidationGroup="Input" Width="225px" />
            </td>        
        </tr>   
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemNo" HeaderStyle-Width="80px" HeaderText="ItemNo" />
                        <asp:BoundField DataField="JnsPermohonan" HeaderStyle-Width="250px"  HeaderText="Jenis Permohonan" />
                        <asp:BoundField DataField="NoRegistrasi" HeaderStyle-Width="250px"  HeaderText="No Registrasi" />
                        <asp:BoundField DataField="Place" HeaderStyle-Width="100px" HeaderText="Tempat Pengajuan" /> 
                        <asp:BoundField DataField="Penyerapan" HeaderStyle-Width="100px" HeaderText="Penyerapan Biaya" />
                        <asp:BoundField DataField="Area" HeaderStyle-Width="100px" HeaderText="Area" />                                             
                        <asp:BoundField DataField="Biaya" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px" HeaderText="Biaya" />
            ...
            <table> 
                 ...
                 <tr>
                   ...
                   <td colspan="4"> <asp:Label ID="lbItemNo" runat="server" Text="" /> </td>
                    ...
                    <tr>
                    <td><asp:LinkButton ID="lbJenisPermohonan"  runat="server" Text="Jenis Permohonan"/> </td>
                    <td>:</td>
                    <td><asp:TextBox runat="server" ID="tbJnsPermohonan" CssClass="TextBox" AutoPostBack="true" />
                        <asp:TextBox runat="server"  CssClass="TextBox"
                            ID="tbJnsPermohonanName" EnableTheming="True" Enabled="false" Width="200px"/> 
                        <asp:Button Class="btngo" ID="btnPermohonan" Text="v" runat="server" 
                            visible="True" />                                               
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:TextBox ID="tbNoRegistrasi" runat="server" CssClass="TextBox" 
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:TextBox ID="tbTempatPengajuan" runat="server" CssClass="TextBox" Enabled="True" 
                            Width="225px" />
                                    
                </tr>
                <tr>
                    <td>Penyerapan Biaya</td>
                    <td>:</td>
                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbPenyerpanBiaya" Enabled="True" 
                            Width="225px" /></td>
                </tr>
                ...
                <tr>
                    <td>Area</td>
                    <td>:</td>
                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbArea" Enabled="True" 
                            Width="225px" /></td>
                </tr>
                ...
                <tr>
                    <td>Biaya</td>
                    <td>:</td>
                    <td><asp:TextBox CssClass="TextBox" runat="server" ID="tbBiaya" Enabled="True" 
                            Width="225px" /></td>
                </tr>
