...
Partial Class Transaction_TrSTTGSJ_TrSTGTSJ
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_STTGSJDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Next
                Result = Result + "'"
                Session("SelectCommand") = "EXEC  S_STFormTGSJ" + Result
                Session("ReportFile") = ".../../../Rpt/FormTGSJ.frx"
            ...
            For j = 0 To (Nmbr.Length - 1)
                If Nmbr(j) = "" Then
                    Exit For
                Else
                    Result = ExecSPCommandGo(ActionValue, "S_STTGSJ", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                    If Trim(Result) <> "" Then
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                tbReference.Text = GetAutoNmbr("TGO", "N", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), ddlwrhs.SelectedValue, ViewState("DBConnection").ToString)
                'Else
                ...
                'End If
                SQLString = "INSERT INTO STCTGSJHd (TransNmbr, Status, TransDate, WrhsAreaSrc, WrhsAreaDest, Warehouse, FgSubLed, SubLed, " + _
                "IssuedBy, CarNo, Driver, Remark, UserPrep, DatePrep) " + _
                "SELECT " + QuotedStr(tbReference.Text) + ", 'H', '" + Format(tbDate.SelectedValue, "yyyy-MM-dd") + "', " + _
                QuotedStr(ddlWrhsArea.SelectedValue) + ", " + QuotedStr(ddlWrhsAreaDest.SelectedValue) + ", " + _
                QuotedStr(ddlwrhs.SelectedValue) + ", " + QuotedStr(tbFgSubLed.Text) + ", " + QuotedStr(tbSubLed.Text) + ", " + _
                QuotedStr(tbIssuedBy.Text) + ", " + QuotedStr(tbCarNo.Text) + ", " + QuotedStr(tbDriver.Text) + ", " + _
            ...
            Else
                ...
                If cekStatus = "P" Then
                    ...
                    Exit Sub
                End If
                SQLString = "UPDATE STCTGSJHd SET TransDate = '" + Format(tbDate.SelectedValue, "yyyy-MM-dd") + "' " + _
                ...
                ", SubLed = " + QuotedStr(tbSubLed.Text) + ", IssuedBy = " + QuotedStr(tbIssuedBy.Text) + ", CarNo = " + QuotedStr(tbCarNo.Text) + _
                ", Driver = " + QuotedStr(tbDriver.Text) + " , Remark = " + QuotedStr(tbRemark.Text) + ", UserPrep = " + QuotedStr(ViewState("UserId").ToString) + ", DatePrep = getDate()" + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, Product, Qty, Unit, Remark FROM STCTGSJDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
            ...
            Dim Dt As New DataTable("STCTGSJDt")
    ...
    Function CekHd() As Boolean
        Try
            ...
            If ddlwrhs.SelectedValue.Trim = "" Then
                lbStatus.Text = MessageDlg("Warehouse Issue must have value")
                ddlwrhs.Focus()
                Return False
            End If
            If tbSubLed.Text.Trim = "" And tbFgSubLed.Text.Trim <> "N" Then
                ...
                Return False
            End If
            If tbIssuedBy.Text.Trim = "" Then
                lbStatus.Text = MessageDlg("Issued By must have value")
                tbIssuedBy.Focus()
                Return False
            End If
            If tbCarNo.Text.Trim = "" Then
                lbStatus.Text = MessageDlg("Car No must have value")
                tbCarNo.Focus()
                Return False
            End If
            If tbDriver.Text.Trim = "" Then
                lbStatus.Text = MessageDlg("Driver must have value")
                tbDriver.Focus()
                Return False
            End If
            Return True
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "Reference, Date, Status, Wrhs Area Issue, Warehouse Issue, Issue Subled Name, Wrhs Area Dest Name, Issued By, Car No, Driver, Remark"
            FilterValue = "TransNmbr, dbo.FormatDate(TransDate), Status, WrhsAreaSrc_Name, Wrhs_Name, Subled_Name, WrhsAreaDest_Name, IssuedBy, CarNo, Driver, Remark"
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        If CekMenu <> "" Then
                            ...
                            Exit Sub
                        End If
                        Session("SelectCommand") = "EXEC S_STFormTGSJ ''" + QuotedStr(GVR.Cells(2).Text) + "''"
                        Session("ReportFile") = ".../../../Rpt/FormTGSJ.frx"
                        Session("DBConnection") = ViewState("DBConnection")
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
