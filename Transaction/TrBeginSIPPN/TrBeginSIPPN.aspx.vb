...
Partial Class Transaction_TrBeginSIPPN_TrBeginSIPPN
    ...
    Private Sub BindData(Optional ByVal AdvanceFilter As String = "")
        ...
        Try
            ...
            If AdvanceFilter.Length > 1 Then
                StrFilter = AdvanceFilter
            End If
            DT = BindDataTransaction("Select * From V_FNBeginSIPPN", StrFilter, ViewState("DBConnection").ToString)
        ...
        Try
            ...
            For j = 0 To (Nmbr.Length - 1)
                If Nmbr(j) = "" Then
                    Exit For
                Else
                    Result = ExecSPCommandGo(ActionValue, "S_FNSIBeginPPN", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                    If Trim(Result) <> "" Then
    ...
    Private Sub FillTextBox(ByVal e As GridViewRow)
        ...
        Try
            Nmbr = e.Cells(2).Text
            Dt = BindDataTransaction("Select * From V_FNBeginSIPPN", "InvoiceNo = " + QuotedStr(Nmbr), ViewState("DBConnection").ToString)
            newTrans()
    ...
    Function cekhd() As Boolean
        ...
        Try
            ...
            If ViewState("StateHd") = "Insert" Then
                Infois = SQLExecuteScalar("SELECT COALESCE(InvoiceNo, '') FROM FINBeginSIPPN WHERE InvoiceNo = " + QuotedStr(tbInvoiceNo.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub SaveData()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                'insert                
                SQLString = "Insert INTO FINBeginSIPPN (InvoiceNo, Status, InvoiceDate, FgReport, " + _
            ...
            Else
                ...
                CekStatus = SQLExecuteScalar("Select Status FROM FINBeginSIPPN WHERE InvoiceNo = " + QuotedStr(tbInvoiceNo.Text), ViewState("DBConnection").ToString)
                If CekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                'edit
                SQLString = "UPDATE FINBeginSIPPN SET InvoiceDate = " + QuotedStr(Format(tbTransDate.SelectedDate, "yyyy-MM-dd")) + _
