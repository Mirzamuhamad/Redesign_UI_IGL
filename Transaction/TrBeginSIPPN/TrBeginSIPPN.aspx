<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrBeginSIPPN.aspx.vb" Inherits="Transaction_TrBeginSIPPN_TrBeginSIPPN" %>
...
<head runat="server">
    <title>Supplier Begin (PPN)</title>
...
<body>
    ...
    <div class="Content">
    <div class="H1">SUPPLIER BEGIN (PPN)</div>
     <hr style="color:Blue" />        
     ...
     <asp:Panel ID="pnlInput" DefaultButton="btnSave" runat="server" Visible="false">
        <table>
            <tr>
                ...
                <td>
                    <BDP:BasicDatePicker ID="tbTransDate" runat="server" DateFormat="dd MMM yyyy" 
                        ReadOnly = "true" ValidationGroup="Input" ShowNoneButton = "false"
            ...
            <tr>
                <td>Type</td>
                <td>:</td>
                <td><asp:DropDownList ID ="ddlType" ValidationGroup="Input" runat ="server" CssClass="DropDownList" Width="100px">                                    
             ...
             <tr>
                <td>Term</td>
                <td>:</td>
                <td><asp:TextBox ID="tbTerm" ValidationGroup="Input" AutoPostBack="true" runat="server" CssClass="TextBox" Width="50px" />
                    &nbsp days
                </td>
                <td>Due Date</td>    
                <td>:</td>    
             ...
             <tr>
                ...
                <td>
                 ...
                 <td>
                     :</td>
                 <td>
                     <asp:TextBox ID="tbSuppPONo" runat="server" CssClass="TextBox" 
