...
Partial Class Transaction_TrBeginCI_TrBeginCI
    ...
    Private Sub BindData(Optional ByVal AdvanceFilter As String = "")
        ...
        Try
            ...
            End If
            DT = BindDataTransaction("Select * From V_FNBeginCI", StrFilter, ViewState("DBConnection").ToString)
            If DT.Rows.Count = 0 Then
        ...
        Try
            ...
            For j = 0 To (Nmbr.Length - 1)
                ...
                Else
                    ...
                    Result = ExecSPCommandGo(ActionValue, "S_FNCIBegin", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                    If Trim(Result) <> "" Then
    ...
    Private Sub FillTextBox(ByVal e As GridViewRow)
        ...
        Try
            Nmbr = e.Cells(2).Text
            Dt = BindDataTransaction("Select * From V_FNBeginCI", "InvoiceNo = " + QuotedStr(Nmbr), ViewState("DBConnection").ToString)
            newTrans()
    ...
    Function cekhd() As Boolean
        ...
        Try
            ...
            If ViewState("StateHd") = "Insert" Then
                Infois = SQLExecuteScalar("SELECT COALESCE(InvoiceNo, '') FROM FINBeginCI WHERE InvoiceNo = " + QuotedStr(tbInvoiceNo.Text), ViewState("DBConnection").ToString)
    ...
    Protected Sub SaveData()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                'insert                
                SQLString = "Insert INTO FINBeginCI (InvoiceNo, Status, InvoiceDate, FgReport, " + _
            ...
            Else
                ...
                CekStatus = SQLExecuteScalar("Select Status FROM FINBeginCI WHERE InvoiceNo = " + QuotedStr(tbInvoiceNo.Text), ViewState("DBConnection").ToString)
                If CekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                'edit
                SQLString = "UPDATE FINBeginCI SET InvoiceDate = " + QuotedStr(Format(tbTransDate.SelectedDate, "yyyy-MM-dd")) + _
