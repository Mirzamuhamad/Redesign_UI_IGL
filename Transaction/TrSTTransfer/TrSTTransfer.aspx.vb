...
Partial Class Transaction_TrSTTransfer_TrSTTransfer
		...
		END IF 
            ...
            If Not Session("Result") Is Nothing Then
                If ViewState("Sender") = "btnProdSrc" Then
                    ...
                    Else
                        tbLevelProduct.Text = TrimStr(Session("Result")(4).ToString)
                    End If
                    tbProdSrcCode.Focus()
                ...
                If ViewState("Sender") = "btnGetDt" Then
                    ...
                    For Each drResult In Session("Result").Rows
                        ...
                        If tbReffNo.Text <> "" Then
                            ...
                            dr("QtySrc") = FormatNumber(drResult("Qty"), ViewState("DigitQty"))
                            If (ViewState("StrKode") <> "TRL") Then
                                If Len(drResult("LevelProduct")) = 0 Then
                                    dr("LevelProduct") = 0
                                Else
                                    dr("LevelProduct") = drResult("LevelProduct")
                                End If
    ...
    Private Sub SetInit()
        ...
        If Request.QueryString("ContainerId").ToString = "ChangeGoodID" Then
            ViewState("FgType") = "FG"
            ViewState("StrKode") = "TRG"
            lbTrans.Text = "CHANGE GOOD"
            ViewState("TransferType") = "Change"
            tbType.Text = "Change"
        ...
        ElseIf Request.QueryString("ContainerId").ToString = "TransLocationID" Then
            ViewState("FgType") = "FG"
            ViewState("StrKode") = "TRL"
            tbProdDestCode.Enabled = False
            tbProdDestName.Enabled = False
            tbQtyDest.Enabled = False
            lbTrans.Text = "TRANSFER LOCATION"
            ViewState("TransferType") = "Location"
            tbType.Text = "Location"
            lbMemo.Enabled = False
            tbMemo.Enabled = False
            ddlReffType.Enabled = True
            If ddlReffType.SelectedValue = "Adjust" Then
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Else : Session("ReportFile") = ".../../../Rpt/FormSTTransferQC.frx"
                End If
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                ...
                SQLString = "INSERT INTO stctransferhd(TransNmbr,Status,TransDate,WrhsArea,WrhsSrc,FgSrcSubLed,SrcSubLed,WrhsDest,FgDestSubLed,DestSubLed,Operator,MemoMBD,Remark,UserPrep,DatePrep,TransferType, ReffType, ReffNmbr) " + _
                ...
                QuotedStr(tbFgSubledDest.Text) + ", " + QuotedStr(tbSubledDest.Text) + "," + QuotedStr(tbOperator.Text) + "," + QuotedStr(tbMemo.Text) + "," + QuotedStr(tbRemark.Text) + "," + _
                QuotedStr(ViewState("UserId").ToString) + ", getDate(), " + QuotedStr(ViewState("TransferType").ToString) + "," + QuotedStr(ddlReffType.SelectedValue) + "," + QuotedStr(tbReffNo.Text)
            Else
                ...
                "', MemoMBD = " + QuotedStr(tbMemo.Text) + ", WrhsArea = " + QuotedStr(ddlWrhsArea.Text) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, ProductSrc, ProductDest, QtySrc, UnitSrc, QtyDest, UnitDest, Remark, LevelProduct FROM STCTransferDt WHERE TransNmbr = '" & ViewState("Reference") & "'", con)
            ...
            Dim Update_Command = New SqlCommand( _
                    "UPDATE STCTransferDt SET ProductSrc = @ProductSrc, ProductDest = @ProductDest, QtySrc = @QtySrc, UnitSrc = @UnitSrc, QtyDest = @QtyDest, UnitDest = @UnitDest, Remark = @Remark, LevelProduct = @LevelProduct " + _
                    " WHERE TransNmbr = '" & ViewState("Reference") & "' AND ProductSrc = @OldProductSrc AND ProductDest = @OldProductDest ", con)
            ...
            Update_Command.Parameters.Add("@LevelProduct", SqlDbType.Int, 4, "LevelProduct")
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM STCTransferDt WHERE TransNmbr = '" & ViewState("Reference") & "' AND ProductSrc = @ProductSrc AND ProductDest = @ProductDest ", con)
    ...
    Protected Sub GridDt_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridDt.RowDeleting
        ...
        dr = ViewState("Dt").Select("ProductSrc+'|'+ProductDest = " + QuotedStr(GVR.Cells(1).Text + "|" + GVR.Cells(3).Text))
        dr(0).Delete()
    ...
    Protected Sub FillTextBoxDt(ByVal ItemNo As String)
        Dim Dr As DataRow()
        Try
            Dr = ViewState("Dt").select("ProductSrc+'|'+Productdest = " + QuotedStr(ItemNo))
            If Dr.Length > 0 Then
                ...
                BindToText(tbLevelProduct, Dr(0)("LevelProduct").ToString)
            End If
        Catch ex As Exception
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveDt.Click
        ...
        Try
            If ViewState("StateDt") = "Edit" Then
                If ViewState("DtValue") <> tbProdSrcCode.Text + "|" + tbProdDestCode.Text Then
                    If CekExistData(ViewState("Dt"), "ProductSrc,ProductDest", tbProdSrcCode.Text + "|" + tbProdDestCode.Text) Then
                        lbStatus.Text = "Product Src '" + tbProdSrcName.Text + "' Product Dest '" + tbProdSrcName.Text + "' has already exists"
                        Exit Sub
                    End If
                End If
                Row = ViewState("Dt").Select("ProductSrc+'|'+ProductDest = " + QuotedStr(ViewState("DtValue")))(0)
                If CekDt() = False Then
                    Exit Sub
                End If
                Row.BeginEdit()
                ...
                'If ViewState("StrKode") <> "TRL" Then
                '    Row("LevelProduct") = tbLevelProduct.Text
                'End If
            ...
            Else
                ...
                End If
                If CekExistData(ViewState("Dt"), "ProductSrc,ProductDest", tbProdSrcCode.Text + "|" + tbProdDestCode.Text) Then
                    lbStatus.Text = "Product Src '" + tbProdSrcName.Text + "' Product Dest '" + tbProdDestName.Text + "' has already exists"
                    Exit Sub
                End If
                Dim dr As DataRow
                dr = ViewState("Dt").NewRow
                ...
                'If ViewState("StrKode") <> "TRL" Then
                '    dr("LevelProduct") = tbLevelProduct.Text
                'End If
    ...
    Protected Sub tbProdDestCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbProdDestCode.TextChanged
        ...
        Try
            If ViewState("StrKode") = "TRG" Then
                Dt = SQLExecuteQuery("SELECT Product_Code, Product_Name, Specification, Unit FROM VMsProduct WHERE Product_Code = " + QuotedStr(tbProdDestCode.Text) + " And LevelProduct > " + tbLevelProduct.Text, ViewState("DBConnection").ToString).Tables(0)
            Else
                Dt = SQLExecuteQuery("SELECT Product_Code, Product_Name, Specification, Unit FROM VMsProduct WHERE Product_Code = " + QuotedStr(tbProdDestCode.Text), ViewState("DBConnection").ToString).Tables(0)
            End If
    ...
    Protected Sub btnProdDest_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnProdDest.Click
        Dim ResultField, CriteriaField As String
        Try
            'if tbLevelProduct.Text = "" then 
            '                lbStatus.Text = MessageDlg("Level Product in Product Source must have value")
            '                btnProdSrc.Focus()
            '  exit sub
            '              End If
		
            CriteriaField = "Product_Code, Product_Name, Specification, Product_Alias, Unit "
            If ViewState("StrKode") = "TRL" Then
                Session("filter") = "select Product_Code, Product_Name, Specification, Unit from VMsProduct WHERE Product_Code <> " + QuotedStr(tbProdSrcCode.Text)
            Else
		if tbLevelProduct.Text = "" then 
                    Session("filter") = "select Product_Code, Product_Name, Specification, Unit, LevelProduct from VMsProduct WHERE Product_Code <> " + QuotedStr(tbProdSrcCode.Text) + " " '" AND LevelProduct > 0 "
		else
                    Session("filter") = "select Product_Code, Product_Name, Specification, Unit, LevelProduct from VMsProduct WHERE Product_Code <> " + QuotedStr(tbProdSrcCode.Text) + ""  ' " AND LevelProduct > " + tbLevelProduct.Text
		END IF
            End If
    ...
    Protected Sub btnReffNo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReffNo.Click
        Dim ResultField As String
        Try
            Session("filter") = "SELECT DISTINCT TransNmbr, Wrhs_Area, Warehouse, WarehouseName, FgSubled, Subled, Subled_Name, Operator, Remark, OpnameNo from V_STTransferGetProduct WHERE ReffType = " + QuotedStr(ddlReffType.SelectedValue)
    ...
    Protected Sub btnGetDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGetDt.Click
        ...
        Try
            ...
            If tbReffNo.Text <> "" Then
                ...
                Session("Filter") = "EXEC S_STTransferReff " + QuotedStr(tbReffNo.Text) + ", " + QuotedStr(ddlWrhsSrc.SelectedValue) + ", " + QuotedStr(tbSubledDest.Text) + ", " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnGetLHP_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGetLHP.Click
        ...
        Try
            ...
            If tbReffNo.Text = "" Then
                ...
                Session("filter") = "SELECT * From V_STTransferGetLHPLot Where DoneTT = 'N' And Warehouse = " + QuotedStr(ddlWrhsSrc.SelectedValue)
                Session("CriteriaField") = CriteriaField.Split(",")
            End If
