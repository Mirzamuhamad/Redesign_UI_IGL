<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrTransferTBM.aspx.vb" Inherits="Transaction_TrTransferTBM_TrTransferTBM" %>
...
<body>     
    <form id="form1" runat="server">
     <div class="Content">
    <div class="H1">Transfer TBM to TM</div>
     <hr style="color:Blue" />        
            ...
            <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                <asp:GridView ID="GridDt" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Block" HeaderStyle-Width="100px" HeaderText="Block Code" SortExpression="BlockCode" >
                ...
                <td style="width:60%">                
                    <table>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:DropDownList ID="ddlCode" runat="server" AutoPostBack="False" 
