...
Partial Class Transaction_TrTransferTBM_TrTransferTBM
    Inherits System.Web.UI.Page

    Protected con As New SqlConnection
    Protected da As New SqlDataAdapter
    Protected GetStringHd As String = "Select * From V_PLTransferTMHd"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            '        ddlCode.SelectedValue = Session("Result")(0).ToString
    ...
    Private Sub SetInit()
        FillRange(ddlRange)
        FillCombo(ddlCode, "EXEC S_GetBlock", True, "Block_Code", "Block_Name", ViewState("DBConnection"))
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT TransNmbr, Block, BlockName,  Remark From V_PLTransferTMDt WHERE TransNmbr = " + QuotedStr(Nmbr)
    End Function
    ...
    Protected Sub BtnGo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGo.Click, btnGo2.Click
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                Session("SelectCommand") = "EXEC S_FormTransferTM " + Result + " , " + QuotedStr(ViewState("UserId").ToString)
                lbStatus.Text = Session("SelectCommand")
                Exit Sub
                Session("ReportFile") = ".../../../Rpt/FormTrTransferTM.frx"
            ...
            Else
                ...
                For j = 0 To (Nmbr.Length - 1)
                    If Nmbr(j) = "" Then
                        Exit For
                    Else
                        Result = ExecSPCommandGo(ActionValue, "S_PLTransferTM", Nmbr(j), CInt(Session(Request.QueryString("KeyId"))("Year")), CInt(Session(Request.QueryString("KeyId"))("Period")), ViewState("UserId").ToString, ViewState("DBConnection").ToString)
                        If Trim(Result) <> "" Then
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbRef.Text = GetAutoNmbr("PT", "Y", Year(tbDate.SelectedDate), Month(tbDate.SelectedDate), "", ViewState("DBConnection").ToString)
                'lbStatus.Text = tbRef.Text
                'Exit Sub

                SQLString = "INSERT INTO PLTransferTMHd (TransNmbr, TransDate, Status, Remark, UserPrep, DatePrep) " + _
            ...
            Else
                ...
                cekStatus = SQLExecuteScalar("Select Status FROM PLTransferTMHd WHERE TransNmbr = " + QuotedStr(tbRef.Text), ViewState("DBConnection").ToString)
                If cekStatus = "P" Then
                    lbStatus.Text = MessageDlg("Save failed... Data has already posted by another user")
                    Exit Sub
                End If
                SQLString = "UPDATE PLTransferTMHd SET Remark = " + QuotedStr(tbRemark.Text) + _
            ...
            con.Open()
            Dim cmdSql As New SqlCommand("SELECT TransNmbr, Block, Remark FROM PLTransferTMDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "'", con)
            ...
            Dim Update_Command = New SqlCommand( _
                    "UPDATE PLTransferTMDt SET Block = @Block,  Remark = @Remark " + _
            ...
            Dim Delete_Command = New SqlCommand( _
                "DELETE FROM PLTransferTMDt WHERE TransNmbr = '" & ViewState("TransNmbr") & "' AND Block = @Block", con)
            ' Add the parameters for the DeleteCommand.
            param = Delete_Command.Parameters.Add("@Block", SqlDbType.VarChar, 5, "Block")
            param.SourceVersion = DataRowVersion.Original
            da.DeleteCommand = Delete_Command

            Dim Dt As New DataTable("PLTransferTMDt")
    ...
    Protected Sub btnSaveAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveAll.Click
        Try
            ...
            End If
            For Each dr In ViewState("Dt").Rows
                If CekDt(dr, "TransDate") = False Then
                    Exit Sub
                End If
            Next
            SaveAll()
    ...
    Function CekDt(Optional ByVal Dr As DataRow = Nothing, Optional ByVal FieldKey As String = "") As Boolean
        Try
            If Not (Dr Is Nothing) Then
                ...
                'End If
            Else
                If ddlCode.SelectedValue.Trim = "" Then
    ...
    Protected Sub LbAdvSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LbAdvSearch.Click
        ...
        Try
            ...
            FilterName = "TransNmbr, Date, Remark"
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        End If
                        Session("DBConnection") = ViewState("DBConnection")
                        Session("SelectCommand") = "EXEC S_PLFormTransferTM " + QuotedStr(GVR.Cells(2).Text) + "," + QuotedStr(ViewState("UserId").ToString)
                        Session("ReportFile") = ".../../../Rpt/FormTransferTM.frx"
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    Protected Sub GridDt_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridDt.RowEditing
        ...
        Try
            ...
            ViewState("DtValue") = ddlCode.SelectedValue
            ddlCode.Focus()
            StatusButtonSave(False)
        Catch ex As Exception
    ...
    Protected Sub FillTextBoxDt(ByVal Product As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                BindToDropList(ddlCode, Dr(0)("Block").ToString)
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveDt.Click
        ...
        Try
            ...
            If ViewState("StateDt") = "Edit" Then
                If ViewState("DtValue") <> ddlCode.SelectedValue Then
                    If CekExistData(ViewState("Dt"), "Block ", ddlCode.SelectedValue) Then
                        lbStatus.Text = "Block has already exists"
                        Exit Sub
                    End If
                End If
                ...
                'End If
                Row.BeginEdit()
                Row("Block") = ddlCode.SelectedValue
            ...
            Else
                ...
                dr("Block") = ddlCode.SelectedValue
    ...
    'Protected Sub ddlCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlCode.SelectedValueChanged
    '    Dim Dt As DataTable
    '    Dim Dr As DataRow
    '    Try
    '        Dt = SQLExecuteQuery("SELECT BlockCode, BlockName From MsBlock Where Block = '" + ddlCode.SelectedValue + "'", ViewState("DBConnection").ToString).Tables(0)

    '        If Dt.Rows.Count > 0 Then
    '            Dr = Dt.Rows(0)
    '            ddlCode.SelectedValue = Dr("BlockCode").ToString
