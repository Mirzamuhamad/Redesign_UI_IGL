...
Partial Class JEntry
    ...
    Protected GetStringHdJS As String = "Select * From V_GLJournalHD WHERE TransClass = 'JS'"
        ...
        Try
            ...
            If Not Session("Result") Is Nothing Then
                If ViewState("Sender") = "btnAcc" Then
                    ...
                    If tbfgSubled.Text <> "N" Then
                        btnSubled.Enabled = True
                    Else
                        btnSubled.Enabled = False
                    End If
    ...
    Private Sub SetInit()
        ...
        End If
        If Request.QueryString("ContainerId").ToString = "JSEntryID" Then
            ViewState("StrTransType") = "JS"
            lblTitle.Text = "Journal Special"
        Else
            ViewState("StrTransType") = "JE"
            lblTitle.Text = "Journal Entry"
        End If
    ...
    Private Sub BindData(Optional ByVal AdvanceFilter As String = "")
        ...
        Try
            ...
            'Exit Sub
            If Request.QueryString("ContainerId").ToString = "JSEntryID" Then
                DT = BindDataTransaction(GetStringHdJS, StrFilter, ViewState("DBConnection").ToString)
            Else
    ...
    Private Function GetStringDt(ByVal Nmbr As String) As String
        Return "SELECT * From V_GLJournalDt WHERE Reference = " + QuotedStr(Nmbr) + " AND TransClass = 'JE' Order By ItemNo"
    End Function
    Private Function GetStringDtJS(ByVal Nmbr As String) As String
        Return "SELECT * From V_GLJournalDt WHERE Reference = " + QuotedStr(Nmbr) + " AND TransClass = 'JS' Order By ItemNo"
    End Function
        ...
        Try
            ...
            If ActionValue = "Print" Then
                ...
                For Each GVR In GridView1.Rows
                    ...
                    If CB.Checked Then
                        If Request.QueryString("ContainerId").ToString = "JSEntryID" Then
                            ListSelectNmbr = GVR.Cells(2).Text + "|JS"
                        Else
                ...
                Session("SelectCommand") = "EXEC S_GLFormJournal " + Result + " , " + QuotedStr(ViewState("StrTransType")) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Private Sub BindDataDt(ByVal Referens As String)
        Try
            ...
            'If Request.QueryString("ContainerId").ToString = "JSEntryID" Then
            '    dt = SQLExecuteQuery(GetStringDtJS(Referens), ViewState("DBConnection").ToString).Tables(0)
            'Else
    ...
    Protected Sub btnSaveDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveDt.Click
        ...
        Try
            ...
            Else
                ...
                dr("TransClass") = ViewState("StrTransType")
    ...
    Private Sub SaveAll()
        ...
        Try
            ...
            If ViewState("StateSave") = "Insert" Then
                tbRef.Text = GetAutoNmbr(ViewState("StrTransType"), "Y", Year(tbDate.SelectedValue), Month(tbDate.SelectedValue), "", ViewState("DBConnection").ToString)

                SQLString = "INSERT INTO GLJournalHd (Reference, TransClass, Status, TransDate, FormatJE, Remark, UserPrep, DatePrep, FgReport) " + _
                "SELECT '" + tbRef.Text + "', " + QuotedStr(ViewState("StrTransType")) + ", 'H', '" + Format(tbDate.SelectedValue, "yyyy-MM-dd") + "', '" + ddlJE.SelectedValue + "', " + QuotedStr(tbRemark.Text) + "," + _
            ...
            Else
                ...
                " WHERE Reference = '" + tbRef.Text + "' AND TransClass = " + QuotedStr(ViewState("StrTransType"))
            End If
            ...
            For I = 0 To Row.Length - 1
                ...
                Row(I)("TransClass") = ViewState("StrTransType")
                Row(I).EndEdit()
            Next
    ...
    Protected Sub btnSaveTrans_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveTrans.Click
        ...
        Try
            If CekHd() = False Then
                Exit Sub
            End If
            If CFloat(tbSelisih.Text) <> 0 Then
    ...
    Protected Sub btnSaveAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveAll.Click
        Try
            ...
            End If
            If CFloat(tbSelisih.Text) <> 0 Then
                lbStatus.Text = MessageDlg("Debet - Credit must be same")
                Exit Sub
            End If
            If IsNothing(ViewState("Dt")) Then
                lbStatus.Text = MessageDlg("Detail must have at least 1 record")
    ...
    Protected Sub tbAccCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbAccCode.TextChanged
        ...
        Dim Dr As DataRow
        Try
            Dt = SQLExecuteQuery("EXEC S_FindAccountJS " + QuotedStr(tbAccCode.Text.Trim) + "," + QuotedStr(ddlJE.SelectedValue) + ", " + QuotedStr(ViewState("StrTransType")), ViewState("DBConnection").ToString).Tables(0)
            If Dt.Rows.Count > 0 Then
                Dr = Dt.Rows(0)
            ...
            If e.CommandName = "Go" Then
                ...
                ElseIf DDL.SelectedValue = "Print" Then
                    Try
                        ...
                        End If
                        Session("DBConnection") = ViewState("DBConnection")
                        Session("SelectCommand") = "EXEC S_GLFormJournal ''" + QuotedStr(GVR.Cells(2).Text + "|" + ViewState("StrTransType")) + "'', " + QuotedStr(ViewState("StrTransType")) + "," + QuotedStr(ViewState("UserId").ToString)
                        Session("ReportFile") = ".../../../Rpt/FormJournal.frx"
                        AttachScript("openprintdlg();", Page, Me.GetType)
                    Catch ex As Exception
    ...
    Protected Sub BtnGetDt_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnGetDt.Click
        ...
        Try
            Session("Result") = Nothing
            Session("Filter") = "select * from V_MsAccountDt WHERE TransType = " + QuotedStr(ViewState("StrTransType"))
    ...
    Protected Sub FillTextBoxHd(ByVal Nmbr As String)
        ...
        Try
            If Request.QueryString("ContainerId").ToString = "JSEntryID" Then
                Dt = BindDataTransaction(GetStringHdJS, "Reference = " + QuotedStr(Nmbr), ViewState("DBConnection").ToString)
            Else
            ...
            BindToText(tbDebit, Dt.Rows(0)("Credit").ToString)
            BindToText(tbCredit, Dt.Rows(0)("Debit").ToString)
            BindToText(tbSelisih, Dt.Rows(0)("Selisih").ToString)
    ...
    Protected Sub FillTextBoxDt(ByVal ItemNo As String)
        ...
        Try
            ...
            If Dr.Length > 0 Then
                ...
                BindToText(tbDebitForex, Dr(0)("DebitForex").ToString, ViewState("DigitCurr"))
                BindToText(tbCreditForex, Dr(0)("CreditForex").ToString, ViewState("DigitCurr"))
                BindToText(tbDebitHome, Dr(0)("DebitHome").ToString, ViewState("DigitCurr"))
                BindToText(tbCreditHome, Dr(0)("CreditHome").ToString, ViewState("DigitCurr"))
