...
#Region "Region Product Type============================================================================================================"
    ...
    Protected Sub btnPrintPT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrintPT.Click
        ...
        Try
            ...
            SQLString = "exec S_MsMateriCodeAccRpt " + QuotedStr(ViewState("UserId"))
            Session("SelectCommand") = SQLString
            Session("ReportFile") = ".../../../Rpt/RptPrintMsMateriCodeAcc.frx"
    ...
    Private Sub bindDataGridDt()
        ...
        Try
            ...
            'SqlString = "Select * from MsMateriCode " + StrFilter
            SqlString = "SELECT A.*, B.BentukName As MateriCodeName, C.AccountName AS AccInventName, " + _
            ...
            "MsMateriCode B ON A.MateriCode = B.MateriCode LEFT OUTER JOIN " + _
            ...
            If e.CommandName = "Go" Then
                ...
                If DDL.SelectedValue = "Delete" Then
                    Try
                        ...
                        SQLExecuteNonQuery("Delete from MsProductMateriDt where MateriCode = " + QuotedStr(GVR.Cells(1).Text) + " AND WrhsType =" + QuotedStr(GVR.Cells(3).Text), ViewState("DBConnection").ToString)
                        bindDataGridDt()
    ...
    Protected Sub DataGridDt_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGridDt.RowUpdating
        ...
        Try
            ...
            ", MateriCode= " + QuotedStr(ddlProductBentuk.SelectedValue) + _
            ...
            " AND MateriCode =" + QuotedStr(ViewState("Nmbr"))
    ...
    Protected Sub FillTextBoxDt(ByVal Nmbr As String, ByVal Code As String)
        Try
            ...
            "MsAccount K ON A.AccSales = K.Account LEFT OUTER JOIN " + _
            "MsAccount L ON A.AccSRetur = L.Account LEFT OUTER JOIN " + _
            "MsAccount R ON A.AccExpLoss = R.Account WHERE A.MateriCode =" + QuotedStr(Nmbr) + " AND WrhsType = " + QuotedStr(Code), ViewState("DBConnection").ToString).Tables(0).Rows(0)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If ViewState("State") = "Insert" Then
                ...
                '    Exit Sub
                'End If
                If SQLExecuteScalar("SELECT WrhsType From MsProductMateriDt WHERE MateriCode = " + QuotedStr(ddlProductBentuk.SelectedValue) + " AND WrhsType =" + QuotedStr(ddlWrhsType.SelectedValue), ViewState("DBConnection").ToString).Length > 0 Then
                ...
                SQLString = "Insert Into MsProductMateriDt (Insert Into MsProductMateriDt (ProductJenis, MateriCode, WrhsType, AccInvent, AccSales, AccCOGS, AccTransitSJ, AccTransitWrhs, AccTransitReject, AccTransitRetur, AccSRetur, AccExpLoss, UserId, UserDate) " + _
                "SELECT " + QuotedStr(ViewState("Nmbr")) + "," + QuotedStr(ddlProductBentuk.SelectedValue) + ", " + QuotedStr(ddlWrhsType.SelectedValue) + "," + _
...
#Region "Region Customer Group=========================================================================================================="
    ...
    Private Sub bindDataGridDtCustGroup()
        ...
        Try
            ...
            "I.AccountName AS AccPPNName, M.AccountName AS AccOtherName,P.AccountName AS AccSJUninvoiceName,  " + _
    ...
    Protected Sub btnSaveDtCustGroup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveDtCustGroup.Click
        ...
        Try
            ...
            If ViewState("StateDt") = "Insert" Then
                ...
                SQLString = "Insert Into MsCustGroupAcc (CustGroup, CurrCode, AccAR, AccCreditAR, AccSJUninvoice, AccDP, AccDeposit, AccPPn, AccOther, AccDisc, UserId, UserDate) " + _
                ...
                QuotedStr(tbAccDiscCustGroup.Text) + "," + QuotedStr(ViewState("UserId")) + ", getDate()"
                'Else
