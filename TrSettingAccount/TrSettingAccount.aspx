                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField">
                                        <asp:ListItem Selected="true" Text="Product Bentuk Code" Value="A.ProductBentuk"></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField2">
                                            <asp:ListItem Selected="true" Text="Product Bentuk Code" Value="ProductBentuk"></asp:ListItem>
                                            <asp:ListItem Text="Product Bentuk Name" Value="ProductBentukName"></asp:ListItem>
                                            <asp:ListItem Text="Wrhs Type" Value="WrhsType"></asp:ListItem>
                                            <asp:ListItem Text="Acc Invent" Value="AccInvent"></asp:ListItem>
                                            <asp:ListItem Text="Acc Invent Name" Value="C.AccountName"></asp:ListItem>
                                            <asp:ListItem Text="Acc Cogs" Value="AccCogs"></asp:ListItem>
                        ...
                        <div style="border: 0px  solid; width: 100%; height: 100%; overflow: auto;">
                            <asp:GridView ID="DataGridDt" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ProductBentuk" SortExpression="ProductBentuk" HeaderText="Product Bentuk" />
                                    <asp:BoundField DataField="ProductBentukName" SortExpression="ProductBentukName" HeaderText="Product Bentuk Name" />
