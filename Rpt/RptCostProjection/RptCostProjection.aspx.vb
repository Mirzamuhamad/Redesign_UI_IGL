...
Partial Class Rpt_RptMonitoringBiayaKavling
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_RptMonitoringKavlingCost " + QuotedStr(tbProcess.Text) + "," + QuotedStr(Format(ViewState("ServerDate"), "yyyy-MM-dd")) + ", " + QuotedStr(ViewState("UserId"))

            'lbStatus.Text = Session("SelectCommand")
            'Exit Sub

            Session("ReportFile") = ".../../../Rpt/RptMonitoringBiayaKavling.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            ViewState("PrintType") = "Preview"
            Session("DBConnection") = ViewState("DBConnection")
            SQLString = "EXEC S_RptMonitoringKavlingCost " + QuotedStr(tbProcess.Text) + ", " + QuotedStr(Format(ViewState("ServerDate"), "yyyy-MM-dd")) + ", " + QuotedStr(ViewState("UserId"))
            ...
            GridExport.DataBind()
            ExportGridToExcel("RptMonitoringBiayaKavling")
