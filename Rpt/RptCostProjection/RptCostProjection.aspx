<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptCostProjection.aspx.vb" Inherits="Rpt_RptMonitoringBiayaKavling" %>
...
<head id="Head1" runat="server">
    <title>Report Cost Projection</title>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Cost Projection / Monitoring Biaya Kavling</div>
     <hr style="color:Blue" />     
        <br />
      <table>
        <tr>
            ...
            <td>:</td>
            <td>
            <asp:DropDownList CssClass="DropDownList" ID="ddlsitePlan" AutoPostBack = "true" runat="server"/>
