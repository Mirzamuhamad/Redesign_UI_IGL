<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgDateSumDetailMonitoring.aspx.vb" Inherits="Rpt_RptDlgDateSumDetailMonitoring_ReportTemplate" %>
     ...
     <hr style="color:Blue" />
      <table>
        <tr>
                ...
                <td>
                    <BDP:BasicDatePicker Visible = "False" ID="tbStartDate" runat="server" DateFormat="dd MMM yyyy" 
                ...
                <td> 
                    <BDP:BasicDatePicker  Visible = "False" ID="tbEndDate" runat="server" DateFormat="dd MMM yyyy" 
                        ShowNoneButton = "false" ReadOnly = "true" ButtonImageHeight="19px" ButtonImageWidth="20px" 
                        DisplayType="TextBoxAndImage" 
                        TextBoxStyle-CssClass="TextDate"><TextBoxStyle CssClass="TextDate" /></BDP:BasicDatePicker>
                </td> 
