    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptCashFlowForecast")
    ...
    Private Sub print()
        Try
            ...
            If ddlCurrency.SelectedIndex = 1 Then
                ...
                Session("SelectCommand") = "EXEC S_GLRptCashFlowForecast " + ddlYear.SelectedValue + _
                "," + ddlPeriod.SelectedValue + ", " + QuotedStr(ddlCurrency.SelectedValue) + ",'" + result + "', " + tbRate.Text.Replace(",", "") + ", 0 "
                Session("SelectCommand2") = "EXEC S_GLRptCashFlowForecast " + ddlYear.SelectedValue + _
            "," + ddlPeriod.SelectedValue + ", " + QuotedStr(ddlCurrency.SelectedValue) + ",'" + result + "', " + tbRate.Text.Replace(",", "") + ", 2 "
                Session("ReportFile") = Server.MapPath("~\Rpt\RptCashFlowActual.frx")
            ...
            Else
                ...
                Session("SelectCommand") = "EXEC S_GLRptCashFlowForecast " + ddlYear.SelectedValue + _
                "," + ddlPeriod.SelectedValue + ", " + QuotedStr(ddlCurrency.SelectedValue) + ",'" + result + "', " + tbRate.Text.Replace(",", "") + ", 0 "
                Session("ReportFile") = Server.MapPath("~\Rpt\RptCashFlowForecast.frx")
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            If tbRate.Text.Trim = "" Then
                ...
                Exit Sub
            End If
            SQLString = "EXEC S_GLRptCashFlowForecast " + ddlYear.SelectedValue + _
            "," + ddlPeriod.SelectedValue + ", " + QuotedStr(ddlCurrency.SelectedValue) + ",'" + result + "', " + tbRate.Text.Replace(",", "") + ", 1 "

            dt = SQLExecuteQuery(SQLString, ViewState("DBConnection")).Tables(0)
            GridExport.DataSource = dt
            GridExport.DataBind()
            ExportGridToExcel("RptCashFlowDetail")
        Catch ex As Exception
            Throw New Exception("btn Export Error : " + ex.ToString)
        End Try
    End Sub

    Protected Sub btnExportSum_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportSum.Click
        Dim dt As DataTable
        Dim SQLString, result As String
        Try
            result = ReportGrid.ResultString
