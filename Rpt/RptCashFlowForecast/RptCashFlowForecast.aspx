<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptCashFlowForecast.aspx.vb" Inherits="RptCashFlowForcash" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Cash Flow Projection</div>
    <hr style="color:Blue" />                
        <table>
            <tr>
                ...
                <td>:</td>--%>
                <td>
                    <asp:TextBox runat="server" ID="tbRate" CssClass="TextBox" Width="70px" Visible=false></asp:TextBox>
                    <asp:Label runat="server" ID="lbRate" Text=" /US$" Visible=false></asp:Label>
                </td>
        ...
        <asp:Button class="bitbtn btnexcel" runat="server" Width="110px" ID="btnExportSum" Text="Export Summary"/>        
        <br />
