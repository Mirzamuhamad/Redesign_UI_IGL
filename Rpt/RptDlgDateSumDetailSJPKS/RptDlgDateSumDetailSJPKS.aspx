<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgDateSumDetailSJPKS.aspx.vb" Inherits="Rpt_RptDlgDateRekapSJPKS_ReportTemplate" %>
        ...
        <tr>
            <td>Period</td>
                ...
                <td> 
                 ...
                 <td> &nbsp &nbsp &nbsp 
                Customer</td>
            <td> <asp:CheckBox ID="cbCuss" AutoPostBack="true" runat="server" Text=":" />
                </td>
            <td>
                
                <asp:TextBox ID="tbCustomer" runat="server" AutoPostBack="True" CssClass="TextBox" Width="70px" Visible="False" Enabled="True"  />
                <asp:TextBox ID="tbCustonerName" runat="server" CssClass="TextBoxR" Enabled="False" Visible="False"  
                    Width="120px" />
             ...
             <td> &nbsp &nbsp &nbsp
                No Contract</td>
            <td>
              <asp:CheckBox ID="cbKontrak" AutoPostBack="true" runat="server" Text=":" />
            </td>
            <td>
                <asp:TextBox ID="tbNoContract" Visible = "False"  runat="server" CssClass="TextBox" Width="120px"  />
               
                <asp:Button ID="btnContract" runat="server" Class="btngo" Visible = "False" Text="..." />
            </td>
