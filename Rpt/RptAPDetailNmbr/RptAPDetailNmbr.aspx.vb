...
Partial Class Rpt_RptAPDetailNmbr_RptAPDetailNmbr
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptAPDetailNmbr")
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FNRptAPDetailNmbr " + QuotedStr(tbTransDate.SelectedValue) + ",'" + _
            result + "', '', '', ''," + _
            ...
            If RBRType.SelectedIndex = 0 Then
                Session("ReportFile") = ".../../../Rpt/RptAPSummaryNmbr.frx"
            Else
                Session("ReportFile") = ".../../../Rpt/RptAPDetailNmbr.frx"
            End If
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Dim dt As DataTable
        Dim SQLString, result, Range1, Range2, Range3 As String
        Dim FgFwd As String
        Try
            result = ReportGrid.ResultString
            'cat = ReportGrid.ResultCategory
            ...
            If RBRType.SelectedIndex = 0 Then
                'modify this one
                SQLString = "EXEC S_FNRptAPSummaryNmbr " + QuotedStr(tbTransDate.SelectedValue) + ",'" + _
                result + "', '', '', ''," + _
                ...
                GridExport.DataBind()
                ExportGridToExcel("RptAPSummaryNmbr")
            Else
                'modify this one
                SQLString = "EXEC S_FNRptAPDetailNmbr " + QuotedStr(tbTransDate.SelectedValue) + ",'" + _
                result + "', '', '', ''," + _
                Range1 + "," + Range2 + "," + Range3 + ", 0," + FgFwd + ",'N'," + QuotedStr(ViewState("UserId")) + ",1"
                ...
                GridExport.DataSource = dt
                GridExport.DataBind()
                ExportGridToExcel("RptAPDetailNmbr")
            End If
