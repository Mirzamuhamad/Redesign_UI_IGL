...
Partial Class Rpt_RptDlgDateRekapTonase_ReportTemplate
    ...
    Private Sub print()
        ...
        Try
            ...
            ElseIf ViewState("xPrint") = 0 Then
                ...
                Form2 = "2"
                Form3 = "3"
                Session("SelectCommand") = "EXEC S_PLRptJurnalPanen " + " '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2', " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand2") = "SELECT *  FROM RptJurnalPanenBlokTemp "
                Session("SelectCommand2") = "SELECT *  FROM RptJurnalPanenOPTemp "
                Session("ReportFile") = ".../../../Rpt/RptJurnalPanen.frx"
                AttachScriptAJAX("openreport3();", Page, Me.GetType)
            Else
