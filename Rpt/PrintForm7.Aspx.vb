...
Partial Class Rpt_PrintForm7
    ...
    Protected Sub Page_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            ...
            'Session("SelectCommand4") = Nothing
            'Session("SelectCommand5") = Nothing
        ...
        Try
            If Not Me.IsPostBack Then
                If Me.WebReport1.ReportFile = "" Then
                    ...
                    ViewState("SelectCommand4") = Session("SelectCommand4")
                    ViewState("SelectCommand5") = Session("SelectCommand5")
                    ViewState("SelectCommand6") = Session("SelectCommand6")
                    ViewState("SelectCommand7") = Session("SelectCommand7")
                    ...
                    Session("SelectCommand4") = Nothing
                    Session("SelectCommand5") = Nothing
                    Session("SelectCommand6") = Nothing
                    Session("SelectCommand7") = Nothing
    ...
    Protected Sub WebReport1_StartReport(ByVal sender As Object, ByVal e As System.EventArgs) Handles WebReport1.StartReport
        Try
            ...
            Dim DS4 As DataSet
            DS4 = SQLExecuteQuery(ViewState("SelectCommand4"), ViewState("DBConnection"))
            WebReport1.Report.RegisterData(DS4.Tables(0), "DS4")

            Dim DS5 As DataSet
            DS5 = SQLExecuteQuery(ViewState("SelectCommand5"), ViewState("DBConnection"))
            WebReport1.Report.RegisterData(DS5.Tables(0), "DS5")

            Dim DS6 As DataSet
            DS6 = SQLExecuteQuery(ViewState("SelectCommand6"), ViewState("DBConnection"))
            WebReport1.Report.RegisterData(DS6.Tables(0), "DS6")

            Dim DS7 As DataSet
            DS7 = SQLExecuteQuery(ViewState("SelectCommand7"), ViewState("DBConnection"))
            WebReport1.Report.RegisterData(DS7.Tables(0), "DS7")
