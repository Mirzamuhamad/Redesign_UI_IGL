...
Partial Class Rpt_RptDlgMpSumDetail
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " , " + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
            ...
            If ViewState("xPrint") = 5 Then
                Session("SelectCommand2") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand3") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '3' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand4") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '4' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand5") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '5' , " + QuotedStr(ViewState("UserId").ToString)
                AttachScriptAJAX("openreport5();", Page, Me.GetType)
            ElseIf ViewState("xPrint") = 4 Then
                Session("SelectCommand2") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand3") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '3' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand4") = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '4' , " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            FgForceNewPage = "X"
            'End If
            SQLString = ViewState("ExeSP") + " " + QuotedStr(tbProcess.Text) + " ," + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(tbinflasi.Text) + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            Session("filter") = "SELECT TransNmbr, MasterPlanName FROM PLMasterPlanHd " 'WHERE UserId = " + QuotedStr(ViewState("UserId").ToString)
