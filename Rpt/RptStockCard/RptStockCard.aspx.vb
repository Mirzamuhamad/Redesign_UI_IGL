...
Imports System.IO
Partial Class Rpt_RptStockCard_RptStockCard
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            Session("DBConnection") = ViewState("DBConnection")
            Session("PrintType") = "Preview"
            SQLString ="EXEC S_STRptStockCard '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', ' ', '" + Result + "', '', " + FgReport + "," + QuotedStr(ViewState("UserId").ToString)
