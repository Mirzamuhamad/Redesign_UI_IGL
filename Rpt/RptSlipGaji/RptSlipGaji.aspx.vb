...
Partial Class Rpt_RptSlipGaji_RptSlipGaji
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_PYRptSlipGaji " + QuotedStr(tbProcess.Text) + ", '" + result + "', '', " + QuotedStr(Str)

            Session("ReportFile") = ".../../../Rpt/RptSlipGaji.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            ViewState("PrintType") = "Preview"
            Session("DBConnection") = ViewState("DBConnection")
            SQLString = "EXEC S_PYRptSlipGaji " + QuotedStr(tbProcess.Text) + ", '" + Result + "', '', " + QuotedStr(Str)

            dt = SQLExecuteQuery(SQLString, ViewState("DBConnection")).Tables(0)
            GridExport.DataSource = dt
            GridExport.DataBind()
            ExportGridToExcel("RptSlipGaji")
