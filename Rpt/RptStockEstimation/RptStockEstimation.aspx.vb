...
Imports System.IO
Partial Class Rpt_RptStockEstimation_RptStockEstimation
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptStockEstimation")
    ...
    Private Sub print()
        ...
        Try
            ...
            ReportGrid.setConnection(ViewState("DBConnection"), ViewState("UserId"))
            Session("SelectCommand") = "EXEC S_STRptStockEstimation '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + result + "','','', " + cbcek + ", " + QuotedStr(ViewState("UserId"))

            Session("ReportFile") = ".../../../Rpt/RptStockEstimation.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            SQLString = "EXEC S_STRptStockEstimation '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + Result + "','','X', " + cbcek + ", " + QuotedStr(ViewState("UserId"))

            dt = SQLExecuteQuery(SQLString, ViewState("DBConnection")).Tables(0)
            GridExport.DataSource = dt
            GridExport.DataBind()
            ExportGridToExcel("Stock Estimation")
