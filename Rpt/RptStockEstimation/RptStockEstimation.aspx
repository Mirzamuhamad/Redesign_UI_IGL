<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStockEstimation.aspx.vb" Inherits="Rpt_RptStockEstimation_RptStockEstimation" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Report Stock Estimation</div>
     <hr style="color:Blue" />
      <table>
        <tr>
            <td>Date</td>
