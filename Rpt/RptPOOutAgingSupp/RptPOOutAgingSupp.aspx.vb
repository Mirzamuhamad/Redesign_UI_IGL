...
Partial Class Rpt_RptPOOutAgingSupp_RptPOOutAgingSupp
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptPOOutAgingSupp")
    ...
    Protected Sub Print()
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_PRRptPOOutAging '" + Format(tbDate.SelectedDate, "yyyy-MM-dd") + "'," + Range1 + "," + Range2 + "," + Range3 + ",1,'" + Result + "','','','', " + RBFoward.SelectedIndex.ToString + ", " + RBType.SelectedIndex.ToString + "," + force + "," + QuotedStr(ViewState("UserId").ToString)
            If RBType.SelectedIndex = 0 Then
                Session("ReportFile") = ".../../../Rpt/RptPOOutAgingSupp.frx"
            Else
                Session("ReportFile") = ".../../../Rpt/RptPOOutAgingSuppDetail.frx"
            End If
