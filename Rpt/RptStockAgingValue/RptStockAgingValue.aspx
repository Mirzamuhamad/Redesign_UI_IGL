<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStockAgingValue.aspx.vb"
    Inherits="Rpt_RptStockAgingValue_RptStockAgingValue" %>
...
<head id="Head1" runat="server">
    <title>Report Stock Aging Value</title>
...
<body>
    ...
    <div class="Content">
        <div class="H1">Report Stock Aging Value</div>
        <hr style="color: Blue" />
        <table>
            <tr>
                <td>
