...
Partial Class Rpt_RptStockAgingValue_RptStockAgingValue
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptStockAging")
    ...
    Private Sub print()
        ...
        Try
            ...
            ReportGrid.setConnection(ViewState("DBConnection"), ViewState("UserId"))            
            Session("SelectCommand") = "EXEC S_STRptStockAgingValue '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + result + "','','', " + cbcek + ", " + QuotedStr(ViewState("UserId"))

            'lbStatus.Text = Session("SelectCommand")
            'Exit Sub
            
            Session("ReportFile") = ".../../../Rpt/RptStockAgingValue.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            SQLString = "EXEC S_STRptStockAgingValue '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + Result + "','','', " + cbcek + ", " + QuotedStr(ViewState("UserId"))
