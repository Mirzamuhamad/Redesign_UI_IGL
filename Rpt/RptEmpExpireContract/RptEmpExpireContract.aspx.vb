...
Partial Class Rpt_RptEmpExpireContract_RptEmpExpireContract
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_PERptEmpExpireContract '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '" + EmpStatus + "', " + rbType.SelectedIndex.ToString()
            Session("ReportFile") = Server.MapPath("~\Rpt\RptEmpExpireContract.frx")
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptEmpExpireContract")
            End If
            ReportGrid.setConnection(ViewState("DBConnection"), ViewState("UserId"))
