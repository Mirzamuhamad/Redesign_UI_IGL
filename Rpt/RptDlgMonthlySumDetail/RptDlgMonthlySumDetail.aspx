<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgMonthlySumDetail.aspx.vb" Inherits="Rpt_RptDlgMonthlySumDetail_ReportTemplate" %>
     ...
     <hr style="color:Blue" />
      <table>
            <tr>
                ...
                <td><asp:DropDownList ID="ddlStartPeriod" runat="server" CssClass="DropDownList" /></td>
                <td>AS AT</td>
                <td><asp:DropDownList ID="ddlEndYear" runat="server" CssClass="DropDownList" /></td>
                <td><asp:DropDownList ID="ddlEndPeriod" runat="server" CssClass="DropDownList" /></td>
