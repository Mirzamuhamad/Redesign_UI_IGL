...
Partial Class Rpt_RptDlgMonthlySumDetail_ReportTemplate
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                If dt.Rows(0)("FgPrintValue").ToString.Trim = "2" Or dt.Rows(0)("FgPrintValue").ToString.Trim = "3" Or dt.Rows(0)("FgPrintValue").ToString.Trim = "4" Or dt.Rows(0)("FgPrintValue").ToString.Trim = "5" Then
                    ViewState("xPrint") = CInt(dt.Rows(0)("FgPrintValue").ToString)
                Else
                    ViewState("xPrint") = 1
                End If
                ...
                FillCombo(ddlStartPeriod, "Select Period, Description FROM GLPeriod WHERE Period BETWEEN 1 and 12", False, "Period", "Description", ViewState("DBConnection"))
                'FillCombo(ddlEndPeriod, "Select Period, Description FROM GLPeriod WHERE Period BETWEEN 1 and 12", False, "Period", "Description", ViewState("DBConnection"))
                ddlStartYear.SelectedValue = ViewState("GLYear")
                'ddlEndYear.SelectedValue = ViewState("GLYear")
                ddlStartPeriod.SelectedValue = ViewState("GLPeriod")
                'ddlEndPeriod.SelectedValue = ViewState("GLPeriod")
            End If
            ReportGrid.setConnection(ViewState("DBConnection"), ViewState("UserId"))
            lbStatus.Text = ""
    ...
    Private Sub print()
        ...
        Try
            'cekPeriod = CekRangePeriodSelected(ddlStartYear.SelectedValue, ddlStartPeriod.SelectedValue)
            'If cekPeriod <> "" Then
            ...
            Session("SelectCommand") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
            ...
            If ViewState("xPrint") = 5 Then
                Session("SelectCommand2") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand3") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '3' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand4") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '4' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand5") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '5' , " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Dim FastRpt() As String
        Try
            'CekPeriod = CekRangePeriodSelected(ddlStartYear.SelectedValue, ddlStartPeriod.SelectedValue, ddlEndYear.SelectedValue, ddlEndPeriod.SelectedValue)
            'If CekPeriod <> "" Then
            '    lbStatus.Text = MessageDlg(CekPeriod)
            '    Exit Sub
            'End If
            ...
            FgForceNewPage = "X"
            'End If
            SQLString = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ddlStartPeriod.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
