...
Partial Class Rpt_GraphPerbandinganBPBInvoice_GraphPerbandinganBPBInvoice
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("GraphPerbandinganBPBInvoice")
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_EXERptMNGBPBInvoice " + ddlStartYear.SelectedValue + ", " + ddlStartMonth.SelectedValue + "," + ddlPeriod.SelectedValue.ToString + ", " + tbPeriod.Text + "," + ddlEndYear.SelectedValue + "," + ddlEndMonth.SelectedValue + ",'" + Result + "','',''," + RBType.SelectedIndex.ToString + "," + QuotedStr(ViewState("UserId").ToString)
