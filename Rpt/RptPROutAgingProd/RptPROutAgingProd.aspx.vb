...
Partial Class Rpt_RptPROutAgingProd_RptPROutAgingProd
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptPROutAgingProd")
    ...
    Protected Sub Print()
        ...
        Dim cat, force, Range1, Range2, Range3, Range4 As String
        Try
            ...
            Session("SelectCommand") = "EXEC S_PRRptPROutAging '" + Format(tbTransDate.SelectedDate, "yyyy-MM-dd") + "'," + Range1 + "," + Range2 + "," + Range3 + ",0,'" + Result + "','','','', " + RBFoward.SelectedIndex.ToString + ", " + RBType.SelectedIndex.ToString + "," + force + "," + QuotedStr(ViewState("UserId").ToString)
            If RBType.SelectedIndex = 0 Then
                Session("ReportFile") = ".../../../Rpt/RptPROutAgingProd.frx"
            Else
                Session("ReportFile") = ".../../../Rpt/RptPROutAgingProdDetail.frx"
            End If
