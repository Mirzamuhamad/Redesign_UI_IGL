<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgMonthCosting.aspx.vb" Inherits="Rpt_RptDlgDateSumDetail_ReportTemplate" %>
      ...
      <table>
        <tr>
            <td>Period</td>
                <td>:</td>
                <td>
                    <BDP:BasicDatePicker ID="tbStartDate" runat="server" AutoPostBack = "true" DateFormat="dd MMM yyyy" 
                ...
                <td>As</td>
                <td> 
                    <BDP:BasicDatePicker ID="tbEndDate" runat="server" Enabled = "False" DateFormat="dd MMM yyyy" 
                        ShowNoneButton = "false" ReadOnly = "true" ButtonImageHeight="19px" ButtonImageWidth="20px" 
                        DisplayType="TextBoxAndImage" 
                        TextBoxStyle-CssClass="TextDate"><TextBoxStyle CssClass="TextDate" /></BDP:BasicDatePicker>
                </td> 
