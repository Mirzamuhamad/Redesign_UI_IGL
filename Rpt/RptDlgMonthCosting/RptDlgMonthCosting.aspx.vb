...
Partial Class Rpt_RptDlgDateSumDetail_ReportTemplate
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_RptCostingReport2 '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ",'N', " + QuotedStr(ViewState("UserId").ToString)

            Session("SelectCommand2") = "EXEC S_RptCostingReport2 '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ",'Y', " + QuotedStr(ViewState("UserId").ToString)

            Session("ReportFile") = ".../../../Rpt/RptCostingReport-V.2.frx"
    ...
    Protected Sub tbStartDate_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbStartDate.SelectionChanged
        ...
        Try
            ...
            DST = SQLExecuteQuery("EXEC S_GetEnddate  '" + tbStartDate.SelectedDate + "' ", ViewState("DBConnection").ToString)
            dr = DST.Tables(0).Rows(0)
            tbEndDate.SelectedDate = dr("LastDate").ToString
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            SQLString = "EXEC S_RptCostingReport2 '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ",'N', " + QuotedStr(ViewState("UserId").ToString)
