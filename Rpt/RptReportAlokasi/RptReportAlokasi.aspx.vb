...
Partial Class Rpt_RptReportAlokasi_RptReportAlokasi
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_RptReportAlokasi " + QuotedStr(tbProcess.Text) + ", " + QuotedStr(ViewState("UserId"))

            Session("ReportFile") = ".../../../Rpt/RptAlokasiCost.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            ViewState("PrintType") = "Preview"
            Session("DBConnection") = ViewState("DBConnection")
            SQLString = "EXEC S_RptReportAlokasi " + QuotedStr(tbProcess.Text) + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            ...
            Session("filter") = "SELECT TransNmbr, " + _
     "STUFF((SELECT Distinct ', ' + s.TypeAlokasi FROM FINalokasiDt s WHERE c.TransNmbr= s.TransNmbr FOR XML PATH('')), 1, 1, '') As Type," + _
    "TransDate,Status,TotalAmount,Remark FROM FINalokasiHD C WHERE Status = 'P'"
            ResultField = "TransNmbr,TransDate,Status,TotalAmount,Remark"
