...
Partial Class Rpt_RptDlgYearlySumDetailTBS_ReportTemplate
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", " + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            FgForceNewPage = "X"
            'End If
            SQLString = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
