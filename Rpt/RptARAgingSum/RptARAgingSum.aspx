<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptARAgingSum.aspx.vb" Inherits="Rpt_RptARAgingSum_RptARAgingSum" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Analisa Umur Piutang</div>
     <hr style="color:Blue" />     
        <br />
      <table>
        <tr>
            ...
            <legend>Type</legend>
            <asp:RadioButtonList ID="RBFwd" Width="301px" runat="server" RepeatColumns="3">
