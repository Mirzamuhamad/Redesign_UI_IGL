...
Partial Class Rpt_RptReportMutasiSertifikat
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            If tbProcess.Text.Trim = "" Then
                lbStatus.Text = MessageDlg("No Tanda Terima must have values")
                btnProcess.Focus()
                Exit Sub
            End If
            ...
            Session("SelectCommand") = "EXEC S_PRptMutasiSertifikat " + QuotedStr(tbProcess.Text) + ", " + QuotedStr(ViewState("UserId"))

            Session("ReportFile") = ".../../../Rpt/RptLandPurchaseMutasi.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            SQLString = "EXEC RptLandPurchaseMutasi " + QuotedStr(tbProcess.Text) + ", " + QuotedStr(ViewState("UserId"))
            ...
            GridExport.DataBind()
            ExportGridToExcel("RptCostingReport")
    ...
    Protected Sub tbProcess_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbProcess.TextChanged
        Try
        ...
        Catch ex As Exception
            lbStatus.Text = "Process Change Error : " + ex.ToString
        End Try
    End Sub
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            ' Session("filter") = "SELECT TransNmbr,TransDate,Status,TotalAmount,Remark FROM FINalokasiHD WHERE Status = 'P'"
            Session("filter") = "SELECT Reference,JenisDoc,NoDoc,SellName,LuasUkur FROM  V_GetLandReference A WHERE EXISTS ( SELECT 1 FROM PRCIPRecvDocDt2 B INNER JOIN PRCIPRecvDocHD C ON B.TransNmbr = C.TransNmbr    WHERE B.Reference = A.Reference AND C.Status = 'P')"

            ResultField = "Reference"
