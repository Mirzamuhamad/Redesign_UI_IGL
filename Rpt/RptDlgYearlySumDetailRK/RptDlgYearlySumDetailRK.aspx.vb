...
Partial Class Rpt_RptDlgYearlySumDetailRK_ReportTemplate
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(ddlMonth.SelectedValue) + ", " + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
            ...
            If ViewState("xPrint") = 5 Then
                Session("SelectCommand2") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand3") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '3' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand4") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '4' , " + QuotedStr(ViewState("UserId").ToString)
                Session("SelectCommand5") = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '5' , " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            FgForceNewPage = "X"
            'End If
            SQLString = ViewState("ExeSP") + " " + ddlStartYear.SelectedValue.ToString + "," + QuotedStr(ddlMonth.SelectedValue) + ", '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", " + QuotedStr(FgPrintValue) + ", " + QuotedStr(ViewState("UserId").ToString)
