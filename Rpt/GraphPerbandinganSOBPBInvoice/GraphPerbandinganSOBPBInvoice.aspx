<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GraphPerbandinganSOBPBInvoice.aspx.vb" Inherits="Rpt_GraphPerbandinganSOBPBInvoice_GraphPerbandinganSOBPBInvoice" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Graph Perbandingan SO - BPB Invoice</div>
    <hr style="color:Blue" />                
        <br />
        <table>
            <tr>
