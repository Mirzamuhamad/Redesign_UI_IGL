<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptPOOutAgingProd.aspx.vb" Inherits="Rpt_RptPOOutAging_RptPOOutAging" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">PO Out Aging Per Product Report</div>
     <hr style="color:Blue" />
      <table>
        <tr>
            <td>Date</td>
       ...
       <fieldset style="width:260px; " >
            ...
            <asp:RadioButtonList ID="RBType" Width="250px" runat="server" RepeatColumns="3" 
                ...
                <asp:ListItem>Detail</asp:ListItem>
                        ...
                        <fieldset style="width:260px; ">
                            <legend></legend>
                            <asp:RadioButtonList ID="RBFoward" runat="server" Height="30px" 
                                RepeatColumns="3" Visible="True" Width="250px">
