...
Partial Class Rpt_RptPOOutAging_RptPOOutAging
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("RptPOOutAgingProd")
    ...
    Protected Sub Print()
        Dim result, cat, force, Range1, Range2, Range3, Range4 As String
        Try
            ...
            Session("SelectCommand") = "EXEC S_PRRptPOOutAging '" + Format(tbTransDate.SelectedDate, "yyyy-MM-dd") + "'," + Range1 + "," + Range2 + "," + Range3 + ",0 ,'" + result + "','','','', " + RBFoward.SelectedIndex.ToString + ", " + RBType.SelectedIndex.ToString + "," + force + "," + QuotedStr(ViewState("UserId").ToString)
            If RBType.SelectedIndex = 0 Then
                Session("ReportFile") = ".../../../Rpt/RptPOOutAgingProd.frx"
            Else
                Session("ReportFile") = ".../../../Rpt/RptPOOutAgingProdDetail.frx"
            End If
