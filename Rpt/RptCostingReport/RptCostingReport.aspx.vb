...
Partial Class Rpt_RptCostingReport_RptCostingReport
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_RptCostingReport " + QuotedStr(tbProcess.Text) + ",'N', " + QuotedStr(ViewState("UserId"))
            Session("SelectCommand2") = "EXEC S_RptCostingReport " + QuotedStr(tbProcess.Text) + ",'Y', " + QuotedStr(ViewState("UserId"))
            Session("ReportFile") = ".../../../Rpt/RptCostingReport-V.1.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            ViewState("PrintType") = "Preview"
            Session("DBConnection") = ViewState("DBConnection")
            SQLString = "EXEC S_RptCostingReport " + QuotedStr(tbProcess.Text) + ",'N', " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            Session("filter") = "SELECT TransNmbr,Status,TransDate,ReceiptNo,CustomerCode,CustomerName,CustomerCode FROM V_FINTandaTerimaHd Where Status = 'P'"
            ResultField = "TransNmbr,Status,TransDate,ReceiptNo,CustomerCode,CustomerName,CustomerCode"
