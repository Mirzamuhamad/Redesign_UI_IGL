...
Imports System.IO
Partial Class Rpt_RptStockAging_RptStockAging
    ...
    Private Sub print()
        ...
        Try
            ...
            ReportGrid.setConnection(ViewState("DBConnection"), ViewState("UserId"))            
            Session("SelectCommand") = "EXEC S_STRptStockAging '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + result + "','','', " + cbcek + ", " + QuotedStr(ViewState("UserId"))
            
            Session("ReportFile") = ".../../../Rpt/RptStockAging.frx"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            SQLString = "EXEC S_STRptStockAging '" + Format(tbTransDate.SelectedValue, "yyyy-MM-dd") + "', " + Range1 + _
            "," + Range2 + "," + Range3 + "," + Range4 + "," + Range5 + "," + Range6 + ",'" + Result + "','','', " + cbcek + ", " + QuotedStr(ViewState("UserId"))
