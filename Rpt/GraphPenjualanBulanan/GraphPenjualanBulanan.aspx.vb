...
Partial Class Rpt_GraphPembelianBulanan_ReportTemplate
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            If Not IsPostBack Then
                ...
                ReportGrid.SetRpt("GraphPenjualanBulanan")
    ...
    Private Sub print()
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_EXERptMNGSalesMonthly 'PENJUALAN BULANAN','PENJUALAN'," + ddlStartYear.SelectedValue + "," + ddlStartMonth.SelectedValue + "," + ddlEndYear.SelectedValue + "," + ddlEndMonth.SelectedValue + ",'" + Result + "', '', '', " + rgData.SelectedValue + ", " + rgType.SelectedValue + ", " + rgReport.SelectedValue + ", " + QuotedStr(ViewState("UserId").ToString)
            Session("ReportFile") = Server.MapPath("~\Rpt\RptPrintGraphPenjualan.frx")
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            Session("DBConnection") = ViewState("DBConnection")
            SQLString = "EXEC S_EXERptMNGSalesMonthly 'PENJUALAN BULANAN','PENJUALAN'," + ddlStartYear.SelectedValue + "," + ddlStartMonth.SelectedValue + "," + ddlEndYear.SelectedValue + "," + ddlEndMonth.SelectedValue + ",'" + result + "', '', '', " + rgData.SelectedValue + ", " + rgType.SelectedValue + ", " + rgReport.SelectedValue + ", " + QuotedStr(ViewState("UserId").ToString)

            dt = SQLExecuteQuery(SQLString, Session("DBConnection")).Tables(0)
            GridExport.DataSource = dt
            GridExport.DataBind()
            ExportGridToExcel("GraphPenjualanBulanan")
        Catch ex As Exception
