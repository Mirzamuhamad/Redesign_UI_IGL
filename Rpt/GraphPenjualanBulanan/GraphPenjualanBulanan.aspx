<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GraphPenjualanBulanan.aspx.vb" Inherits="Rpt_GraphPembelianBulanan_ReportTemplate" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Graph Penjualan Bulanan</div>
     <hr style="color:Blue" />
      <table>
        <tr>
            <td>Start Period</td>
      ...
      <tr>
        <td>      
            <fieldset style="width:260px">
                    ...
                    <asp:RadioButtonList ID="rgReport" runat="server" RepeatDirection="Horizontal">
                      <asp:ListItem Value="0" Selected="True">SO</asp:ListItem>
                      <asp:ListItem Value="1">SJ</asp:ListItem>
        ...
        <td>        
            <fieldset style="width:260px">
                    ...
                    <asp:RadioButtonList ID="rgType" runat="server" RepeatDirection="Horizontal">
                      <asp:ListItem Value="0" Selected="True">Qty</asp:ListItem>
