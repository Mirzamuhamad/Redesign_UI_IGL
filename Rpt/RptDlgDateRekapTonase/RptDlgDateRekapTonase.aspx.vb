    ...
    Private Sub print()
        ...
        Try
            ...
            ElseIf ViewState("xPrint") = 0 Then
                ...
                Form1 = "1"
                Form2 = "2"
                Session("SelectCommand") = "EXEC S_PLRptRekapTonase " + " '" + Format(tbStartDate.SelectedDate, "yyyy-MM-dd") + "','" + Format(tbEndDate.SelectedDate, "yyyy-MM-dd") + "', '" + Result + "', '', '', " + QuotedStr(ViewState("MenuParam").ToString) + ", " + FgReport.ToString + ", " + FgReport2.ToString + ", " + QuotedStr(FgForceNewPage) + ", '2', " + QuotedStr(ViewState("UserId").ToString)
                ...
                Session("ReportFile") = ".../../../Rpt/RptRekapTonase.frx"
                AttachScriptAJAX("openreport2();", Page, Me.GetType)
            Else
