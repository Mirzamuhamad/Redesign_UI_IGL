<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgBufferStock.aspx.vb" Inherits="Rpt_RptDlgOutSumDetail_ReportTemplate" %>
    ...
    <div class="H1"><asp:Label runat="server" ID="lblTitle"></asp:Label></div>
     <hr style="color:Blue" />
      <table style="width: 294px">
        <tr>
            <td>Date</td>
                <td>:</td>
                <td>
                    <BDP:BasicDatePicker  Enabled="False" ID="tbDate" runat="server" DateFormat="dd MMM yyyy" 
      ...
      <table>
        ...
        <asp:Button class="bitbtn btnprint" runat="server" ID="btnPrint" Enabled="false" Text="Print"/>
