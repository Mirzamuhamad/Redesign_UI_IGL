<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStockNonMoveAging.aspx.vb" Inherits="Rpt_RptStockNonMoveAging_RptStockNonMoveAging" %>
...
<%@ Register Assembly="BasicFrame.WebControls.BasicDatePicker" Namespace="BasicFrame.WebControls"
    TagPrefix="BDP" %>
<%@ Register TagPrefix="GridRpt2" TagName="RptGridCtrl2" Src="~/UserControl/RangeControl2.ascx" %>    
...
<body>
    ...
    <div class="Content">
    <div class="H1">Report Stock Non Moving</div>
     <hr style="color:Blue" />
      <table>
        <tr>
            <td>Date</td>
      ...
      <td valign="top" >      
      <asp:panel runat="server" id="pnlmode">      
      <fieldset style="width:120px">
                <legend>Report Type</legend>
                <asp:RadioButtonList ID="RBType" Width="120px" runat="server" RepeatColumns="1">
                <asp:ListItem Selected="True" Value="0">All</asp:ListItem>
                <asp:ListItem Value="1">Palet</asp:ListItem>
                <asp:ListItem Value="2">Recehan</asp:ListItem>
                </asp:RadioButtonList>          
                </fieldset>
      </asp:panel> 
      </td>
