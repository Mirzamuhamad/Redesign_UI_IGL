<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptDlgGraphSPBPencapaianProduksi.aspx.vb" Inherits="Rpt_RptDlgDateSumDetail_ReportTemplate" %>
     ...
     <hr style="color:Blue" />
      <table>
        ...
        <td>Job</td>
            <td>:</td>
            <td class="style3">
                    <asp:TextBox ID="tbProcess" runat="server" CssClass="TextBoxR" Width="95px" 
                        Enabled="false"/>
                    <asp:TextBox ID="tbName" runat="server" CssClass="TextBoxR" Width="138px" 
                        Enabled="false"/>
            ...
            <%--<td>Period</td>
                ...
                <td>&nbsp;</td>
                <td>Month :</td>
                <td><asp:DropDownList ID="ddlMonth1" runat="server" CssClass="DropDownList" >
                ...
                <td>&nbsp;</td>
                <td>Month :</td>
                <td><asp:DropDownList ID="ddlMonth2" runat="server" CssClass="DropDownList" >
                    <asp:ListItem Selected="True">1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                                    <asp:ListItem>3</asp:ListItem>
                                    <asp:ListItem>4</asp:ListItem>
