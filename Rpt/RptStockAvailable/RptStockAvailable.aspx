<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStockAvailable.aspx.vb" Inherits="Rpt_RptStockAvailable_RptStockAvailable" %>
...
<body>
    ...
    <div class="Content">
    <div class="H1">Stock Available Report</div>
     <hr style="color:Blue" />
      <table>
        <tr>
            <td>Date</td>
        ...
        <tr>
            <td>  
                <asp:CheckBox ID="cbQty" runat="server" Text="Qty Available < Qty Min" />                             
            </td>
        </tr>          
      </table>    
      <br />
