...
Partial Class MsPeriod_MsPeriod
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            If StrFilter = "" Then
                SqlString = "SELECT *  FROM VMsPeriod WHERE YEAR = " + QuotedStr(ddlYear.Text) + " ORDER BY PeriodCode ASC"
            Else
                StrFilter = StrFilter.Replace("Where", "")
                SqlString = "SELECT *  FROM VMsPeriod WHERE Year = " + QuotedStr(ddlYear.Text) + " AND (" + StrFilter + ") ORDER BY PeriodCode ASC"
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster4 'VMsPeriod','PeriodCode','Start_Date','End_Date','FgClosing', 'Period File','Period','Start Date','End Date', 'Closing' ," + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
