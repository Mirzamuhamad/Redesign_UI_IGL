...
Imports System.Data
Partial Class MsProductLevelType_MsProductLevelType
    ...
    '        SqlString = "SELECT * FROM MsProductType " + StrFilter + " Order By TypeName "
    ...
    Private Sub bindDataGrid()
        ...
        Try
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            SqlString = "SELECT A.ProductJenis, A.ProductType,A.TypeName, B.JenisName FROM MsProductLevelType A INNER JOIN MsProductJenis B ON A.ProductJenis = B.JenisCode" + StrFilter + " Order By A.TypeName "
            If ViewState("SortExpression") = Nothing Then
                ViewState("SortExpression") = "ProductJenis ASC"
                ViewState("SortOrder") = "ASC"
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster4 'VMsProductLevelTypeNew','JenisName','ProductJenis','ProductType','TypeName'," + QuotedStr(lblTitle.Text) + ",'Product Jenis Code','Product Jenis Name','Product Size','Product Size Name'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Dim dbSize, dbCode, dbName As TextBox
        ...
        Try
            If e.CommandName = "Insert" Then
                dbSize = DataGrid.FooterRow.FindControl("ProductTypeAdd")
                dbName = DataGrid.FooterRow.FindControl("ProductTypeNameAdd")
                ddlJenis = DataGrid.FooterRow.FindControl("ProductJenisAdd")
                dbCode = DataGrid.FooterRow.FindControl("ProductTJenisAdd")


                If ddlJenis.SelectedValue.Trim.Length = 0 Then
                    lstatus.Text = "Jenis Type Code must be filled."
                    ddlJenis.Focus()
                    Exit Sub
                End If
                If dbSize.Text.Trim.Length = 0 Then
                    lstatus.Text = "Type Size Name must be filled."
                    dbSize.Focus()
                    Exit Sub
                End If
                If dbName.Text.Trim.Length = 0 Then
                    lstatus.Text = "Product Type Name must be filled."
                    dbName.Focus()
                    Exit Sub
                End If


                If SQLExecuteScalar("SELECT ProductJenis From VMsProductLevelTypeNew WHERE ProductJenis = " + QuotedStr(ddlJenis.SelectedValue), ViewState("DBConnection")).Length > 0 Then
                    lstatus.Text = "Product Jenis " + QuotedStr(ddlJenis.SelectedValue) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsProductLevelType (ProductJenis, ProductType, TypeName, UserId, UserDate ) " + _
                "SELECT " + QuotedStr(ddlJenis.SelectedValue) + ", " + QuotedStr(dbSize.Text) + ", " + QuotedStr(dbName.Text) + ", " + QuotedStr(ViewState("UserId").ToString) + ", getDate()"
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsProductLevelType where ProductJenis = '" & txtID.Text & "'", ViewState("DBConnection"))
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            txt = obj.FindControl("ProductTypeNameEdit")
            txt.Focus()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            dbName = DataGrid.Rows(e.RowIndex).FindControl("ProductTypeNameEdit")
            ...
            SQLString = "Update MsProductLevelType set TypeName= " + QuotedStr(dbName.Text) + _
