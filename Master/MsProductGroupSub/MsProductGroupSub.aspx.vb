...
Imports System.Data
Partial Class MsProductGroupSub_MsProductGroupSub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        dsProductGroup.ConnectionString = ViewState("DBConnection")
        lstatus.Text = ""
    End Sub
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            SqlString = "Select A.*, B.ProductGrpName from MsProductGroupSub A INNER JOIN MsProductGroup B ON A.ProductGroup = B.ProductGrpCode " + StrFilter + " Order By A.ProductSubGrpName "
            If ViewState("SortExpression") = Nothing Then
                ViewState("SortExpression") = "ProductSubGrpCode ASC"
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster3 'VMsProductGroupSub','ProductSubGrpCode','Product_SubGroup_Name','Product_Group_Name'," + QuotedStr(lblTitle.Text) + ",'Product Sub Group Code','Product Sub Group Name','Product Group Name'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                dbCode = DataGrid.FooterRow.FindControl("ProductSubGrpCodeAdd")
                dbName = DataGrid.FooterRow.FindControl("ProductSubGrpNameAdd")
                cbxProductCat = DataGrid.FooterRow.FindControl("ProductGroupAdd")

                If dbCode.Text.Trim.Length = 0 Then
                    lstatus.Text = MessageDlg("Product Sub Group Code must be filled.")
                    dbCode.Focus()
                    Exit Sub
                End If
                If dbName.Text.Trim.Length = 0 Then
                    lstatus.Text = MessageDlg("Product Sub Group Name must be filled.")
                    dbName.Focus()
                    Exit Sub
                End If

                If SQLExecuteScalar("SELECT Product_SubGroup_Code From VMsProductGroupSub WHERE Product_SubGroup_Code = " + QuotedStr(dbCode.Text), ViewState("DBConnection")).Length > 0 Then
                    lstatus.Text = "Product Sub Group " + QuotedStr(dbCode.Text) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsProductGroupSub (ProductSubGrpCode, ProductSubGrpName, ProductGroup, UserId, UserDate ) " + _
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            If CheckMenuLevel("Delete") = False Then
                Exit Sub
            End If
            txtID = DataGrid.Rows(e.RowIndex).FindControl("ProductSubGrpCode")

            SQLExecuteNonQuery("Delete from MsProductGroupSub where ProductSubGrpCode = '" & txtID.Text & "'", ViewState("DBConnection"))
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            txt = obj.FindControl("ProductSubGrpNameEdit")
            txt.Focus()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            lbCode = DataGrid.Rows(e.RowIndex).FindControl("ProductSubGrpCodeEdit")
            dbName = DataGrid.Rows(e.RowIndex).FindControl("ProductSubGrpNameEdit")
            cbxProductCat = DataGrid.Rows(e.RowIndex).FindControl("ProductGroupEdit")
            ...
            SQLString = "Update MsProductGroupSub set ProductSubGrpName= " + QuotedStr(dbName.Text) + "," & _
            "ProductGroup = " + QuotedStr(cbxProductCat.SelectedValue) + " where ProductSubGrpCode = " & QuotedStr(lbCode.Text)
