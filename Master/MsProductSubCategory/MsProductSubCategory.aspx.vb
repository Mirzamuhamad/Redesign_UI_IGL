...
Imports System.Data
Partial Class MsProductSubCategory_MsProductSubCategory
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            SqlString = "SELECT * FROM MsProductCategorySub " + StrFilter + " Order By ProductSubCatName "
    ...
    '    Try
    '        StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
    '        SqlString = "SELECT A.ProductSubCatCode AS Sub_Category_Code, A.ProductSubCatName AS Sub_Category_Name,A.ProductCategory AS Category_Code, B.ProductCatName AS Category_Name FROM (msproductcategorysub a INNER join msproductcategory b on((a.productcategory = b.productcatcode)))" + StrFilter + " Order By A.ProductSubCatName "
    '        If ViewState("SortExpression") = Nothing Then
    '            ViewState("SortExpression") = "ProductSubCatCode ASC"
    '            ViewState("SortOrder") = "ASC"
    '        End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster4 'VMsProductCategorySub','Sub_Category_Code','Sub_Category_Name','Category_Code','Category_Name'," + QuotedStr(lblTitle.Text) + ",'Product Sub Category Code','Product Category Name','Category Code','Category Name'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                ddlCategory = DataGrid.FooterRow.FindControl("ProductCategoryAdd")


                If ddlCategory.SelectedValue.Trim.Length = 0 Then
                    lstatus.Text = "Category  must be filled."
                    ddlCategory.Focus()
                    Exit Sub
                End If
                If dbCode.Text.Trim = "" Then
                    lstatus.Text = "Product Category Code must be filled."
                    dbCode.Focus()
                    Exit Sub
                End If
                If dbName.Text.Trim = "" Then
                    lstatus.Text = "Product Category Name must be filled."
                    dbName.Focus()
                    Exit Sub
                End If


                If SQLExecuteScalar("SELECT sub_Category_Code From VMsProductCategorySub WHERE sub_Category_Code = " + QuotedStr(dbCode.Text), ViewState("DBConnection")).Length > 0 Then
                    lstatus.Text = "Product Category Code " + QuotedStr(dbCode.Text) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsProductCategorySub (ProductSubCatCode, ProductSubCatName, ProductCategory, UserId, UserDate ) " + _
                "SELECT " + QuotedStr(dbCode.Text) + ", " + QuotedStr(dbName.Text) + ", " + QuotedStr(ddlCategory.SelectedValue) + ", " + QuotedStr(ViewState("UserId").ToString) + ", getDate()"
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsProductCategorySub where ProductSubCatCode = '" & txtID.Text & "'", ViewState("DBConnection"))
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            ddlCategory = DataGrid.Rows(e.RowIndex).FindControl("ProductCategoryEdit")
            ...
            SQLString = "Update MsProductCategorySub set ProductSubCatName= " + QuotedStr(dbName.Text) + ", ProductCategory= " + QuotedStr(ddlCategory.SelectedValue) + _
            " where ProductSubCatCode = '" & lbCode.Text + "'"
