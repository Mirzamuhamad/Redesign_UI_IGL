...
Partial Class Master_MsDepartment_MsDepartment
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            End If
            SqlString = "SELECT * FROM VMsDepartment " + StrFilter + MenuParam + " Order By Dept_Code"
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            txt = obj.FindControl("DeptNameEdit")
            txt.Focus()
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                dbName = DataGrid.FooterRow.FindControl("DeptNameAdd")
                'LblItem = DataGrid.FooterRow.FindControl("ItemNoAdd")
                ddlGroup = DataGrid.FooterRow.FindControl("DeptGroupAdd")
                ...
                If SQLExecuteScalar("SELECT Dept_Code From VMsDepartment WHERE Dept_Code = " + QuotedStr(dbCode.Text), ViewState("DBConnection").ToString).Length > 0 Then
                    lstatus.Text = "Department " + QuotedStr(dbCode.Text) + " has already been exist"
                    Exit Sub
                End If
                ...
                Cek = "SELECT Dept_Code, Dept_Name, Dept_Level FROM VMsDepartment Order By Dept_Code"
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            lbCode = DataGrid.Rows(e.RowIndex).FindControl("DeptCodeEdit")
            dbName = DataGrid.Rows(e.RowIndex).FindControl("DeptNameEdit")
            ddlGroup = DataGrid.Rows(e.RowIndex).FindControl("DeptGroupEdit")
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            Cek = "SELECT Section_Code, Section_Name FROM VMsSection WHERE Dept_Code = " + QuotedStr(txtID.Text)
            dt = SQLExecuteQuery(Cek, ViewState("DBConnection")).Tables(0)

            If dt.Rows.Count > 0 Then
                Dr = dt.Rows(0)
                lstatus.Text = MessageDlg("Can not delete, Department has already use by Section " + QuotedStr(Dr("Section_Name")))
                Exit Sub
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "S_FormPrintMaster3 'VMsDepartment','Dept_Code','Dept_Name','Group_Code','Department File','Code','Description','Group'," + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
