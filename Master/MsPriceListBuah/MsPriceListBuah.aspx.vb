...
Partial Class MsPriceListBuah_MsPriceListBuah
    ...
    Private Sub bindDataGrid()
        ...
        Dim PriceHK As TextBox
        Try
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            'StrFilter = "" Then
            SqlString = "SELECT *  FROM V_MsBuahPriceView " + StrFilter
            'Else
            ' StrFilter = StrFilter.Replace("Where", "")
            'SqlString = "SELECT *  FROM MsHKPrice WHERE EffectiveDate = " + QuotedStr(ddlYear.Text) + " AND (" + StrFilter + ") ORDER BY EffectiveDate ASC"
            'End If
            ...
            PriceHK = GVR.FindControl("PriceHKAdd")
            PriceHK.Attributes.Add("OnKeyDown", "return PressNumeric();")
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster 'V_MsBuahPriceView','Effective_Date','PriceBuah','Buah Price File','Effective Date',' Price (Rp) / Buah'," + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                dbPriceHK = DataGrid.FooterRow.FindControl("PriceHKAdd")
                ...
                If dbPriceHK.Text.Trim.Length = 0 Then
                    lstatus.Text = "Price must be filled."
                    dbPriceHK.Focus()
                    Exit Sub
                End If

                If SQLExecuteScalar("SELECT EffectiveDate From MsBuahPrice WHERE EffectiveDate = " + QuotedStr(dbEffectiveDate.SelectedValue), ViewState("DBConnection").ToString).Length > 0 Then
                    lstatus.Text = "Effective Date " + QuotedStr(dbEffectiveDate.SelectedDateFormatted) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsBuahPrice (EffectiveDate, PriceBuah, UserId, UserDate ) " + _
                "SELECT " + QuotedStr(dbEffectiveDate.SelectedValue) + ", " + QuotedStr(dbPriceHK.Text) + _
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsBuahPrice where dbo.FormatDate(EffectiveDate) = '" & txtID.Text & "'", ViewState("DBConnection").ToString)
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            PriceHK = obj.FindControl("PriceHKEdit")
            PriceHK.Attributes.Add("OnKeyDown", "return PressNumeric();")
            txt.Focus()
        Catch ex As Exception
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            dbPriceHK = DataGrid.Rows(e.RowIndex).FindControl("PriceHKEdit")




            If dbPriceHK.Text.Trim.Length = 0 Then
                lstatus.Text = "Price Name must be filled."
                dbPriceHK.Focus()
                Exit Sub
            End If
            ...
            'If SQLExecuteScalar("SELECT EffectiveDate From MsHKPrice WHERE EffectiveDate = " + QuotedStr(dbEffectiveDate.SelectedValue), ViewState("DBConnection").ToString).Length > 0 Then
            'lstatus.Text = "Effective Date " + QuotedStr(dbEffectiveDate.SelectedDateFormatted) + " has already been exist"
            'Exit Sub
            'End If
            ...
            'insert the new entry
            SQLString = "UPDATE MsBuahPrice SET EffectiveDate = " + QuotedStr(dbEffectiveDate.SelectedDate) + _
            ", PriceBuah = " + QuotedStr(dbPriceHK.Text) + _
