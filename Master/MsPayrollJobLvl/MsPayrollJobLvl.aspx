<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPayrollJobLvl.aspx.vb" Inherits="Assign_MsPayrollJobLvl_MsPayrollJobLvl" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Payroll Slip Job Level</div>
    <hr style="color:Blue" /> 
        <br />                     
              ...
              <table width="100%">
               ...
               <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView id="DataGrid" runat="server" ShowFooter="False" AllowSorting="True" 
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Job Level Code" HeaderStyle-Width="70" SortExpression="Job_Level">
								<Itemtemplate>
									<asp:Label Runat="server" Width="70" ID="JobLevel" text='<%# DataBinder.Eval(Container.DataItem, "Job_Level") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="JobLevelEdit" MaxLength="5" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "Job_Level") %>'>
									</asp:Label>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="JobLevelAdd" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>								   
								</FooterTemplate>
							    <HeaderStyle Width="70px" />
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Job Level Name" HeaderStyle-Width="150" SortExpression="Job_Level_Name">
								<Itemtemplate>
									<asp:Label Runat="server" Width="200" ID="JobLevelName" text='<%# DataBinder.Eval(Container.DataItem, "Job_Level_Name") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
								    <asp:Label Runat="server" Width="200" ID="JobLevelNameEdit" text='<%# DataBinder.Eval(Container.DataItem, "Job_Level_Name") %>'>
									</asp:Label>									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="JobLevelNameAdd" CssClass="TextBox" Width="100%" MaxLength="60" Runat="Server"/>
        ...
        <asp:Panel ID="pnlNewSlip" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "Job_Level"                     
                        ...
                        <dx:GridViewDataColumn Caption="Job Level Code" FieldName="Job_Level" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Job Level Name" FieldName="Job_Level_Name" VisibleIndex="2" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
