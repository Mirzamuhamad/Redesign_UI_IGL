    <%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsProductMateri.aspx.vb" Inherits="Master_MsProductMateri_MsProductMateri" %>
...
<body>
    ...
    <div class="Content">
        ...
        <tr>
            ...
            <td><asp:TextBox CssClass="TextBox"  runat="server" ID ="tbFilter"/> 
                <asp:DropDownList CssClass="DropDownList" runat="server" ID="ddlField" >
                  <asp:ListItem Selected="true" Text="Product Type Code" Value=MateriCode"></asp:ListItem>
                      <asp:ListItem Text="Product Type Name" Value="MateriName"></asp:ListItem>
                      <asp:ListItem Text="Product Category" Value="GroupType"></asp:ListItem>
     ...
     <table>   
      ...
      <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True" 
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
				            <asp:TemplateField HeaderText="Product Type Code" HeaderStyle-Width="220" SortExpression="MateriCode">
								<Itemtemplate>
									<asp:Label Runat="server" ID="MateriCode" text='<%# DataBinder.Eval(Container.DataItem, "MateriCode") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="MateriCodeEdit" Text='<%# DataBinder.Eval(Container.DataItem, "MateriCode") %>'>
									</asp:Label>								    
								</EditItemTemplate>
								<FooterTemplate>
								    <asp:TextBox ID="MateriCodeAdd" Placeholder = "can't blank" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>
									<%--<cc1:TextBoxWatermarkExtender ID="MateriCodeAdd_TextBoxWatermarkExtender" 
                                        runat="server" Enabled="True" TargetControlID="MateriCodeAdd" WatermarkText="can't blank" WatermarkCssClass="Watermarked" >
                                    </cc1:TextBoxWatermarkExtender>--%>
								</FooterTemplate>
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Product Type Name" HeaderStyle-Width="300" SortExpression="MateriName">
								<Itemtemplate>
									<asp:Label Runat="server" Width="300" ID="MateriName" text='<%# DataBinder.Eval(Container.DataItem, "MateriName") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:TextBox Runat="server" ID="MateriNameEdit" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "MateriName") %>'>
									</asp:TextBox>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="MateriNameAdd" Placeholder = "can't blank" CssClass="TextBox" Width="100%" MaxLength="60" Runat="Server"/>
								  <%-- <cc1:TextBoxWatermarkExtender ID="MateriNameAdd_TextBoxWatermarkExtender" 
                                        runat="server" Enabled="True" TargetControlID="MateriNameAdd" WatermarkText="can't blank" WatermarkCssClass="Watermarked" >
                                   </cc1:TextBoxWatermarkExtender>--%>
								</FooterTemplate>
							    <HeaderStyle Width="70px" />
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Product Category" HeaderStyle-Width="130" SortExpression="GroupType">
								<Itemtemplate>
									<asp:Label Runat="server" Width="130" ID="GroupType" text='<%# DataBinder.Eval(Container.DataItem, "GroupType") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:DropDownList ID="GroupTypeEdit" Runat="Server" Width="100%" CssClass="DropDownList" text='<%# DataBinder.Eval(Container.DataItem, "GroupType") %>'								    
                                        DataSourceID="dsProductMateri" DataTextField="Product_Group_Name"  OnSelectedIndexChanged="GroupTypeEdit_SelectedIndexChanged"
								...
								<FooterTemplate>
								   	<asp:DropDownList ID="GroupTypeAdd" Runat="Server" Width="100%" CssClass="DropDownList"									    
                                        DataSourceID="dsProductMateri" DataTextField="Product_Group_Name" 
                                        DataValueField="Product_Group_Code" >                                        
									</asp:DropDownList>
								</FooterTemplate>
							...
							<asp:TemplateField HeaderText="Action" headerstyle-width="180" >
							    <ItemTemplate>
									...
									<asp:Button ID="btnView" Width="70px" runat="server" class="bitbtndt btnedit" Text="Account" CommandName="View" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"/>
								</ItemTemplate>
								<EditItemTemplate>
     ...
     <asp:Label ID="lbProductMateriCode" ForeColor="Blue" CssClass="H1" Font-Bold="true" runat="server" />
     </asp:Panel>
	 <br />
...
<%--            <tr>
    ...
    <asp:SqlDataSource ID="dsProductCategory" runat="server" 
        ...
        <asp:SqlDataSource ID="dsProductMateri" runat="server"            
           SelectCommand="EXEC S_GetGroupTypeNew">
        </asp:SqlDataSource>
