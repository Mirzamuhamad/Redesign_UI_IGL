...
Imports System.Data
Partial Class MsPayroll_MsPayroll
    ...
    Private Sub ClearInput()
        Try
            ...
            lbFormulaDesc.Text = ""
            ddlPayrolType.SelectedValue = "GP"
            lbPayrollTypeName.Text = ""
            ...
            ddlRapel.SelectedValue = "N"
            ddlSlip.SelectedValue = "Y"
            ddlValue.SelectedValue = "1"
            ddlAnnual.SelectedValue = "Y"
            ddlJamsostek.SelectedValue = "N"
            ddlAbsen.SelectedValue = "Y"
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            If StrFilter = "" Then
                Filter = " WHERE PayrollPref = 'P' "
            Else
                Filter = StrFilter + " AND PayrollPref = 'P' "
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            If StrFilter = "" Then
                StrFilter = " WHERE PayrollPref = 'P' "
            Else
                StrFilter = StrFilter + " AND PayrollPref = 'P' "
            End If
            Session("SelectCommand") = "S_FormMsPayroll " + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
            Session("ReportFile") = ".../../../Rpt/FormMsPayroll.frx"
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                'If SQLExecuteScalar("SELECT Wrhs_Code From VMsPayroll WHERE Wrhs_Code = " + QuotedStr(dbCode.Text), Session("DBConnection").ToString).Length > 0 Then
                '    lstatus.Text = "Warehouse " + QuotedStr(dbCode.Text) + " has already been exist"
                '    Exit Sub
                'End If

                ''insert the new entry
                'SQLString = "Insert into MsPayroll (WrhsCode, WrhsName, WrhsGroup, WrhsArea, WrhsType, WrhsCondition, FgActive, UserId, UserDate ) " + _
            ...
            ElseIf e.CommandName = "Location" Then
                ...
                'gvr = DataGrid.Rows(CInt(e.CommandArgument))
                'If (Not ClientScript.IsStartupScriptRegistered("tes")) Then
                '    Page.ClientScript.RegisterStartupScript(Me.GetType(), "tes", "OpenAssign('Warehouse', '" + gvr.Cells(0).Text + "|" + gvr.Cells(1).Text + "','AssMsPayrollLoc');", True)
                'End If
            End If
        Catch ex As Exception
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            'SQLExecuteNonQuery("Delete from MsPayroll where WrhsCode = '" & txtID.Text & "'")
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            lbFormulaDesc.Text = obj.Cells(5).Text
            BindToDropList(ddlPayrolType, obj.Cells(6).Text)
            lbPayrollTypeName.Text = obj.Cells(7).Text
            BindToDropList(ddlPPh, obj.Cells(8).Text)
            'BindToText(tbAmount, obj.Cells(9).Text)
            BindToDropList(ddlGroupBy, obj.Cells(9).Text)
            BindToText(tbPriority, obj.Cells(10).Text)
            BindToDropList(ddlResponsibility, obj.Cells(11).Text)
            BindToDropList(ddlRapel, obj.Cells(12).Text)
            BindToDropList(ddlSlip, obj.Cells(13).Text)
            BindToDropList(ddlValue, obj.Cells(14).Text)
            BindToDropList(ddlAnnual, obj.Cells(15).Text)
            BindToDropList(ddlJamsostek, obj.Cells(16).Text)
            BindToDropList(ddlAbsen, obj.Cells(17).Text)
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            SQLString = "Update MsPayroll set WrhsName= " + QuotedStr(dbName.Text) + "," & _
    ...
    Private Function cekInput() As Boolean
        Try
            If tbNo.Text.Trim.Length = 0 Then
                lstatus.Text = MessageDlg("Payroll Code cannot empty")
                tbNo.Focus()
                Return False
            End If
            If tbName.Text.Trim.Length = 0 Then
                lstatus.Text = MessageDlg("Payroll Name cannot empty")
                tbName.Focus()
                Return False
            End If
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Try
            ...
            If ViewState("State") = "Insert" Then
                ...
                'Sampai Sini
                If SQLExecuteScalar("SELECT PayrollNo From VMsPayroll WHERE PayrollPref = 'P' AND PayrollNo = " + QuotedStr(tbNo.Text), ViewState("DBConnection").ToString).Length > 0 Then
                    lstatus.Text = "Payroll " + QuotedStr(tbNo.Text) + " has already been exist"
                    Exit Sub
                End If
                ...
                "0, " + QuotedStr(ddlPayrolType.SelectedValue) + ", " + QuotedStr(ddlResponsibility.SelectedValue) + ", " + QuotedStr(ddlGroupBy.SelectedValue) + ", " & _
                QuotedStr(tbPriority.Text) + ", " + QuotedStr(ddlSlip.SelectedValue) + ", " + QuotedStr(ddlPPh.SelectedValue) + ", " + QuotedStr(ddlAbsen.SelectedValue) + ", " + QuotedStr(ddlRapel.SelectedValue) + ", " & _
                QuotedStr(ddlJamsostek.SelectedValue) + "," + QuotedStr(ddlAnnual.SelectedValue) + ", " + ddlValue.SelectedValue + ", " & _
            ...
            Else
                SqlString = "UPDATE MsPayroll SET PayrollName= " + QuotedStr(tbName.Text) & _
                            ...
                            ", PayrollType = " + QuotedStr(ddlPayrolType.SelectedValue) & _
                            ", Tertanggung = " + QuotedStr(ddlResponsibility.SelectedValue) & _
                            ", GroupBy = " + QuotedStr(ddlGroupBy.SelectedValue) & _
                            ", Prioritas = " + QuotedStr(tbPriority.Text) & _
                            ", FgSlip = " + QuotedStr(ddlSlip.SelectedValue) & _
                            ", FgPPH = " + QuotedStr(ddlPPh.SelectedValue) & _
                            ", FgCheckAbsen = " + QuotedStr(ddlAbsen.SelectedValue) & _
                            ", FgRapel = " + QuotedStr(ddlRapel.SelectedValue) & _
                            ", FgJamsostek = " + QuotedStr(ddlJamsostek.SelectedValue) & _
                            ", FgAnnual = " + QuotedStr(ddlAnnual.SelectedValue) & _
                            ", FgValue = " + ddlValue.SelectedValue & _
    ...
    Protected Sub ddlFormula_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlFormula.SelectedIndexChanged
        Try
            filterConditionFormula()
        Catch ex As Exception
            lstatus.Text = "ddlFormula_SelectedIndexChanged Error : " + ex.ToString
        End Try
    End Sub

    Sub filterConditionFormula()
        Dim dr As DataRow
        Dim ds As DataSet
        Try
            ds = SQLExecuteQuery("SELECT FormulaDesc FROM VMsFormula WHERE FormulaCode = " + QuotedStr(ddlFormula.SelectedValue), ViewState("DBConnection").ToString)
            If IsNothing(ds) Or ds.Tables(0).Rows.Count <= 0 Or IsNothing(ds.Tables(0)) Then
                lbFormulaDesc.Text = ""
            Else
                dr = ds.Tables(0).Rows(0)
                lbFormulaDesc.Text = dr("FormulaDesc").ToString
            End If

        Catch ex As Exception
            lstatus.Text = "filterConditionFormula Error : " + ex.ToString
        End Try
    End Sub

    Sub filterConditionType()
        Try
            If ddlPayrolType.Text = "GP" Then
                lbPayrollTypeName.Text = "Gaji Pokok"
            ElseIf ddlPayrolType.Text = "TT" Then
                lbPayrollTypeName.Text = "Tunjangan Tetap"
            ElseIf ddlPayrolType.Text = "TTT" Then
                lbPayrollTypeName.Text = "Tunjangan Tidak Tetap"
            ElseIf ddlPayrolType.Text = "POT" Then
                lbPayrollTypeName.Text = "Potongan"
            ElseIf ddlPayrolType.Text = "PPH" Then
                lbPayrollTypeName.Text = "PPh 21"
            Else
                lbPayrollTypeName.Text = ddlPayrolType.Text
            End If
        Catch ex As Exception
            lstatus.Text = "filterConditionType Error : " + ex.ToString
        End Try
    End Sub

    Protected Sub ddlPayrolType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlPayrolType.SelectedIndexChanged
        Try
            filterConditionType()
            SetEnabled()
            'If (ddlPayrolType.SelectedValue = "PPH") Or (ddlPayrolType.SelectedValue = "RAPEL") Then
            'ddlPPh.SelectedValue = "N"
            'ddlRapel.SelectedValue = "N"
            'ddlAnnual.SelectedValue = "N"
            'ddlJamsostek.SelectedValue = "N"
            'ddlGroupBy.SelectedValue = "All"
            'ElseIf (ddlPayrolType.SelectedValue = "GP") Or (ddlPayrolType.SelectedValue = "TT") Then
            'ddlPPh.SelectedValue = "Y"
            'ddlRapel.SelectedValue = "Y"
            'ddlAnnual.SelectedValue = "Y"
            'ddlJamsostek.SelectedValue = "N"
            'ElseIf (ddlPayrolType.SelectedValue = "TTT") Or (ddlPayrolType.SelectedValue = "POT") Then
            'ddlPPh.SelectedValue = "Y"
            'ddlRapel.SelectedValue = "N"
            'ddlAnnual.SelectedValue = "Y"
            'ddlJamsostek.SelectedValue = "N"
            'End If
        Catch ex As Exception
            lstatus.Text = "ddlPayrolType_SelectedIndexChanged Error : " + ex.ToString
        End Try
    End Sub
    ...
    Sub SetEnabled()
        Try
            ...
            If Not ((ddlPayrolType.SelectedValue = "POT") Or (ddlPayrolType.SelectedValue = "PPH")) Then
                ddlValue.SelectedValue = "1"
            Else
                ddlValue.SelectedValue = "-1"
            End If
            ddlPPh.Enabled = Not ((ddlPayrolType.SelectedValue = "PPH"))
            If ddlPPh.Enabled = False Then
                ddlPPh.SelectedValue = "N"
            Else
                ddlPPh.SelectedValue = "Y"
            End If
            ddlJamsostek.Enabled = Not ((ddlPayrolType.SelectedValue = "PPH") Or (ddlPayrolType.SelectedValue = "RAPEL") Or (ddlPayrolType.SelectedValue = "PHK"))
            If ddlJamsostek.Enabled = False Then
                ddlJamsostek.SelectedValue = "N"
            End If
            ddlRapel.Enabled = Not ((ddlPayrolType.SelectedValue = "PPH") Or (ddlPayrolType.SelectedValue = "RAPEL") Or (ddlPayrolType.SelectedValue = "PHK"))
            If ddlRapel.Enabled = False Then
                ddlRapel.SelectedValue = "N"
            End If
            ddlAnnual.Enabled = Not ((ddlPayrolType.SelectedValue = "PPH") Or (ddlPayrolType.SelectedValue = "RAPEL") Or (ddlPayrolType.SelectedValue = "PHK"))
            If ddlAnnual.Enabled = False Then
                ddlAnnual.SelectedValue = "N"
            End If
            ddlGroupBy.Enabled = Not ((ddlPayrolType.SelectedValue = "PPH") Or (ddlPayrolType.SelectedValue = "RAPEL") Or (ddlPayrolType.SelectedValue = "PHK"))
        Catch ex As Exception
            lstatus.Text = "SetEnabled Error : " + ex.ToString
        End Try
    End Sub
