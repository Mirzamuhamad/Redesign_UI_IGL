<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsModerator.aspx.vb" Inherits="MsModerator_MsModerator" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Moderator File</title>
...
<body>
    ...
    <div class="Content">
     <div class="H1">Moderator File</div>
     <hr style="color:Blue" />
        ...
        <tr>
            ...
            <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox" /> 
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" > 
                    <asp:ListItem Selected="true" Text="Moderator Code" Value="ModCode"></asp:ListItem>
                    <asp:ListItem Text="Moderator Name" Value="ModName"></asp:ListItem>                   
                    <asp:ListItem Text="Gender" Value="Gender"></asp:ListItem>
                    <asp:ListItem Text="Type ID" Value="TypeID"></asp:ListItem>
                    <asp:ListItem Text="Moderator ID" Value="ModID"></asp:ListItem>
     ...
     <table>   
      ...
      <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True" 
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
				            ...
				            <asp:BoundField DataField="ModCode" HeaderText="Moderator Code" HeaderStyle-Width="140" SortExpression="ModCode"/>
							<asp:BoundField DataField="ModName" HeaderText="Moderator Name" HeaderStyle-Width="300" SortExpression="ModName"/>
                            <asp:BoundField DataField="Gender" HeaderText="Gender" SortExpression="Gender"/>
							<asp:BoundField DataField="TypeID" HeaderText="Type ID " SortExpression="TypeID"/>	
                            <asp:BoundField DataField="ModID" HeaderText="ID No" SortExpression="ModID"/>
      ...
      <asp:Panel runat="server" ID="pnlInput" Visible="false">
        <table>
            <tr>
                <td>Moderator Code</td>
                <td>:</td> 
                <td><asp:TextBox runat="server" CssClass="TextBox" ID="tbCode" AutoPostBack="true" MaxLength = "5"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>ID No</td>
                <td>:</td>
                <td><asp:TextBox runat="server" MaxLength="60" CssClass="TextBox" ID="tbModeratorID" ValidationGroup="Input" Width="300px"/></td>
            </tr>
            ...
            <tr>
                <td>Phone</td>
                <td>:</td>
                <td><asp:TextBox runat="server" MaxLength="14" CssClass="TextBox" ID="tbPhone" ValidationGroup="Input" Width="300px"/></td>
            </tr>
