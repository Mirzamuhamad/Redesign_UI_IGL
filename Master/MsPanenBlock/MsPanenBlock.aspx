<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPanenBlock.aspx.vb" Inherits="Master_MsPanenBlock_MsPanenBlock" %>
        ...
        <asp:Panel runat="server" ID="PnlAssign">          
              <table width="100%">
                <tr>
                    ...
                    <td>:</td>
                    <td><BDP:BasicDatePicker ID="tbDate" runat="server" 
                ...
                <td style="width:40%;">
                   <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">                   
                    <dx:ASPxGridView ID="AssignedGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        EmptyDataText="There are no data records to display." KeyFieldName = "BlockCode"                     
                        ...
                        <dx:GridViewDataColumn FieldName="BlockCode" VisibleIndex="1" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="BlockName" VisibleIndex="2" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn> 
                        <dx:GridViewDataColumn FieldName="StartDate" VisibleIndex="3" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>   
                        <dx:GridViewDataColumn FieldName="EndDate" VisibleIndex="4" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                              
                        <dx:GridViewDataColumn FieldName="DivisionName" VisibleIndex="5" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                              
                        <dx:GridViewDataColumn FieldName="StatusTanam" VisibleIndex="6" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                                                      
                        </Columns>
                ...
                <td style="width:40%;">
                  <div style="border:0px  solid; width:100%; height:300px; overflow:auto;">
                    <dx:ASPxGridView ID="AvailableGrid" runat="server" Width="100%" style="table-layout:fixed;"
                        ...
                        <dx:GridViewDataColumn FieldName="BlockCode" VisibleIndex="1" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="BlockName" VisibleIndex="2" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn> 
                        <dx:GridViewDataColumn FieldName="LastDate" VisibleIndex="3" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                           
                        <dx:GridViewDataColumn FieldName="LastPanen" VisibleIndex="4" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                           
                        <dx:GridViewDataColumn FieldName="DivisionName" VisibleIndex="5" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                              
                        <dx:GridViewDataColumn FieldName="StatusTanam" VisibleIndex="6" ><Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                                                                      
                        </Columns>
                        <Settings ShowFilterRow="True" ShowFilterBar="Auto" ShowFilterRowMenu="True" />
