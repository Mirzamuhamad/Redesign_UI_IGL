<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsProcess.aspx.vb" Inherits="Execute_Master_MsProcess_MsProcess" %>
            ...
            <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox"/> 
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" >
                  ...
                  <asp:ListItem Text="Process Name" Value="ProcessName"></asp:ListItem>        
                    <asp:ListItem Value="FgQC">QC</asp:ListItem>
                </asp:DropDownList>     
     ...
     <table>   
      ...
      <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True" 
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Process Code" SortExpression="ProcessCode">
								<Itemtemplate>
								...
								<FooterTemplate>
									<asp:TextBox ID="ProcessCodeAdd" CssClass="TextBox" MaxLength="10" Runat="Server" Width="100%"/>
							...
							<asp:TemplateField HeaderText="Process Name" HeaderStyle-Width="350" SortExpression="ProcessName">
								<Itemtemplate>
									<asp:Label Runat="server" ID="ProcessName" text='<%# DataBinder.Eval(Container.DataItem, "ProcessName") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="ProcessNameEdit" MaxLength="60" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "ProcessName") %>'>
									</asp:TextBox>
									<cc1:TextBoxWatermarkExtender ID="ProcessNameEdit_WtExt" 
                                        runat="server" Enabled="True" TargetControlID="ProcessNameEdit" 
                                        WatermarkText="can't blank" WatermarkCssClass="Watermarked">
                                     </cc1:TextBoxWatermarkExtender>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="ProcessNameAdd" CssClass="TextBox" MaxLength="60" Runat="Server" Width="100%"/>
									<cc1:TextBoxWatermarkExtender ID="ProcessNameAdd_WtExt" 
                                        runat="server" Enabled="True" TargetControlID="ProcessNameAdd" 
                                        WatermarkText="can't blank" WatermarkCssClass="Watermarked">
                                     </cc1:TextBoxWatermarkExtender>
								</FooterTemplate>
							</asp:TemplateField>		
							...
							<asp:TemplateField HeaderText="QC" SortExpression="FgQC">
								...
								<FooterTemplate>
									<asp:DropDownList CssClass="DropDownList" ID="FgQCAdd" Runat="Server" Width="100%">
