...
Partial Class Master_MsJobFactoryHK_MsJobFactoryHK
    ...
    Sub BindData()
        ...
        Try
            ...
            tempDS = SQLExecuteQuery("EXEC S_MsJobPlantHKFactorView " + QuotedStr(ddlJobGroup.SelectedValue) + " , " + QuotedStr(StrFilter) + " , " + QuotedStr(ViewState("UserId").ToString), ViewState("DBConnection"))
    ...
    Protected Sub BtnApply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnApply.Click
        ...
        Dim lbCode, StatusTanam, RotasiNo As Label
        Dim FactorHK As TextBox
        ...
        Try
            ...
            For i = 0 To DataGrid.Rows.Count - 1
                ...
                FactorHK = GVR.FindControl("FactorHK")
                FactorHK.Text = FactorHK.Text.Replace(",", "")

                If FactorHK.Text.Trim = "" Then
                    FactorHK.Text = "0"
                End If

                If Not IsNumeric(FactorHK.Text) Then
            ...
            If exe Then
                For i = 0 To DataGrid.Rows.Count - 1
                    ...
                    If Not ((FactorHK.Text = "" Or FactorHK.Text = "0")) Then ' And ((QtyConvert.Text <> lbLastPriceEmp.Text) Or (QtyAreal.Text <> lbLastPriceContractor.Text)) Then
                        SQLString = "EXEC S_MsJobPlantHKFactorUpdate " + _
                            QuotedStr(lbCode.Text) + ", " + QuotedStr(StatusTanam.Text) + ", " + RotasiNo.Text + ", " + FactorHK.Text + ", " + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            Catch ex As Exception
                Throw New Exception("Bind Data Error : " + ex.ToString)
            End Try
            ExportGridToExcel("Job Factory HK")
        Catch ex As Exception
