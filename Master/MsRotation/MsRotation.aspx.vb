...
Partial Class Master_MsRotation_MsRotation
    ...
    Protected Sub btnBackDtTop_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBackDtTop.Click, btnBack2.Click
        ...
        Dim SQLString3, number As String
        Try
            SQLString3 = "SELECT COUNT(RotationCode) FROM MsRotasiDt WHERE RotationCode =" + QuotedStr(ViewState("Nmbr"))
            number = SQLExecuteScalar(SQLString3, ViewState("DBConnection").ToString)

            SQLString2 = "UPDATE MsRotasi SET Rotation = " + number + _
