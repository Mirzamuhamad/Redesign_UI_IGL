     ...
     <table>   
      ...
      <asp:GridView id="DataGrid" runat="server" 
            ...
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="KegiatanCode" HeaderStyle-Width="100" SortExpression="KegiatanCode">
								<Itemtemplate>
									<asp:Label Runat="server" ID="KegiatanCode" text='<%# DataBinder.Eval(Container.DataItem, "KegiatanCode") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="KegiatanCode" text='<%# DataBinder.Eval(Container.DataItem, "KegiatanCode") %>'>
								...
								<FooterTemplate >
									<asp:TextBox Kegiatanholder="can't blank" ID="KegiatanCodeAdd" CssClass="TextBox" MaxLength="5" Runat="Server" Width="100%"/>
...
<HeaderStyle Width="100px"></HeaderStyle>
							...
							<asp:TemplateField HeaderText="KegiatanName " HeaderStyle-Width="320" SortExpression="KegiatanName">
								<Itemtemplate>
									<asp:Label Runat="server" ID="KegiatanName" text='<%# DataBinder.Eval(Container.DataItem, "KegiatanName") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="KegiatanNameEdit" MaxLength="40" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "KegiatanName") %>'>
									</asp:TextBox>
									<cc1:TextBoxWatermarkExtender ID="KegiatanNameEdit_WtExt" 
                                        runat="server" Enabled="True" TargetControlID="KegiatanNameEdit" 
                                        WatermarkText="can't blank" WatermarkCssClass="Watermarked">
                                     </cc1:TextBoxWatermarkExtender>
								</EditItemTemplate>
								
								<FooterTemplate>
									<asp:TextBox Kegiatanholder="can't blank" ID="KegiatanNameAdd" CssClass="TextBox" MaxLength="100" Runat="Server" Width="100%">
									</asp:TextBox>
