<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsGeneralComplaint.aspx.vb" Inherits="MsGeneralComplaint" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
        ...
        <body>
            <form id="form1" runat="server">
                ...
                <div class="Content">
                    <div class="H1">Pengaduan Umum</div>
                    <hr style="color:Blue" />
                    <asp:Panel runat="server" ID="pnlHd">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList">
                                        ...
                                        <asp:ListItem Text="Nama Pelapor" Value="Nama"></asp:ListItem>
                                    </asp:DropDownList>
                        ...
                        <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Phone" HeaderText="No Hp" SortExpression="Phone" />
                                 <asp:BoundField DataField="Schedule" DataFormatString="{0:dd MMM yyyy HH:mm:ss}"
                                    HeaderText="Jadwal call Pelapor" SortExpression="Schedule" />
                                <asp:BoundField DataField="Description" HeaderText="Detail Pelaporan"
                            ...
                            <div id="customModalReject" class="custom-modal">
                                <div class="custom-modal-content">
                                    <div class="custom-modal-header">
                                        <h5>Masukan Catatan Close Ticket</h5>
                                        <span class="close-btn" onclick="closeCustomModalReject()">&times;</span>
                                    </div>

                                    <div class="custom-modal-body">
                                        <asp:TextBox ID="tbRemarkClose" runat="server" CssClass="TextBox"
