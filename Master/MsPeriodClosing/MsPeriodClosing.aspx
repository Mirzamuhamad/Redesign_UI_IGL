<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPeriodClosing.aspx.vb" Inherits="MsPeriodClosing_MsPeriodClosing" %>
...
<body>
  <form id="form1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div class="Content">
     <div class="H1">Period Production Closing File</div>
     <hr style="color:Blue" />   
        ...
        <tr>
            ...
            <td><asp:DropDownList ID="ddlYear" Runat="Server"  CssClass="DropDownList"									    
                ...
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" >
                  ...
                  <asp:ListItem Text="Period" Value="PeriodCode"></asp:ListItem>        
                </asp:DropDownList>                   
