<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPortalRegistrasi.aspx.vb" Inherits="MsPortalRegistrasi" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
        ...
        <body>
            <form id="form1" runat="server">
                ...
                <div class="Content">
                    <div class="H1">Registration Request</div>
                    <hr style="color:Blue" />
                    <asp:Panel runat="server" ID="pnlHd">
                        ...
                        <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RequestNumber" HeaderText="No Registrasi"
                                ...
                                <asp:BoundField DataField="FullName" HeaderText="Nama" HeaderStyle-Width="200"
