<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPayrollEmpSt.aspx.vb" Inherits="Assign_MsPayrollEmpSt_MsPayrollEmpSt" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Payroll Slip Employee Status</div>
    <hr style="color:Blue" /> 
        <br />                     
              ...
              <table width="100%">
               ...
               <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView id="DataGrid" runat="server" ShowFooter="False" AllowSorting="True" 
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Employee Status Code" HeaderStyle-Width="70" SortExpression="EmpStatus">
								<Itemtemplate>
									<asp:Label Runat="server" Width="70" ID="EmpStatus" text='<%# DataBinder.Eval(Container.DataItem, "EmpStatus") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="EmpStatusEdit" MaxLength="5" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "EmpStatus") %>'>
									</asp:Label>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="EmpStatusAdd" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>								   
								</FooterTemplate>
							    <HeaderStyle Width="70px" />
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Employee Status Name" HeaderStyle-Width="150" SortExpression="EmpStatus_Name">
								<Itemtemplate>
									<asp:Label Runat="server" Width="200" ID="EmpStatusName" text='<%# DataBinder.Eval(Container.DataItem, "EmpStatus_Name") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
								    <asp:Label Runat="server" Width="200" ID="EmpStatusNameEdit" text='<%# DataBinder.Eval(Container.DataItem, "EmpStatus_Name") %>'>
									</asp:Label>									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="EmpNameStatusAdd" CssClass="TextBox" Width="100%" MaxLength="60" Runat="Server"/>
        ...
        <asp:Panel ID="pnlNewSlip" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "EmpStatus_Code"                     
                        ...
                        <dx:GridViewDataColumn Caption="Employee Status Code" FieldName="EmpStatus_Code" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Employee Status Name" FieldName="EmpStatus_Name" VisibleIndex="2" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
        ...
        <asp:Panel ID="pnlNewAdjust" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "EmpStatus"                     
                        ...
                        <dx:GridViewDataColumn Caption="Employee Status Code" FieldName="EmpStatus" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Employee Status Name" FieldName="EmpStatus_Name" VisibleIndex="2"> <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
                        <dx:GridViewDataColumn Caption="Effective Date" FieldName="Start_Date" VisibleIndex="3" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Amount" FieldName="Amount" VisibleIndex="4" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Formula" FieldName="Formula" VisibleIndex="5" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
                        </Columns>
                        <Settings ShowFilterRow="True" ShowFilterBar="Auto" ShowFilterRowMenu="True" />
                    </dx:ASPxGridView>
                  <%--</div>  --%>
