<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsNotaris.aspx.vb" Inherits="MsNotaris_MsNotaris" %>
        ...
        <tr>
            ...
            <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox" /> 
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" > 
                    <asp:ListItem Selected="true" Text="Notaris Code" Value="NotCode"></asp:ListItem>
                    <asp:ListItem Text="Notaris Name" Value="NotName"></asp:ListItem>                   
                    <asp:ListItem Text="Gender" Value="Gender"></asp:ListItem>
                    <asp:ListItem Text="Type ID" Value="TypeID"></asp:ListItem>
                    <asp:ListItem Text="Notaris ID" Value="NotID"></asp:ListItem>
      ...
      <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True" 
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
				            ...
				            <asp:BoundField DataField="NotCode" HeaderText="Notaris Code" HeaderStyle-Width="140" SortExpression="NotCode"/>
							<asp:BoundField DataField="NotName" HeaderText="Notaris Name" HeaderStyle-Width="300" SortExpression="NotName"/>
                            <asp:BoundField DataField="Gender" HeaderText="Gender" SortExpression="Gender"/>
							<asp:BoundField DataField="TypeID" HeaderText="Type ID " SortExpression="TypeID"/>	
                            <asp:BoundField DataField="NotID" HeaderText="ID No" SortExpression="NotID"/>
      ...
      <asp:Panel runat="server" ID="pnlInput" Visible="false">
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><asp:DropDownList runat="server" CssClass="DropDownList" Width="306px" ID="ddlTypeID" ValidationGroup="Input">
                    ...
                    <asp:ListItem>ID Notaris</asp:ListItem>
                    </asp:DropDownList> 
                </td>
             </tr>
            ...
            <tr>
                <td>ID No</td>
                <td>:</td>
                <td><asp:TextBox runat="server" MaxLength="60" CssClass="TextBox" ID="tbNotarisID" ValidationGroup="Input" Width="300px"/></td>
            </tr>
            ...
            <tr>
                <td>ZipCode</td>
                <td>:</td>
                <td><asp:TextBox runat="server" MaxLength="60" CssClass="TextBox" ID="tbZipCode" ValidationGroup="Input" Width="300px"/></td>
            </tr>
