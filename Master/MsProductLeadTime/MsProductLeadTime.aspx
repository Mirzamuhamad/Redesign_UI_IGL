<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsProductLeadTime.aspx.vb" Inherits="Master_MsProductLeadTime_MsProductLeadTime" %>
            ...
            <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox"/> 
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" >
                  <asp:ListItem Selected="true" Value="ProductCode" Text="Product Code"></asp:ListItem>
                    ...
                    <asp:ListItem Value="LeadTime" Text="LeadTime"></asp:ListItem>                    
                </asp:DropDownList>     
                <asp:Button class="bitbtn btnsearch" runat="server" ID="btnSearch" Text="Search" />
                <asp:Button class="btngo" runat="server" ID="btnExpand" Text="..."/>
                <%--<asp:Button class="bitbtn btnprint" runat="server" ID="btnPrint" Text="Print"/>--%>
                &nbsp &nbsp &nbsp &nbsp
                <asp:Label ID="lb1" runat="server" Text = "Setting Lead Time in selected row : "> </asp:Label>
                <asp:TextBox ID="tbLeadTime" runat="server" CssClass="TextBox" Width="25px" Text="1">                    
                </asp:TextBox>     
            ...
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
				          <asp:TemplateField>
							...
							<asp:TemplateField HeaderText="Lead Time (Period)" SortExpression="LeadTime">
								<Itemtemplate>
									<asp:Label Runat="server" ID="LeadTime" text='<%# DataBinder.Eval(Container.DataItem, "LeadTime") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
								    <asp:TextBox Runat="server" CssClass="TextBox" ID="LeadTimeEdit" MaxLength="10" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "LeadTime") %>'>
									</asp:TextBox>									
								</EditItemTemplate>								
							</asp:TemplateField>
