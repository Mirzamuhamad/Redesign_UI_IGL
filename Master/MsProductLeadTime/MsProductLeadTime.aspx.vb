...
Partial Class Master_MsProductLeadTime_MsProductLeadTime
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            LeadTime = DataGrid.Rows(e.NewEditIndex).FindControl("LeadTimeEdit")
            LeadTime.Attributes.Add("OnKeyDown", "return PressNumeric();")
        Catch ex As Exception
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            tbLead = DataGrid.Rows(e.RowIndex).FindControl("LeadTimeEdit")

            SQLString = "UPDATE MsProduct SET LeadTime = " + tbLead.Text.Trim.Replace(",", "") + " WHERE ProductCode = " & QuotedStr(lbCode.Text)
    ...
    '        Session("SelectCommand") = "S_FormPrintMaster3 'MsProductLeadTime','DurationCode','DurationName','Days','Maintenance Interval File','Period Code','Period Name','Days'," + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
    ...
    Private Sub bindDataSetLeadTime()
        Try
            ...
            If tbLeadTime.Text.Trim = "" Then
                tbLeadTime.Text = "0"
            End If
            If IsNumeric(tbLeadTime.Text) = False Then
                lstatus.Text = "Lead time must be input in numeric type"
                Exit Sub
            End If
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "Update MsProduct SET LeadTime = " + tbLeadTime.Text.Trim.Replace(",", "") + " WHERE ProductCode = " + QuotedStr(lb.Text.Trim)
                    SQLExecuteNonQuery(SQLString, ViewState("DBConnection").ToString)
                End If
            Next
            If HaveSelect = False Then
                lstatus.Text = "Please Check Product for Setting Lead Time"
                Exit Sub
            Else
                lstatus.Text = "Setting Lead Time Success for Selected Product"
            End If
            bindDataGrid()
        Catch ex As Exception
            Throw New Exception("bindDataGridsetLeadTime Error : " + ex.ToString)
        End Try
    End Sub
