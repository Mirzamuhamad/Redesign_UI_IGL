          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="true"
            CssClass="Grid" AutoGenerateColumns="false"> 
              ...
              <Columns>              
                  ...
                  <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Action" ItemStyle-Wrap="false">
                      <ItemTemplate>
                  ...
                  <asp:BoundField DataField="BuyingDate" DataFormatString="{0:dd MMM yyyy}"  htmlencode="true" SortExpression="BuyingDate" HeaderText="Buying Date" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false"></asp:BoundField>
                  ...
                  <asp:BoundField DataField="Fg_Moving" HeaderText="Moving" SortExpression="Fg_Moving" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false"></asp:BoundField>
                  <asp:BoundField DataField="FgActive" HeaderText="Active" SortExpression="FgActive" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false"></asp:BoundField>
              </Columns>
          </asp:GridView>
          </div>
