...
Partial Class MsCashFlow_MsCashFlow
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "S_FormprintMaster5 'VMsCashFlow', 'CashFlowCode +''-''+ CashFlowName ', 'CashFlowType', 'Days', 'Nominal', 'AccountName', 'Cash Flow', 'Cash Flow Code - Name', 'Cash Flow Type', 'days', 'Nominal', 'Account', '" + StrFilter + "', " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Dim ddlCashFlowType, ddlYearency, ddlStartMonth, ddlEndMonth, ddlYear As DropDownList
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                SQLString = "Insert into MsCashFlow (CashFlowCode, CashFlowName, CashFlowType, Days, Currency, Nominal,Account,StartYear, EndYear, StartMonth, EndMonth, UserId, UserDate ) " + _
                "SELECT " + QuotedStr(dbCode.Text) + ", " + QuotedStr(dbName.Text) + _
                "," + QuotedStr(ddlCashFlowType.SelectedValue) + ", " + tbDays.Text + ", " + QuotedStr(ddlYearency.SelectedValue) + ", " + tbNominal.Text.Replace(",", "") + _
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Dim ddlCashFlowType, ddlYearency, ddlStartMonth, ddlEndMonth As DropDownList
        Dim lbCode As Label
        'taro
        Try
    ...
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        SQLString = "EXEC S_MsCashFlowDt " + QuotedStr(lbCashFlow.Text) + ", " + QuotedStr(lbStartYear.Text) + ", " + QuotedStr(lbEndYear.Text) + ", " + QuotedStr(lbStartMonth.Text) + ", " + QuotedStr(lbEndMonth.Text) + ", " + QuotedStr(lbAmount.Text) + ", " + QuotedStr(ViewState("UserId"))
