...
Partial Class MsMachineLoadFactor_MsMachineLoadFactor
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "S_FormPrintMaster6 'VMsMachine','Machine_Code','Machine_Name','MachineGroup_Name','Specification','Unit','LoadFactor','Machine Load Factor FOH File','Machine Code','Machine Name','Machine Group Name','Specification','Unit','Load Factor'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            If CFloat(dbLoadFactor.Text.Replace(",", "")) <= 0 Then
                lstatus.Text = MessageDlg("Load Factor Must Have Value")
                dbLoadFactor.Focus()
                Exit Sub
            End If

            SQLString = "Update MsMachine set LoadFactor = " + dbLoadFactor.Text.Replace(",", "") + _
    ...
    Private Sub bindDataSetLF()
        Try
            ...
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "Update MsMachine set LoadFactor = " + tbLoadFactor.Text.Replace(",", "") + " WHERE MachineCode = " + QuotedStr(lb.Text.Trim)
                    SQLExecuteNonQuery(SQLString, ViewState("DBConnection").ToString)
                End If
            Next
            If HaveSelect = False Then
                lstatus.Text = "Please Check Machine for Setting Load Factor"
                Exit Sub
            Else
                lstatus.Text = "Setting Load Factor Success for Selected Machine"
            End If
            bindDataGrid()
        Catch ex As Exception
