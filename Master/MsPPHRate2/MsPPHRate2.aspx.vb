...
Partial Class Master_MsPPHRate2_MsPPHRate2
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            SqlString = "Select Code, dbo.FORMATFloat(StartValue,0) As StartValue, dbo.FORMATFloat(EndValue,0) As EndValue, " + _
                     " dbo.FORMATFloat(RateNPWP,0) As RateNPWP, dbo.FORMATFloat(RateNonNPWP,0) As RateNonNPWP from MsPPHRate2 " + StrFilter
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster5 'MsPPHRate2','Code','StartValue', 'EndValue', 'RateNPWP', 'RAteNonNPWP','Rate PPH Pesangon','Code','Start Value','End Value', 'Rate NPWP', 'Rate Non NPWP'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                If SQLExecuteScalar("Select Code From VMsPPHRate2 WHERE Code = " + QuotedStr(dbCode.Text), ViewState("DBConnection").ToString).Length > 0 Then
                    lstatus.Text = "Code " + QuotedStr(dbCode.Text) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsPPHRate2 SELECT " + QuotedStr(dbCode.Text) + _
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsPPHRate2 where Code = " + QuotedStr(txtID.Text), ViewState("DBConnection").ToString)
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            SQLString = "Update MsPPHRate2 SET StartValue = " + QuotedStr(dbStartValue.Text.Replace(",", "")) + _
