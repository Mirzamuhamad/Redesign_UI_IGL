<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPPHRate2.aspx.vb" Inherits="Master_MsPPHRate2_MsPPHRate2" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Rate PPH Pesangon</title>
...
<body>
    ...
    <div class="Content">
     <div class="H1">Rate PPH Pesangon</div>
     <hr style="color:Blue" />
           <table>
        <tr>
            ...
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
							...
							<asp:TemplateField HeaderText="Start Value" HeaderStyle-Width="100" SortExpression="StartValue" ItemStyle-HorizontalAlign="Right" >
								...
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="StartValueEdit" MaxLength="30" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "StartValue") %>'>
									</asp:TextBox>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="StartValueAdd" CssClass="TextBox" Runat="Server" MaxLength="30" Width="100%"/>
							...
							<asp:TemplateField HeaderText="End Value" HeaderStyle-Width="100" SortExpression="EndValue" ItemStyle-HorizontalAlign="Right" >
								...
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="EndValueEdit" MaxLength="30" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "EndValue") %>'>
									</asp:TextBox>
									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="EndValueAdd" CssClass="TextBox" Runat="Server" MaxLength="30" Width="100%"/>
							...
							<asp:TemplateField HeaderText="Rate NPWP (%)" HeaderStyle-Width="100" SortExpression="RateNPWP" ItemStyle-HorizontalAlign="Right" >
								...
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="RateNPWPEdit" MaxLength="30" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "RateNPWP") %>'>
									</asp:TextBox>
									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="RateNPWPAdd" CssClass="TextBox" Runat="Server" MaxLength="30" Width="100%"/>
							...
							<asp:TemplateField HeaderText="Rate Non NPWP (%)" HeaderStyle-Width="120" SortExpression="RateNonNPWP" ItemStyle-HorizontalAlign="Right" >
								...
								<EditItemTemplate>
									<asp:TextBox Runat="server" CssClass="TextBox" ID="RateNonNPWPEdit" MaxLength="30" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "RateNonNPWP") %>'>
									</asp:TextBox>
									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="RateNonNPWPAdd" CssClass="TextBox" Runat="Server" MaxLength="30" Width="100%"/>
