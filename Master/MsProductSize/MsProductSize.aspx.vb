...
Imports System.Data
Partial Class MsProductSize_MsProductSize
    ...
    '        SqlString = "SELECT * FROM MsProductSize " + StrFilter + " Order By SizeName "
    ...
    Private Sub bindDataGrid()
        ...
        Try
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            SqlString = "SELECT A.ProductJenis, A.ProductSize,A.SizeName, B.JenisName FROM MsProductSize A INNER JOIN MsProductJenis B ON A.ProductJenis = B.JenisCode" + StrFilter + " Order By A.SizeName "
            If ViewState("SortExpression") = Nothing Then
                ViewState("SortExpression") = "ProductJenis ASC"
                ViewState("SortOrder") = "ASC"
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster4 'VMsProductSizeNew','JenisName','ProductJenis','ProductSize','SizeName'," + QuotedStr(lblTitle.Text) + ",'Product Jenis Code','Product Jenis Name','Product Size','Product Size Name'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Dim dbSize, dbName As TextBox
        Dim ddlJenis As DropDownList

        Try
            If e.CommandName = "Insert" Then
                dbSize = DataGrid.FooterRow.FindControl("ProductSizeAdd")
                dbName = DataGrid.FooterRow.FindControl("ProductSizeNameAdd")
                ...
                If SQLExecuteScalar("SELECT ProductJenis From VMsProductSizeNew WHERE ProductJenis = " + QuotedStr(ddlJenis.SelectedValue), ViewState("DBConnection")).Length > 0 Then
                    lstatus.Text = "Product Sub Group " + QuotedStr(ddlJenis.SelectedValue) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "Insert into MsProductSize (ProductJenis, ProductSize, SizeName, UserId, UserDate ) " + _
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsProductSize where ProductJenis = '" & txtID.Text & "'", ViewState("DBConnection"))
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            txt = obj.FindControl("ProductSizeNameEdit")
            txt.Focus()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Try
            ...
            dbName = DataGrid.Rows(e.RowIndex).FindControl("ProductSizeNameEdit")
            ...
            SQLString = "Update MsProductSize set SizeName= " + QuotedStr(dbName.Text) + _
