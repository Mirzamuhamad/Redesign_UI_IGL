...
Partial Class Master_MsJobPrice_MsJobPrice
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                InitProperty()
                FillCombo(ddlCategory, "Select JobPlantGrpCode, JobPlantGrpName from MsJobPlantGroup", False, "JobPlantGrpCode", "JobPlantGrpName", ViewState("DBConnection"))
    ...
    Sub BindData()
        ...
        Try
            ...
            End If
            tempDS = SQLExecuteQuery("EXEC S_MsJobPlantPriceGetDt " + QuotedStr(Format(tbDate.SelectedDate, "yyyyMMdd")) + ", " + QuotedStr(ddlCategory.SelectedValue) + ", " + QuotedStr(StrFilter), ViewState("DBConnection").ToString)
            ...
            If exe Then
                For i = 0 To DataGrid.Rows.Count - 1
                    ...
                    If Not ((tbPrice.Text = "" Or tbPrice.Text = "0")) And (tbPrice.Text <> lbLastPrice.Text) Then
                        SQLString = "EXEC S_MsJobPlantPriceUpdate " + QuotedStr(Format(tbDate.SelectedDate, "yyyy-MM-dd")) + ", " + _
