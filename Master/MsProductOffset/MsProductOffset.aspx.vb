...
Partial Class Master_MsProductOffset_MsProductOffset
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.tbOffset.Attributes.Add("OnKeyDown", "return PressNumeric();")
            'bindDataGrid()
            Dim dt As DataTable
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            SqlString = "SELECT * FROM VMsProductForSetting " + StrFilter
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            Offset = DataGrid.Rows(e.NewEditIndex).FindControl("OffsetEdit")
            Offset.Attributes.Add("OnKeyDown", "return PressNumeric();")
        Catch ex As Exception
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Dim lbCode As Label
        Dim tbLead As TextBox

        Try
            lbCode = DataGrid.Rows(e.RowIndex).FindControl("ProductCodeEdit")
            tbLead = DataGrid.Rows(e.RowIndex).FindControl("OffsetEdit")

            SQLString = "UPDATE MsProduct SET Offset = " + tbLead.Text.Trim.Replace(",", "") + " WHERE ProductCode = " & QuotedStr(lbCode.Text)
    ...
    '        Session("SelectCommand") = "S_FormPrintMaster3 'MsProductOffset','DurationCode','DurationName','Days','Maintenance Interval File','Period Code','Period Name','Days'," + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
    ...
    Private Sub bindDataSetOffset()
        Try
            ...
            Dim SQLString As String
            HaveSelect = False
            If tbOffset.Text.Trim = "" Then
                tbOffset.Text = "0"
            End If
            If IsNumeric(tbOffset.Text) = False Then
                lstatus.Text = "Offset must be input in numeric type"
                Exit Sub
            End If
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "Update MsProduct SET Offset = " + tbOffset.Text.Trim.Replace(",", "") + " WHERE ProductCode = " + QuotedStr(lb.Text.Trim)
                    SQLExecuteNonQuery(SQLString, ViewState("DBConnection").ToString)
                End If
            Next
            If HaveSelect = False Then
                lstatus.Text = "Please Check Product for Setting Offset"
                Exit Sub
            Else
                lstatus.Text = "Setting Offset Success for Selected Product"
            End If
            bindDataGrid()
        Catch ex As Exception
            Throw New Exception("bindDataGridsetOffset Error : " + ex.ToString)
        End Try
    End Sub
