<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPayrollJbTtl.aspx.vb" Inherits="Assign_MsPayrollJbTtl_MsPayrollJbTtl" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Payroll Slip Job Title</div>
    <hr style="color:Blue" /> 
        <br />                     
              ...
              <table width="100%">
               ...
               <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView id="DataGrid" runat="server" ShowFooter="False" AllowSorting="True" 
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Job Title" HeaderStyle-Width="70" SortExpression="JobTitle">
								<Itemtemplate>
									<asp:Label Runat="server" Width="70" ID="JobTitle" text='<%# DataBinder.Eval(Container.DataItem, "JobTitle") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="JobTitleEdit" MaxLength="5" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "JobTitle") %>'>
									</asp:Label>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="JobTitleAdd" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>								   
								</FooterTemplate>
							    <HeaderStyle Width="70px" />
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Job Title Name" HeaderStyle-Width="150" SortExpression="Job_Title_Name">
								<Itemtemplate>
									<asp:Label Runat="server" Width="200" ID="JobTitleName" text='<%# DataBinder.Eval(Container.DataItem, "Job_Title_Name") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
								    <asp:Label Runat="server" Width="200" ID="JobTitleNameEdit" text='<%# DataBinder.Eval(Container.DataItem, "Job_Title_Name") %>'>
									</asp:Label>									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="JobTitleNameAdd" CssClass="TextBox" Width="100%" MaxLength="60" Runat="Server"/>
        ...
        <asp:Panel ID="pnlNewSlip" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    <legend> Apply for : </legend>
                        ...
                        <asp:ListItem Value= "0" Selected="True">All Job Title</asp:ListItem>
                        <asp:ListItem Value= "1">Selected Job Title</asp:ListItem>                        
                    </asp:RadioButtonList>                
                    </fieldset>
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "Job_Title_Code"                     
                        ...
                        <dx:GridViewDataColumn Caption="Job Title" FieldName="Job_Title_Code" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Job Title Name" FieldName="Job_Title_Name" VisibleIndex="2" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
                        </Columns>
