<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsDeduction.aspx.vb" Inherits="MsDeduction_MsDeduction" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Deduction File</title>
...
<body>
    ...
    <div class="Content">
     <div class="H1">Deduction File</div>
     <hr style="color:Blue" />
        ...
        <tr>
            ...
            <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox" /> 
                <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" > 
                    <asp:ListItem Selected="true" Text="Deduction Code" Value="PayrollCode"></asp:ListItem>
                    <asp:ListItem Text="Deduction Name" Value="PayrollName"></asp:ListItem>                   
     ...
     <table>   
      ...
      <asp:GridView id="DataGrid" runat="server" ShowFooter="True" AllowSorting="True" 
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				      ...
				      <Columns>
				            ...
				            <asp:BoundField DataField="PayrollCode" HeaderText="Deduction Code" HeaderStyle-Width="140" SortExpression="PayrollCode"/>
							<asp:BoundField DataField="PayrollName" HeaderText="Deduction Name" HeaderStyle-Width="300" SortExpression="PayrollName"/>
							...
							<asp:BoundField DataField="Prioritas" HeaderText="Priority" HeaderStyle-Width="80" SortExpression="Prioritas" ItemStyle-HorizontalAlign = "Right"/>
      ...
      <asp:Panel runat="server" ID="pnlInput" Visible="false">
        <table style="margin-right: 93px; width: 694px;">
            <tr>
                <td class="style7">Deduction Code</td>
                <td>:</td>
                <td>
                    ...
                    <asp:TextBox ID="tbNoView" runat="server" CssClass="TextBox" MaxLength="5" 
                        Enabled = "false" Width="78px"/>
                </td>
            </tr>
            <tr>
                <td class="style7">Deduction Name</td>
                <td>:</td>
