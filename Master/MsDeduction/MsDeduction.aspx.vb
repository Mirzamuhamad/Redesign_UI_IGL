...
Imports System.Data
Partial Class MsDeduction_MsDeduction
    ...
    Private Sub bindDataGrid()
        ...
        Try
            ...
            If StrFilter = "" Then
                Filter = " WHERE PayrollPref = 'D' "
            Else
                Filter = StrFilter + " AND PayrollPref = 'D' "
            End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            If StrFilter = "" Then
                StrFilter = " WHERE PayrollPref = 'D'"
            Else
                StrFilter = StrFilter + " AND PayrollPref = 'D'"
            End If
            SQLString = "S_FormPrintMaster5 'VMsPayroll', 'PayrollCode', 'PayrollName', 'FormulaName', 'PayrollTypeName', 'Tertanggung', 'Deduction File', 'Deduction Code', 'Deduction Name', 'Formula', 'Payroll Type', 'Responsibility By', " + QuotedStr(StrFilter) + ", " + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                'If SQLExecuteScalar("SELECT Wrhs_Code From VMsDeduction WHERE Wrhs_Code = " + QuotedStr(dbCode.Text), Session("DBConnection").ToString).Length > 0 Then
                '    lstatus.Text = "Warehouse " + QuotedStr(dbCode.Text) + " has already been exist"
                '    Exit Sub
                'End If

                ''insert the new entry
                'SQLString = "Insert into MsDeduction (WrhsCode, WrhsName, WrhsGroup, WrhsArea, WrhsType, WrhsCondition, FgActive, UserId, UserDate ) " + _
            ...
            ElseIf e.CommandName = "Location" Then
                ...
                'gvr = DataGrid.Rows(CInt(e.CommandArgument))
                'If (Not ClientScript.IsStartupScriptRegistered("tes")) Then
                '    Page.ClientScript.RegisterStartupScript(Me.GetType(), "tes", "OpenAssign('Warehouse', '" + gvr.Cells(0).Text + "|" + gvr.Cells(1).Text + "','AssMsDeductionLoc');", True)
                'End If
            End If
        Catch ex As Exception
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            'SQLExecuteNonQuery("Delete from MsDeduction where WrhsCode = '" & txtID.Text & "'")
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        '    SQLString = "Update MsDeduction set WrhsName= " + QuotedStr(dbName.Text) + "," & _
    ...
    Private Function cekInput() As Boolean
        Try
            If tbNo.Text.Trim.Length = 0 Then
                lstatus.Text = MessageDlg("Deduction Code cannot empty")
                tbNo.Focus()
                Return False
            End If
            If tbName.Text.Trim.Length = 0 Then
                lstatus.Text = MessageDlg("Deduction Name cannot empty")
                tbName.Focus()
                Return False
            End If
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Try
            ...
            If ViewState("State") = "Insert" Then
                ...
                'Sampai Sini
                If SQLExecuteScalar("SELECT PayrollNo From VMsPayroll WHERE PayrollPref = 'D' AND PayrollCode = " + QuotedStr(PayrollCode), ViewState("DBConnection").ToString).Length > 0 Then
                    lstatus.Text = "Deduction " + QuotedStr(tbNo.Text) + " has already been exist"
                    Exit Sub
                End If
                ...
                tbAmount.Text.Replace(",", "") + ", 'POT', " + QuotedStr(ddlResponsibility.SelectedValue) + ", 'All', " & _
