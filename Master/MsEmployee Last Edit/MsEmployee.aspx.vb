        ...
        Try
            ...
            If ViewState("StateHd") = "Insert" Then
                ...
                If FileUpload.PostedFile Is Nothing OrElse String.IsNullOrEmpty(FileUpload.PostedFile.FileName) OrElse FileUpload.PostedFile.InputStream Is Nothing Then
                    lbStatus.Text = MessageDlg("Tolong Upload Foto Yang Valid")
                    'Upload Image mempunyai id = Label5
                    Exit Sub
                End If

                'Memastikan Type File yang di Upload bertype Image
                ...
                Select Case extension
                    ...
                    Case Else
                        'Format Tidak Sesuai
                        Label5.Text = "Format Foto Tidak Sesuai"
                        'Upload Image mempunyai id = Label5
                        Exit Sub
                End Select

                Dim fs As System.IO.Stream = FileUpload.PostedFile.InputStream
                'Tempat Untuk Upload ( Yang Ada Browse / Telusuri ) mempunyai id = FileUpload
                Dim br As New System.IO.BinaryReader(fs)
                Dim bytes As Byte() = br.ReadBytes(CType(fs.Length, Integer))
                Dim base64String As String = Convert.ToBase64String(bytes, 0, bytes.Length)
                Image1.ImageUrl = "data:image/png;base64," & base64String
                Image1.Visible = True
                'Image mempunyai id = ImagePreview
                ...
                " UserID, UserDate, JobLevel, Department, JobTitle, EmpStatus, WorkPlace, SKNo, EndDateContract, MethodSalary, Image) " + _
               ...
               QuotedStr(Format(tbEndContract.SelectedValue, "yyyy-MM-dd")) + ", " + QuotedStr(ddlMethod.SelectedValue) + ", " + QuotedStr("@image")


                Dim myCommand As New SqlCommand(SQLString, con)
