...
<body>     
    ...
    <%--<Input type="file" ID="fuimage" name="fileUpload" onchange="Show(this);" /> 
    <img id="imgpreview" Alt="image before upload" /> --%>   
                       ...
                       <table>
                            ...
                            <tr>
                                ...
                                <td >
                                    :</td>
                                <td>
                                     <asp:Image ID="Image1" CssClass="Image" runat="server" Height = "100" Width = "100" />
                                     <asp:FileUpload ID="FileUpload" CssClass="FileUpload" runat="server" AutoPostBack="True" onchange="showpreview(this);" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >
                                    :</td>
                                <td >
                                    <asp:TextBox ID="tbWeight" runat="server" CssClass="TextBox"  MaxLength="16" />
                                    kg</td>
                            </tr>
                            <tr>
                                <td >
