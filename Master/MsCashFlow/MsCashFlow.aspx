  ...
  <form id="form1" runat="server">
     ...
     <asp:Panel id="pnlHd" runat="server">
            ...
            <tr>
                ...
                <td><asp:TextBox runat="server" ID ="tbFilter" CssClass="TextBox"/> 
                    <asp:DropDownList runat="server" ID="ddlField" CssClass="DropDownList" >
                      ...
                      <asp:ListItem Text="Group" Value="CashFlowGroup"></asp:ListItem> 
                ...
                AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				    ...
				    <EmptyDataTemplate>
				          ...
				          <Columns>					            		      
    							...
    							<asp:TemplateField HeaderText="Group" HeaderStyle-Width="150px" SortExpression="CashFlowGroupName">
								    <Itemtemplate>
									    <asp:Label Runat="server" ID="CashFlowGroup" Width="100%" text='<%# DataBinder.Eval(Container.DataItem, "CashFlowGroupName") %>'>
									    </asp:Label>
								    </Itemtemplate>
								    <EditItemTemplate>
									    <asp:DropDownList Runat="server" ID="CashFlowGroupEdit" Width="100%" CssClass="DropDownList"
                                            SelectedValue='<%# DataBinder.Eval(Container.DataItem, "CashFlowGroup") %>'
                                            DataSourceID="dsCashFlowGroup" DataTextField="CashFlowGroupName" 
                                            DataValueField="CashFlowGroupCode">
									    </asp:DropDownList>													
								    </EditItemTemplate>
								    <FooterTemplate>
									    <asp:DropDownList CssClass="DropDownList" ID="CashFlowGroupAdd" Runat="Server" Width="100%" 
                                            DataSourceID="dsCashFlowGroup" DataTextField="CashFlowGroupName" 
                                            DataValueField="CashFlowGroupCode">
									    </asp:DropDownList>									
								    </FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="Flow Type" HeaderStyle-Width="150px" SortExpression="CashFlowTypeName">
								    <Itemtemplate>
									    <asp:Label Runat="server" ID="CashFlowType" Width="100%" text='<%# DataBinder.Eval(Container.DataItem, "CashFlowTypeName") %>'>
									    </asp:Label>
								    </Itemtemplate>
								    <EditItemTemplate>
								    ...
								    <FooterTemplate>
									    <asp:DropDownList CssClass="DropDownList" ID="CashFlowTypeAdd" Runat="Server" Width="100%" 
                                            DataSourceID="dsCashFlowType" DataTextField="CashFlowTypeName" 
                                            DataValueField="CashFlowTypeCode">
									    </asp:DropDownList>									
								    </FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="Account" HeaderStyle-Width="100%" SortExpression="Account">
								    ...
								    <EditItemTemplate>
								        <asp:TextBox CssClass="TextBox" runat="server" ID="AccountEdit"  Width="65%" 
								    ...
								    <FooterTemplate >
								     <asp:TextBox CssClass="TextBox" runat="server" ID="AccountAdd" Width="45%"
                                            text='<%# DataBinder.Eval(Container.DataItem, "Account") %>' 
								       ...
								       <%-- <asp:TextBox CssClass="TextBox" runat="server" id="AccountAdd"  
                                            ontextchanged="AccountAdd_TextChanged" AutoPostBack="true" Width="65%" />
                                        <asp:Button class="btngo" runat="server" ID="btnAccAdd" Text="..." CommandName="SearchAdd" />   --%>                                                     
								    </FooterTemplate>  
							    ...
							    <asp:TemplateField HeaderText="Days" HeaderStyle-Width="20px" SortExpression="Days">
								    ...
								    <EditItemTemplate>
									    <asp:TextBox Runat="server" ID="DaysEdit" CssClass="TextBox"  Width="100%" ontextchanged="DaysEdit_TextChanged" AutoPostBack="true" Text='<%# DataBinder.Eval(Container.DataItem, "Days") %>'>
									    </asp:TextBox>
								    </EditItemTemplate>
								    <FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="Nominal" HeaderStyle-Width="50px" SortExpression="Nominal" ItemStyle-HorizontalAlign = "Right">
								    <Itemtemplate>
									    ...
									    <%--<asp:Label Runat="server" ID="Nominal" text='<%# String.Format("{0:###,###.00}",Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "Nominal"))) %>'>
									    </asp:Label>--%>
								    </Itemtemplate>
								    <EditItemTemplate>
								        <asp:TextBox Runat="server" CssClass="TextBox" ID="NominalEdit" Width="100%" text='<%# DataBinder.Eval(Container.DataItem, "Nominal") %>'>
									    </asp:TextBox>
									    <%--<asp:TextBox Runat="server" CssClass="TextBox" ID="NominalEdit" Width="100%" text='<%# String.Format("{0:###,###.00}",Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "Nominal"))) %>'>
									    </asp:TextBox>--%>
								    </EditItemTemplate>
								    <FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="StartYear" HeaderStyle-Width="50px" SortExpression="StartYear">
								    ...
								    <EditItemTemplate>
									    <asp:TextBox Runat="server" CssClass="TextBox" ID="StartYearEdit" MaxLength="4" Width="100%" ontextchanged="StartYearAdd_TextChanged" AutoPostBack="true" Text='<%# DataBinder.Eval(Container.DataItem, "StartYear") %>'>
									    </asp:TextBox>
								    </EditItemTemplate>
								    <FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="EndYear" HeaderStyle-Width="80px" SortExpression="EndYear">
								    ...
								    <EditItemTemplate>
									    <asp:TextBox Runat="server" CssClass="TextBox" ID="EndYearEdit" MaxLength="4" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "EndYear") %>'>
									    </asp:TextBox>
								    </EditItemTemplate>
								    <FooterTemplate>
							    ...
							    <asp:TemplateField HeaderText="Action" headerstyle-width="126px" >
								    <ItemTemplate>
								        ...
								        <asp:Button class="bitbtn btndetail"  runat="server" ID="btnDetail" Text="Detail" CommandName="Detail" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" /> 
    								</ItemTemplate>
								    <EditItemTemplate>
	    ...
	    <br />    	 
         ...
         <asp:SqlDataSource ID="dsCashFlowGroup" runat="server"                                                                                 
                                        SelectCommand="EXEC S_GetCashFlowGroup">                                        
        </asp:SqlDataSource>
