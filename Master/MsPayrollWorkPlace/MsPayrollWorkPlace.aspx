<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPayrollWorkPlace.aspx.vb" Inherits="Assign_MsPayrollWorkPlace_MsPayrollWorkPlace" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Payroll Slip Work Place</div>
    <hr style="color:Blue" /> 
        <br />                     
              ...
              <table width="100%">
               ...
               <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView id="DataGrid" runat="server" ShowFooter="False" AllowSorting="True" 
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Work Place" HeaderStyle-Width="70" SortExpression="WorkPlace">
								<Itemtemplate>
									<asp:Label Runat="server" Width="70" ID="WorkPlace" text='<%# DataBinder.Eval(Container.DataItem, "WorkPlace") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="WorkPlaceEdit" MaxLength="5" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "WorkPlace") %>'>
									</asp:Label>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="WorkPlaceAdd" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>								   
								</FooterTemplate>
							    <HeaderStyle Width="70px" />
							</asp:TemplateField>
							
							<asp:TemplateField HeaderText="Work Place Name" HeaderStyle-Width="150" SortExpression="WorkPlaceName">
								<Itemtemplate>
									<asp:Label Runat="server" Width="200" ID="WorkPlaceName" text='<%# DataBinder.Eval(Container.DataItem, "WorkPlaceName") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
								    <asp:Label Runat="server" Width="200" ID="WorkPlaceNameEdit" text='<%# DataBinder.Eval(Container.DataItem, "WorkPlaceName") %>'>
									</asp:Label>									
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="WorkPlaceNameAdd" CssClass="TextBox" Width="100%" MaxLength="60" Runat="Server"/>
							...
							<asp:TemplateField HeaderText="Currency" HeaderStyle-Width="40" SortExpression="Currency">
								<Itemtemplate>
        ...
        <asp:Panel ID="pnlNewSlip" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    <legend> Apply for : </legend>
                        ...
                        <asp:ListItem Value= "0" Selected="True">All Work Place</asp:ListItem>
                        <asp:ListItem Value= "1">Selected Work Place</asp:ListItem>                        
                    </asp:RadioButtonList>                
                    </fieldset>
                    
                    <br/>
                    Work Place Available
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "WorkPlaceCode"                     
                        ...
                        <dx:GridViewDataColumn Caption="Work Place" FieldName="WorkPlaceCode" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Work Place Name" FieldName="WorkPlaceName" VisibleIndex="2" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        
                        </Columns>
