...
Partial Class MsMachineLoadFactorLB_MsMachineLoadFactorLB
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'bindDataGrid()
            tbLoadFactor.Attributes.Add("OnKeyDown", "return PressNumeric();")
        End If
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "S_FormPrintMaster6 'VMsMachine','Machine_Code','Machine_Name','MachineGroup_Name','Specification','ManPower','LoadFactor','Machine Load Factor Labor File','Machine Code','Machine Name','Machine Group Name','Specification','Man Power','Load Factor'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId"))
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            txt = obj.FindControl("LoadFactorEdit")
            txt.Focus()
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        ...
        Dim dbLoadFactor, dbManPower As TextBox
        Dim lbCode As Label

        Try
            lbCode = DataGrid.Rows(e.RowIndex).FindControl("MachineCodeEdit")
            dbLoadFactor = DataGrid.Rows(e.RowIndex).FindControl("LoadFactorEdit")
            dbManPower = DataGrid.Rows(e.RowIndex).FindControl("ManPowerEdit")

            If CFloat(dbManPower.Text.Replace(",", "")) <= 0 Then
                lstatus.Text = MessageDlg("Man Power Must Have Value")
                dbManPower.Focus()
                Exit Sub
            End If
            If CFloat(dbLoadFactor.Text.Replace(",", "")) <= 0 Then
                lstatus.Text = MessageDlg("Load Factor LB Must Have Value")
                dbLoadFactor.Focus()
                Exit Sub
            End If

            SQLString = "Update MsMachine set LoadFactorLB = " + dbLoadFactor.Text.Replace(",", "") + _
            ", ManPower = " + dbManPower.Text.Replace(",", "") + _
    ...
    Private Sub bindDataSetLF()
        Try
            ...
            For Each GVR In DataGrid.Rows
                ...
                lb = GVR.FindControl("MachineCode")
                If CB.Checked Then
                    HaveSelect = True
            ...
            If HaveSelect = False Then
                lstatus.Text = "Please Check Machine for Setting Load Factor Labor"
                Exit Sub
            Else
                lstatus.Text = "Setting Load Factor Labor Success for Selected Machine"
            End If
            bindDataGrid()
        Catch ex As Exception
    ...
    Private Sub bindDataSetManPower()
        Try
            Dim GVR As GridViewRow
            Dim CB As CheckBox
            Dim lb As Label
            ...
            For Each GVR In DataGrid.Rows
                ...
                If CB.Checked Then
                    HaveSelect = True
                    SQLString = "Update MsMachine set ManPower = " + tbManPower.Text.Replace(",", "") + " WHERE MachineCode = " + QuotedStr(lb.Text.Trim)
                    SQLExecuteNonQuery(SQLString, ViewState("DBConnection").ToString)
                End If
            Next
            If HaveSelect = False Then
                lstatus.Text = "Please Check Machine for Setting Man Power"
                Exit Sub
            Else
                lstatus.Text = "Setting Man Power Success for Selected Machine"
            End If
            bindDataGrid()
        Catch ex As Exception
            Throw New Exception("bindDataSetManPower Error : " + ex.ToString)
        End Try
    End Sub
