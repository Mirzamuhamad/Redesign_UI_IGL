...
Imports System.Data
Partial Class MsProductStockType_MsProductStockType
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Session("Result") Is Nothing Then
            If ViewState("Sender") = "SearchAdd" Or ViewState("Sender") = "SearchEdit" Then
                ...
                If Session("Result")(2).ToString = "D" Then
                    tbType.Text = "Cost"
                Else
                    tbType.Text = "Income"
                End If
    ...
    Protected Sub AccountEdit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            ds = SQLExecuteQuery("Select Account, Description, FgNormal AS AccountName From VMsAccount WHERE Account = " + QuotedStr(Acc.Text), ViewState("DBConnection").ToString)
            If IsNothing(ds) Or ds.Tables(0).Rows.Count <= 0 Or IsNothing(ds.Tables(0)) Then
                tbType.Text = "Cost"
            Else
                dr = ds.Tables(0).Rows(0)
                If dr("FgNormal").ToString = "D" Then
                    tbType.Text = "Cost"
                Else
                    tbType.Text = "Income"
                End If
    ...
    '        SqlString = "Select * from MsStockType " + StrFilter
    '        If ViewState("SortExpression") = Nothing Then
    '            ViewState("SortExpression") = "StockTypeCode ASC"
    '        End If
    ...
    Private Sub bindDataGrid()
        ...
        Try
            StrFilter = GenerateFilterMs(ddlField.SelectedValue, ddlField2.SelectedValue, tbFilter.Text, tbfilter2.Text, ddlNotasi.SelectedValue)
            SqlString = "SELECT A.StockTypeCode, A.StockTypeName, A.Account,A.Type, B.AccountName FROM MsStockType A INNER JOIN MsAccount B ON A.Account = B.Account  " + StrFilter + " Order By A.StockTypeCode "
            If ViewState("SortExpression") = Nothing Then
                ViewState("SortExpression") = "StockTypeCode ASC"
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Session("SelectCommand") = "EXEC S_FormPrintMaster4 'VMsStockTypeNew','Type_Code','StockTypeNAme','Account','Type_Stock'," + QuotedStr(lblTitle.Text) + ",'Stock Type Code','Stock Type Name','Account', 'Type Stock'," + QuotedStr(StrFilter) + "," + QuotedStr(ViewState("UserId").ToString)
    ...
    Protected Sub DataGrid_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataGrid.RowCommand
        ...
        Dim dbCode, dbName, dbtype, dbAccount As TextBox
        ...
        Try
            If e.CommandName = "Insert" Then
                ...
                dbtype = DataGrid.FooterRow.FindControl("TypeAdd")

                If dbCode.Text.Trim.Length = 0 Then
                    lstatus.Text = "Type Code must be filled."
                    dbCode.Focus()
                    Exit Sub
                End If
                ...
                If dbAccount.Text.Trim.Length = 0 Then
                    lstatus.Text = "Account Name must be filled."
                    dbAccount.Focus()
                    Exit Sub
                End If

                If SQLExecuteScalar("SELECT Stock_Type_Code From VMsStockType WHERE Stock_Type_Code = " + QuotedStr(dbCode.Text), ViewState("DBConnection")).Length > 0 Then
                    lstatus.Text = "Product Stock Type " + QuotedStr(dbCode.Text) + " has already been exist"
                    Exit Sub
                End If

                'insert the new entry
                SQLString = "INSERT INTO MsStockType (StockTypeCode, StockTypeName, Account, Type, UserId, UserDate ) " + _
                " SELECT " + QuotedStr(dbCode.Text) + ", " + QuotedStr(dbName.Text) + ", " + _
                QuotedStr(dbAccount.Text) + ", " + QuotedStr(dbtype.Text) + ", " + QuotedStr(ViewState("UserId").ToString) + ", getDate()"
            ...
            ElseIf e.CommandName = "SearchAdd" Or e.CommandName = "SearchEdit" Then
                ...
                FieldResult = "Account, Description, FgNormal"
            ...
            ElseIf e.CommandName = "Detail" Then
                ...
                If (Not ClientScript.IsStartupScriptRegistered("tes")) Then
                    Page.ClientScript.RegisterStartupScript(Me.GetType(), "tes", "OpenAssign('TypeStock', '" + Request.QueryString("KeyId") + "', '" + lbCode.Text + "|" + lbName.Text + "','AssMsPettyUser');", True)
                End If
    ...
    Protected Sub DataGrid_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles DataGrid.RowDeleting
        ...
        Try
            ...
            SQLExecuteNonQuery("Delete from MsStockType where StockTypeCode = '" & txtID.Text & "'", ViewState("DBConnection"))
            bindDataGrid()
    ...
    Protected Sub DataGrid_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles DataGrid.RowEditing
        ...
        Try
            ...
            lbJenisCode = obj.FindControl("StockTypeCodeEdit")
            ViewState("StockTypeCode") = lbJenisCode.Text
    ...
    Protected Sub DataGrid_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles DataGrid.RowUpdating
        Dim SQLString As String
        Dim dbName, dbAccount, dbType As TextBox
        Dim lbCode As Label
        'Dim ddlMateri As DropDownList
        ...
        Try
            ...
            dbType = DataGrid.Rows(e.RowIndex).FindControl("TypeEdit")
            ...
            SQLString = "Update MsStockType set StockTypeName= " + QuotedStr(dbName.Text) + ",Account= " + QuotedStr(dbAccount.Text) + ", Type= " + QuotedStr(dbType.Text) + " where StockTypeCode = " + QuotedStr(lbCode.Text)
    ...
    'Protected Sub AccountAdd_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Dim dr As DataRow
    '    Dim ds As DataSet
    '    Dim dgi As GridViewRow
    '    Dim Count As Integer
    ...
    Protected Sub TypeAdd_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'Dim dgi As GridViewRow
        'Dim Count As Integer
        'Dim ddlmateri As DropDownList
        'Dim dbJenisCode, dbJenisNo As TextBox
    ...
    Protected Sub TypeEdit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'Dim dgi As GridViewRow
        'Dim Count As Integer
        'Dim ddlmateri As DropDownList
        'Dim dbJenisCode, dbJenisNo As TextBox
