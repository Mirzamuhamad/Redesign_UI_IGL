<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsHKPrice.aspx.vb" Inherits="MsHKPrice_MsHKPrice" %>
...
<body>
  <form id="form1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div class="Content">
     <div class="H1">HK Price File</div>
     <hr style="color:Blue" />   
      <table>
        <tr>
            ...
            AutoGenerateColumns="False" AllowPaging="True" CssClass="Grid">
				...
				<EmptyDataTemplate>
				      ...
				      <Columns>				      
							...
							<asp:TemplateField HeaderText="Price (Rp)/ HK" HeaderStyle-Width="100" SortExpression="PriceHK">
								<Itemtemplate>
									<asp:Label Runat="server" ID="PriceHK" text='<%# Format(DataBinder.Eval(Container.DataItem, "PriceHK"),"#,##0.00") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:TextBox Runat="server" ID="PriceHKEdit" MaxLength="30" Width="100%" CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "PriceHK") %>'>
									</asp:TextBox>
