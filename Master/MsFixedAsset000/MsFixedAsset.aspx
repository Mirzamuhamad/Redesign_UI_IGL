      ...
      <table>
        ...
        <tr>
            ...
            <td colspan="9" rowspan="3">
                ...
                <tr>
                     <td><asp:TextBox runat="server" ID="tbLifeBuying" CssClass="TextBox" 
                             Enabled="False"/></td>
                     <td><asp:TextBox runat="server" ID="tbLifeDepr" CssClass="TextBox" 
                             Enabled="False"/></td>
                     <td><asp:TextBox runat="server" ID="tbLifeBalance" CssClass="TextBox" 
                             Enabled="False"/></td>
                     <td>
                     </td>
                </tr>
                    <tr>
                        <td>
                            <asp:TextBox ID="tbTotalBuying" runat="server" CssClass="TextBox" 
                                Enabled="False" />
                        </td>
                        <td>
                            <asp:TextBox ID="tbTotalDepr" runat="server" CssClass="TextBox" 
                                Enabled="False" />
                        </td>
                        <td>
                            <asp:TextBox ID="tbTotalBalance" runat="server" CssClass="TextBox" 
                                Enabled="False" />
                        </td>
                        <td>
                            <asp:TextBox ID="tbTotalNDA" runat="server" CssClass="TextBox" 
                                Enabled="False" />
                        </td>
                    </tr>
                </table>
