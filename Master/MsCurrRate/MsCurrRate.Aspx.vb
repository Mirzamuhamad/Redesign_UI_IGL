...
Partial Class Master_MsCurrRate_MsCurrRate
    ...
    Sub BindData()
        ...
        Dim CurrRate, TaxRate As TextBox
        Try
            ...
            End If
            tempDS = SQLExecuteQuery("EXEC S_MsCurrRateGetDt " + QuotedStr(Format(tbDate.SelectedDate, "yyyyMMdd")) + ", " + QuotedStr(StrFilter), ViewState("DBConnection").ToString)
            DataGrid.DataSource = tempDS.Tables(0)
            DataGrid.DataBind()

            For Each GVR In DataGrid.Rows
                CurrRate = GVR.FindControl("CurrRate")
                TaxRate = GVR.FindControl("TaxRate")
                CurrRate.Attributes.Add("OnKeyDown", "return PressNumeric();")
        ...
        Try
            ...
            If exe Then
                For i = 0 To DataGrid.Rows.Count - 1
                    ...
                    If Not ((tbRate.Text = "" Or tbRate.Text = "0") And (tbTaxRate.Text = "" Or tbTaxRate.Text = "0")) Then
                        SQLString = "EXEC S_MsCurrRateUpdate " + QuotedStr(Format(tbDate.SelectedDate, "yyyy-MM-dd")) + ", " + _
                            QuotedStr(lbCode.Text) + ", " + tbRate.Text + ", " + tbTaxRate.Text + ",'', " + QuotedStr(ViewState("UserId").ToString) ', " + QuotedStr(DDLOperator.SelectedValue) + "
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            Catch ex As Exception
                Throw New Exception("Bind Data Error : " + ex.ToString)
            End Try
            ExportGridToExcel("Currency_Rate")
        Catch ex As Exception
