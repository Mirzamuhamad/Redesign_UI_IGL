<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MsPayrollMaritalSt.aspx.vb" Inherits="Assign_MsPayrollMaritalSt_MsPayrollMaritalSt" %>
...
<body>    
    ...
    <div class="Content">   
    <div class="H1">Payroll Slip Marital Status</div>
    <hr style="color:Blue" /> 
        <br />                     
              ...
              <table width="100%">
               ...
               <div style="border:0px  solid; width:100%; height:100%; overflow:auto;">
                    <asp:GridView id="DataGrid" runat="server" ShowFooter="False" AllowSorting="True" 
				      ...
				      <Columns>
							<asp:TemplateField HeaderText="Marital Status" HeaderStyle-Width="70" SortExpression="MaritalStatus">
								<Itemtemplate>
									<asp:Label Runat="server" Width="70" ID="MaritalStatus" text='<%# DataBinder.Eval(Container.DataItem, "MaritalStatus") %>'>
									</asp:Label>
								</Itemtemplate>
								<EditItemTemplate>
									<asp:Label Runat="server" ID="MaritalStatusEdit" MaxLength="5" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "MaritalStatus") %>'>
									</asp:Label>
								</EditItemTemplate>
								<FooterTemplate>
									<asp:TextBox ID="MaritalStatusAdd" CssClass="TextBox" Width="100%" MaxLength="5" Runat="Server"/>								   
								</FooterTemplate>
        ...
        <asp:Panel ID="pnlNewSlip" runat="server" Visible ="false">
            ...
            <fieldset style="width:300px">
                    <legend> Apply for : </legend>
                        ...
                        <asp:ListItem Value= "0" Selected="True">All Marital Status</asp:ListItem>
                        <asp:ListItem Value= "1">Selected Marital Status</asp:ListItem>                        
                    </asp:RadioButtonList>                
                    </fieldset>
                    ...
                    <td style="width:40%;">
                        ...
                        EmptyDataText="There are no data records to display." KeyFieldName = "MaritalStatus"                     
                        ...
                        <dx:GridViewDataColumn Caption="Marital Status" FieldName="MaritalStatus" VisibleIndex="1" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>
                        <%--<dx:GridViewDataColumn Caption="Marital Status Name" FieldName="MaritalStatusName" VisibleIndex="2" > <Settings AutoFilterCondition="Contains" /> </dx:GridViewDataColumn>                        --%>
                        </Columns>
