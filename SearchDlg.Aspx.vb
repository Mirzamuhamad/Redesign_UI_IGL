...
Partial Public Class SearchDlg
    ...
    Protected Sub btnExpand_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExpand.Click
        Try
            ...
            '    lbStatus.Text = lbStatus.Text + a(i) + "<br/>"
            'Next
        Catch ex As Exception
    ...
    'Protected Sub GridView1_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs) Handles GridView1.CustomCallback
    '    Dim SelectValue As Object
    '    Dim Result(20), pk(10), Selected() As String
    '    Dim i, j As Integer

    '    Selected = ViewState("InColumn")
    '    For i = 0 To Selected.Count - 1
    '        Selected(i) = Selected(i).Trim
    '    Next

    '    pk = ViewState("pk").ToString.Split(";")

    '    SelectValue = GridView1.GetRowValues(Convert.ToInt32(e.Parameters), pk)

    '    For i = 0 To Selected.Count - 1
    '        'Result(i) = SelectValue(i).ToString
    '        For j = 0 To pk.Count - 1
    '            If Selected(i).ToString.ToLower = pk(j).ToLower Then
    '                Result(i) = SelectValue(j).ToString
    '            End If
    '        Next
    '    Next
    '    Session("Result") = Result
    ...
    Protected Sub btnApply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApply.Click, btnApply2.Click
        Dim SelectValue As Object
        Dim FocusRowIndex As Integer
        Dim Result(25), pk(10), Selected() As String
        Dim i, j As Integer
        Try
            FocusRowIndex = GridView1.FocusedRowIndex
            If FocusRowIndex >= 0 Then
                pk = ViewState("pk").ToString.Split(";")

                SelectValue = GridView1.GetRowValues(FocusRowIndex, pk)
            ...
            End If
        Catch ex As Exception
            lbStatus.Text = "btn Apply Click Error : " + ex.ToString
        End Try
    End Sub
